 ...
 */
@NoAutoDetect
class EventBackfillCloseResponse @JsonCreator private constructor(
    ...
    fun validate(): EventBackfillCloseResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(eventBackfillCloseResponse: EventBackfillCloseResponse) =
            apply {
                ...
                replaceExistingEvents = eventBackfillCloseResponse.replaceExistingEvents

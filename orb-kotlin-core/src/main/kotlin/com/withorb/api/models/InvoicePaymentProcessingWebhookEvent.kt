...
class InvoicePaymentProcessingWebhookEvent
...
private constructor(
    ...
    /** A builder for [InvoicePaymentProcessingWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            invoicePaymentProcessingWebhookEvent: InvoicePaymentProcessingWebhookEvent
        ) = apply {
            id = invoicePaymentProcessingWebhookEvent.id
            createdAt = invoicePaymentProcessingWebhookEvent.createdAt
            invoice = invoicePaymentProcessingWebhookEvent.invoice
            properties = invoicePaymentProcessingWebhookEvent.properties
            type = invoicePaymentProcessingWebhookEvent.type
            additionalProperties =
                invoicePaymentProcessingWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InvoicePaymentProcessingWebhookEvent].
         *
         ...
         */
        fun build(): InvoicePaymentProcessingWebhookEvent =
            InvoicePaymentProcessingWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): InvoicePaymentProcessingWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        ) : this(paymentProviderId, paymentProvider, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(paymentProviderId, paymentProvider, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Properties{paymentProviderId=$paymentProviderId, paymentProvider=$paymentProvider, additionalProperties=$additionalProperties}"
    }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val INVOICE_PAYMENT_PROCESSING = of("invoice.payment_processing")
        ...
        fun value(): Value =
            when (this) {
                INVOICE_PAYMENT_PROCESSING -> Value.INVOICE_PAYMENT_PROCESSING
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                INVOICE_PAYMENT_PROCESSING -> Known.INVOICE_PAYMENT_PROCESSING
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InvoicePaymentProcessingWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "InvoicePaymentProcessingWebhookEvent{id=$id, createdAt=$createdAt, invoice=$invoice, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}

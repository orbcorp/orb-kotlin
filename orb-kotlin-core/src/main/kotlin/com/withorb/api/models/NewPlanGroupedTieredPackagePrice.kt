...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(newPlanGroupedTieredPackagePrice: NewPlanGroupedTieredPackagePrice) =
            apply {
                ...
                conversionRateConfig = newPlanGroupedTieredPackagePrice.conversionRateConfig
                currency = newPlanGroupedTieredPackagePrice.currency
                dimensionalPriceConfiguration =
                    newPlanGroupedTieredPackagePrice.dimensionalPriceConfiguration
                ...
                licenseTypeId = newPlanGroupedTieredPackagePrice.licenseTypeId
                metadata = newPlanGroupedTieredPackagePrice.metadata
                referenceId = newPlanGroupedTieredPackagePrice.referenceId
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NewPlanGroupedTieredPackagePrice &&
    ...
    override fun toString() =
        "NewPlanGroupedTieredPackagePrice{cadence=$cadence, groupedTieredPackageConfig=$groupedTieredPackageConfig, itemId=$itemId, modelType=$modelType, name=$name, billableMetricId=$billableMetricId, billedInAdvance=$billedInAdvance, billingCycleConfiguration=$billingCycleConfiguration, conversionRate=$conversionRate, conversionRateConfig=$conversionRateConfig, currency=$currency, dimensionalPriceConfiguration=$dimensionalPriceConfiguration, externalPriceId=$externalPriceId, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, invoicingCycleConfiguration=$invoicingCycleConfiguration, licenseTypeId=$licenseTypeId, metadata=$metadata, referenceId=$referenceId, additionalProperties=$additionalProperties}"
}

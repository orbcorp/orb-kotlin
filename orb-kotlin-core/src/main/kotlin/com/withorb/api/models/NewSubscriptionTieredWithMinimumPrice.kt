...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            tieredWithMinimumConfig = newSubscriptionTieredWithMinimumPrice.tieredWithMinimumConfig
            ...
            conversionRateConfig = newSubscriptionTieredWithMinimumPrice.conversionRateConfig
            currency = newSubscriptionTieredWithMinimumPrice.currency
            dimensionalPriceConfiguration =
                newSubscriptionTieredWithMinimumPrice.dimensionalPriceConfiguration
            ...
            licenseTypeId = newSubscriptionTieredWithMinimumPrice.licenseTypeId
         ...
         * [TieredWithMinimumConfig] value instead. This method is primarily for setting the field
        ...
        /**
         * Returns an immutable instance of [NewSubscriptionTieredWithMinimumPrice].
         *
    ...
    private constructor(
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [TieredWithMinimumConfig].
             *
             * The following fields are required:
             * ```kotlin
             * .tiers()
    ...
    override fun toString() =
        "NewSubscriptionTieredWithMinimumPrice{cadence=$cadence, itemId=$itemId, modelType=$modelType, name=$name, tieredWithMinimumConfig=$tieredWithMinimumConfig, billableMetricId=$billableMetricId, billedInAdvance=$billedInAdvance, billingCycleConfiguration=$billingCycleConfiguration, conversionRate=$conversionRate, conversionRateConfig=$conversionRateConfig, currency=$currency, dimensionalPriceConfiguration=$dimensionalPriceConfiguration, externalPriceId=$externalPriceId, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, invoicingCycleConfiguration=$invoicingCycleConfiguration, licenseTypeId=$licenseTypeId, metadata=$metadata, referenceId=$referenceId, additionalProperties=$additionalProperties}"
}

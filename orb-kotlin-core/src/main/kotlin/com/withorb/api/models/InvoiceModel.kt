...
private constructor(
    ...
    fun billingAddress(): AddressModel? = billingAddress.getNullable("billing_address")
     ...
     */
    fun customerTaxId(): CustomerTaxIdModel? = customerTaxId.getNullable("customer_tax_id")
    ...
    fun maximum(): MaximumModel? = maximum.getNullable("maximum")
    ...
    fun minimum(): MinimumModel? = minimum.getNullable("minimum")
    ...
    fun shippingAddress(): AddressModel? = shippingAddress.getNullable("shipping_address")
    ...
    fun validate(): InvoiceModel = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InvoiceModel].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(invoiceModel: InvoiceModel) = apply {
            id = invoiceModel.id
            amountDue = invoiceModel.amountDue
            autoCollection = invoiceModel.autoCollection
            billingAddress = invoiceModel.billingAddress
            createdAt = invoiceModel.createdAt
            creditNotes = invoiceModel.creditNotes.map { it.toMutableList() }
            currency = invoiceModel.currency
            customer = invoiceModel.customer
            customerBalanceTransactions =
                invoiceModel.customerBalanceTransactions.map { it.toMutableList() }
            customerTaxId = invoiceModel.customerTaxId
            discount = invoiceModel.discount
            discounts = invoiceModel.discounts.map { it.toMutableList() }
            dueDate = invoiceModel.dueDate
            eligibleToIssueAt = invoiceModel.eligibleToIssueAt
            hostedInvoiceUrl = invoiceModel.hostedInvoiceUrl
            invoiceDate = invoiceModel.invoiceDate
            invoiceNumber = invoiceModel.invoiceNumber
            invoicePdf = invoiceModel.invoicePdf
            invoiceSource = invoiceModel.invoiceSource
            issueFailedAt = invoiceModel.issueFailedAt
            issuedAt = invoiceModel.issuedAt
            lineItems = invoiceModel.lineItems.map { it.toMutableList() }
            maximum = invoiceModel.maximum
            maximumAmount = invoiceModel.maximumAmount
            memo = invoiceModel.memo
            metadata = invoiceModel.metadata
            minimum = invoiceModel.minimum
            minimumAmount = invoiceModel.minimumAmount
            paidAt = invoiceModel.paidAt
            paymentAttempts = invoiceModel.paymentAttempts.map { it.toMutableList() }
            paymentFailedAt = invoiceModel.paymentFailedAt
            paymentStartedAt = invoiceModel.paymentStartedAt
            scheduledIssueAt = invoiceModel.scheduledIssueAt
            shippingAddress = invoiceModel.shippingAddress
            status = invoiceModel.status
            subscription = invoiceModel.subscription
            subtotal = invoiceModel.subtotal
            syncFailedAt = invoiceModel.syncFailedAt
            total = invoiceModel.total
            voidedAt = invoiceModel.voidedAt
            willAutoIssue = invoiceModel.willAutoIssue
            additionalProperties = invoiceModel.additionalProperties.toMutableMap()
        }

...
private constructor(
     ...
     *   responded with an unexpected value).
     */
    fun pendingSubscriptionChange(): SubscriptionChangeMinified? =
     ...
     *   responded with an unexpected value).
     */
    fun redeemedCoupon(): CouponRedemption? = redeemedCoupon.getNullable("redeemed_coupon")
     ...
     *   responded with an unexpected value).
     */
    fun changedResources(): ChangedSubscriptionResources? =
    ...
    class Builder internal constructor() {
        ...
        internal fun from(mutatedSubscription: MutatedSubscription) = apply {
            ...
            autoIssuance = mutatedSubscription.autoIssuance
    ...
    private constructor(
        ...
        fun tieredPercentage(): TieredPercentage? = tieredPercentage
         ...
         * import com.withorb.api.core.JsonValue
         *
         * val result: String? = discountInterval.accept(object : DiscountInterval.Visitor<String?> {
         *     override fun visitAmount(amount: AmountDiscountInterval): String? = amount.toString()
         *
         *     // ...
         *

 ...
 * Orb.
 */
@JsonDeserialize(using = CreditLedgerEntryModel.Deserializer::class)
@JsonSerialize(using = CreditLedgerEntryModel.Serializer::class)
class CreditLedgerEntryModel
private constructor(
    ...
    private val blockExpiryLedgerEntry: CreditBlockExpiryLedgerEntry? = null,
    ...
    fun blockExpiryLedgerEntry(): CreditBlockExpiryLedgerEntry? = blockExpiryLedgerEntry
    ...
    fun isBlockExpiryLedgerEntry(): Boolean = blockExpiryLedgerEntry != null
    ...
    fun asBlockExpiryLedgerEntry(): CreditBlockExpiryLedgerEntry =
        blockExpiryLedgerEntry.getOrThrow("blockExpiryLedgerEntry")
    ...
    fun <T> accept(visitor: Visitor<T>): T {
        return when {
            ...
            blockExpiryLedgerEntry != null ->
                visitor.visitBlockExpiryLedgerEntry(blockExpiryLedgerEntry)
    ...
    fun validate(): CreditLedgerEntryModel = apply {
        if (validated) {
            return@apply
        }
        ...
        accept(
            object : Visitor<Unit> {
                ...
                override fun visitBlockExpiryLedgerEntry(
                    blockExpiryLedgerEntry: CreditBlockExpiryLedgerEntry
                ) {
                    blockExpiryLedgerEntry.validate()
                }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CreditLedgerEntryModel && incrementLedgerEntry == other.incrementLedgerEntry && decrementLedgerEntry == other.decrementLedgerEntry && expirationChangeLedgerEntry == other.expirationChangeLedgerEntry && blockExpiryLedgerEntry == other.blockExpiryLedgerEntry && voidLedgerEntry == other.voidLedgerEntry && voidInitiatedLedgerEntry == other.voidInitiatedLedgerEntry && amendmentLedgerEntry == other.amendmentLedgerEntry /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(incrementLedgerEntry, decrementLedgerEntry, expirationChangeLedgerEntry, blockExpiryLedgerEntry, voidLedgerEntry, voidInitiatedLedgerEntry, amendmentLedgerEntry) /* spotless:on */

    override fun toString(): String =
        when {
            incrementLedgerEntry != null ->
                "CreditLedgerEntryModel{incrementLedgerEntry=$incrementLedgerEntry}"
            decrementLedgerEntry != null ->
                "CreditLedgerEntryModel{decrementLedgerEntry=$decrementLedgerEntry}"
            expirationChangeLedgerEntry != null ->
                "CreditLedgerEntryModel{expirationChangeLedgerEntry=$expirationChangeLedgerEntry}"
            blockExpiryLedgerEntry != null ->
                "CreditLedgerEntryModel{blockExpiryLedgerEntry=$blockExpiryLedgerEntry}"
            voidLedgerEntry != null -> "CreditLedgerEntryModel{voidLedgerEntry=$voidLedgerEntry}"
            voidInitiatedLedgerEntry != null ->
            ...
            _json != null -> "CreditLedgerEntryModel{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid CreditLedgerEntryModel")
        }
    ...
    companion object {
        ...
        fun ofBlockExpiryLedgerEntry(blockExpiryLedgerEntry: CreditBlockExpiryLedgerEntry) =
            CreditLedgerEntryModel(blockExpiryLedgerEntry = blockExpiryLedgerEntry)
    ...
    /**
     * An interface that defines how to map each variant of [CreditLedgerEntryModel] to a value of
     * type [T].
     */
    interface Visitor<out T> {
        ...
        fun visitBlockExpiryLedgerEntry(blockExpiryLedgerEntry: CreditBlockExpiryLedgerEntry): T
        ...
        /**
         * Maps an unknown variant of [CreditLedgerEntryModel] to a value of type [T].
         *
         * An instance of [CreditLedgerEntryModel] can contain an unknown variant if it was
        ...
        fun unknown(json: JsonValue?): T {
            throw OrbInvalidDataException("Unknown CreditLedgerEntryModel: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<CreditLedgerEntryModel>(CreditLedgerEntryModel::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): CreditLedgerEntryModel {
            ...
            when (entryType) {
                "increment" -> {
                    tryDeserialize(node, jacksonTypeRef<IncrementLedgerEntry>()) { it.validate() }
                        ?.let {
                            return CreditLedgerEntryModel(incrementLedgerEntry = it, _json = json)
                        }
                }
                "decrement" -> {
                    tryDeserialize(node, jacksonTypeRef<DecrementLedgerEntry>()) { it.validate() }
                        ?.let {
                            return CreditLedgerEntryModel(decrementLedgerEntry = it, _json = json)
                        }
                }
                "expiration_change" -> {
                ...
                "credit_block_expiry" -> {
                    tryDeserialize(node, jacksonTypeRef<CreditBlockExpiryLedgerEntry>()) {
                        ...
                        ?.let {
                            return CreditLedgerEntryModel(blockExpiryLedgerEntry = it, _json = json)
                        }
                }
                "void" -> {
                    tryDeserialize(node, jacksonTypeRef<VoidLedgerEntry>()) { it.validate() }
                        ?.let {
                            return CreditLedgerEntryModel(voidLedgerEntry = it, _json = json)
                        }
                }
                "void_initiated" -> {
                ...
                "amendment" -> {
                    tryDeserialize(node, jacksonTypeRef<AmendmentLedgerEntry>()) { it.validate() }
                        ?.let {
                            return CreditLedgerEntryModel(amendmentLedgerEntry = it, _json = json)
                        }
                }
            }

            return CreditLedgerEntryModel(_json = json)
        }
    }

    internal class Serializer :
        BaseSerializer<CreditLedgerEntryModel>(CreditLedgerEntryModel::class) {

        override fun serialize(
            value: CreditLedgerEntryModel,
            ...
            when {
                ...
                value.blockExpiryLedgerEntry != null ->
                    generator.writeObject(value.blockExpiryLedgerEntry)
    ...
    private constructor(
        ...
        @ExcludeMissing
        private val creditBlock: JsonField<AffectedBlockModel> = JsonMissing.of(),
        ...
        fun creditBlock(): AffectedBlockModel = creditBlock.getRequired("credit_block")
        ...
        @JsonProperty("credit_block")
        @ExcludeMissing
        fun _creditBlock(): JsonField<AffectedBlockModel> = creditBlock
        ...
        class Builder internal constructor() {
            ...
            private var creditBlock: JsonField<AffectedBlockModel>? = null
            ...
            fun creditBlock(creditBlock: AffectedBlockModel) =
                creditBlock(JsonField.of(creditBlock))

            fun creditBlock(creditBlock: JsonField<AffectedBlockModel>) = apply {
    ...
    private constructor(
        ...
        fun newBlockExpiryDate(): OffsetDateTime? =
            newBlockExpiryDate.getNullable("new_block_expiry_date")

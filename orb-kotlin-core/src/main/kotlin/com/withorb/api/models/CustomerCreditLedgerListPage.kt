 ...
 */
class CustomerCreditLedgerListPage private constructor(
    ...
    companion object {
        ...
        fun of(ledgerService: LedgerService, params: CustomerCreditLedgerListParams, response: Response) =
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<CustomerCreditLedgerListResponse> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {

...
class CustomerCreditBalanceRecoveredWebhookEvent
...
private constructor(
    ...
    /** A builder for [CustomerCreditBalanceRecoveredWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            customerCreditBalanceRecoveredWebhookEvent: CustomerCreditBalanceRecoveredWebhookEvent
        ) = apply {
            id = customerCreditBalanceRecoveredWebhookEvent.id
            createdAt = customerCreditBalanceRecoveredWebhookEvent.createdAt
            customer = customerCreditBalanceRecoveredWebhookEvent.customer
            properties = customerCreditBalanceRecoveredWebhookEvent.properties
            type = customerCreditBalanceRecoveredWebhookEvent.type
            additionalProperties =
                customerCreditBalanceRecoveredWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomerCreditBalanceRecoveredWebhookEvent].
         *
         ...
         */
        fun build(): CustomerCreditBalanceRecoveredWebhookEvent =
            CustomerCreditBalanceRecoveredWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): CustomerCreditBalanceRecoveredWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val CUSTOMER_CREDIT_BALANCE_RECOVERED = of("customer.credit_balance_recovered")
        ...
        fun value(): Value =
            when (this) {
                CUSTOMER_CREDIT_BALANCE_RECOVERED -> Value.CUSTOMER_CREDIT_BALANCE_RECOVERED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CUSTOMER_CREDIT_BALANCE_RECOVERED -> Known.CUSTOMER_CREDIT_BALANCE_RECOVERED
                else -> throw OrbInvalidDataException("Unknown Type: $value")
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomerCreditBalanceRecoveredWebhookEvent &&
            id == other.id &&
            createdAt == other.createdAt &&
            customer == other.customer &&
    ...
    override fun toString() =
        "CustomerCreditBalanceRecoveredWebhookEvent{id=$id, createdAt=$createdAt, customer=$customer, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}

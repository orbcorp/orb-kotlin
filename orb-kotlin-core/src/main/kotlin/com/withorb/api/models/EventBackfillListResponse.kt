 ...
 */
@NoAutoDetect
class EventBackfillListResponse @JsonCreator private constructor(
    ...
    fun validate(): EventBackfillListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(eventBackfillListResponse: EventBackfillListResponse) =
            apply {

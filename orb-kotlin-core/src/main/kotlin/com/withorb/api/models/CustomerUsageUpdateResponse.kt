...
@JsonDeserialize(builder = CustomerUsageUpdateResponse.Builder::class)
@NoAutoDetect
class CustomerUsageUpdateResponse
private constructor(
    ...
    fun validate(): CustomerUsageUpdateResponse = apply {
        if (!validated) {
            duplicate()
            ingested()
            validated = true
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomerUsageUpdateResponse &&
    ...
    override fun toString() =
        "CustomerUsageUpdateResponse{duplicate=$duplicate, ingested=$ingested, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(customerUsageUpdateResponse: CustomerUsageUpdateResponse) = apply {
            this.duplicate = customerUsageUpdateResponse.duplicate
            this.ingested = customerUsageUpdateResponse.ingested
            additionalProperties(customerUsageUpdateResponse.additionalProperties)
        }
        ...
        fun build(): CustomerUsageUpdateResponse =

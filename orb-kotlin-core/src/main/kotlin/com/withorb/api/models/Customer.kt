...
class Customer @JsonCreator private constructor(
    ...
    @JsonProperty("balance") @ExcludeMissing private val balance: JsonField<String> = JsonMissing.of(),
    ...
    @JsonProperty("exempt_from_automated_tax") @ExcludeMissing private val exemptFromAutomatedTax: JsonField<Boolean> = JsonMissing.of(),
    ...
    @JsonProperty("portal_url") @ExcludeMissing private val portalUrl: JsonField<String> = JsonMissing.of(),
    ...
    fun exemptFromAutomatedTax(): Boolean? = exemptFromAutomatedTax.getNullable("exempt_from_automated_tax")
    ...
    @ExcludeMissing
    fun _portalUrl(): JsonField<String> = portalUrl
    ...
    class Builder internal constructor() {
        ...
        fun exemptFromAutomatedTax(exemptFromAutomatedTax: Boolean?) = exemptFromAutomatedTax(JsonField.ofNullable(exemptFromAutomatedTax))

        fun exemptFromAutomatedTax(exemptFromAutomatedTax: Boolean) = exemptFromAutomatedTax(exemptFromAutomatedTax as Boolean?)

        fun exemptFromAutomatedTax(exemptFromAutomatedTax: JsonField<Boolean>) =
            apply {
        ...
        fun portalUrl(portalUrl: JsonField<String>) =
            apply {
        ...
        fun build(): Customer =
            Customer(
              ...
              checkRequired(
                "exemptFromAutomatedTax", exemptFromAutomatedTax
              ),
              checkRequired(
    ...
    class Hierarchy @JsonCreator private constructor(
        @JsonProperty("children") @ExcludeMissing private val children: JsonField<List<Child>> = JsonMissing.of(),
        @JsonProperty("parent") @ExcludeMissing private val parent: JsonField<Parent> = JsonMissing.of(),
        @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
        ...
        class Builder internal constructor() {
            ...
            fun children(children: JsonField<List<Child>>) =
                apply {
            ...
            fun addChild(child: Child) =
                apply {
                    children = (children ?: JsonField.of(mutableListOf())).also {
            ...
            fun parent(parent: JsonField<Parent>) =
                apply {
                    this.parent = parent
                }
        ...
        @NoAutoDetect
        class Child @JsonCreator private constructor(
            @JsonProperty("id") @ExcludeMissing private val id: JsonField<String> = JsonMissing.of(),
            @JsonProperty("external_customer_id") @ExcludeMissing private val externalCustomerId: JsonField<String> = JsonMissing.of(),
            @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
            ...
            override fun toString() = "Child{id=$id, externalCustomerId=$externalCustomerId, additionalProperties=$additionalProperties}"
        }

        @NoAutoDetect
        class Parent @JsonCreator private constructor(
            @JsonProperty("id") @ExcludeMissing private val id: JsonField<String> = JsonMissing.of(),
            @JsonProperty("external_customer_id") @ExcludeMissing private val externalCustomerId: JsonField<String> = JsonMissing.of(),
            @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
            ...
            class Builder internal constructor() {
                ...
                internal fun from(parent: Parent) =
                    apply {
                        id = parent.id
            ...
            override fun toString() = "Parent{id=$id, externalCustomerId=$externalCustomerId, additionalProperties=$additionalProperties}"
        }
        ...
        override fun toString() = "Hierarchy{children=$children, parent=$parent, additionalProperties=$additionalProperties}"
    }
    ...
    class AccountingSyncConfiguration @JsonCreator private constructor(
        ...
        class AccountingProvider @JsonCreator private constructor(
            ...
            @JsonProperty("provider_type") @ExcludeMissing private val providerType: JsonField<ProviderType> = JsonMissing.of(),
            @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),

        ) {

            fun externalProviderId(): String? = externalProviderId.getNullable("external_provider_id")
            ...
            class Builder internal constructor() {
                ...
                fun externalProviderId(externalProviderId: String?) = externalProviderId(JsonField.ofNullable(externalProviderId))
                ...
                fun providerType(providerType: JsonField<ProviderType>) =
                    apply {
            ...
            class ProviderType @JsonCreator private constructor(
                private val value: JsonField<String>,
                ...
                enum class Value {
                    ...
                    NETSUITE,
                    /**
                     * An enum member indicating that [ProviderType] was instantiated with an unknown
                     * value.
                     */
                    _UNKNOWN,
                }

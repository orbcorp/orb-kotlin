...
/** List top-ups */
class CustomerCreditTopUpListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(customerCreditTopUpListParams: CustomerCreditTopUpListParams) =
            apply {
    ...
    override fun toString() = "CustomerCreditTopUpListParams{customerId=$customerId, cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

...
@NoAutoDetect
class CustomerBalanceTransactionCreateResponse @JsonCreator private constructor(
    ...
    fun validate(): CustomerBalanceTransactionCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(customerBalanceTransactionCreateResponse: CustomerBalanceTransactionCreateResponse) =
            apply {
                ...
                additionalProperties = customerBalanceTransactionCreateResponse.additionalProperties.toMutableMap()
            }
    ...
    override fun toString() = "CustomerBalanceTransactionCreateResponse{id=$id, action=$action, amount=$amount, createdAt=$createdAt, creditNote=$creditNote, description=$description, endingBalance=$endingBalance, invoice=$invoice, startingBalance=$startingBalance, type=$type, additionalProperties=$additionalProperties}"
}

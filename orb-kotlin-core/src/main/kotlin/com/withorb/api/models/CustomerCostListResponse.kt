...
@NoAutoDetect
class CustomerCostListResponse @JsonCreator private constructor(
    ...
    fun validate(): CustomerCostListResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(customerCostListResponse: CustomerCostListResponse) =
            apply {
    ...
    override fun toString() = "CustomerCostListResponse{data=$data, additionalProperties=$additionalProperties}"
}

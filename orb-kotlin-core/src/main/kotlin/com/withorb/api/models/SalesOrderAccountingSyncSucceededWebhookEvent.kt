...
class SalesOrderAccountingSyncSucceededWebhookEvent
...
private constructor(
    ...
    /** A builder for [SalesOrderAccountingSyncSucceededWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = salesOrderAccountingSyncSucceededWebhookEvent.id
            accountingSyncRecord =
                salesOrderAccountingSyncSucceededWebhookEvent.accountingSyncRecord
            createdAt = salesOrderAccountingSyncSucceededWebhookEvent.createdAt
            invoice = salesOrderAccountingSyncSucceededWebhookEvent.invoice
            properties = salesOrderAccountingSyncSucceededWebhookEvent.properties
            type = salesOrderAccountingSyncSucceededWebhookEvent.type
            additionalProperties =
                salesOrderAccountingSyncSucceededWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SalesOrderAccountingSyncSucceededWebhookEvent].
         *
         ...
         */
        fun build(): SalesOrderAccountingSyncSucceededWebhookEvent =
            SalesOrderAccountingSyncSucceededWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): SalesOrderAccountingSyncSucceededWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val SALES_ORDER_ACCOUNTING_SYNC_SUCCEEDED = of("sales_order.accounting_sync_succeeded")
        ...
        fun value(): Value =
            when (this) {
                SALES_ORDER_ACCOUNTING_SYNC_SUCCEEDED -> Value.SALES_ORDER_ACCOUNTING_SYNC_SUCCEEDED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                SALES_ORDER_ACCOUNTING_SYNC_SUCCEEDED -> Known.SALES_ORDER_ACCOUNTING_SYNC_SUCCEEDED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SalesOrderAccountingSyncSucceededWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "SalesOrderAccountingSyncSucceededWebhookEvent{id=$id, accountingSyncRecord=$accountingSyncRecord, createdAt=$createdAt, invoice=$invoice, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}

...
class CustomerCreditTopUpListByExternalIdParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "CustomerCreditTopUpListByExternalIdParams{externalCustomerId=$externalCustomerId, cursor=$cursor, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(customerCreditTopUpListByExternalIdParams: CustomerCreditTopUpListByExternalIdParams) = apply {
            ...
            additionalBodyProperties(customerCreditTopUpListByExternalIdParams.additionalBodyProperties)
        }
        ...
        fun build(): CustomerCreditTopUpListByExternalIdParams = CustomerCreditTopUpListByExternalIdParams(

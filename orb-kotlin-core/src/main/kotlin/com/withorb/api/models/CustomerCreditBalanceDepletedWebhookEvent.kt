...
class CustomerCreditBalanceDepletedWebhookEvent
...
private constructor(
    ...
    /** A builder for [CustomerCreditBalanceDepletedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            customerCreditBalanceDepletedWebhookEvent: CustomerCreditBalanceDepletedWebhookEvent
        ) = apply {
            id = customerCreditBalanceDepletedWebhookEvent.id
            createdAt = customerCreditBalanceDepletedWebhookEvent.createdAt
            customer = customerCreditBalanceDepletedWebhookEvent.customer
            properties = customerCreditBalanceDepletedWebhookEvent.properties
            type = customerCreditBalanceDepletedWebhookEvent.type
            additionalProperties =
                customerCreditBalanceDepletedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomerCreditBalanceDepletedWebhookEvent].
         *
         ...
         */
        fun build(): CustomerCreditBalanceDepletedWebhookEvent =
            CustomerCreditBalanceDepletedWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): CustomerCreditBalanceDepletedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        ) : this(alertConfiguration, pricingUnit, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(alertConfiguration, pricingUnit, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Properties{alertConfiguration=$alertConfiguration, pricingUnit=$pricingUnit, additionalProperties=$additionalProperties}"
    }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val CUSTOMER_CREDIT_BALANCE_DEPLETED = of("customer.credit_balance_depleted")
        ...
        /** An enum containing [Type]'s known values. */
        enum class Known {
            CUSTOMER_CREDIT_BALANCE_DEPLETED
        }
        ...
        fun value(): Value =
            when (this) {
                CUSTOMER_CREDIT_BALANCE_DEPLETED -> Value.CUSTOMER_CREDIT_BALANCE_DEPLETED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CUSTOMER_CREDIT_BALANCE_DEPLETED -> Known.CUSTOMER_CREDIT_BALANCE_DEPLETED
                else -> throw OrbInvalidDataException("Unknown Type: $value")
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomerCreditBalanceDepletedWebhookEvent &&
            id == other.id &&
            createdAt == other.createdAt &&
            customer == other.customer &&
    ...
    override fun toString() =
        "CustomerCreditBalanceDepletedWebhookEvent{id=$id, createdAt=$createdAt, customer=$customer, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}

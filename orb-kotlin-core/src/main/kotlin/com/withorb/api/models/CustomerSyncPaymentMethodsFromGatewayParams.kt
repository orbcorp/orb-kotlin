 ...
 */
class CustomerSyncPaymentMethodsFromGatewayParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(customerSyncPaymentMethodsFromGatewayParams: CustomerSyncPaymentMethodsFromGatewayParams) =
            apply {
                externalCustomerId = customerSyncPaymentMethodsFromGatewayParams.externalCustomerId
                additionalHeaders = customerSyncPaymentMethodsFromGatewayParams.additionalHeaders.toBuilder()
                additionalQueryParams = customerSyncPaymentMethodsFromGatewayParams.additionalQueryParams.toBuilder()
                additionalBodyProperties = customerSyncPaymentMethodsFromGatewayParams.additionalBodyProperties.toMutableMap()
            }
    ...
    override fun toString() = "CustomerSyncPaymentMethodsFromGatewayParams{externalCustomerId=$externalCustomerId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}

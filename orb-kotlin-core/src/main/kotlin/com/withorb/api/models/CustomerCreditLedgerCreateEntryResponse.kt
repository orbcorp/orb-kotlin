...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CustomerCreditLedgerCreateEntryResponse && increment == other.increment && decrement == other.decrement && expirationChange == other.expirationChange && creditBlockExpiry == other.creditBlockExpiry && void == other.void && voidInitiated == other.voidInitiated && amendment == other.amendment /* spotless:on */
    }
    ...
    companion object {
        ...
        fun ofVoid(void: Void) = CustomerCreditLedgerCreateEntryResponse(void = void)
            ...
            when (entryType) {
                ...
                "expiration_change" -> {
                    return tryDeserialize(node, jacksonTypeRef<ExpirationChange>())?.let {
                        CustomerCreditLedgerCreateEntryResponse(expirationChange = it, _json = json)
                    } ?: CustomerCreditLedgerCreateEntryResponse(_json = json)
                }
                "credit_block_expiry" -> {

...
private constructor(
     ...
     *
     * Unlike [bulkBpsConfig], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("bulk_bps_config")
    @ExcludeMissing
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NewSubscriptionBulkBpsPrice].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(newSubscriptionBulkBpsPrice: NewSubscriptionBulkBpsPrice) = apply {
            ...
            dimensionalPriceConfiguration =
                newSubscriptionBulkBpsPrice.dimensionalPriceConfiguration
            ...
            invoicingCycleConfiguration = newSubscriptionBulkBpsPrice.invoicingCycleConfiguration
            metadata = newSubscriptionBulkBpsPrice.metadata
            referenceId = newSubscriptionBulkBpsPrice.referenceId
            additionalProperties = newSubscriptionBulkBpsPrice.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.bulkBpsConfig] with a well-typed [BulkBpsConfig] value
        ...
        /**
         * Returns an immutable instance of [NewSubscriptionBulkBpsPrice].
         *
    ...
    internal fun validity(): Int =
        (bulkBpsConfig.asKnown()?.validity() ?: 0) +
    ...
    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(bulkBpsConfig, cadence, itemId, modelType, name, billableMetricId, billedInAdvance, billingCycleConfiguration, conversionRate, currency, dimensionalPriceConfiguration, externalPriceId, fixedPriceQuantity, invoiceGroupingKey, invoicingCycleConfiguration, metadata, referenceId, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "NewSubscriptionBulkBpsPrice{bulkBpsConfig=$bulkBpsConfig, cadence=$cadence, itemId=$itemId, modelType=$modelType, name=$name, billableMetricId=$billableMetricId, billedInAdvance=$billedInAdvance, billingCycleConfiguration=$billingCycleConfiguration, conversionRate=$conversionRate, currency=$currency, dimensionalPriceConfiguration=$dimensionalPriceConfiguration, externalPriceId=$externalPriceId, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, invoicingCycleConfiguration=$invoicingCycleConfiguration, metadata=$metadata, referenceId=$referenceId, additionalProperties=$additionalProperties}"
}

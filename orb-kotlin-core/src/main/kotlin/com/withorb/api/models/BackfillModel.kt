...
private constructor(
    ...
    fun validate(): BackfillModel = apply {
        if (validated) {
            return@apply
        }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(backfillModel: BackfillModel) = apply {
            id = backfillModel.id
            closeTime = backfillModel.closeTime
            createdAt = backfillModel.createdAt
            customerId = backfillModel.customerId
            eventsIngested = backfillModel.eventsIngested
            replaceExistingEvents = backfillModel.replaceExistingEvents
            revertedAt = backfillModel.revertedAt
            status = backfillModel.status
            timeframeEnd = backfillModel.timeframeEnd
            timeframeStart = backfillModel.timeframeStart
            deprecationFilter = backfillModel.deprecationFilter
            additionalProperties = backfillModel.additionalProperties.toMutableMap()
        }

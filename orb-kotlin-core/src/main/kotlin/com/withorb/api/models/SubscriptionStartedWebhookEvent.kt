...
class SubscriptionStartedWebhookEvent
...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = subscriptionStartedWebhookEvent.properties().convert(MyClass::class.java)
     * ```
     */
    ...
    /** A builder for [SubscriptionStartedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionStartedWebhookEvent: SubscriptionStartedWebhookEvent) =
            apply {
                id = subscriptionStartedWebhookEvent.id
                createdAt = subscriptionStartedWebhookEvent.createdAt
                properties = subscriptionStartedWebhookEvent.properties
                subscription = subscriptionStartedWebhookEvent.subscription
                type = subscriptionStartedWebhookEvent.type
                additionalProperties =
                    subscriptionStartedWebhookEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SubscriptionStartedWebhookEvent].
         *
         ...
         */
        fun build(): SubscriptionStartedWebhookEvent =
            SubscriptionStartedWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): SubscriptionStartedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val SUBSCRIPTION_STARTED = of("subscription.started")
        ...
        fun value(): Value =
            when (this) {
                SUBSCRIPTION_STARTED -> Value.SUBSCRIPTION_STARTED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                SUBSCRIPTION_STARTED -> Known.SUBSCRIPTION_STARTED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionStartedWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "SubscriptionStartedWebhookEvent{id=$id, createdAt=$createdAt, properties=$properties, subscription=$subscription, type=$type, additionalProperties=$additionalProperties}"
}

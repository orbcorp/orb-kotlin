...
@NoAutoDetect
class SubscriptionFetchCostsResponse @JsonCreator private constructor(
    ...
    fun validate(): SubscriptionFetchCostsResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionFetchCostsResponse: SubscriptionFetchCostsResponse) =
            apply {
                data = subscriptionFetchCostsResponse.data.map { it.toMutableList() }
                additionalProperties = subscriptionFetchCostsResponse.additionalProperties.toMutableMap()
            }
    ...
    override fun toString() = "SubscriptionFetchCostsResponse{data=$data, additionalProperties=$additionalProperties}"
}

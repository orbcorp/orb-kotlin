...
class InvoiceSyncSucceededWebhookEvent
...
private constructor(
    ...
    /** A builder for [InvoiceSyncSucceededWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(invoiceSyncSucceededWebhookEvent: InvoiceSyncSucceededWebhookEvent) =
            apply {
                id = invoiceSyncSucceededWebhookEvent.id
                createdAt = invoiceSyncSucceededWebhookEvent.createdAt
                invoice = invoiceSyncSucceededWebhookEvent.invoice
                properties = invoiceSyncSucceededWebhookEvent.properties
                type = invoiceSyncSucceededWebhookEvent.type
                additionalProperties =
                    invoiceSyncSucceededWebhookEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [InvoiceSyncSucceededWebhookEvent].
         *
         ...
         */
        fun build(): InvoiceSyncSucceededWebhookEvent =
            InvoiceSyncSucceededWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): InvoiceSyncSucceededWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        ) : this(paymentProvider, paymentProviderId, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(paymentProvider, paymentProviderId, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Properties{paymentProvider=$paymentProvider, paymentProviderId=$paymentProviderId, additionalProperties=$additionalProperties}"
    }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val INVOICE_SYNC_SUCCEEDED = of("invoice.sync_succeeded")
        ...
        fun value(): Value =
            when (this) {
                INVOICE_SYNC_SUCCEEDED -> Value.INVOICE_SYNC_SUCCEEDED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                INVOICE_SYNC_SUCCEEDED -> Known.INVOICE_SYNC_SUCCEEDED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InvoiceSyncSucceededWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "InvoiceSyncSucceededWebhookEvent{id=$id, createdAt=$createdAt, invoice=$invoice, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}

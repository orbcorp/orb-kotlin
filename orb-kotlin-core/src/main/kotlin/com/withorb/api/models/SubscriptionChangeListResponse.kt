...
private constructor(
    ...
    ) : this(id, expirationTime, status, subscriptionId, appliedAt, cancelledAt, mutableMapOf())
    ...
    /** A builder for [SubscriptionChangeListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionChangeListResponse: SubscriptionChangeListResponse) = apply {
            id = subscriptionChangeListResponse.id
            expirationTime = subscriptionChangeListResponse.expirationTime
            status = subscriptionChangeListResponse.status
            subscriptionId = subscriptionChangeListResponse.subscriptionId
            appliedAt = subscriptionChangeListResponse.appliedAt
            cancelledAt = subscriptionChangeListResponse.cancelledAt
            additionalProperties =
                subscriptionChangeListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubscriptionChangeListResponse].
         *
         ...
         */
        fun build(): SubscriptionChangeListResponse =
            SubscriptionChangeListResponse(
                checkRequired("id", id),
    ...
    fun validate(): SubscriptionChangeListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionChangeListResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "SubscriptionChangeListResponse{id=$id, expirationTime=$expirationTime, status=$status, subscriptionId=$subscriptionId, appliedAt=$appliedAt, cancelledAt=$cancelledAt, additionalProperties=$additionalProperties}"
}

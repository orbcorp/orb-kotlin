...
private constructor(
    ...
    /** A builder for [NewPlanMinimumCompositePrice]. */
    class Builder internal constructor() {
        ...
        internal fun from(newPlanMinimumCompositePrice: NewPlanMinimumCompositePrice) = apply {
            cadence = newPlanMinimumCompositePrice.cadence
            itemId = newPlanMinimumCompositePrice.itemId
            minimumCompositeConfig = newPlanMinimumCompositePrice.minimumCompositeConfig
            modelType = newPlanMinimumCompositePrice.modelType
            name = newPlanMinimumCompositePrice.name
            billableMetricId = newPlanMinimumCompositePrice.billableMetricId
            billedInAdvance = newPlanMinimumCompositePrice.billedInAdvance
            billingCycleConfiguration = newPlanMinimumCompositePrice.billingCycleConfiguration
            conversionRate = newPlanMinimumCompositePrice.conversionRate
            conversionRateConfig = newPlanMinimumCompositePrice.conversionRateConfig
            currency = newPlanMinimumCompositePrice.currency
            dimensionalPriceConfiguration =
                newPlanMinimumCompositePrice.dimensionalPriceConfiguration
            externalPriceId = newPlanMinimumCompositePrice.externalPriceId
            fixedPriceQuantity = newPlanMinimumCompositePrice.fixedPriceQuantity
            invoiceGroupingKey = newPlanMinimumCompositePrice.invoiceGroupingKey
            invoicingCycleConfiguration = newPlanMinimumCompositePrice.invoicingCycleConfiguration
            licenseTypeId = newPlanMinimumCompositePrice.licenseTypeId
            metadata = newPlanMinimumCompositePrice.metadata
            referenceId = newPlanMinimumCompositePrice.referenceId
            additionalProperties = newPlanMinimumCompositePrice.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NewPlanMinimumCompositePrice].
         *
         ...
         */
        fun build(): NewPlanMinimumCompositePrice =
     ...
     *   type.
     */
    fun validate(): NewPlanMinimumCompositePrice = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (cadence.asKnown()?.validity() ?: 0) +
            ...
            (minimumCompositeConfig.asKnown()?.validity() ?: 0) +
    ...
    class ModelType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val MINIMUM_COMPOSITE = of("minimum_composite")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NewPlanMinimumCompositePrice &&

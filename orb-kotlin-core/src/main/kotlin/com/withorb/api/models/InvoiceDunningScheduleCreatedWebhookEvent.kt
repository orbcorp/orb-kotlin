...
class InvoiceDunningScheduleCreatedWebhookEvent
...
private constructor(
    ...
    /** A builder for [InvoiceDunningScheduleCreatedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            invoiceDunningScheduleCreatedWebhookEvent: InvoiceDunningScheduleCreatedWebhookEvent
        ) = apply {
            id = invoiceDunningScheduleCreatedWebhookEvent.id
            createdAt = invoiceDunningScheduleCreatedWebhookEvent.createdAt
            invoice = invoiceDunningScheduleCreatedWebhookEvent.invoice
            properties = invoiceDunningScheduleCreatedWebhookEvent.properties
            type = invoiceDunningScheduleCreatedWebhookEvent.type
            additionalProperties =
                invoiceDunningScheduleCreatedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InvoiceDunningScheduleCreatedWebhookEvent].
         *
         ...
         */
        fun build(): InvoiceDunningScheduleCreatedWebhookEvent =
            InvoiceDunningScheduleCreatedWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): InvoiceDunningScheduleCreatedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        ) : this(dunningSchedule, dunningSteps, source, mutableMapOf())
         ...
         */
        internal fun validity(): Int =
            (dunningSchedule.asKnown()?.validity() ?: 0) +
                (dunningSteps.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
        ...
        private constructor(
             ...
             */
            fun completionTime(): OffsetDateTime? = completionTime.getNullable("completion_time")
             ...
             *   server responded with an unexpected value).
             */
            fun modifiedAt(): OffsetDateTime? = modifiedAt.getNullable("modified_at")

            /**
             * @throws OrbInvalidDataException if the JSON field has an unexpected type (e.g. if the
             *   server responded with an unexpected value).
             */
            fun startTime(): OffsetDateTime? = startTime.getNullable("start_time")
             ...
             */
            internal fun validity(): Int =
                (if (completionTime.asKnown() == null) 0 else 1) +
                    (if (createdAt.asKnown() == null) 0 else 1) +
                    (if (invoiceId.asKnown() == null) 0 else 1) +
                    (if (modifiedAt.asKnown() == null) 0 else 1) +
        ...
        private constructor(
             ...
             *   server responded with an unexpected value).
             */
            fun executionTime(): OffsetDateTime? = executionTime.getNullable("execution_time")

            /**
             * @throws OrbInvalidDataException if the JSON field has an unexpected type (e.g. if the
             *   server responded with an unexpected value).
             */
            fun manuallyTriggeredAt(): OffsetDateTime? =
                manuallyTriggeredAt.getNullable("manually_triggered_at")
             ...
             *   server responded with an unexpected value).
             */
            fun stepNumber(): Long? = stepNumber.getNullable("step_number")
             ...
             */
            internal fun validity(): Int =
                (actions.asKnown()?.size ?: 0) +
                    (if (createdAt.asKnown() == null) 0 else 1) +
                    (if (executionTime.asKnown() == null) 0 else 1) +
                    (if (manuallyTriggeredAt.asKnown() == null) 0 else 1) +
                    (if (modifiedAt.asKnown() == null) 0 else 1) +
                    (if (status.asKnown() == null) 0 else 1) +
                    (if (stepNumber.asKnown() == null) 0 else 1) +
        ...
        private val hashCode: Int by lazy {
            Objects.hash(dunningSchedule, dunningSteps, source, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Properties{dunningSchedule=$dunningSchedule, dunningSteps=$dunningSteps, source=$source, additionalProperties=$additionalProperties}"
    }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val INVOICE_DUNNING_SCHEDULE_CREATED = of("invoice.dunning_schedule_created")
        ...
        fun value(): Value =
            when (this) {
                INVOICE_DUNNING_SCHEDULE_CREATED -> Value.INVOICE_DUNNING_SCHEDULE_CREATED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                INVOICE_DUNNING_SCHEDULE_CREATED -> Known.INVOICE_DUNNING_SCHEDULE_CREATED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InvoiceDunningScheduleCreatedWebhookEvent &&
            id == other.id &&
            createdAt == other.createdAt &&
    ...
    override fun toString() =
        "InvoiceDunningScheduleCreatedWebhookEvent{id=$id, createdAt=$createdAt, invoice=$invoice, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}

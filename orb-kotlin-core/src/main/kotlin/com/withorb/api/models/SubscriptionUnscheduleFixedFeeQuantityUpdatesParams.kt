...
private constructor(
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("priceId", priceId), additionalProperties.toMutableMap())
        }
         ...
         */
        internal fun validity(): Int = (if (priceId.asKnown() == null) 0 else 1)

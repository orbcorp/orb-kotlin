...
class PlanMigrationRetrieveResponse
...
private constructor(
    ...
    /** A builder for [PlanMigrationRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(planMigrationRetrieveResponse: PlanMigrationRetrieveResponse) = apply {
            id = planMigrationRetrieveResponse.id
            effectiveTime = planMigrationRetrieveResponse.effectiveTime
            planId = planMigrationRetrieveResponse.planId
            status = planMigrationRetrieveResponse.status
        ...
        /**
         * Returns an immutable instance of [PlanMigrationRetrieveResponse].
         *
         ...
         */
        fun build(): PlanMigrationRetrieveResponse =
            PlanMigrationRetrieveResponse(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): PlanMigrationRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class UnionMember2 @JsonCreator private constructor(private val value: JsonField<String>) :
            ...
            companion object {
                ...
                val END_OF_INVOICE = of("end_of_invoice")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PlanMigrationRetrieveResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "PlanMigrationRetrieveResponse{id=$id, effectiveTime=$effectiveTime, planId=$planId, status=$status, additionalProperties=$additionalProperties}"
}

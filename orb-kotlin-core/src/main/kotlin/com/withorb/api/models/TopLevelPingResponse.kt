...
@NoAutoDetect
class TopLevelPingResponse @JsonCreator private constructor(
    @JsonProperty("response") @ExcludeMissing private val response: JsonField<String> = JsonMissing.of(),
    ...
    @ExcludeMissing
    fun _response(): JsonField<String> = response
    ...
    fun validate(): TopLevelPingResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(topLevelPingResponse: TopLevelPingResponse) =
            apply {
        ...
        fun response(response: JsonField<String>) =
            apply {

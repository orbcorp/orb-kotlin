...
class LicenseExternalLicenseGetUsageResponse
...
private constructor(
    ...
    /** A builder for [LicenseExternalLicenseGetUsageResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            licenseExternalLicenseGetUsageResponse: LicenseExternalLicenseGetUsageResponse
        ) = apply {
            data = licenseExternalLicenseGetUsageResponse.data.map { it.toMutableList() }
            paginationMetadata = licenseExternalLicenseGetUsageResponse.paginationMetadata
            additionalProperties =
                licenseExternalLicenseGetUsageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LicenseExternalLicenseGetUsageResponse].
         *
         ...
         */
        fun build(): LicenseExternalLicenseGetUsageResponse =
            LicenseExternalLicenseGetUsageResponse(
     ...
     *   type.
     */
    fun validate(): LicenseExternalLicenseGetUsageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         */
        fun allocationEligibleCredits(): Double? =
            allocationEligibleCredits.getNullable("allocation_eligible_credits")
         ...
         *   server responded with an unexpected value).
         */
        fun externalLicenseId(): String? = externalLicenseId.getNullable("external_license_id")
         ...
         *   server responded with an unexpected value).
         */
        fun licenseId(): String? = licenseId.getNullable("license_id")
         ...
         *   server responded with an unexpected value).
         */
        fun sharedPoolCredits(): Double? = sharedPoolCredits.getNullable("shared_pool_credits")
         ...
         */
        internal fun validity(): Int =
            (if (allocatedCredits.asKnown() == null) 0 else 1) +
                (if (consumedCredits.asKnown() == null) 0 else 1) +
                (if (endDate.asKnown() == null) 0 else 1) +
                (if (licenseTypeId.asKnown() == null) 0 else 1) +
                (if (pricingUnit.asKnown() == null) 0 else 1) +
                (if (remainingCredits.asKnown() == null) 0 else 1) +
                (if (startDate.asKnown() == null) 0 else 1) +
                (if (subscriptionId.asKnown() == null) 0 else 1) +
                (if (allocationEligibleCredits.asKnown() == null) 0 else 1) +
                (if (externalLicenseId.asKnown() == null) 0 else 1) +
                (if (licenseId.asKnown() == null) 0 else 1) +
                (if (sharedPoolCredits.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LicenseExternalLicenseGetUsageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "LicenseExternalLicenseGetUsageResponse{data=$data, paginationMetadata=$paginationMetadata, additionalProperties=$additionalProperties}"
}

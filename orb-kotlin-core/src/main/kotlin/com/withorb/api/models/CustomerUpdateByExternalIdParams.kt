...
class CustomerUpdateByExternalIdParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class CustomerUpdateByExternalIdBody internal constructor(
      private val accountingSyncConfiguration: AccountingSyncConfiguration?,
      private val additionalEmails: List<String>?,
      private val autoCollection: Boolean?,
      private val billingAddress: BillingAddress?,
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is CustomerUpdateByExternalIdBody &&
        ...
        class Builder {
            ...
            internal fun from(customerUpdateByExternalIdBody: CustomerUpdateByExternalIdBody) = apply {
                this.accountingSyncConfiguration = customerUpdateByExternalIdBody.accountingSyncConfiguration
                ...
                this.reportingConfiguration = customerUpdateByExternalIdBody.reportingConfiguration
            ...
            fun build(): CustomerUpdateByExternalIdBody = CustomerUpdateByExternalIdBody(
                accountingSyncConfiguration,
    ...
    override fun toString() = "CustomerUpdateByExternalIdParams{id=$id, accountingSyncConfiguration=$accountingSyncConfiguration, additionalEmails=$additionalEmails, autoCollection=$autoCollection, billingAddress=$billingAddress, currency=$currency, email=$email, emailDelivery=$emailDelivery, externalCustomerId=$externalCustomerId, metadata=$metadata, name=$name, paymentProvider=$paymentProvider, paymentProviderId=$paymentProviderId, reportingConfiguration=$reportingConfiguration, shippingAddress=$shippingAddress, taxId=$taxId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(customerUpdateByExternalIdParams: CustomerUpdateByExternalIdParams) = apply {
            this.id = customerUpdateByExternalIdParams.id
            this.accountingSyncConfiguration = customerUpdateByExternalIdParams.accountingSyncConfiguration
            ...
            this.reportingConfiguration = customerUpdateByExternalIdParams.reportingConfiguration
        ...
        fun build(): CustomerUpdateByExternalIdParams = CustomerUpdateByExternalIdParams(
            checkNotNull(id) {

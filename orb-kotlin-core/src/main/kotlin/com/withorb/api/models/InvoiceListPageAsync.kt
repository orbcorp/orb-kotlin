...
private constructor(
    ...
    fun data(): List<InvoiceModel> = response().data()
    ...
    fun getNextPageParams(): InvoiceListParams? {
        ...
        return InvoiceListParams.builder()
            .from(params)
    ...
    @JsonCreator
    constructor(
        @JsonProperty("data") private val data: JsonField<List<InvoiceModel>> = JsonMissing.of(),
        ...
        fun data(): List<InvoiceModel> = data.getNullable("data") ?: listOf()

        fun paginationMetadata(): PaginationMetadata =
            paginationMetadata.getRequired("pagination_metadata")

        @JsonProperty("data") fun _data(): JsonField<List<InvoiceModel>>? = data
        ...
        class Builder {
            ...
            private var data: JsonField<List<InvoiceModel>> = JsonMissing.of()
            ...
            fun data(data: List<InvoiceModel>) = data(JsonField.of(data))

            fun data(data: JsonField<List<InvoiceModel>>) = apply { this.data = data }
    ...
    class AutoPager(private val firstPage: InvoiceListPageAsync) : Flow<InvoiceModel> {

        override suspend fun collect(collector: FlowCollector<InvoiceModel>) {
            var page = firstPage
            var index = 0
            while (true) {

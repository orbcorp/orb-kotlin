...
private constructor(
    ...
    fun validate(): AmountDiscountModel = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AmountDiscountModel].
         *
    ...
    /** A builder for [AmountDiscountModel]. */
    class Builder internal constructor() {
        ...
        internal fun from(amountDiscountModel: AmountDiscountModel) = apply {
            amountDiscount = amountDiscountModel.amountDiscount
            appliesToPriceIds = amountDiscountModel.appliesToPriceIds.map { it.toMutableList() }
            discountType = amountDiscountModel.discountType
            reason = amountDiscountModel.reason
            additionalProperties = amountDiscountModel.additionalProperties.toMutableMap()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AmountDiscountModel && amountDiscount == other.amountDiscount && appliesToPriceIds == other.appliesToPriceIds && discountType == other.discountType && reason == other.reason && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "AmountDiscountModel{amountDiscount=$amountDiscount, appliesToPriceIds=$appliesToPriceIds, discountType=$discountType, reason=$reason, additionalProperties=$additionalProperties}"
}

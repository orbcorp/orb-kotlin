...
class DimensionalPriceGroupListPage private constructor(
    ...
    override fun toString() = "DimensionalPriceGroupListPage{dimensionalPriceGroupsService=$dimensionalPriceGroupsService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): DimensionalPriceGroupListParams? {
      ...
      return DimensionalPriceGroupListParams.builder().from(params).apply {paginationMetadata().nextCursor()?.let{ this.cursor(it) } }.build()
    }

    fun getNextPage(): DimensionalPriceGroupListPage? {
      return getNextPageParams()?.let {
          dimensionalPriceGroupsService.list(it)
      }
    }
    ...
    companion object {
        ...
        fun of(dimensionalPriceGroupsService: DimensionalPriceGroupService, params: DimensionalPriceGroupListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<DimensionalPriceGroup>> = JsonMissing.of(),
        ...
        @JsonProperty("data")
        fun _data(): JsonField<List<DimensionalPriceGroup>>? = data
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<DimensionalPriceGroup> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {

 ...
 */
class EventBackfillListPage private constructor(
    ...
    companion object {
        ...
        fun of(backfillsService: BackfillService, params: EventBackfillListParams, response: Response) =
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<EventBackfillListResponse> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {

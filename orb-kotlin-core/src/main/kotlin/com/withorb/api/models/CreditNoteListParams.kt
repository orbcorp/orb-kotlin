 ...
 */
class CreditNoteListParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(creditNoteListParams: CreditNoteListParams) =
            apply {
    ...
    override fun toString() = "CreditNoteListParams{cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

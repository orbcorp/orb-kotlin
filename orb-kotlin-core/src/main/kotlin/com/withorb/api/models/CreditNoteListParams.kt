...
class CreditNoteListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "CreditNoteListParams{cursor=$cursor, limit=$limit, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(creditNoteListParams: CreditNoteListParams) = apply {
            ...
            additionalBodyProperties(creditNoteListParams.additionalBodyProperties)
        }
        ...
        fun build(): CreditNoteListParams = CreditNoteListParams(
            cursor,
            limit,

...
private constructor(
    ...
    fun validate(): EditPlanModel = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [EditPlanModel]. */
        fun builder() = Builder()
    }

    /** A builder for [EditPlanModel]. */
    class Builder internal constructor() {
        ...
        internal fun from(editPlanModel: EditPlanModel) = apply {
            externalPlanId = editPlanModel.externalPlanId
            metadata = editPlanModel.metadata
            additionalProperties = editPlanModel.additionalProperties.toMutableMap()
        }
        ...
        fun build(): EditPlanModel =
            EditPlanModel(externalPlanId, metadata, additionalProperties.toImmutable())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EditPlanModel && externalPlanId == other.externalPlanId && metadata == other.metadata && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "EditPlanModel{externalPlanId=$externalPlanId, metadata=$metadata, additionalProperties=$additionalProperties}"
}

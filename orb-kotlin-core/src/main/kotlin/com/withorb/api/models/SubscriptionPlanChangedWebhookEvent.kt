...
class SubscriptionPlanChangedWebhookEvent
...
private constructor(
    ...
    /** A builder for [SubscriptionPlanChangedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = subscriptionPlanChangedWebhookEvent.id
            createdAt = subscriptionPlanChangedWebhookEvent.createdAt
            properties = subscriptionPlanChangedWebhookEvent.properties
            subscription = subscriptionPlanChangedWebhookEvent.subscription
            type = subscriptionPlanChangedWebhookEvent.type
            additionalProperties =
                subscriptionPlanChangedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubscriptionPlanChangedWebhookEvent].
         *
         ...
         */
        fun build(): SubscriptionPlanChangedWebhookEvent =
            SubscriptionPlanChangedWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): SubscriptionPlanChangedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        ) : this(previousPlanId, mutableMapOf())
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (if (previousPlanId.asKnown() == null) 0 else 1)
        ...
        private val hashCode: Int by lazy { Objects.hash(previousPlanId, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Properties{previousPlanId=$previousPlanId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionPlanChangedWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "SubscriptionPlanChangedWebhookEvent{id=$id, createdAt=$createdAt, properties=$properties, subscription=$subscription, type=$type, additionalProperties=$additionalProperties}"
}

...
private constructor(
     ...
     */
    fun taxId(): CustomerTaxIdModel? = taxId.getNullable("tax_id")
    ...
    fun validate(): CustomerModel = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CustomerModel].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(customerModel: CustomerModel) = apply {
            id = customerModel.id
            additionalEmails = customerModel.additionalEmails.map { it.toMutableList() }
            autoCollection = customerModel.autoCollection
            ...
            emailDelivery = customerModel.emailDelivery
            exemptFromAutomatedTax = customerModel.exemptFromAutomatedTax
            externalCustomerId = customerModel.externalCustomerId
            hierarchy = customerModel.hierarchy
            metadata = customerModel.metadata
            name = customerModel.name
            paymentProvider = customerModel.paymentProvider
            paymentProviderId = customerModel.paymentProviderId
            portalUrl = customerModel.portalUrl
            shippingAddress = customerModel.shippingAddress
            taxId = customerModel.taxId
            timezone = customerModel.timezone
            accountingSyncConfiguration = customerModel.accountingSyncConfiguration
            reportingConfiguration = customerModel.reportingConfiguration
            additionalProperties = customerModel.additionalProperties.toMutableMap()
        }
    ...
    private constructor(
        ...
        fun parent(): CustomerMinifiedModel? = parent.getNullable("parent")

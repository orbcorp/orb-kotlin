...
class EventBackfillRevertParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is EventBackfillRevertParams &&
    ...
    override fun toString() = "EventBackfillRevertParams{backfillId=$backfillId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): EventBackfillRevertParams = EventBackfillRevertParams(

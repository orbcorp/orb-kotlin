...
private constructor(
    ...
    fun validate(): PercentageDiscountModel = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PercentageDiscountModel].
         *
    ...
    /** A builder for [PercentageDiscountModel]. */
    class Builder internal constructor() {
        ...
        internal fun from(percentageDiscountModel: PercentageDiscountModel) = apply {
            appliesToPriceIds = percentageDiscountModel.appliesToPriceIds.map { it.toMutableList() }
            discountType = percentageDiscountModel.discountType
            percentageDiscount = percentageDiscountModel.percentageDiscount
            reason = percentageDiscountModel.reason
            additionalProperties = percentageDiscountModel.additionalProperties.toMutableMap()
        }
        ...
        fun build(): PercentageDiscountModel =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PercentageDiscountModel && appliesToPriceIds == other.appliesToPriceIds && discountType == other.discountType && percentageDiscount == other.percentageDiscount && reason == other.reason && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "PercentageDiscountModel{appliesToPriceIds=$appliesToPriceIds, discountType=$discountType, percentageDiscount=$percentageDiscount, reason=$reason, additionalProperties=$additionalProperties}"
}

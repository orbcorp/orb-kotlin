...
@JsonDeserialize(builder = SubscriptionUpdateTrialResponse.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(subscriptionUpdateTrialResponse: SubscriptionUpdateTrialResponse) =
            apply {
                this.metadata = subscriptionUpdateTrialResponse.metadata
                this.id = subscriptionUpdateTrialResponse.id
                this.customer = subscriptionUpdateTrialResponse.customer
                this.plan = subscriptionUpdateTrialResponse.plan
                this.startDate = subscriptionUpdateTrialResponse.startDate
                this.endDate = subscriptionUpdateTrialResponse.endDate
                this.createdAt = subscriptionUpdateTrialResponse.createdAt
                ...
                this.status = subscriptionUpdateTrialResponse.status
                this.trialInfo = subscriptionUpdateTrialResponse.trialInfo
                this.activePlanPhaseOrder = subscriptionUpdateTrialResponse.activePlanPhaseOrder
                this.fixedFeeQuantitySchedule =
                    subscriptionUpdateTrialResponse.fixedFeeQuantitySchedule
                this.defaultInvoiceMemo = subscriptionUpdateTrialResponse.defaultInvoiceMemo
                this.autoCollection = subscriptionUpdateTrialResponse.autoCollection
                this.netTerms = subscriptionUpdateTrialResponse.netTerms
                this.redeemedCoupon = subscriptionUpdateTrialResponse.redeemedCoupon
                this.billingCycleDay = subscriptionUpdateTrialResponse.billingCycleDay
                this.billingCycleAnchorConfiguration =
                    subscriptionUpdateTrialResponse.billingCycleAnchorConfiguration
                this.invoicingThreshold = subscriptionUpdateTrialResponse.invoicingThreshold
                this.priceIntervals = subscriptionUpdateTrialResponse.priceIntervals
                this.adjustmentIntervals = subscriptionUpdateTrialResponse.adjustmentIntervals
                this.discountIntervals = subscriptionUpdateTrialResponse.discountIntervals
                this.minimumIntervals = subscriptionUpdateTrialResponse.minimumIntervals
                this.maximumIntervals = subscriptionUpdateTrialResponse.maximumIntervals
                additionalProperties(subscriptionUpdateTrialResponse.additionalProperties)
            }

...
@NoAutoDetect
class SubscriptionUpdateTrialResponse @JsonCreator private constructor(
    ...
    fun validate(): SubscriptionUpdateTrialResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    /** A builder for [SubscriptionUpdateTrialResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionUpdateTrialResponse: SubscriptionUpdateTrialResponse) =
            apply {
                id = subscriptionUpdateTrialResponse.id
                activePlanPhaseOrder = subscriptionUpdateTrialResponse.activePlanPhaseOrder
                adjustmentIntervals = subscriptionUpdateTrialResponse.adjustmentIntervals.map { it.toMutableList() }
                autoCollection = subscriptionUpdateTrialResponse.autoCollection
                billingCycleAnchorConfiguration = subscriptionUpdateTrialResponse.billingCycleAnchorConfiguration
                billingCycleDay = subscriptionUpdateTrialResponse.billingCycleDay
                createdAt = subscriptionUpdateTrialResponse.createdAt
                currentBillingPeriodEndDate = subscriptionUpdateTrialResponse.currentBillingPeriodEndDate
                currentBillingPeriodStartDate = subscriptionUpdateTrialResponse.currentBillingPeriodStartDate
                customer = subscriptionUpdateTrialResponse.customer
                defaultInvoiceMemo = subscriptionUpdateTrialResponse.defaultInvoiceMemo
                discountIntervals = subscriptionUpdateTrialResponse.discountIntervals.map { it.toMutableList() }
                endDate = subscriptionUpdateTrialResponse.endDate
                fixedFeeQuantitySchedule = subscriptionUpdateTrialResponse.fixedFeeQuantitySchedule.map { it.toMutableList() }
                invoicingThreshold = subscriptionUpdateTrialResponse.invoicingThreshold
                maximumIntervals = subscriptionUpdateTrialResponse.maximumIntervals.map { it.toMutableList() }
                metadata = subscriptionUpdateTrialResponse.metadata
                minimumIntervals = subscriptionUpdateTrialResponse.minimumIntervals.map { it.toMutableList() }
                netTerms = subscriptionUpdateTrialResponse.netTerms
                plan = subscriptionUpdateTrialResponse.plan
                priceIntervals = subscriptionUpdateTrialResponse.priceIntervals.map { it.toMutableList() }
                redeemedCoupon = subscriptionUpdateTrialResponse.redeemedCoupon
                ...
                additionalProperties = subscriptionUpdateTrialResponse.additionalProperties.toMutableMap()
            }
        ...
        fun build(): SubscriptionUpdateTrialResponse =
            SubscriptionUpdateTrialResponse(
              checkRequired(
                "id", id
              ),

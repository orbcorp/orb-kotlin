...
class InvoiceDueDateRecalculationCanceledWebhookEvent
...
private constructor(
    ...
    /** A builder for [InvoiceDueDateRecalculationCanceledWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = invoiceDueDateRecalculationCanceledWebhookEvent.id
            createdAt = invoiceDueDateRecalculationCanceledWebhookEvent.createdAt
            properties = invoiceDueDateRecalculationCanceledWebhookEvent.properties
            type = invoiceDueDateRecalculationCanceledWebhookEvent.type
            additionalProperties =
                invoiceDueDateRecalculationCanceledWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InvoiceDueDateRecalculationCanceledWebhookEvent].
         *
         ...
         */
        fun build(): InvoiceDueDateRecalculationCanceledWebhookEvent =
            InvoiceDueDateRecalculationCanceledWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): InvoiceDueDateRecalculationCanceledWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        ) : this(canceledAt, startedAt, mutableMapOf())
        ...
        class Builder internal constructor() {
            ...
            internal fun from(properties: Properties) = apply {
                canceledAt = properties.canceledAt
        ...
        private val hashCode: Int by lazy {
            Objects.hash(canceledAt, startedAt, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Properties{canceledAt=$canceledAt, startedAt=$startedAt, additionalProperties=$additionalProperties}"
    }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val INVOICE_DUE_DATE_RECALCULATION_CANCELED =
                of("invoice_due_date_recalculation.canceled")
        ...
        fun value(): Value =
            when (this) {
                INVOICE_DUE_DATE_RECALCULATION_CANCELED ->
                    Value.INVOICE_DUE_DATE_RECALCULATION_CANCELED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                INVOICE_DUE_DATE_RECALCULATION_CANCELED ->
                    Known.INVOICE_DUE_DATE_RECALCULATION_CANCELED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InvoiceDueDateRecalculationCanceledWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "InvoiceDueDateRecalculationCanceledWebhookEvent{id=$id, createdAt=$createdAt, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}

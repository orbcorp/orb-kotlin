...
private constructor(
    ...
    private constructor(
        ...
        private val invoice: JsonField<InnerInvoice>,
        ...
        private constructor(
            ...
            @ExcludeMissing
            invoice: JsonField<InnerInvoice> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.invoice] with a well-typed [InnerInvoice] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                /**
                 * Returns an immutable instance of [InnerInvoice].
                 *
                 * Further updates to this [Builder] will not mutate the returned instance.
                 *
                 * The following fields are required:
                ...
                fun build(): InnerInvoice =
                    InnerInvoice(checkRequired("id", id), additionalProperties.toMutableMap())
            }
    ...
    private constructor(
        ...
        private constructor(
            ...
            internal fun validity(): Int =
                (if (amount.asKnown() == null) 0 else 1) +
                    (if (taxRateDescription.asKnown() == null) 0 else 1) +
                    (if (taxRatePercentage.asKnown() == null) 0 else 1)

...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = invoice.discount().convert(MyClass::class.java)
     * ```
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(invoice: Invoice) = apply {
            ...
            hiddenLineItemCount = invoice.hiddenLineItemCount
         ...
         * ```
         */
        fun addTieredPercentageDiscount(tiers: List<InvoiceLevelDiscount.TieredPercentage.Tier>) =
    ...
    private constructor(
         ...
         * `previously_attempted_at` is non-null, and `next_attempt_at` is non-null), or if dunning
         * has been exhausted (`previously_attempted_at` is non-null, but `next_attempt_at` is
         * null).
         *
         * @throws OrbInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
    ...
    private constructor(
        ...
        private constructor(
            ...
            private constructor(
                 ...
                 * `upper_bound` is the inclusive end; `upper_bound` is null only for the open-ended
                 * final tier.
                 */
                class Tier
                @JsonCreator(mode = JsonCreator.Mode.DISABLED)
                private constructor(
                    ...
                    class Builder internal constructor() {
                         ...
                         *
                         * You should usually call [Builder.lowerBound] with a well-typed [Double]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.percentage] with a well-typed [Double]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.upperBound] with a well-typed [Double]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */

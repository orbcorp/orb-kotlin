...
class InvoiceUpdateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class InvoiceUpdateBody internal constructor(private val metadata: Metadata?, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "InvoiceUpdateBody{metadata=$metadata, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): InvoiceUpdateBody = InvoiceUpdateBody(metadata, additionalProperties.toUnmodifiable())
        }
    }
    ...
    override fun toString() = "InvoiceUpdateParams{invoiceId=$invoiceId, metadata=$metadata, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): InvoiceUpdateParams = InvoiceUpdateParams(

...
constructor(
    ...
    internal constructor(
        ...
        class Builder {
            ...
            fun build(): InvoiceUpdateBody =
                InvoiceUpdateBody(metadata, additionalProperties.toUnmodifiable())
        }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is InvoiceUpdateBody && this.metadata == other.metadata && this.additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is InvoiceUpdateParams && this.invoiceId == other.invoiceId && this.metadata == other.metadata && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders && this.additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(invoiceId, metadata, additionalQueryParams, additionalHeaders, additionalBodyProperties) /* spotless:on */
    }

    override fun toString() =
        "InvoiceUpdateParams{invoiceId=$invoiceId, metadata=$metadata, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"

...
private constructor(
     ...
     *
     * Unlike [tierConfig], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("tier_config")
    @ExcludeMissing
    ...
    class Builder internal constructor() {
         ...
         * supported value.
         */
        fun tierConfig(tierConfig: JsonField<TierConfig>) = apply { this.tierConfig = tierConfig }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.lastUnit] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        private val hashCode: Int by lazy {
            Objects.hash(firstUnit, lastUnit, unitAmount, additionalProperties)
        }

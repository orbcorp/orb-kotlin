 ...
 */
class LicenseUsageGetAllUsageParams
private constructor(
    ...
    /** A builder for [LicenseUsageGetAllUsageParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(licenseUsageGetAllUsageParams: LicenseUsageGetAllUsageParams) = apply {
            licenseTypeId = licenseUsageGetAllUsageParams.licenseTypeId
            subscriptionId = licenseUsageGetAllUsageParams.subscriptionId
            cursor = licenseUsageGetAllUsageParams.cursor
            endDate = licenseUsageGetAllUsageParams.endDate
            groupBy = licenseUsageGetAllUsageParams.groupBy?.toMutableList()
            limit = licenseUsageGetAllUsageParams.limit
            startDate = licenseUsageGetAllUsageParams.startDate
            additionalHeaders = licenseUsageGetAllUsageParams.additionalHeaders.toBuilder()
            additionalQueryParams = licenseUsageGetAllUsageParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LicenseUsageGetAllUsageParams].
         *
         ...
         */
        fun build(): LicenseUsageGetAllUsageParams =
            LicenseUsageGetAllUsageParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LicenseUsageGetAllUsageParams &&
    ...
    override fun toString() =
        "LicenseUsageGetAllUsageParams{licenseTypeId=$licenseTypeId, subscriptionId=$subscriptionId, cursor=$cursor, endDate=$endDate, groupBy=$groupBy, limit=$limit, startDate=$startDate, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

...
class CreditNoteMarkedAsVoidWebhookEvent
...
private constructor(
    ...
    ) : this(id, createdAt, creditNote, properties, type, mutableMapOf())
     ...
     * ```kotlin
     * val myObject: MyClass = creditNoteMarkedAsVoidWebhookEvent.properties().convert(MyClass::class.java)
     * ```
     */
    ...
    /** A builder for [CreditNoteMarkedAsVoidWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(creditNoteMarkedAsVoidWebhookEvent: CreditNoteMarkedAsVoidWebhookEvent) =
            apply {
                id = creditNoteMarkedAsVoidWebhookEvent.id
                createdAt = creditNoteMarkedAsVoidWebhookEvent.createdAt
                creditNote = creditNoteMarkedAsVoidWebhookEvent.creditNote
                properties = creditNoteMarkedAsVoidWebhookEvent.properties
                type = creditNoteMarkedAsVoidWebhookEvent.type
                additionalProperties =
                    creditNoteMarkedAsVoidWebhookEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CreditNoteMarkedAsVoidWebhookEvent].
         *
         ...
         */
        fun build(): CreditNoteMarkedAsVoidWebhookEvent =
            CreditNoteMarkedAsVoidWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): CreditNoteMarkedAsVoidWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val CREDIT_NOTE_MARKED_AS_VOID = of("credit_note.marked_as_void")
        ...
        fun value(): Value =
            when (this) {
                CREDIT_NOTE_MARKED_AS_VOID -> Value.CREDIT_NOTE_MARKED_AS_VOID
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CREDIT_NOTE_MARKED_AS_VOID -> Known.CREDIT_NOTE_MARKED_AS_VOID
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreditNoteMarkedAsVoidWebhookEvent &&
            id == other.id &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, createdAt, creditNote, properties, type, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "CreditNoteMarkedAsVoidWebhookEvent{id=$id, createdAt=$createdAt, creditNote=$creditNote, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}

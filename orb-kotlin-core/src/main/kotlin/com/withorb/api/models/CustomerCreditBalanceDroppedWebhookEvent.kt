...
class CustomerCreditBalanceDroppedWebhookEvent
...
private constructor(
    ...
    /** A builder for [CustomerCreditBalanceDroppedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            customerCreditBalanceDroppedWebhookEvent: CustomerCreditBalanceDroppedWebhookEvent
        ) = apply {
            id = customerCreditBalanceDroppedWebhookEvent.id
            createdAt = customerCreditBalanceDroppedWebhookEvent.createdAt
            customer = customerCreditBalanceDroppedWebhookEvent.customer
            properties = customerCreditBalanceDroppedWebhookEvent.properties
            type = customerCreditBalanceDroppedWebhookEvent.type
            additionalProperties =
                customerCreditBalanceDroppedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomerCreditBalanceDroppedWebhookEvent].
         *
         ...
         */
        fun build(): CustomerCreditBalanceDroppedWebhookEvent =
            CustomerCreditBalanceDroppedWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): CustomerCreditBalanceDroppedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        private val balanceThreshold: JsonField<String>,
        ...
        private constructor(
            ...
            @JsonProperty("balance_threshold")
            @ExcludeMissing
            balanceThreshold: JsonField<String> = JsonMissing.of(),
            @JsonProperty("pricing_unit")
            @ExcludeMissing
            pricingUnit: JsonField<PricingUnit> = JsonMissing.of(),
        ) : this(alertConfiguration, balanceThreshold, pricingUnit, mutableMapOf())
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun balanceThreshold(): String = balanceThreshold.getRequired("balance_threshold")
         ...
         */
        fun pricingUnit(): PricingUnit? = pricingUnit.getNullable("pricing_unit")
        ...
        /**
         * Returns the raw JSON value of [balanceThreshold].
         *
         * Unlike [balanceThreshold], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("balance_threshold")
        @ExcludeMissing
        fun _balanceThreshold(): JsonField<String> = balanceThreshold
        ...
        class Builder internal constructor() {
            ...
            fun balanceThreshold(balanceThreshold: String) =
                balanceThreshold(JsonField.of(balanceThreshold))

            /**
             * Sets [Builder.balanceThreshold] to an arbitrary JSON value.
             *
             * You should usually call [Builder.balanceThreshold] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun balanceThreshold(balanceThreshold: JsonField<String>) = apply {
                this.balanceThreshold = balanceThreshold
            }

            /** A currency or custom credit unit, as embedded in webhook payloads. */
            fun pricingUnit(pricingUnit: PricingUnit?) =
                pricingUnit(JsonField.ofNullable(pricingUnit))
            ...
            fun build(): Properties =
                Properties(
                    ...
                    checkRequired("balanceThreshold", balanceThreshold),
        ...
        internal fun validity(): Int =
            (alertConfiguration.asKnown()?.validity() ?: 0) +
                (if (balanceThreshold.asKnown() == null) 0 else 1) +
                (pricingUnit.asKnown()?.validity() ?: 0)
        ...
        private val hashCode: Int by lazy {
            Objects.hash(alertConfiguration, balanceThreshold, pricingUnit, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Properties{alertConfiguration=$alertConfiguration, balanceThreshold=$balanceThreshold, pricingUnit=$pricingUnit, additionalProperties=$additionalProperties}"
    }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val CUSTOMER_CREDIT_BALANCE_DROPPED = of("customer.credit_balance_dropped")
        ...
        fun value(): Value =
            when (this) {
                CUSTOMER_CREDIT_BALANCE_DROPPED -> Value.CUSTOMER_CREDIT_BALANCE_DROPPED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CUSTOMER_CREDIT_BALANCE_DROPPED -> Known.CUSTOMER_CREDIT_BALANCE_DROPPED
                else -> throw OrbInvalidDataException("Unknown Type: $value")
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomerCreditBalanceDroppedWebhookEvent &&
            id == other.id &&
            createdAt == other.createdAt &&
            customer == other.customer &&
    ...
    override fun toString() =
        "CustomerCreditBalanceDroppedWebhookEvent{id=$id, createdAt=$createdAt, customer=$customer, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}

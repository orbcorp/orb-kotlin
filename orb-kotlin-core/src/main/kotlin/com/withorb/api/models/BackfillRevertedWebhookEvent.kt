...
class BackfillRevertedWebhookEvent
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val id: JsonField<String>,
    private val backfill: JsonField<Backfill>,
    ...
    private constructor(
        ...
        @JsonProperty("backfill") @ExcludeMissing backfill: JsonField<Backfill> = JsonMissing.of(),
        @JsonProperty("created_at")
        @ExcludeMissing
        createdAt: JsonField<OffsetDateTime> = JsonMissing.of(),
        @JsonProperty("properties") @ExcludeMissing properties: JsonValue = JsonMissing.of(),
        @JsonProperty("type") @ExcludeMissing type: JsonField<Type> = JsonMissing.of(),
    ) : this(id, backfill, createdAt, properties, type, mutableMapOf())
     ...
     *   missing or null (e.g. if the server responded with an unexpected value).
     */
    fun backfill(): Backfill = backfill.getRequired("backfill")
     ...
     * ```kotlin
     * val myObject: MyClass = backfillRevertedWebhookEvent.properties().convert(MyClass::class.java)
     * ```
     */
    ...
    /**
     * Returns the raw JSON value of [backfill].
     *
     * Unlike [backfill], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("backfill") @ExcludeMissing fun _backfill(): JsonField<Backfill> = backfill
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BackfillRevertedWebhookEvent].
         *
    ...
    /** A builder for [BackfillRevertedWebhookEvent]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var backfill: JsonField<Backfill>? = null
        private var createdAt: JsonField<OffsetDateTime>? = null
        private var properties: JsonValue? = null
        private var type: JsonField<Type>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(backfillRevertedWebhookEvent: BackfillRevertedWebhookEvent) = apply {
            id = backfillRevertedWebhookEvent.id
            backfill = backfillRevertedWebhookEvent.backfill
            createdAt = backfillRevertedWebhookEvent.createdAt
            properties = backfillRevertedWebhookEvent.properties
            type = backfillRevertedWebhookEvent.type
            additionalProperties = backfillRevertedWebhookEvent.additionalProperties.toMutableMap()
        }
         ...
         * timeframe.
         */
        fun backfill(backfill: Backfill) = backfill(JsonField.of(backfill))

        /**
         * Sets [Builder.backfill] to an arbitrary JSON value.
         *
         * You should usually call [Builder.backfill] with a well-typed [Backfill] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun backfill(backfill: JsonField<Backfill>) = apply { this.backfill = backfill }
        ...
        /**
         * Returns an immutable instance of [BackfillRevertedWebhookEvent].
         *
         ...
         */
        fun build(): BackfillRevertedWebhookEvent =
            BackfillRevertedWebhookEvent(
                checkRequired("id", id),
                checkRequired("backfill", backfill),
     ...
     *   type.
     */
    fun validate(): BackfillRevertedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *
         * Unlike [eventsIngested], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("events_ingested")
        @ExcludeMissing
        ...
        companion object {
            ...
            /**
             * Returns a mutable builder for constructing an instance of [Backfill].
             *
             * The following fields are required:
             * ```kotlin
             * .id()
        ...
        class Builder internal constructor() {
            ...
            internal fun from(backfill: Backfill) = apply {
                id = backfill.id
                closeTime = backfill.closeTime
                createdAt = backfill.createdAt
                customerId = backfill.customerId
                eventsIngested = backfill.eventsIngested
                replaceExistingEvents = backfill.replaceExistingEvents
                revertedAt = backfill.revertedAt
                status = backfill.status
                timeframeEnd = backfill.timeframeEnd
                timeframeStart = backfill.timeframeStart
                deprecationFilter = backfill.deprecationFilter
                additionalProperties = backfill.additionalProperties.toMutableMap()
            }
             ...
             *
             * You should usually call [Builder.eventsIngested] with a well-typed [Long] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * newly ingested events associated with the backfill. If `false`, newly ingested events
             * will be added to the existing events.
             */
            ...
            /** The time at which this backfill was reverted. */
            fun revertedAt(revertedAt: OffsetDateTime?) =
                revertedAt(JsonField.ofNullable(revertedAt))
            ...
            /**
             * Returns an immutable instance of [Backfill].
             *
             * Further updates to this [Builder] will not mutate the returned instance.
             *
             * The following fields are required:
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val BACKFILL_REVERTED = of("backfill.reverted")
        ...
        fun value(): Value =
            when (this) {
                BACKFILL_REVERTED -> Value.BACKFILL_REVERTED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                BACKFILL_REVERTED -> Known.BACKFILL_REVERTED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BackfillRevertedWebhookEvent &&
            id == other.id &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, backfill, createdAt, properties, type, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BackfillRevertedWebhookEvent{id=$id, backfill=$backfill, createdAt=$createdAt, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}

...
@NoAutoDetect
class CustomerCreditTopUpCreateByExternalIdResponse @JsonCreator private constructor(
    ...
    fun validate(): CustomerCreditTopUpCreateByExternalIdResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(customerCreditTopUpCreateByExternalIdResponse: CustomerCreditTopUpCreateByExternalIdResponse) =
            apply {
                ...
                additionalProperties = customerCreditTopUpCreateByExternalIdResponse.additionalProperties.toMutableMap()
            }
    ...
    override fun toString() = "CustomerCreditTopUpCreateByExternalIdResponse{id=$id, amount=$amount, currency=$currency, invoiceSettings=$invoiceSettings, perUnitCostBasis=$perUnitCostBasis, threshold=$threshold, expiresAfter=$expiresAfter, expiresAfterUnit=$expiresAfterUnit, additionalProperties=$additionalProperties}"
}

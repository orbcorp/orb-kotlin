...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(newPlanTieredPrice: NewPlanTieredPrice) = apply {
            ...
            conversionRateConfig = newPlanTieredPrice.conversionRateConfig
            currency = newPlanTieredPrice.currency
            dimensionalPriceConfiguration = newPlanTieredPrice.dimensionalPriceConfiguration
            ...
            licenseTypeId = newPlanTieredPrice.licenseTypeId
            metadata = newPlanTieredPrice.metadata
            referenceId = newPlanTieredPrice.referenceId
    ...
    override fun toString() =
        "NewPlanTieredPrice{cadence=$cadence, itemId=$itemId, modelType=$modelType, name=$name, tieredConfig=$tieredConfig, billableMetricId=$billableMetricId, billedInAdvance=$billedInAdvance, billingCycleConfiguration=$billingCycleConfiguration, conversionRate=$conversionRate, conversionRateConfig=$conversionRateConfig, currency=$currency, dimensionalPriceConfiguration=$dimensionalPriceConfiguration, externalPriceId=$externalPriceId, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, invoicingCycleConfiguration=$invoicingCycleConfiguration, licenseTypeId=$licenseTypeId, metadata=$metadata, referenceId=$referenceId, additionalProperties=$additionalProperties}"
}

...
class CouponListPage private constructor(private val couponsService: CouponService, private val params: CouponListParams, private val response: Response, ) {
    ...
    override fun toString() = "CouponListPage{couponsService=$couponsService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): CouponListParams? {
      ...
      return CouponListParams.builder().from(params).apply {paginationMetadata().nextCursor()?.let{ this.cursor(it) } }.build()
    }

    fun getNextPage(): CouponListPage? {
      return getNextPageParams()?.let {
          couponsService.list(it)
      }
    }
    ...
    companion object {
        ...
        fun of(couponsService: CouponService, params: CouponListParams, response: Response) = CouponListPage(
            couponsService,
            params,
            response,
        )
    ...
    @NoAutoDetect
    class Response constructor(private val data: JsonField<List<Coupon>>, private val paginationMetadata: JsonField<PaginationMetadata>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        @JsonProperty("data")
        fun _data(): JsonField<List<Coupon>>? = data
        ...
        override fun toString() = "CouponListPage.Response{data=$data, paginationMetadata=$paginationMetadata, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: CouponListPage, ) : Sequence<Coupon> {

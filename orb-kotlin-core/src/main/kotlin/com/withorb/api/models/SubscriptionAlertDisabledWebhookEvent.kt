...
class SubscriptionAlertDisabledWebhookEvent
...
private constructor(
    ...
    /**
     * Sent when the system disables an alert on its own, currently for cardinality-limit
     * enforcement on grouped cost alerts.
     *
     * @throws OrbInvalidDataException if the JSON field has an unexpected type or is unexpectedly
     *   missing or null (e.g. if the server responded with an unexpected value).
     */
    ...
    /** A builder for [SubscriptionAlertDisabledWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            subscriptionAlertDisabledWebhookEvent: SubscriptionAlertDisabledWebhookEvent
        ) = apply {
            id = subscriptionAlertDisabledWebhookEvent.id
            createdAt = subscriptionAlertDisabledWebhookEvent.createdAt
            ...
            type = subscriptionAlertDisabledWebhookEvent.type
            additionalProperties =
                subscriptionAlertDisabledWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubscriptionAlertDisabledWebhookEvent].
         *
         ...
         */
        fun build(): SubscriptionAlertDisabledWebhookEvent =
            SubscriptionAlertDisabledWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): SubscriptionAlertDisabledWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        private val cardinality: JsonField<Long>,
        private val cardinalityLimit: JsonField<Long>,
        ...
        private constructor(
            ...
            @ExcludeMissing
            cardinality: JsonField<Long> = JsonMissing.of(),
            @JsonProperty("cardinality_limit")
            @ExcludeMissing
            cardinalityLimit: JsonField<Long> = JsonMissing.of(),
            @JsonProperty("reason") @ExcludeMissing reason: JsonField<Reason> = JsonMissing.of(),
        ) : this(alertConfiguration, cardinality, cardinalityLimit, reason, mutableMapOf())
         ...
         */
        fun cardinality(): Long? = cardinality.getNullable("cardinality")

        /**
         * @throws OrbInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         */
        fun cardinalityLimit(): Long? = cardinalityLimit.getNullable("cardinality_limit")
        ...
        @JsonProperty("cardinality")
        @ExcludeMissing
        fun _cardinality(): JsonField<Long> = cardinality

        /**
         * Returns the raw JSON value of [cardinalityLimit].
         *
         * Unlike [cardinalityLimit], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("cardinality_limit")
        @ExcludeMissing
        fun _cardinalityLimit(): JsonField<Long> = cardinalityLimit
        ...
        class Builder internal constructor() {
            ...
            private var cardinality: JsonField<Long>? = null
            private var cardinalityLimit: JsonField<Long>? = null
            ...
            internal fun from(properties: Properties) = apply {
                ...
                cardinalityLimit = properties.cardinalityLimit
            ...
            fun cardinality(cardinality: Long?) = cardinality(JsonField.ofNullable(cardinality))

            /**
             * Alias for [Builder.cardinality].
             *
             * This unboxed primitive overload exists for backwards compatibility.
             */
            fun cardinality(cardinality: Long) = cardinality(cardinality as Long?)

            /**
             * Sets [Builder.cardinality] to an arbitrary JSON value.
             *
             * You should usually call [Builder.cardinality] with a well-typed [Long] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun cardinality(cardinality: JsonField<Long>) = apply { this.cardinality = cardinality }

            fun cardinalityLimit(cardinalityLimit: Long?) =
                cardinalityLimit(JsonField.ofNullable(cardinalityLimit))

            /**
             * Alias for [Builder.cardinalityLimit].
             *
             * This unboxed primitive overload exists for backwards compatibility.
             */
            fun cardinalityLimit(cardinalityLimit: Long) =
                cardinalityLimit(cardinalityLimit as Long?)

            /**
             * Sets [Builder.cardinalityLimit] to an arbitrary JSON value.
             *
             * You should usually call [Builder.cardinalityLimit] with a well-typed [Long] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun cardinalityLimit(cardinalityLimit: JsonField<Long>) = apply {
            ...
            fun build(): Properties =
                Properties(
                    ...
                    checkRequired("cardinalityLimit", cardinalityLimit),
        ...
        internal fun validity(): Int =
            (alertConfiguration.asKnown()?.validity() ?: 0) +
                (if (cardinality.asKnown() == null) 0 else 1) +
                (if (cardinalityLimit.asKnown() == null) 0 else 1) +
        ...
        class Reason @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
            ...
            companion object {
                ...
                val SYSTEM_CARDINALITY_LIMIT = of("system_cardinality_limit")
            ...
            fun value(): Value =
                when (this) {
                    USER -> Value.USER
                    SYSTEM_CARDINALITY_LIMIT -> Value.SYSTEM_CARDINALITY_LIMIT
                    else -> Value._UNKNOWN
                }
            ...
            fun known(): Known =
                when (this) {
                    USER -> Known.USER
                    SYSTEM_CARDINALITY_LIMIT -> Known.SYSTEM_CARDINALITY_LIMIT
        ...
        override fun toString() =
            "Properties{alertConfiguration=$alertConfiguration, cardinality=$cardinality, cardinalityLimit=$cardinalityLimit, reason=$reason, additionalProperties=$additionalProperties}"
    }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val SUBSCRIPTION_ALERT_DISABLED = of("subscription.alert_disabled")
        ...
        fun value(): Value =
            when (this) {
                SUBSCRIPTION_ALERT_DISABLED -> Value.SUBSCRIPTION_ALERT_DISABLED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                SUBSCRIPTION_ALERT_DISABLED -> Known.SUBSCRIPTION_ALERT_DISABLED
                else -> throw OrbInvalidDataException("Unknown Type: $value")
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionAlertDisabledWebhookEvent &&
            id == other.id &&
            createdAt == other.createdAt &&
    ...
    override fun toString() =
        "SubscriptionAlertDisabledWebhookEvent{id=$id, createdAt=$createdAt, properties=$properties, subscription=$subscription, type=$type, additionalProperties=$additionalProperties}"
}

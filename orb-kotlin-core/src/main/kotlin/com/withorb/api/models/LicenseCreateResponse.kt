...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LicenseCreateResponse].
         *
    ...
    /** A builder for [LicenseCreateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(licenseCreateResponse: LicenseCreateResponse) = apply {
            id = licenseCreateResponse.id
            endDate = licenseCreateResponse.endDate
            externalLicenseId = licenseCreateResponse.externalLicenseId
            licenseTypeId = licenseCreateResponse.licenseTypeId
            startDate = licenseCreateResponse.startDate
            status = licenseCreateResponse.status
            subscriptionId = licenseCreateResponse.subscriptionId
            additionalProperties = licenseCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LicenseCreateResponse].
         *
         ...
         */
        fun build(): LicenseCreateResponse =
    ...
    fun validate(): LicenseCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LicenseCreateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "LicenseCreateResponse{id=$id, endDate=$endDate, externalLicenseId=$externalLicenseId, licenseTypeId=$licenseTypeId, startDate=$startDate, status=$status, subscriptionId=$subscriptionId, additionalProperties=$additionalProperties}"
}

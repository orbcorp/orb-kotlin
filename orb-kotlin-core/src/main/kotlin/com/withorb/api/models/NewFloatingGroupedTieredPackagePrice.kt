...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            conversionRateConfig = newFloatingGroupedTieredPackagePrice.conversionRateConfig
            dimensionalPriceConfiguration =
                newFloatingGroupedTieredPackagePrice.dimensionalPriceConfiguration
            ...
            licenseTypeId = newFloatingGroupedTieredPackagePrice.licenseTypeId
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NewFloatingGroupedTieredPackagePrice &&
    ...
    override fun toString() =
        "NewFloatingGroupedTieredPackagePrice{cadence=$cadence, currency=$currency, groupedTieredPackageConfig=$groupedTieredPackageConfig, itemId=$itemId, modelType=$modelType, name=$name, billableMetricId=$billableMetricId, billedInAdvance=$billedInAdvance, billingCycleConfiguration=$billingCycleConfiguration, conversionRate=$conversionRate, conversionRateConfig=$conversionRateConfig, dimensionalPriceConfiguration=$dimensionalPriceConfiguration, externalPriceId=$externalPriceId, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, invoicingCycleConfiguration=$invoicingCycleConfiguration, licenseTypeId=$licenseTypeId, metadata=$metadata, additionalProperties=$additionalProperties}"
}

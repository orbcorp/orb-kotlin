  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    class Builder {
        ...
        internal fun from(subscriptionFetchUsageParams: SubscriptionFetchUsageParams) = apply {
            ...
            additionalBodyProperties(subscriptionFetchUsageParams.additionalBodyProperties)
        }
    ...
    class Granularity @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
        ...
        companion object {
            ...
            val DAY = Granularity(JsonField.of("day"))

            fun of(value: String) = Granularity(JsonField.of(value))
        }

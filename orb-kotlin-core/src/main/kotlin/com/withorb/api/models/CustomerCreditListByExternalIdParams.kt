 ...
 */
class CustomerCreditListByExternalIdParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.includeAllBlocks?.let {
          queryParams.put(
            "include_all_blocks", listOf(it.toString())
          )
      }
      this.limit?.let {
          queryParams.put(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(customerCreditListByExternalIdParams: CustomerCreditListByExternalIdParams) =
            apply {
                ...
                additionalQueryParams = customerCreditListByExternalIdParams.additionalQueryParams.toBuilder()
            }
         ...
         * returned.
         */
        fun includeAllBlocks(includeAllBlocks: Boolean) = includeAllBlocks(includeAllBlocks as Boolean?)
    ...
    override fun toString() = "CustomerCreditListByExternalIdParams{externalCustomerId=$externalCustomerId, currency=$currency, cursor=$cursor, includeAllBlocks=$includeAllBlocks, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

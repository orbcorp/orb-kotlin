...
class CustomerCostListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "CustomerCostListParams{customerId=$customerId, currency=$currency, timeframeEnd=$timeframeEnd, timeframeStart=$timeframeStart, viewMode=$viewMode, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(customerCostListParams: CustomerCostListParams) = apply {
            ...
            additionalBodyProperties(customerCostListParams.additionalBodyProperties)
        }
        ...
        fun build(): CustomerCostListParams = CustomerCostListParams(

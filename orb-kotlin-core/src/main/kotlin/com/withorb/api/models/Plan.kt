...
private constructor(
     ...
     */
    @Deprecated("deprecated") fun basePlan(): BasePlan? = basePlan.getNullable("base_plan")
     ...
     *   responded with an unexpected value).
     */
    @Deprecated("deprecated") fun basePlanId(): String? = basePlanId.getNullable("base_plan_id")
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [addPrice] with `Price.ofGroupedTieredMatrix(groupedTieredMatrix)`. */
        fun addPrice(groupedTieredMatrix: Price.GroupedTieredMatrix) =
            addPrice(Price.ofGroupedTieredMatrix(groupedTieredMatrix))
    ...
    private constructor(
         ...
         *     override fun visitUsageDiscount(usageDiscount: PlanPhaseUsageDiscountAdjustment): String? = usageDiscount.toString()
         *
         *     // ...
         *

 ...
 */
@JsonDeserialize(builder = MetricCreateResponse.Builder::class)
@NoAutoDetect
class MetricCreateResponse
private constructor(
    ...
    fun validate(): MetricCreateResponse = apply {
        if (!validated) {
            metadata().validate()
            id()
            name()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MetricCreateResponse &&
    ...
    override fun toString() =
        "MetricCreateResponse{metadata=$metadata, id=$id, name=$name, description=$description, status=$status, item=$item, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(metricCreateResponse: MetricCreateResponse) = apply {
            this.metadata = metricCreateResponse.metadata
            this.id = metricCreateResponse.id
            this.name = metricCreateResponse.name
            this.description = metricCreateResponse.description
            this.status = metricCreateResponse.status
            this.item = metricCreateResponse.item
            additionalProperties(metricCreateResponse.additionalProperties)
        }
        ...
        fun build(): MetricCreateResponse =

...
private constructor(
     ...
     * import com.withorb.api.core.JsonValue
     *
     * val result: String? = customerCreditLedgerListResponse.accept(object : CustomerCreditLedgerListResponse.Visitor<String?> {
    ...
    companion object {
        ...
        fun ofVoid(void: VoidLedgerEntry) = CustomerCreditLedgerListResponse(void = void)

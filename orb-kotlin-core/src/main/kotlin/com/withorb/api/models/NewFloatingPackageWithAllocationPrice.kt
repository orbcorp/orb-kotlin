...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            conversionRateConfig = newFloatingPackageWithAllocationPrice.conversionRateConfig
            dimensionalPriceConfiguration =
                newFloatingPackageWithAllocationPrice.dimensionalPriceConfiguration
            ...
            licenseTypeId = newFloatingPackageWithAllocationPrice.licenseTypeId
    ...
    override fun toString() =
        "NewFloatingPackageWithAllocationPrice{cadence=$cadence, currency=$currency, itemId=$itemId, modelType=$modelType, name=$name, packageWithAllocationConfig=$packageWithAllocationConfig, billableMetricId=$billableMetricId, billedInAdvance=$billedInAdvance, billingCycleConfiguration=$billingCycleConfiguration, conversionRate=$conversionRate, conversionRateConfig=$conversionRateConfig, dimensionalPriceConfiguration=$dimensionalPriceConfiguration, externalPriceId=$externalPriceId, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, invoicingCycleConfiguration=$invoicingCycleConfiguration, licenseTypeId=$licenseTypeId, metadata=$metadata, additionalProperties=$additionalProperties}"
}

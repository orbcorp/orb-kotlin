...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(newPlanTieredWithMinimumPrice: NewPlanTieredWithMinimumPrice) = apply {
            ...
            conversionRateConfig = newPlanTieredWithMinimumPrice.conversionRateConfig
            currency = newPlanTieredWithMinimumPrice.currency
            dimensionalPriceConfiguration =
                newPlanTieredWithMinimumPrice.dimensionalPriceConfiguration
            ...
            licenseTypeId = newPlanTieredWithMinimumPrice.licenseTypeId
            metadata = newPlanTieredWithMinimumPrice.metadata
            referenceId = newPlanTieredWithMinimumPrice.referenceId
    ...
    override fun toString() =
        "NewPlanTieredWithMinimumPrice{cadence=$cadence, itemId=$itemId, modelType=$modelType, name=$name, tieredWithMinimumConfig=$tieredWithMinimumConfig, billableMetricId=$billableMetricId, billedInAdvance=$billedInAdvance, billingCycleConfiguration=$billingCycleConfiguration, conversionRate=$conversionRate, conversionRateConfig=$conversionRateConfig, currency=$currency, dimensionalPriceConfiguration=$dimensionalPriceConfiguration, externalPriceId=$externalPriceId, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, invoicingCycleConfiguration=$invoicingCycleConfiguration, licenseTypeId=$licenseTypeId, metadata=$metadata, referenceId=$referenceId, additionalProperties=$additionalProperties}"
}

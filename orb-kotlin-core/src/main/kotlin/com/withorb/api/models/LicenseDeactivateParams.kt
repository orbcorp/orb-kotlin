 ...
 * date in the customer's timezone. Otherwise, the deactivation time will default to the **end** of
 * the current day in the customer's timezone.
 */
...
private constructor(
    ...
    /**
     * The date to deactivate the license. If not provided, defaults to end of day today in the
     * customer's timezone.
     *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(licenseDeactivateParams: LicenseDeactivateParams) = apply {
            licenseId = licenseDeactivateParams.licenseId
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /**
             * The date to deactivate the license. If not provided, defaults to end of day today in
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(endDate, additionalProperties.toMutableMap())
        }
        ...
        override fun toString() =
            "Body{endDate=$endDate, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LicenseDeactivateParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(licenseId, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "LicenseDeactivateParams{licenseId=$licenseId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

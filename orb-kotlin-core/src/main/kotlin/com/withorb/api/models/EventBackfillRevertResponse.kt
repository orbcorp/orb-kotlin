 ...
 */
@JsonDeserialize(builder = EventBackfillRevertResponse.Builder::class)
@NoAutoDetect
class EventBackfillRevertResponse private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is EventBackfillRevertResponse &&
          this.id == other.id &&
    ...
    class Builder {
        ...
        fun build(): EventBackfillRevertResponse = EventBackfillRevertResponse(
            id,
            status,
            createdAt,
            timeframeStart,

 ...
 */
@NoAutoDetect
class EventBackfillRevertResponse @JsonCreator private constructor(
    ...
    fun validate(): EventBackfillRevertResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    /** A builder for [EventBackfillRevertResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(eventBackfillRevertResponse: EventBackfillRevertResponse) =
            apply {
                ...
                replaceExistingEvents = eventBackfillRevertResponse.replaceExistingEvents

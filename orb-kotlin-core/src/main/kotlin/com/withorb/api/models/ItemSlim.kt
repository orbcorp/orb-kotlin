...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ItemSlim].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(itemSlim: ItemSlim) = apply {
            id = itemSlim.id
            name = itemSlim.name
        ...
        /**
         * Returns an immutable instance of [ItemSlim].
         *
    ...
    override fun toString() =
        "ItemSlim{id=$id, name=$name, additionalProperties=$additionalProperties}"
}

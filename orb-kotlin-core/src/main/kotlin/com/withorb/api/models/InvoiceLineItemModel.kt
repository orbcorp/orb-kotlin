...
private constructor(
    ...
    @ExcludeMissing
    private val taxAmounts: JsonField<List<TaxAmountModel>> = JsonMissing.of(),
    ...
    @Deprecated("deprecated") fun maximum(): MaximumModel? = maximum.getNullable("maximum")
    ...
    /** This field is deprecated in favor of `adjustments`. */
    @Deprecated("deprecated") fun minimum(): MinimumModel? = minimum.getNullable("minimum")
     ...
     */
    fun price(): PriceModel? = price.getNullable("price")
     ...
     * configured.
     */
    fun taxAmounts(): List<TaxAmountModel> = taxAmounts.getRequired("tax_amounts")
    ...
    @JsonProperty("maximum")
    @ExcludeMissing
    fun _maximum(): JsonField<MaximumModel> = maximum
    ...
    @JsonProperty("minimum")
    @ExcludeMissing
    fun _minimum(): JsonField<MinimumModel> = minimum
    ...
    @JsonProperty("tax_amounts")
    @ExcludeMissing
    fun _taxAmounts(): JsonField<List<TaxAmountModel>> = taxAmounts
    ...
    fun validate(): InvoiceLineItemModel = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InvoiceLineItemModel].
         *
    ...
    /** A builder for [InvoiceLineItemModel]. */
    class Builder internal constructor() {
        ...
        private var taxAmounts: JsonField<MutableList<TaxAmountModel>>? = null
        private var usageCustomerIds: JsonField<MutableList<String>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(invoiceLineItemModel: InvoiceLineItemModel) = apply {
            id = invoiceLineItemModel.id
            adjustedSubtotal = invoiceLineItemModel.adjustedSubtotal
            adjustments = invoiceLineItemModel.adjustments.map { it.toMutableList() }
            amount = invoiceLineItemModel.amount
            creditsApplied = invoiceLineItemModel.creditsApplied
            discount = invoiceLineItemModel.discount
            endDate = invoiceLineItemModel.endDate
            filter = invoiceLineItemModel.filter
            grouping = invoiceLineItemModel.grouping
            maximum = invoiceLineItemModel.maximum
            maximumAmount = invoiceLineItemModel.maximumAmount
            minimum = invoiceLineItemModel.minimum
            minimumAmount = invoiceLineItemModel.minimumAmount
            name = invoiceLineItemModel.name
            partiallyInvoicedAmount = invoiceLineItemModel.partiallyInvoicedAmount
            price = invoiceLineItemModel.price
            quantity = invoiceLineItemModel.quantity
            startDate = invoiceLineItemModel.startDate
            subLineItems = invoiceLineItemModel.subLineItems.map { it.toMutableList() }
            subtotal = invoiceLineItemModel.subtotal
            taxAmounts = invoiceLineItemModel.taxAmounts.map { it.toMutableList() }
            usageCustomerIds = invoiceLineItemModel.usageCustomerIds.map { it.toMutableList() }
            additionalProperties = invoiceLineItemModel.additionalProperties.toMutableMap()
        }
         ...
         * [the core concepts documentation](/core-concepts#plan-and-price)
         */
        fun price(price: PriceModel?) = price(JsonField.ofNullable(price))
         ...
         * configured.
         */
        fun taxAmounts(taxAmounts: List<TaxAmountModel>) = taxAmounts(JsonField.of(taxAmounts))

        /**
         * An array of tax rates and their incurred tax amounts. Empty if no tax integration is
         * configured.
         */
        fun taxAmounts(taxAmounts: JsonField<List<TaxAmountModel>>) = apply {
         ...
         * configured.
         */
        fun addTaxAmount(taxAmount: TaxAmountModel) = apply {
            taxAmounts =
        ...
        fun build(): InvoiceLineItemModel =
    ...
    private constructor(
        ...
        fun monetaryMaximum(): MonetaryMaximumAdjustment? = monetaryMaximum
    ...
    private constructor(
        ...
        fun other(): OtherSubLineItem? = other
        ...
        companion object {
            ...
            fun ofOther(other: OtherSubLineItem) = SubLineItem(other = other)
        }
        ...
        private constructor(
            ...
            @JsonProperty("grouping")
            @ExcludeMissing
            private val grouping: JsonField<SubLineItemGroupingModel> = JsonMissing.of(),
            ...
            fun grouping(): SubLineItemGroupingModel? = grouping.getNullable("grouping")
            ...
            @JsonProperty("grouping")
            @ExcludeMissing
            fun _grouping(): JsonField<SubLineItemGroupingModel> = grouping
            ...
            class Builder internal constructor() {
                ...
                private var amount: JsonField<String>? = null
                private var grouping: JsonField<SubLineItemGroupingModel>? = null
                ...
                fun grouping(grouping: SubLineItemGroupingModel?) =
                    grouping(JsonField.ofNullable(grouping))

                fun grouping(grouping: JsonField<SubLineItemGroupingModel>) = apply {

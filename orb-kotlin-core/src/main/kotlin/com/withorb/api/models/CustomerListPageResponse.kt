...
private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Customer>> = JsonMissing.of(),
     ...
     */
    fun data(): List<Customer> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Customer>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<Customer>>? = null
        ...
        internal fun from(customerListPageResponse: CustomerListPageResponse) = apply {
            ...
            paginationMetadata = customerListPageResponse.paginationMetadata
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<Customer>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<Customer>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [Customer] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Customer) = apply {
            this.data =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CustomerListPageResponse && data == other.data && paginationMetadata == other.paginationMetadata && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "CustomerListPageResponse{data=$data, paginationMetadata=$paginationMetadata, additionalProperties=$additionalProperties}"
}

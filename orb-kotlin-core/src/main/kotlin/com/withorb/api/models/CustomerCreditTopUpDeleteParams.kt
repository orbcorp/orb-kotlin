...
class CustomerCreditTopUpDeleteParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CustomerCreditTopUpDeleteParams &&
    ...
    override fun toString() = "CustomerCreditTopUpDeleteParams{customerId=$customerId, topUpId=$topUpId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(customerCreditTopUpDeleteParams: CustomerCreditTopUpDeleteParams) = apply {
        ...
        fun build(): CustomerCreditTopUpDeleteParams = CustomerCreditTopUpDeleteParams(

...
private constructor(
     ...
     *
     * Unlike [groupedWithMeteredMinimumConfig], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("grouped_with_metered_minimum_config")
    @ExcludeMissing
    ...
    class Builder internal constructor() {
        ...
        private var groupedWithMeteredMinimumConfig: JsonField<GroupedWithMeteredMinimumConfig>? =
            null
        ...
        internal fun from(
            ...
            dimensionalPriceConfiguration =
                newSubscriptionGroupedWithMeteredMinimumPrice.dimensionalPriceConfiguration
            externalPriceId = newSubscriptionGroupedWithMeteredMinimumPrice.externalPriceId
            fixedPriceQuantity = newSubscriptionGroupedWithMeteredMinimumPrice.fixedPriceQuantity
            invoiceGroupingKey = newSubscriptionGroupedWithMeteredMinimumPrice.invoiceGroupingKey
            invoicingCycleConfiguration =
            ...
            additionalProperties =
                newSubscriptionGroupedWithMeteredMinimumPrice.additionalProperties.toMutableMap()
        }
         ...
         * [GroupedWithMeteredMinimumConfig] value instead. This method is primarily for setting the
        ...
        /**
         * Returns an immutable instance of [NewSubscriptionGroupedWithMeteredMinimumPrice].
         *
        ...
        fun build(): NewSubscriptionGroupedWithMeteredMinimumPrice =
            NewSubscriptionGroupedWithMeteredMinimumPrice(
                ...
                checkRequired("groupedWithMeteredMinimumConfig", groupedWithMeteredMinimumConfig),
    ...
    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(cadence, groupedWithMeteredMinimumConfig, itemId, modelType, name, billableMetricId, billedInAdvance, billingCycleConfiguration, conversionRate, currency, dimensionalPriceConfiguration, externalPriceId, fixedPriceQuantity, invoiceGroupingKey, invoicingCycleConfiguration, metadata, referenceId, additionalProperties) }
    /* spotless:on */

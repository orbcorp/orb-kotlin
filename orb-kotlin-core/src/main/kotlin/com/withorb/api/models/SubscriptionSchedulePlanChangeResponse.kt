...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            adjustmentIntervals =
                subscriptionSchedulePlanChangeResponse.adjustmentIntervals.map {
                    it.toMutableList()
                }
            ...
            discountIntervals =
                subscriptionSchedulePlanChangeResponse.discountIntervals.map { it.toMutableList() }
            endDate = subscriptionSchedulePlanChangeResponse.endDate
            fixedFeeQuantitySchedule =
                subscriptionSchedulePlanChangeResponse.fixedFeeQuantitySchedule.map {
                    it.toMutableList()
                }
            invoicingThreshold = subscriptionSchedulePlanChangeResponse.invoicingThreshold
            maximumIntervals =
                subscriptionSchedulePlanChangeResponse.maximumIntervals.map { it.toMutableList() }
            metadata = subscriptionSchedulePlanChangeResponse.metadata
            minimumIntervals =
                subscriptionSchedulePlanChangeResponse.minimumIntervals.map { it.toMutableList() }
            name = subscriptionSchedulePlanChangeResponse.name
            netTerms = subscriptionSchedulePlanChangeResponse.netTerms
            pendingSubscriptionChange =
                subscriptionSchedulePlanChangeResponse.pendingSubscriptionChange
            plan = subscriptionSchedulePlanChangeResponse.plan
            priceIntervals =
                subscriptionSchedulePlanChangeResponse.priceIntervals.map { it.toMutableList() }
            ...
            changedResources = subscriptionSchedulePlanChangeResponse.changedResources

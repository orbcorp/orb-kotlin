...
@NoAutoDetect
class SubscriptionSchedulePlanChangeResponse @JsonCreator private constructor(
    ...
    /** A builder for [SubscriptionSchedulePlanChangeResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionSchedulePlanChangeResponse: SubscriptionSchedulePlanChangeResponse) =
            apply {
                ...
                adjustmentIntervals = subscriptionSchedulePlanChangeResponse.adjustmentIntervals.map { it.toMutableList() }
                autoCollection = subscriptionSchedulePlanChangeResponse.autoCollection
                billingCycleAnchorConfiguration = subscriptionSchedulePlanChangeResponse.billingCycleAnchorConfiguration
                ...
                currentBillingPeriodEndDate = subscriptionSchedulePlanChangeResponse.currentBillingPeriodEndDate
                currentBillingPeriodStartDate = subscriptionSchedulePlanChangeResponse.currentBillingPeriodStartDate
                ...
                discountIntervals = subscriptionSchedulePlanChangeResponse.discountIntervals.map { it.toMutableList() }
                endDate = subscriptionSchedulePlanChangeResponse.endDate
                fixedFeeQuantitySchedule = subscriptionSchedulePlanChangeResponse.fixedFeeQuantitySchedule.map { it.toMutableList() }
                invoicingThreshold = subscriptionSchedulePlanChangeResponse.invoicingThreshold
                maximumIntervals = subscriptionSchedulePlanChangeResponse.maximumIntervals.map { it.toMutableList() }
                metadata = subscriptionSchedulePlanChangeResponse.metadata
                minimumIntervals = subscriptionSchedulePlanChangeResponse.minimumIntervals.map { it.toMutableList() }
                netTerms = subscriptionSchedulePlanChangeResponse.netTerms
                plan = subscriptionSchedulePlanChangeResponse.plan
                priceIntervals = subscriptionSchedulePlanChangeResponse.priceIntervals.map { it.toMutableList() }
                ...
                additionalProperties = subscriptionSchedulePlanChangeResponse.additionalProperties.toMutableMap()
            }

...
class MetricFetchParams constructor(private val metricId: String, private val additionalQueryParams: Map<String, List<String>>, private val additionalHeaders: Map<String, List<String>>, ) {
    ...
    override fun toString() = "MetricFetchParams{metricId=$metricId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        fun build(): MetricFetchParams = MetricFetchParams(

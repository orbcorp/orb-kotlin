...
@NoAutoDetect
class CustomerCreditTopUpListResponse private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CustomerCreditTopUpListResponse &&
          this.id == other.id &&
    ...
    override fun toString() = "CustomerCreditTopUpListResponse{id=$id, currency=$currency, threshold=$threshold, amount=$amount, perUnitCostBasis=$perUnitCostBasis, invoiceSettings=$invoiceSettings, expiresAfter=$expiresAfter, expiresAfterUnit=$expiresAfterUnit, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(customerCreditTopUpListResponse: CustomerCreditTopUpListResponse) = apply {
        ...
        fun build(): CustomerCreditTopUpListResponse = CustomerCreditTopUpListResponse(
            id,
            currency,
            threshold,
            amount,

...
private constructor(
    ...
    fun validate(): TrialDiscountModel = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [TrialDiscountModel]. */
    class Builder internal constructor() {
        ...
        internal fun from(trialDiscountModel: TrialDiscountModel) = apply {
            appliesToPriceIds = trialDiscountModel.appliesToPriceIds.map { it.toMutableList() }
            discountType = trialDiscountModel.discountType
            reason = trialDiscountModel.reason
            trialAmountDiscount = trialDiscountModel.trialAmountDiscount
            trialPercentageDiscount = trialDiscountModel.trialPercentageDiscount
            additionalProperties = trialDiscountModel.additionalProperties.toMutableMap()
        }
    ...
    override fun toString() =
        "TrialDiscountModel{appliesToPriceIds=$appliesToPriceIds, discountType=$discountType, reason=$reason, trialAmountDiscount=$trialAmountDiscount, trialPercentageDiscount=$trialPercentageDiscount, additionalProperties=$additionalProperties}"
}

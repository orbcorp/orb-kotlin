...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
            ...
            internal fun validity(): Int =
                (if (id.asKnown() == null) 0 else 1) +
                    (if (amountApplied.asKnown() == null) 0 else 1) +
    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (if (amountApplied.asKnown() == null) 0 else 1) +
                (discountType.asKnown()?.validity() ?: 0) +
                (if (percentageDiscount.asKnown() == null) 0 else 1) +
                (appliesToPrices.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
                (if (reason.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is MaximumAmountAdjustment &&
                ...
                discountType == other.discountType &&
                percentageDiscount == other.percentageDiscount &&
                appliesToPrices == other.appliesToPrices &&
                reason == other.reason &&
                additionalProperties == other.additionalProperties
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreditNote &&
            ...
            creditNotePdf == other.creditNotePdf &&
            customer == other.customer &&
            invoiceId == other.invoiceId &&
            lineItems == other.lineItems &&
            maximumAmountAdjustment == other.maximumAmountAdjustment &&
            memo == other.memo &&
            minimumAmountRefunded == other.minimumAmountRefunded &&
            reason == other.reason &&
            subtotal == other.subtotal &&
            total == other.total &&
            type == other.type &&

...
class CreditNote @JsonCreator private constructor(
    ...
    fun maximumAmountAdjustment(): MaximumAmountAdjustment? = maximumAmountAdjustment.getNullable("maximum_amount_adjustment")

    /** An optional memo supplied on the credit note. */
    fun memo(): String? = memo.getNullable("memo")

    /** Any credited amount from the applied minimum on the invoice. */
    fun minimumAmountRefunded(): String? = minimumAmountRefunded.getNullable("minimum_amount_refunded")
    ...
    class MaximumAmountAdjustment @JsonCreator private constructor(
        ...
        fun appliesToPrices(): List<AppliesToPrice>? = appliesToPrices.getNullable("applies_to_prices")

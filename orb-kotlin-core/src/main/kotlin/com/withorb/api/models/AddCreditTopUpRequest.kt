...
private constructor(
    ...
    fun validate(): AddCreditTopUpRequest = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [AddCreditTopUpRequest]. */
    class Builder internal constructor() {
        ...
        internal fun from(addCreditTopUpRequest: AddCreditTopUpRequest) = apply {
            amount = addCreditTopUpRequest.amount
            currency = addCreditTopUpRequest.currency
            invoiceSettings = addCreditTopUpRequest.invoiceSettings
            perUnitCostBasis = addCreditTopUpRequest.perUnitCostBasis
            threshold = addCreditTopUpRequest.threshold
            activeFrom = addCreditTopUpRequest.activeFrom
            expiresAfter = addCreditTopUpRequest.expiresAfter
            expiresAfterUnit = addCreditTopUpRequest.expiresAfterUnit
            additionalProperties = addCreditTopUpRequest.additionalProperties.toMutableMap()
        }
        ...
        fun build(): AddCreditTopUpRequest =
    ...
    override fun toString() =
        "AddCreditTopUpRequest{amount=$amount, currency=$currency, invoiceSettings=$invoiceSettings, perUnitCostBasis=$perUnitCostBasis, threshold=$threshold, activeFrom=$activeFrom, expiresAfter=$expiresAfter, expiresAfterUnit=$expiresAfterUnit, additionalProperties=$additionalProperties}"
}

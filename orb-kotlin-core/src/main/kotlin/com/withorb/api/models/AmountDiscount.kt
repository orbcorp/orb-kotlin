...
private constructor(
    ...
    ) : this(amountDiscount, discountType, appliesToPriceIds, reason, mutableMapOf())
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AmountDiscount && amountDiscount == other.amountDiscount && discountType == other.discountType && appliesToPriceIds == other.appliesToPriceIds && reason == other.reason && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(amountDiscount, discountType, appliesToPriceIds, reason, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "AmountDiscount{amountDiscount=$amountDiscount, discountType=$discountType, appliesToPriceIds=$appliesToPriceIds, reason=$reason, additionalProperties=$additionalProperties}"
}

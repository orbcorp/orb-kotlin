...
private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Item>> = JsonMissing.of(),
     ...
     */
    fun data(): List<Item> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Item>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<Item>>? = null
        ...
        internal fun from(itemListPageResponse: ItemListPageResponse) = apply {
            data = itemListPageResponse.data.map { it.toMutableList() }
            paginationMetadata = itemListPageResponse.paginationMetadata
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<Item>` value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<Item>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [Item] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Item) = apply {
            this.data =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ItemListPageResponse && data == other.data && paginationMetadata == other.paginationMetadata && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ItemListPageResponse{data=$data, paginationMetadata=$paginationMetadata, additionalProperties=$additionalProperties}"
}

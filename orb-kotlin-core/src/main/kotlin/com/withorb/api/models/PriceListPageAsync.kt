...
class PriceListPageAsync private constructor(private val pricesService: PriceServiceAsync, private val params: PriceListParams, private val response: Response, ) {
    ...
    companion object {
        ...
        fun of(pricesService: PriceServiceAsync, params: PriceListParams, response: Response) = PriceListPageAsync(
            pricesService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<Price>>, private val paginationMetadata: JsonField<PaginationMetadata>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "PriceListPageAsync.Response{data=$data, paginationMetadata=$paginationMetadata, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: PriceListPageAsync, ) : Flow<Price> {

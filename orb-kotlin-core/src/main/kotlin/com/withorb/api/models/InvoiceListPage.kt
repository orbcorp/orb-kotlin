...
class InvoiceListPage private constructor(private val invoicesService: InvoiceService, private val params: InvoiceListParams, private val response: Response, ) {
    ...
    override fun toString() = "InvoiceListPage{invoicesService=$invoicesService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): InvoiceListParams? {
      ...
      return InvoiceListParams.builder().from(params).apply {paginationMetadata().nextCursor()?.let{ this.cursor(it) } }.build()
    }

    fun getNextPage(): InvoiceListPage? {
      return getNextPageParams()?.let {
          invoicesService.list(it)
      }
    }
    ...
    companion object {
        ...
        fun of(invoicesService: InvoiceService, params: InvoiceListParams, response: Response) = InvoiceListPage(
            invoicesService,
            params,
            response,
        )
    ...
    @NoAutoDetect
    class Response constructor(private val data: JsonField<List<Invoice>>, private val paginationMetadata: JsonField<PaginationMetadata>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "InvoiceListPage.Response{data=$data, paginationMetadata=$paginationMetadata, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: InvoiceListPage, ) : Sequence<Invoice> {

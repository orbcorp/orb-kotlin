...
class TransactionAccountingSyncFailedWebhookEvent
...
private constructor(
    ...
    /** A builder for [TransactionAccountingSyncFailedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            transactionAccountingSyncFailedWebhookEvent: TransactionAccountingSyncFailedWebhookEvent
        ) = apply {
            id = transactionAccountingSyncFailedWebhookEvent.id
            accountingSyncRecord = transactionAccountingSyncFailedWebhookEvent.accountingSyncRecord
            createdAt = transactionAccountingSyncFailedWebhookEvent.createdAt
            ...
            type = transactionAccountingSyncFailedWebhookEvent.type
            additionalProperties =
                transactionAccountingSyncFailedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TransactionAccountingSyncFailedWebhookEvent].
         *
         ...
         */
        fun build(): TransactionAccountingSyncFailedWebhookEvent =
            TransactionAccountingSyncFailedWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): TransactionAccountingSyncFailedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun transactionRecordId(): String? =
            transactionRecordId.getNullable("transaction_record_id")
        ...
        internal fun validity(): Int =
            (if (id.asKnown() == null) 0 else 1) +
                ...
                (if (transactionRecordId.asKnown() == null) 0 else 1)
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val TRANSACTION_ACCOUNTING_SYNC_FAILED = of("transaction.accounting_sync_failed")
        ...
        fun value(): Value =
            when (this) {
                TRANSACTION_ACCOUNTING_SYNC_FAILED -> Value.TRANSACTION_ACCOUNTING_SYNC_FAILED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                TRANSACTION_ACCOUNTING_SYNC_FAILED -> Known.TRANSACTION_ACCOUNTING_SYNC_FAILED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransactionAccountingSyncFailedWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "TransactionAccountingSyncFailedWebhookEvent{id=$id, accountingSyncRecord=$accountingSyncRecord, createdAt=$createdAt, properties=$properties, transaction=$transaction, type=$type, additionalProperties=$additionalProperties}"
}

 ...
 */
class PlanExternalPlanIdUpdateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        override fun toString() = "Body{externalPlanId=$externalPlanId, metadata=$metadata, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(planExternalPlanIdUpdateParams: PlanExternalPlanIdUpdateParams) =
            apply {
        ...
        fun otherExternalPlanId(otherExternalPlanId: String) =
            apply {
    ...
    override fun toString() = "PlanExternalPlanIdUpdateParams{otherExternalPlanId=$otherExternalPlanId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

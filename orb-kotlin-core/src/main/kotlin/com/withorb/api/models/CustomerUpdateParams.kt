...
constructor(
    ...
    internal constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is CustomerUpdateBody &&
                ...
                this.taxConfiguration == other.taxConfiguration &&
    ...
    class Builder {
        ...
        internal fun from(customerUpdateParams: CustomerUpdateParams) = apply {
            ...
            this.taxConfiguration = customerUpdateParams.taxConfiguration
    ...
    private constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is TaxConfiguration &&
                this.newAvalaraTaxConfiguration == other.newAvalaraTaxConfiguration &&
                this.newTaxJarConfiguration == other.newTaxJarConfiguration
        }

        override fun hashCode(): Int {
            return Objects.hash(newAvalaraTaxConfiguration, newTaxJarConfiguration)
        }
        ...
        private constructor(
            ...
            private val taxExemptionName: JsonField<String>,
            private val additionalProperties: Map<String, JsonValue>,
        ) {
            ...
            fun taxExemptionName(): String? = taxExemptionName.getNullable("tax_exemption_name")
            ...
            @JsonProperty("tax_exemption_name")
            @ExcludeMissing
            fun _taxExemptionName() = taxExemptionName
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is NewAvalaraTaxConfiguration &&
                    ...
                    this.taxExemptionCode == other.taxExemptionCode &&
                    this.taxExemptionName == other.taxExemptionName &&
                    this.additionalProperties == other.additionalProperties
            }
            ...
            override fun toString() =
                "NewAvalaraTaxConfiguration{taxProvider=$taxProvider, taxExempt=$taxExempt, taxExemptionCode=$taxExemptionCode, taxExemptionName=$taxExemptionName, additionalProperties=$additionalProperties}"
            ...
            class Builder {
                ...
                private var taxExemptionName: JsonField<String> = JsonMissing.of()
                private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()
                ...
                internal fun from(newAvalaraTaxConfiguration: NewAvalaraTaxConfiguration) = apply {
                    ...
                    this.taxExemptionName = newAvalaraTaxConfiguration.taxExemptionName
                ...
                fun taxExemptionName(taxExemptionName: String) =
                    taxExemptionName(JsonField.of(taxExemptionName))

                @JsonProperty("tax_exemption_name")
                @ExcludeMissing
                fun taxExemptionName(taxExemptionName: JsonField<String>) = apply {
            ...
            private constructor(
                ...
                override fun equals(other: Any?): Boolean {
                    ...
                    return other is TaxProvider && this.value == other.value
                }
        ...
        private constructor(
            ...
            override fun toString() =
                "NewTaxJarConfiguration{taxProvider=$taxProvider, taxExempt=$taxExempt, additionalProperties=$additionalProperties}"

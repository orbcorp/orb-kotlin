...
class CustomerUpdateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    fun additionalEmails(): List<String>? = additionalEmails
    ...
    fun emailDelivery(): Boolean? = emailDelivery
    ...
    fun paymentProviderId(): String? = paymentProviderId
    ...
    @NoAutoDetect
    class CustomerUpdateBody internal constructor(
      private val accountingSyncConfiguration: AccountingSyncConfiguration?,
      private val additionalEmails: List<String>?,
      private val autoCollection: Boolean?,
      private val billingAddress: BillingAddress?,
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is CustomerUpdateBody &&
        ...
        class Builder {
            ...
            @JsonProperty("accounting_sync_configuration")
            fun accountingSyncConfiguration(accountingSyncConfiguration: AccountingSyncConfiguration) = apply {
            ...
            fun build(): CustomerUpdateBody = CustomerUpdateBody(
                accountingSyncConfiguration,
    ...
    override fun toString() = "CustomerUpdateParams{customerId=$customerId, accountingSyncConfiguration=$accountingSyncConfiguration, additionalEmails=$additionalEmails, autoCollection=$autoCollection, billingAddress=$billingAddress, currency=$currency, email=$email, emailDelivery=$emailDelivery, externalCustomerId=$externalCustomerId, metadata=$metadata, name=$name, paymentProvider=$paymentProvider, paymentProviderId=$paymentProviderId, reportingConfiguration=$reportingConfiguration, shippingAddress=$shippingAddress, taxId=$taxId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(customerUpdateParams: CustomerUpdateParams) = apply {
            ...
            this.accountingSyncConfiguration = customerUpdateParams.accountingSyncConfiguration
            this.additionalEmails(customerUpdateParams.additionalEmails ?: listOf())
            this.autoCollection = customerUpdateParams.autoCollection
            this.billingAddress = customerUpdateParams.billingAddress
            this.currency = customerUpdateParams.currency
            this.email = customerUpdateParams.email
            this.emailDelivery = customerUpdateParams.emailDelivery
            this.externalCustomerId = customerUpdateParams.externalCustomerId
            this.metadata = customerUpdateParams.metadata
            this.name = customerUpdateParams.name
            this.paymentProvider = customerUpdateParams.paymentProvider
            this.paymentProviderId = customerUpdateParams.paymentProviderId
            this.reportingConfiguration = customerUpdateParams.reportingConfiguration
            this.shippingAddress = customerUpdateParams.shippingAddress
            this.taxId = customerUpdateParams.taxId
            additionalQueryParams(customerUpdateParams.additionalQueryParams)
            additionalHeaders(customerUpdateParams.additionalHeaders)
            additionalBodyProperties(customerUpdateParams.additionalBodyProperties)
        }
        ...
        fun build(): CustomerUpdateParams = CustomerUpdateParams(
    ...
    @NoAutoDetect
    class AccountingSyncConfiguration private constructor(private val excluded: Boolean?, private val accountingProviders: List<AccountingProvider>?, private val additionalProperties: Map<String, JsonValue>, ) {

        private var hashCode: Int = 0

        @JsonProperty("excluded")
        fun excluded(): Boolean? = excluded
        ...
        class Builder {
            ...
            @JsonProperty("excluded")
            fun excluded(excluded: Boolean) = apply {
        ...
        @NoAutoDetect
        class AccountingProvider private constructor(private val providerType: String?, private val externalProviderId: String?, private val additionalProperties: Map<String, JsonValue>, ) {

            private var hashCode: Int = 0

            @JsonProperty("provider_type")
            fun providerType(): String? = providerType
            ...
            class Builder {
                ...
                @JsonProperty("provider_type")
                fun providerType(providerType: String) = apply {
                ...
                fun build(): AccountingProvider = AccountingProvider(
                    checkNotNull(providerType) {
                        "`providerType` is required but was not set"
                    },
    ...
    @NoAutoDetect
    class ReportingConfiguration private constructor(private val exempt: Boolean?, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        class Builder {
            ...
            @JsonProperty("exempt")
            fun exempt(exempt: Boolean) = apply {
                this.exempt = exempt
            }
            ...
            fun build(): ReportingConfiguration = ReportingConfiguration(checkNotNull(exempt) {
                "`exempt` is required but was not set"
            }, additionalProperties.toUnmodifiable())
        }
    }
    ...
    class TaxId private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
            ...
            @JsonProperty("country")
            fun country(country: Country) = apply {
                this.country = country
            }

...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(newSubscriptionTieredBpsPrice: NewSubscriptionTieredBpsPrice) = apply {
            ...
            conversionRateConfig = newSubscriptionTieredBpsPrice.conversionRateConfig
    ...
    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(cadence, itemId, modelType, name, tieredBpsConfig, billableMetricId, billedInAdvance, billingCycleConfiguration, conversionRate, conversionRateConfig, currency, dimensionalPriceConfiguration, externalPriceId, fixedPriceQuantity, invoiceGroupingKey, invoicingCycleConfiguration, metadata, referenceId, additionalProperties) }
    /* spotless:on */

...
class CustomerCreditLedgerCreateEntryByExternalIdResponse private constructor(
    ...
    fun validate(): CustomerCreditLedgerCreateEntryByExternalIdResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    interface Visitor<out T> {
        ...
        /**
         * Maps an unknown variant of [CustomerCreditLedgerCreateEntryByExternalIdResponse]
         * to a value of type [T].
         *
         * An instance of [CustomerCreditLedgerCreateEntryByExternalIdResponse] can contain
         * an unknown variant if it was deserialized from data that doesn't match any known
    ...
    internal class Deserializer : BaseDeserializer<CustomerCreditLedgerCreateEntryByExternalIdResponse>(CustomerCreditLedgerCreateEntryByExternalIdResponse::class) {
    ...
    internal class Serializer : BaseSerializer<CustomerCreditLedgerCreateEntryByExternalIdResponse>(CustomerCreditLedgerCreateEntryByExternalIdResponse::class) {
    ...
    class ExpirationChangeLedgerEntry @JsonCreator private constructor(
        ...
        fun newBlockExpiryDate(): OffsetDateTime? = newBlockExpiryDate.getNullable("new_block_expiry_date")

...
private constructor(
     ...
     * import com.withorb.api.core.JsonValue
     *
     * val result: String? = customerCreditLedgerCreateEntryByExternalIdResponse.accept(object : CustomerCreditLedgerCreateEntryByExternalIdResponse.Visitor<String?> {

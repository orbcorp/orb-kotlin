...
class PlanListPageAsync private constructor(private val plansService: PlanServiceAsync, private val params: PlanListParams, private val response: Response, ) {
    ...
    companion object {
        ...
        fun of(plansService: PlanServiceAsync, params: PlanListParams, response: Response) = PlanListPageAsync(
            plansService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<Plan>>, private val paginationMetadata: JsonField<PaginationMetadata>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "PlanListPageAsync.Response{data=$data, paginationMetadata=$paginationMetadata, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: PlanListPageAsync, ) : Flow<Plan> {

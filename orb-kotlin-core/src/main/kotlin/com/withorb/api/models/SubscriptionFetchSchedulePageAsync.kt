...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SubscriptionFetchSchedulePageAsync && this.subscriptionsService == other.subscriptionsService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    fun getNextPageParams(): SubscriptionFetchScheduleParams? {
        ...
        return SubscriptionFetchScheduleParams.builder()
            .from(params)
    ...
    constructor(
        ...
        override fun toString() =
            "SubscriptionFetchSchedulePageAsync.Response{data=$data, paginationMetadata=$paginationMetadata, additionalProperties=$additionalProperties}"

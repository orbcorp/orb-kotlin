...
class PlanExternalPlanIdFetchParams constructor(private val externalPlanId: String, private val additionalQueryParams: Map<String, List<String>>, private val additionalHeaders: Map<String, List<String>>, ) {
    ...
    override fun toString() = "PlanExternalPlanIdFetchParams{externalPlanId=$externalPlanId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        fun build(): PlanExternalPlanIdFetchParams = PlanExternalPlanIdFetchParams(
            checkNotNull(externalPlanId) {
                "`externalPlanId` is required but was not set"
            },

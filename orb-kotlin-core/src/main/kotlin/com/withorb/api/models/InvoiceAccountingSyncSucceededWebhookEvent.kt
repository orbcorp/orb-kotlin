...
class InvoiceAccountingSyncSucceededWebhookEvent
...
private constructor(
    ...
    /** A builder for [InvoiceAccountingSyncSucceededWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            invoiceAccountingSyncSucceededWebhookEvent: InvoiceAccountingSyncSucceededWebhookEvent
        ) = apply {
            id = invoiceAccountingSyncSucceededWebhookEvent.id
            accountingSyncRecord = invoiceAccountingSyncSucceededWebhookEvent.accountingSyncRecord
            createdAt = invoiceAccountingSyncSucceededWebhookEvent.createdAt
            invoice = invoiceAccountingSyncSucceededWebhookEvent.invoice
            properties = invoiceAccountingSyncSucceededWebhookEvent.properties
            type = invoiceAccountingSyncSucceededWebhookEvent.type
            additionalProperties =
                invoiceAccountingSyncSucceededWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InvoiceAccountingSyncSucceededWebhookEvent].
         *
         ...
         */
        fun build(): InvoiceAccountingSyncSucceededWebhookEvent =
            InvoiceAccountingSyncSucceededWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): InvoiceAccountingSyncSucceededWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val INVOICE_ACCOUNTING_SYNC_SUCCEEDED = of("invoice.accounting_sync_succeeded")
        ...
        fun value(): Value =
            when (this) {
                INVOICE_ACCOUNTING_SYNC_SUCCEEDED -> Value.INVOICE_ACCOUNTING_SYNC_SUCCEEDED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                INVOICE_ACCOUNTING_SYNC_SUCCEEDED -> Known.INVOICE_ACCOUNTING_SYNC_SUCCEEDED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InvoiceAccountingSyncSucceededWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "InvoiceAccountingSyncSucceededWebhookEvent{id=$id, accountingSyncRecord=$accountingSyncRecord, createdAt=$createdAt, invoice=$invoice, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}

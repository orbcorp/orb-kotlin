...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            unitWithProrationConfig = newSubscriptionUnitWithProrationPrice.unitWithProrationConfig
            ...
            conversionRateConfig = newSubscriptionUnitWithProrationPrice.conversionRateConfig
            currency = newSubscriptionUnitWithProrationPrice.currency
            dimensionalPriceConfiguration =
                newSubscriptionUnitWithProrationPrice.dimensionalPriceConfiguration
            ...
            licenseTypeId = newSubscriptionUnitWithProrationPrice.licenseTypeId
         ...
         * [UnitWithProrationConfig] value instead. This method is primarily for setting the field
        ...
        /**
         * Returns an immutable instance of [NewSubscriptionUnitWithProrationPrice].
         *
    ...
    override fun toString() =
        "NewSubscriptionUnitWithProrationPrice{cadence=$cadence, itemId=$itemId, modelType=$modelType, name=$name, unitWithProrationConfig=$unitWithProrationConfig, billableMetricId=$billableMetricId, billedInAdvance=$billedInAdvance, billingCycleConfiguration=$billingCycleConfiguration, conversionRate=$conversionRate, conversionRateConfig=$conversionRateConfig, currency=$currency, dimensionalPriceConfiguration=$dimensionalPriceConfiguration, externalPriceId=$externalPriceId, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, invoicingCycleConfiguration=$invoicingCycleConfiguration, licenseTypeId=$licenseTypeId, metadata=$metadata, referenceId=$referenceId, additionalProperties=$additionalProperties}"
}

...
class CustomerCreditLedgerListByExternalIdPage private constructor(private val ledgerService: LedgerService, private val params: CustomerCreditLedgerListByExternalIdParams, private val response: Response, ) {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CustomerCreditLedgerListByExternalIdPage &&
    ...
    override fun toString() = "CustomerCreditLedgerListByExternalIdPage{ledgerService=$ledgerService, params=$params, response=$response}"
    ...
    companion object {
        ...
        fun of(ledgerService: LedgerService, params: CustomerCreditLedgerListByExternalIdParams, response: Response) = CustomerCreditLedgerListByExternalIdPage(
            ledgerService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<CustomerCreditLedgerListByExternalIdResponse>>, private val paginationMetadata: JsonField<PaginationMetadata>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "CustomerCreditLedgerListByExternalIdPage.Response{data=$data, paginationMetadata=$paginationMetadata, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: CustomerCreditLedgerListByExternalIdPage, ) : Sequence<CustomerCreditLedgerListByExternalIdResponse> {

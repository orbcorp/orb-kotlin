 ...
 */
class CustomerCreditLedgerListByExternalIdPage private constructor(
    ...
    companion object {
        ...
        fun of(ledgerService: LedgerService, params: CustomerCreditLedgerListByExternalIdParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<CustomerCreditLedgerListByExternalIdResponse>> = JsonMissing.of(),
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<CustomerCreditLedgerListByExternalIdResponse> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {

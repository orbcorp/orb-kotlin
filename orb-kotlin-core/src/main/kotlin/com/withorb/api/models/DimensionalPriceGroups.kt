...
private constructor(
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<DimensionalPriceGroup>> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<DimensionalPriceGroup>`
        ...
        /**
         * Adds a single [DimensionalPriceGroup] to [Builder.data].
         *
        ...
        /**
         * Returns an immutable instance of [DimensionalPriceGroups].
         *

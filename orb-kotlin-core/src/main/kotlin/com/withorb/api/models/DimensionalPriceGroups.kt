...
@NoAutoDetect
class DimensionalPriceGroups @JsonCreator private constructor(
    @JsonProperty("data") @ExcludeMissing private val data: JsonField<List<DimensionalPriceGroup>> = JsonMissing.of(),
    ...
    fun validate(): DimensionalPriceGroups =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(dimensionalPriceGroups: DimensionalPriceGroups) =
            apply {
        ...
        fun data(data: JsonField<List<DimensionalPriceGroup>>) =
            apply {
                this.data = data.map { it.toMutableList() }
            }

        fun addData(data: DimensionalPriceGroup) =
            apply {
    ...
    override fun toString() = "DimensionalPriceGroups{data=$data, paginationMetadata=$paginationMetadata, additionalProperties=$additionalProperties}"
}

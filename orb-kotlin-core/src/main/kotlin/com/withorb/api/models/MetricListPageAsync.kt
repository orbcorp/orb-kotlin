...
class MetricListPageAsync private constructor(private val metricsService: MetricServiceAsync, private val params: MetricListParams, private val response: Response, ) {
    ...
    companion object {
        ...
        fun of(metricsService: MetricServiceAsync, params: MetricListParams, response: Response) = MetricListPageAsync(
            metricsService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<BillableMetric>>, private val paginationMetadata: JsonField<PaginationMetadata>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "MetricListPageAsync.Response{data=$data, paginationMetadata=$paginationMetadata, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: MetricListPageAsync, ) : Flow<BillableMetric> {

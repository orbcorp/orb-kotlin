...
private constructor(
    ...
    fun data(): List<ItemModel> = response().data()
    ...
    companion object {
        ...
        fun of(itemsService: ItemService, params: ItemListParams, response: Response) =
    ...
    @JsonCreator
    constructor(
        @JsonProperty("data") private val data: JsonField<List<ItemModel>> = JsonMissing.of(),
        ...
        fun data(): List<ItemModel> = data.getNullable("data") ?: listOf()

        fun paginationMetadata(): PaginationMetadata =
            paginationMetadata.getRequired("pagination_metadata")

        @JsonProperty("data") fun _data(): JsonField<List<ItemModel>>? = data
        ...
        class Builder {
            ...
            private var data: JsonField<List<ItemModel>> = JsonMissing.of()
            ...
            fun data(data: List<ItemModel>) = data(JsonField.of(data))

            fun data(data: JsonField<List<ItemModel>>) = apply { this.data = data }
    ...
    class AutoPager(private val firstPage: ItemListPage) : Sequence<ItemModel> {

        override fun iterator(): Iterator<ItemModel> = iterator {
            var page = firstPage
            var index = 0
            while (true) {

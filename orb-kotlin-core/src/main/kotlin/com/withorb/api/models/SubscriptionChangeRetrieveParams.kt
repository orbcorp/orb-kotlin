...
private constructor(
    ...
    companion object {
        ...
        fun none(): SubscriptionChangeRetrieveParams = builder().build()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionChangeRetrieveParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(subscriptionChangeId, additionalHeaders, additionalQueryParams)

...
class SubscriptionEndedWebhookEvent
...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = subscriptionEndedWebhookEvent.properties().convert(MyClass::class.java)
     * ```
     */
    ...
    /** A builder for [SubscriptionEndedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionEndedWebhookEvent: SubscriptionEndedWebhookEvent) = apply {
            id = subscriptionEndedWebhookEvent.id
            createdAt = subscriptionEndedWebhookEvent.createdAt
            properties = subscriptionEndedWebhookEvent.properties
            subscription = subscriptionEndedWebhookEvent.subscription
            type = subscriptionEndedWebhookEvent.type
            additionalProperties = subscriptionEndedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubscriptionEndedWebhookEvent].
         *
         ...
         */
        fun build(): SubscriptionEndedWebhookEvent =
            SubscriptionEndedWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): SubscriptionEndedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val SUBSCRIPTION_ENDED = of("subscription.ended")
        ...
        fun value(): Value =
            when (this) {
                SUBSCRIPTION_ENDED -> Value.SUBSCRIPTION_ENDED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                SUBSCRIPTION_ENDED -> Known.SUBSCRIPTION_ENDED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionEndedWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "SubscriptionEndedWebhookEvent{id=$id, createdAt=$createdAt, properties=$properties, subscription=$subscription, type=$type, additionalProperties=$additionalProperties}"
}

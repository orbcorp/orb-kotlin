...
@NoAutoDetect
class CustomerCreditTopUpListByExternalIdResponse @JsonCreator private constructor(
    ...
    fun validate(): CustomerCreditTopUpListByExternalIdResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    /** A builder for [CustomerCreditTopUpListByExternalIdResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(customerCreditTopUpListByExternalIdResponse: CustomerCreditTopUpListByExternalIdResponse) =
            apply {
                ...
                additionalProperties = customerCreditTopUpListByExternalIdResponse.additionalProperties.toMutableMap()
            }
    ...
    override fun toString() = "CustomerCreditTopUpListByExternalIdResponse{id=$id, amount=$amount, currency=$currency, invoiceSettings=$invoiceSettings, perUnitCostBasis=$perUnitCostBasis, threshold=$threshold, expiresAfter=$expiresAfter, expiresAfterUnit=$expiresAfterUnit, additionalProperties=$additionalProperties}"
}

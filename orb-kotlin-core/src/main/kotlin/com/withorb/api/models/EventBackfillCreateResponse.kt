...
@NoAutoDetect
class EventBackfillCreateResponse private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    class Builder {
        ...
        fun build(): EventBackfillCreateResponse = EventBackfillCreateResponse(
            id,
            status,
            createdAt,
            timeframeStart,

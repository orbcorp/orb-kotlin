...
class NewSubscriptionMatrixWithAllocationPrice
private constructor(
    ...
    /** A builder for [NewSubscriptionMatrixWithAllocationPrice]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            cadence = newSubscriptionMatrixWithAllocationPrice.cadence
            itemId = newSubscriptionMatrixWithAllocationPrice.itemId
            matrixWithAllocationConfig =
                newSubscriptionMatrixWithAllocationPrice.matrixWithAllocationConfig
            modelType = newSubscriptionMatrixWithAllocationPrice.modelType
            name = newSubscriptionMatrixWithAllocationPrice.name
            billableMetricId = newSubscriptionMatrixWithAllocationPrice.billableMetricId
            billedInAdvance = newSubscriptionMatrixWithAllocationPrice.billedInAdvance
            billingCycleConfiguration =
                newSubscriptionMatrixWithAllocationPrice.billingCycleConfiguration
            conversionRate = newSubscriptionMatrixWithAllocationPrice.conversionRate
            currency = newSubscriptionMatrixWithAllocationPrice.currency
            dimensionalPriceConfiguration =
                newSubscriptionMatrixWithAllocationPrice.dimensionalPriceConfiguration
            externalPriceId = newSubscriptionMatrixWithAllocationPrice.externalPriceId
            fixedPriceQuantity = newSubscriptionMatrixWithAllocationPrice.fixedPriceQuantity
            invoiceGroupingKey = newSubscriptionMatrixWithAllocationPrice.invoiceGroupingKey
            invoicingCycleConfiguration =
                newSubscriptionMatrixWithAllocationPrice.invoicingCycleConfiguration
            metadata = newSubscriptionMatrixWithAllocationPrice.metadata
            referenceId = newSubscriptionMatrixWithAllocationPrice.referenceId
            additionalProperties =
                newSubscriptionMatrixWithAllocationPrice.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NewSubscriptionMatrixWithAllocationPrice].
         *
         ...
         */
        fun build(): NewSubscriptionMatrixWithAllocationPrice =
            NewSubscriptionMatrixWithAllocationPrice(
    ...
    fun validate(): NewSubscriptionMatrixWithAllocationPrice = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is NewSubscriptionMatrixWithAllocationPrice && cadence == other.cadence && itemId == other.itemId && matrixWithAllocationConfig == other.matrixWithAllocationConfig && modelType == other.modelType && name == other.name && billableMetricId == other.billableMetricId && billedInAdvance == other.billedInAdvance && billingCycleConfiguration == other.billingCycleConfiguration && conversionRate == other.conversionRate && currency == other.currency && dimensionalPriceConfiguration == other.dimensionalPriceConfiguration && externalPriceId == other.externalPriceId && fixedPriceQuantity == other.fixedPriceQuantity && invoiceGroupingKey == other.invoiceGroupingKey && invoicingCycleConfiguration == other.invoicingCycleConfiguration && metadata == other.metadata && referenceId == other.referenceId && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(cadence, itemId, matrixWithAllocationConfig, modelType, name, billableMetricId, billedInAdvance, billingCycleConfiguration, conversionRate, currency, dimensionalPriceConfiguration, externalPriceId, fixedPriceQuantity, invoiceGroupingKey, invoicingCycleConfiguration, metadata, referenceId, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "NewSubscriptionMatrixWithAllocationPrice{cadence=$cadence, itemId=$itemId, matrixWithAllocationConfig=$matrixWithAllocationConfig, modelType=$modelType, name=$name, billableMetricId=$billableMetricId, billedInAdvance=$billedInAdvance, billingCycleConfiguration=$billingCycleConfiguration, conversionRate=$conversionRate, currency=$currency, dimensionalPriceConfiguration=$dimensionalPriceConfiguration, externalPriceId=$externalPriceId, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, invoicingCycleConfiguration=$invoicingCycleConfiguration, metadata=$metadata, referenceId=$referenceId, additionalProperties=$additionalProperties}"
}

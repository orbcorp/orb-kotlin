...
class AlertListPageAsync private constructor(private val alertsService: AlertServiceAsync, private val params: AlertListParams, private val response: Response, ) {
    ...
    companion object {
        ...
        fun of(alertsService: AlertServiceAsync, params: AlertListParams, response: Response) = AlertListPageAsync(
            alertsService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<Alert>>, private val paginationMetadata: JsonField<PaginationMetadata>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "AlertListPageAsync.Response{data=$data, paginationMetadata=$paginationMetadata, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: AlertListPageAsync, ) : Flow<Alert> {

...
private constructor(
    ...
    constructor(
        ...
        @JsonProperty("data") fun _data(): JsonField<List<AlertModel>>? = data
    ...
    class AutoPager(private val firstPage: AlertListPageAsync) : Flow<AlertModel> {

        override suspend fun collect(collector: FlowCollector<AlertModel>) {
            var page = firstPage
            var index = 0
            while (true) {

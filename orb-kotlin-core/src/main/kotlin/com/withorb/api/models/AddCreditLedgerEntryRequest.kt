...
private constructor(
    ...
    fun incrementCreditLedgerEntryRequestParams(): AddIncrementCreditLedgerEntryRequestParams? =
        incrementCreditLedgerEntryRequestParams

    fun decrementCreditLedgerEntryRequestParams(): AddDecrementCreditLedgerEntryRequestParams? =
    ...
    fun voidCreditLedgerEntryRequestParams(): AddVoidCreditLedgerEntryRequestParams? =
        voidCreditLedgerEntryRequestParams

    fun amendmentCreditLedgerEntryRequestParams(): AddAmendmentCreditLedgerEntryRequestParams? =

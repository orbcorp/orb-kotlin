...
class SubscriptionPriceIntervalsParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    fun add(): List<Add>? = add

    fun addAdjustments(): List<AddAdjustment>? = addAdjustments

    fun edit(): List<Edit>? = edit
    ...
    @NoAutoDetect
    class SubscriptionPriceIntervalsBody internal constructor(
      private val add: List<Add>?,
      private val addAdjustments: List<AddAdjustment>?,
      private val edit: List<Edit>?,
      private val editAdjustments: List<EditAdjustment>?,
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun toString() = "SubscriptionPriceIntervalsBody{add=$add, addAdjustments=$addAdjustments, edit=$edit, editAdjustments=$editAdjustments, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            internal fun from(subscriptionPriceIntervalsBody: SubscriptionPriceIntervalsBody) = apply {
            ...
            fun build(): SubscriptionPriceIntervalsBody = SubscriptionPriceIntervalsBody(
                add?.toUnmodifiable(),
    ...
    override fun toString() = "SubscriptionPriceIntervalsParams{subscriptionId=$subscriptionId, add=$add, addAdjustments=$addAdjustments, edit=$edit, editAdjustments=$editAdjustments, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(subscriptionPriceIntervalsParams: SubscriptionPriceIntervalsParams) = apply {
        ...
        fun build(): SubscriptionPriceIntervalsParams = SubscriptionPriceIntervalsParams(
    ...
    class Add private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        fun endDate(): EndDate? = endDate

        /** A list of fixed fee quantity transitions to initialize on the price interval. */
        @JsonProperty("fixed_fee_quantity_transitions")
        fun fixedFeeQuantityTransitions(): List<FixedFeeQuantityTransition>? = fixedFeeQuantityTransitions

        /** A list of discounts to initialize on the price interval. */
        @JsonProperty("discounts")
        fun discounts(): List<Discount>? = discounts
        ...
        fun minimumAmount(): Double? = minimumAmount
        ...
        fun maximumAmount(): Double? = maximumAmount
        ...
        override fun toString() = "Add{priceId=$priceId, externalPriceId=$externalPriceId, price=$price, allocationPrice=$allocationPrice, startDate=$startDate, endDate=$endDate, fixedFeeQuantityTransitions=$fixedFeeQuantityTransitions, discounts=$discounts, minimumAmount=$minimumAmount, maximumAmount=$maximumAmount, additionalProperties=$additionalProperties}"
        ...
        class Builder {
             ...
             */
            @JsonProperty("start_date")
            fun startDate(startDate: StartDate) = apply {
             ...
             */
            @JsonProperty("end_date")
            fun endDate(endDate: EndDate) = apply {
                this.endDate = endDate
            }

            /** A list of fixed fee quantity transitions to initialize on the price interval. */
            @JsonProperty("fixed_fee_quantity_transitions")
            fun fixedFeeQuantityTransitions(fixedFeeQuantityTransitions: List<FixedFeeQuantityTransition>) = apply {
                this.fixedFeeQuantityTransitions = fixedFeeQuantityTransitions
            }
             ...
             */
            @JsonProperty("minimum_amount")
            fun minimumAmount(minimumAmount: Double) = apply {
        ...
        class StartDate private constructor(private val offsetDateTime: OffsetDateTime? = null, private val billingCycleRelativeDate: BillingCycleRelativeDate? = null, private val _json: JsonValue? = null, ) {

            private var validated: Boolean = false

            fun offsetDateTime(): OffsetDateTime? = offsetDateTime
            fun billingCycleRelativeDate(): BillingCycleRelativeDate? = billingCycleRelativeDate
            ...
            fun asBillingCycleRelativeDate(): BillingCycleRelativeDate = billingCycleRelativeDate.getOrThrow("billingCycleRelativeDate")
            ...
            fun <T> accept(visitor: Visitor<T>): T {
              return when {
                  ...
                  billingCycleRelativeDate != null -> visitor.visitBillingCycleRelativeDate(billingCycleRelativeDate)
            ...
            override fun toString(): String {
              return when {
                  ...
                  billingCycleRelativeDate != null -> "StartDate{billingCycleRelativeDate=$billingCycleRelativeDate}"
            ...
            companion object {
                ...
                fun ofOffsetDateTime(offsetDateTime: OffsetDateTime) = StartDate(offsetDateTime = offsetDateTime)

                fun ofBillingCycleRelativeDate(billingCycleRelativeDate: BillingCycleRelativeDate) = StartDate(billingCycleRelativeDate = billingCycleRelativeDate)
            }
            ...
            interface Visitor<out T> {
                ...
                fun visitBillingCycleRelativeDate(billingCycleRelativeDate: BillingCycleRelativeDate): T
            ...
            class Serializer : BaseSerializer<StartDate>(StartDate::class) {
                ...
                override fun serialize(value: StartDate, generator: JsonGenerator, provider: SerializerProvider) {
                  when {
                      value.offsetDateTime != null -> generator.writeObject(value.offsetDateTime)
                      value.billingCycleRelativeDate != null -> generator.writeObject(value.billingCycleRelativeDate)
        ...
        @NoAutoDetect
        class AllocationPrice private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            override fun toString() = "AllocationPrice{currency=$currency, amount=$amount, cadence=$cadence, expiresAtEndOfCadence=$expiresAtEndOfCadence, additionalProperties=$additionalProperties}"
            ...
            class Builder {
                ...
                /** The cadence at which to allocate the amount to the customer. */
                @JsonProperty("cadence")
                fun cadence(cadence: Cadence) = apply {
                ...
                fun build(): AllocationPrice = AllocationPrice(
                    ...
                    checkNotNull(cadence) {
                        "`cadence` is required but was not set"
                    },
        ...
        class Discount private constructor(
          ...
          private val _json: JsonValue? = null,
            ...
            fun amountDiscountCreationParams(): AmountDiscountCreationParams? = amountDiscountCreationParams
            fun percentageDiscountCreationParams(): PercentageDiscountCreationParams? = percentageDiscountCreationParams
            fun usageDiscountCreationParams(): UsageDiscountCreationParams? = usageDiscountCreationParams

            fun isAmountDiscountCreationParams(): Boolean = amountDiscountCreationParams != null
            fun isPercentageDiscountCreationParams(): Boolean = percentageDiscountCreationParams != null
            fun isUsageDiscountCreationParams(): Boolean = usageDiscountCreationParams != null

            fun asAmountDiscountCreationParams(): AmountDiscountCreationParams = amountDiscountCreationParams.getOrThrow("amountDiscountCreationParams")
            fun asPercentageDiscountCreationParams(): PercentageDiscountCreationParams = percentageDiscountCreationParams.getOrThrow("percentageDiscountCreationParams")
            fun asUsageDiscountCreationParams(): UsageDiscountCreationParams = usageDiscountCreationParams.getOrThrow("usageDiscountCreationParams")

            fun _json(): JsonValue? = _json

            fun <T> accept(visitor: Visitor<T>): T {
              return when {
                  amountDiscountCreationParams != null -> visitor.visitAmountDiscountCreationParams(amountDiscountCreationParams)
                  percentageDiscountCreationParams != null -> visitor.visitPercentageDiscountCreationParams(percentageDiscountCreationParams)
                  usageDiscountCreationParams != null -> visitor.visitUsageDiscountCreationParams(usageDiscountCreationParams)
                  else -> visitor.unknown(_json)
              }
            }
            ...
            fun validate(): Discount = apply {
                if (!validated) {
                  if (amountDiscountCreationParams == null && percentageDiscountCreationParams == null && usageDiscountCreationParams == null) {
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Discount &&
                  ...
                  this.percentageDiscountCreationParams == other.percentageDiscountCreationParams &&
            ...
            override fun toString(): String {
              return when {
                  amountDiscountCreationParams != null -> "Discount{amountDiscountCreationParams=$amountDiscountCreationParams}"
                  percentageDiscountCreationParams != null -> "Discount{percentageDiscountCreationParams=$percentageDiscountCreationParams}"
                  usageDiscountCreationParams != null -> "Discount{usageDiscountCreationParams=$usageDiscountCreationParams}"
            ...
            companion object {
                ...
                fun ofAmountDiscountCreationParams(amountDiscountCreationParams: AmountDiscountCreationParams) = Discount(amountDiscountCreationParams = amountDiscountCreationParams)

                fun ofPercentageDiscountCreationParams(percentageDiscountCreationParams: PercentageDiscountCreationParams) = Discount(percentageDiscountCreationParams = percentageDiscountCreationParams)

                fun ofUsageDiscountCreationParams(usageDiscountCreationParams: UsageDiscountCreationParams) = Discount(usageDiscountCreationParams = usageDiscountCreationParams)
            }

            interface Visitor<out T> {

                fun visitAmountDiscountCreationParams(amountDiscountCreationParams: AmountDiscountCreationParams): T

                fun visitPercentageDiscountCreationParams(percentageDiscountCreationParams: PercentageDiscountCreationParams): T

                fun visitUsageDiscountCreationParams(usageDiscountCreationParams: UsageDiscountCreationParams): T
            ...
            class Deserializer : BaseDeserializer<Discount>(Discount::class) {
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): Discount {
                  val json = JsonValue.fromJsonNode(node)
                  tryDeserialize(node, jacksonTypeRef<AmountDiscountCreationParams>()){ it.validate() }?.let {
                      return Discount(amountDiscountCreationParams = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<PercentageDiscountCreationParams>()){ it.validate() }?.let {
                      return Discount(percentageDiscountCreationParams = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<UsageDiscountCreationParams>()){ it.validate() }?.let {
            ...
            class Serializer : BaseSerializer<Discount>(Discount::class) {
                ...
                override fun serialize(value: Discount, generator: JsonGenerator, provider: SerializerProvider) {
                  when {
                      value.amountDiscountCreationParams != null -> generator.writeObject(value.amountDiscountCreationParams)
                      value.percentageDiscountCreationParams != null -> generator.writeObject(value.percentageDiscountCreationParams)
                      value.usageDiscountCreationParams != null -> generator.writeObject(value.usageDiscountCreationParams)
                      value._json != null -> generator.writeObject(value._json)
                      else -> throw IllegalStateException("Invalid Discount")
                  }
                }
            ...
            @NoAutoDetect
            class AmountDiscountCreationParams private constructor(private val discountType: JsonField<DiscountType>, private val amountDiscount: JsonField<Double>, private val additionalProperties: Map<String, JsonValue>, ) {
                ...
                override fun toString() = "AmountDiscountCreationParams{discountType=$discountType, amountDiscount=$amountDiscount, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    internal fun from(amountDiscountCreationParams: AmountDiscountCreationParams) = apply {
                    ...
                    /** Only available if discount_type is `amount`. */
                    fun amountDiscount(amountDiscount: Double) = amountDiscount(JsonField.of(amountDiscount))
                    ...
                    fun build(): AmountDiscountCreationParams = AmountDiscountCreationParams(
                        discountType,
                        amountDiscount,
                        additionalProperties.toUnmodifiable(),
                    )
            ...
            @NoAutoDetect
            class PercentageDiscountCreationParams private constructor(private val discountType: JsonField<DiscountType>, private val percentageDiscount: JsonField<Double>, private val additionalProperties: Map<String, JsonValue>, ) {
                ...
                override fun toString() = "PercentageDiscountCreationParams{discountType=$discountType, percentageDiscount=$percentageDiscount, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    internal fun from(percentageDiscountCreationParams: PercentageDiscountCreationParams) = apply {
                        this.discountType = percentageDiscountCreationParams.discountType
                        this.percentageDiscount = percentageDiscountCreationParams.percentageDiscount
                    ...
                    fun build(): PercentageDiscountCreationParams = PercentageDiscountCreationParams(
                        discountType,
                        percentageDiscount,
                        additionalProperties.toUnmodifiable(),
                    )
            ...
            @NoAutoDetect
            class UsageDiscountCreationParams private constructor(private val discountType: JsonField<DiscountType>, private val usageDiscount: JsonField<Double>, private val additionalProperties: Map<String, JsonValue>, ) {
                ...
                override fun toString() = "UsageDiscountCreationParams{discountType=$discountType, usageDiscount=$usageDiscount, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    internal fun from(usageDiscountCreationParams: UsageDiscountCreationParams) = apply {
                    ...
                    fun build(): UsageDiscountCreationParams = UsageDiscountCreationParams(
                        discountType,
                        usageDiscount,
                        additionalProperties.toUnmodifiable(),
                    )
        ...
        class EndDate private constructor(private val offsetDateTime: OffsetDateTime? = null, private val billingCycleRelativeDate: BillingCycleRelativeDate? = null, private val _json: JsonValue? = null, ) {
            ...
            override fun toString(): String {
              return when {
                  ...
                  billingCycleRelativeDate != null -> "EndDate{billingCycleRelativeDate=$billingCycleRelativeDate}"
            ...
            companion object {
                ...
                fun ofOffsetDateTime(offsetDateTime: OffsetDateTime) = EndDate(offsetDateTime = offsetDateTime)

                fun ofBillingCycleRelativeDate(billingCycleRelativeDate: BillingCycleRelativeDate) = EndDate(billingCycleRelativeDate = billingCycleRelativeDate)
            }
            ...
            class Serializer : BaseSerializer<EndDate>(EndDate::class) {
                ...
                override fun serialize(value: EndDate, generator: JsonGenerator, provider: SerializerProvider) {
                  when {
                      value.offsetDateTime != null -> generator.writeObject(value.offsetDateTime)
                      value.billingCycleRelativeDate != null -> generator.writeObject(value.billingCycleRelativeDate)
                      value._json != null -> generator.writeObject(value._json)
        ...
        @NoAutoDetect
        class FixedFeeQuantityTransition private constructor(private val quantity: Long?, private val effectiveDate: OffsetDateTime?, private val additionalProperties: Map<String, JsonValue>, ) {
            ...
            override fun toString() = "FixedFeeQuantityTransition{quantity=$quantity, effectiveDate=$effectiveDate, additionalProperties=$additionalProperties}"
            ...
            class Builder {
                ...
                fun build(): FixedFeeQuantityTransition = FixedFeeQuantityTransition(
        ...
        class Price private constructor(
          ...
          private val newFloatingMatrixWithAllocationPrice: NewFloatingMatrixWithAllocationPrice? = null,
          ...
          private val newFloatingThresholdTotalAmountPrice: NewFloatingThresholdTotalAmountPrice? = null,
          ...
          private val newFloatingPackageWithAllocationPrice: NewFloatingPackageWithAllocationPrice? = null,
          private val newFloatingTieredPackageWithMinimumPrice: NewFloatingTieredPackageWithMinimumPrice? = null,
          private val newFloatingUnitWithPercentPrice: NewFloatingUnitWithPercentPrice? = null,
          private val newFloatingTieredWithProrationPrice: NewFloatingTieredWithProrationPrice? = null,
          ...
          private val _json: JsonValue? = null,
            ...
            fun newFloatingMatrixWithAllocationPrice(): NewFloatingMatrixWithAllocationPrice? = newFloatingMatrixWithAllocationPrice
            ...
            fun newFloatingThresholdTotalAmountPrice(): NewFloatingThresholdTotalAmountPrice? = newFloatingThresholdTotalAmountPrice
            fun newFloatingTieredPackagePrice(): NewFloatingTieredPackagePrice? = newFloatingTieredPackagePrice
            fun newFloatingGroupedTieredPrice(): NewFloatingGroupedTieredPrice? = newFloatingGroupedTieredPrice
            fun newFloatingTieredWithMinimumPrice(): NewFloatingTieredWithMinimumPrice? = newFloatingTieredWithMinimumPrice
            fun newFloatingPackageWithAllocationPrice(): NewFloatingPackageWithAllocationPrice? = newFloatingPackageWithAllocationPrice
            fun newFloatingTieredPackageWithMinimumPrice(): NewFloatingTieredPackageWithMinimumPrice? = newFloatingTieredPackageWithMinimumPrice
            fun newFloatingUnitWithPercentPrice(): NewFloatingUnitWithPercentPrice? = newFloatingUnitWithPercentPrice
            fun newFloatingTieredWithProrationPrice(): NewFloatingTieredWithProrationPrice? = newFloatingTieredWithProrationPrice
            fun newFloatingUnitWithProrationPrice(): NewFloatingUnitWithProrationPrice? = newFloatingUnitWithProrationPrice
            fun newFloatingGroupedAllocationPrice(): NewFloatingGroupedAllocationPrice? = newFloatingGroupedAllocationPrice
            fun newFloatingBulkWithProrationPrice(): NewFloatingBulkWithProrationPrice? = newFloatingBulkWithProrationPrice
            ...
            fun isNewFloatingMatrixWithAllocationPrice(): Boolean = newFloatingMatrixWithAllocationPrice != null
            ...
            fun isNewFloatingThresholdTotalAmountPrice(): Boolean = newFloatingThresholdTotalAmountPrice != null
            ...
            fun isNewFloatingTieredWithMinimumPrice(): Boolean = newFloatingTieredWithMinimumPrice != null
            fun isNewFloatingPackageWithAllocationPrice(): Boolean = newFloatingPackageWithAllocationPrice != null
            fun isNewFloatingTieredPackageWithMinimumPrice(): Boolean = newFloatingTieredPackageWithMinimumPrice != null
            fun isNewFloatingUnitWithPercentPrice(): Boolean = newFloatingUnitWithPercentPrice != null
            fun isNewFloatingTieredWithProrationPrice(): Boolean = newFloatingTieredWithProrationPrice != null
            fun isNewFloatingUnitWithProrationPrice(): Boolean = newFloatingUnitWithProrationPrice != null
            fun isNewFloatingGroupedAllocationPrice(): Boolean = newFloatingGroupedAllocationPrice != null
            fun isNewFloatingBulkWithProrationPrice(): Boolean = newFloatingBulkWithProrationPrice != null

            fun asNewFloatingUnitPrice(): NewFloatingUnitPrice = newFloatingUnitPrice.getOrThrow("newFloatingUnitPrice")
            fun asNewFloatingPackagePrice(): NewFloatingPackagePrice = newFloatingPackagePrice.getOrThrow("newFloatingPackagePrice")
            fun asNewFloatingMatrixPrice(): NewFloatingMatrixPrice = newFloatingMatrixPrice.getOrThrow("newFloatingMatrixPrice")
            fun asNewFloatingMatrixWithAllocationPrice(): NewFloatingMatrixWithAllocationPrice = newFloatingMatrixWithAllocationPrice.getOrThrow("newFloatingMatrixWithAllocationPrice")
            fun asNewFloatingTieredPrice(): NewFloatingTieredPrice = newFloatingTieredPrice.getOrThrow("newFloatingTieredPrice")
            fun asNewFloatingTieredBpsPrice(): NewFloatingTieredBpsPrice = newFloatingTieredBpsPrice.getOrThrow("newFloatingTieredBpsPrice")
            fun asNewFloatingBpsPrice(): NewFloatingBpsPrice = newFloatingBpsPrice.getOrThrow("newFloatingBpsPrice")
            fun asNewFloatingBulkBpsPrice(): NewFloatingBulkBpsPrice = newFloatingBulkBpsPrice.getOrThrow("newFloatingBulkBpsPrice")
            fun asNewFloatingBulkPrice(): NewFloatingBulkPrice = newFloatingBulkPrice.getOrThrow("newFloatingBulkPrice")
            fun asNewFloatingThresholdTotalAmountPrice(): NewFloatingThresholdTotalAmountPrice = newFloatingThresholdTotalAmountPrice.getOrThrow("newFloatingThresholdTotalAmountPrice")
            fun asNewFloatingTieredPackagePrice(): NewFloatingTieredPackagePrice = newFloatingTieredPackagePrice.getOrThrow("newFloatingTieredPackagePrice")
            fun asNewFloatingGroupedTieredPrice(): NewFloatingGroupedTieredPrice = newFloatingGroupedTieredPrice.getOrThrow("newFloatingGroupedTieredPrice")
            fun asNewFloatingTieredWithMinimumPrice(): NewFloatingTieredWithMinimumPrice = newFloatingTieredWithMinimumPrice.getOrThrow("newFloatingTieredWithMinimumPrice")
            fun asNewFloatingPackageWithAllocationPrice(): NewFloatingPackageWithAllocationPrice = newFloatingPackageWithAllocationPrice.getOrThrow("newFloatingPackageWithAllocationPrice")
            fun asNewFloatingTieredPackageWithMinimumPrice(): NewFloatingTieredPackageWithMinimumPrice = newFloatingTieredPackageWithMinimumPrice.getOrThrow("newFloatingTieredPackageWithMinimumPrice")
            fun asNewFloatingUnitWithPercentPrice(): NewFloatingUnitWithPercentPrice = newFloatingUnitWithPercentPrice.getOrThrow("newFloatingUnitWithPercentPrice")
            fun asNewFloatingTieredWithProrationPrice(): NewFloatingTieredWithProrationPrice = newFloatingTieredWithProrationPrice.getOrThrow("newFloatingTieredWithProrationPrice")
            fun asNewFloatingUnitWithProrationPrice(): NewFloatingUnitWithProrationPrice = newFloatingUnitWithProrationPrice.getOrThrow("newFloatingUnitWithProrationPrice")
            fun asNewFloatingGroupedAllocationPrice(): NewFloatingGroupedAllocationPrice = newFloatingGroupedAllocationPrice.getOrThrow("newFloatingGroupedAllocationPrice")
            fun asNewFloatingBulkWithProrationPrice(): NewFloatingBulkWithProrationPrice = newFloatingBulkWithProrationPrice.getOrThrow("newFloatingBulkWithProrationPrice")

            fun _json(): JsonValue? = _json

            fun <T> accept(visitor: Visitor<T>): T {
              return when {
                  newFloatingUnitPrice != null -> visitor.visitNewFloatingUnitPrice(newFloatingUnitPrice)
                  newFloatingPackagePrice != null -> visitor.visitNewFloatingPackagePrice(newFloatingPackagePrice)
                  newFloatingMatrixPrice != null -> visitor.visitNewFloatingMatrixPrice(newFloatingMatrixPrice)
                  newFloatingMatrixWithAllocationPrice != null -> visitor.visitNewFloatingMatrixWithAllocationPrice(newFloatingMatrixWithAllocationPrice)
                  newFloatingTieredPrice != null -> visitor.visitNewFloatingTieredPrice(newFloatingTieredPrice)
                  newFloatingTieredBpsPrice != null -> visitor.visitNewFloatingTieredBpsPrice(newFloatingTieredBpsPrice)
                  newFloatingBpsPrice != null -> visitor.visitNewFloatingBpsPrice(newFloatingBpsPrice)
                  newFloatingBulkBpsPrice != null -> visitor.visitNewFloatingBulkBpsPrice(newFloatingBulkBpsPrice)
                  newFloatingBulkPrice != null -> visitor.visitNewFloatingBulkPrice(newFloatingBulkPrice)
                  newFloatingThresholdTotalAmountPrice != null -> visitor.visitNewFloatingThresholdTotalAmountPrice(newFloatingThresholdTotalAmountPrice)
                  newFloatingTieredPackagePrice != null -> visitor.visitNewFloatingTieredPackagePrice(newFloatingTieredPackagePrice)
                  newFloatingGroupedTieredPrice != null -> visitor.visitNewFloatingGroupedTieredPrice(newFloatingGroupedTieredPrice)
                  newFloatingTieredWithMinimumPrice != null -> visitor.visitNewFloatingTieredWithMinimumPrice(newFloatingTieredWithMinimumPrice)
                  newFloatingPackageWithAllocationPrice != null -> visitor.visitNewFloatingPackageWithAllocationPrice(newFloatingPackageWithAllocationPrice)
                  newFloatingTieredPackageWithMinimumPrice != null -> visitor.visitNewFloatingTieredPackageWithMinimumPrice(newFloatingTieredPackageWithMinimumPrice)
                  newFloatingUnitWithPercentPrice != null -> visitor.visitNewFloatingUnitWithPercentPrice(newFloatingUnitWithPercentPrice)
                  newFloatingTieredWithProrationPrice != null -> visitor.visitNewFloatingTieredWithProrationPrice(newFloatingTieredWithProrationPrice)
                  newFloatingUnitWithProrationPrice != null -> visitor.visitNewFloatingUnitWithProrationPrice(newFloatingUnitWithProrationPrice)
                  newFloatingGroupedAllocationPrice != null -> visitor.visitNewFloatingGroupedAllocationPrice(newFloatingGroupedAllocationPrice)
                  newFloatingBulkWithProrationPrice != null -> visitor.visitNewFloatingBulkWithProrationPrice(newFloatingBulkWithProrationPrice)
                  else -> visitor.unknown(_json)
              }
            }
            ...
            override fun equals(other: Any?): Boolean {
              ...
              return other is Price &&
                  ...
                  this.newFloatingMatrixWithAllocationPrice == other.newFloatingMatrixWithAllocationPrice &&
                  ...
                  this.newFloatingThresholdTotalAmountPrice == other.newFloatingThresholdTotalAmountPrice &&
                  ...
                  this.newFloatingTieredWithMinimumPrice == other.newFloatingTieredWithMinimumPrice &&
                  this.newFloatingPackageWithAllocationPrice == other.newFloatingPackageWithAllocationPrice &&
                  this.newFloatingTieredPackageWithMinimumPrice == other.newFloatingTieredPackageWithMinimumPrice &&
            ...
            override fun toString(): String {
              return when {
                  newFloatingUnitPrice != null -> "Price{newFloatingUnitPrice=$newFloatingUnitPrice}"
                  newFloatingPackagePrice != null -> "Price{newFloatingPackagePrice=$newFloatingPackagePrice}"
                  newFloatingMatrixPrice != null -> "Price{newFloatingMatrixPrice=$newFloatingMatrixPrice}"
                  newFloatingMatrixWithAllocationPrice != null -> "Price{newFloatingMatrixWithAllocationPrice=$newFloatingMatrixWithAllocationPrice}"
                  newFloatingTieredPrice != null -> "Price{newFloatingTieredPrice=$newFloatingTieredPrice}"
                  newFloatingTieredBpsPrice != null -> "Price{newFloatingTieredBpsPrice=$newFloatingTieredBpsPrice}"
                  newFloatingBpsPrice != null -> "Price{newFloatingBpsPrice=$newFloatingBpsPrice}"
                  newFloatingBulkBpsPrice != null -> "Price{newFloatingBulkBpsPrice=$newFloatingBulkBpsPrice}"
                  newFloatingBulkPrice != null -> "Price{newFloatingBulkPrice=$newFloatingBulkPrice}"
                  newFloatingThresholdTotalAmountPrice != null -> "Price{newFloatingThresholdTotalAmountPrice=$newFloatingThresholdTotalAmountPrice}"
                  newFloatingTieredPackagePrice != null -> "Price{newFloatingTieredPackagePrice=$newFloatingTieredPackagePrice}"
                  newFloatingGroupedTieredPrice != null -> "Price{newFloatingGroupedTieredPrice=$newFloatingGroupedTieredPrice}"
                  newFloatingTieredWithMinimumPrice != null -> "Price{newFloatingTieredWithMinimumPrice=$newFloatingTieredWithMinimumPrice}"
                  newFloatingPackageWithAllocationPrice != null -> "Price{newFloatingPackageWithAllocationPrice=$newFloatingPackageWithAllocationPrice}"
                  newFloatingTieredPackageWithMinimumPrice != null -> "Price{newFloatingTieredPackageWithMinimumPrice=$newFloatingTieredPackageWithMinimumPrice}"
                  newFloatingUnitWithPercentPrice != null -> "Price{newFloatingUnitWithPercentPrice=$newFloatingUnitWithPercentPrice}"
                  newFloatingTieredWithProrationPrice != null -> "Price{newFloatingTieredWithProrationPrice=$newFloatingTieredWithProrationPrice}"
                  newFloatingUnitWithProrationPrice != null -> "Price{newFloatingUnitWithProrationPrice=$newFloatingUnitWithProrationPrice}"
                  newFloatingGroupedAllocationPrice != null -> "Price{newFloatingGroupedAllocationPrice=$newFloatingGroupedAllocationPrice}"
                  newFloatingBulkWithProrationPrice != null -> "Price{newFloatingBulkWithProrationPrice=$newFloatingBulkWithProrationPrice}"
            ...
            companion object {
                ...
                fun ofNewFloatingUnitPrice(newFloatingUnitPrice: NewFloatingUnitPrice) = Price(newFloatingUnitPrice = newFloatingUnitPrice)

                fun ofNewFloatingPackagePrice(newFloatingPackagePrice: NewFloatingPackagePrice) = Price(newFloatingPackagePrice = newFloatingPackagePrice)

                fun ofNewFloatingMatrixPrice(newFloatingMatrixPrice: NewFloatingMatrixPrice) = Price(newFloatingMatrixPrice = newFloatingMatrixPrice)

                fun ofNewFloatingMatrixWithAllocationPrice(newFloatingMatrixWithAllocationPrice: NewFloatingMatrixWithAllocationPrice) = Price(newFloatingMatrixWithAllocationPrice = newFloatingMatrixWithAllocationPrice)

                fun ofNewFloatingTieredPrice(newFloatingTieredPrice: NewFloatingTieredPrice) = Price(newFloatingTieredPrice = newFloatingTieredPrice)

                fun ofNewFloatingTieredBpsPrice(newFloatingTieredBpsPrice: NewFloatingTieredBpsPrice) = Price(newFloatingTieredBpsPrice = newFloatingTieredBpsPrice)

                fun ofNewFloatingBpsPrice(newFloatingBpsPrice: NewFloatingBpsPrice) = Price(newFloatingBpsPrice = newFloatingBpsPrice)

                fun ofNewFloatingBulkBpsPrice(newFloatingBulkBpsPrice: NewFloatingBulkBpsPrice) = Price(newFloatingBulkBpsPrice = newFloatingBulkBpsPrice)

                fun ofNewFloatingBulkPrice(newFloatingBulkPrice: NewFloatingBulkPrice) = Price(newFloatingBulkPrice = newFloatingBulkPrice)

                fun ofNewFloatingThresholdTotalAmountPrice(newFloatingThresholdTotalAmountPrice: NewFloatingThresholdTotalAmountPrice) = Price(newFloatingThresholdTotalAmountPrice = newFloatingThresholdTotalAmountPrice)

                fun ofNewFloatingTieredPackagePrice(newFloatingTieredPackagePrice: NewFloatingTieredPackagePrice) = Price(newFloatingTieredPackagePrice = newFloatingTieredPackagePrice)

                fun ofNewFloatingGroupedTieredPrice(newFloatingGroupedTieredPrice: NewFloatingGroupedTieredPrice) = Price(newFloatingGroupedTieredPrice = newFloatingGroupedTieredPrice)

                fun ofNewFloatingTieredWithMinimumPrice(newFloatingTieredWithMinimumPrice: NewFloatingTieredWithMinimumPrice) = Price(newFloatingTieredWithMinimumPrice = newFloatingTieredWithMinimumPrice)

                fun ofNewFloatingPackageWithAllocationPrice(newFloatingPackageWithAllocationPrice: NewFloatingPackageWithAllocationPrice) = Price(newFloatingPackageWithAllocationPrice = newFloatingPackageWithAllocationPrice)

                fun ofNewFloatingTieredPackageWithMinimumPrice(newFloatingTieredPackageWithMinimumPrice: NewFloatingTieredPackageWithMinimumPrice) = Price(newFloatingTieredPackageWithMinimumPrice = newFloatingTieredPackageWithMinimumPrice)

                fun ofNewFloatingUnitWithPercentPrice(newFloatingUnitWithPercentPrice: NewFloatingUnitWithPercentPrice) = Price(newFloatingUnitWithPercentPrice = newFloatingUnitWithPercentPrice)

                fun ofNewFloatingTieredWithProrationPrice(newFloatingTieredWithProrationPrice: NewFloatingTieredWithProrationPrice) = Price(newFloatingTieredWithProrationPrice = newFloatingTieredWithProrationPrice)

                fun ofNewFloatingUnitWithProrationPrice(newFloatingUnitWithProrationPrice: NewFloatingUnitWithProrationPrice) = Price(newFloatingUnitWithProrationPrice = newFloatingUnitWithProrationPrice)

                fun ofNewFloatingGroupedAllocationPrice(newFloatingGroupedAllocationPrice: NewFloatingGroupedAllocationPrice) = Price(newFloatingGroupedAllocationPrice = newFloatingGroupedAllocationPrice)

                fun ofNewFloatingBulkWithProrationPrice(newFloatingBulkWithProrationPrice: NewFloatingBulkWithProrationPrice) = Price(newFloatingBulkWithProrationPrice = newFloatingBulkWithProrationPrice)
            }
            ...
            interface Visitor<out T> {
                ...
                fun visitNewFloatingMatrixWithAllocationPrice(newFloatingMatrixWithAllocationPrice: NewFloatingMatrixWithAllocationPrice): T

                fun visitNewFloatingTieredPrice(newFloatingTieredPrice: NewFloatingTieredPrice): T

                fun visitNewFloatingTieredBpsPrice(newFloatingTieredBpsPrice: NewFloatingTieredBpsPrice): T
                ...
                fun visitNewFloatingThresholdTotalAmountPrice(newFloatingThresholdTotalAmountPrice: NewFloatingThresholdTotalAmountPrice): T

                fun visitNewFloatingTieredPackagePrice(newFloatingTieredPackagePrice: NewFloatingTieredPackagePrice): T

                fun visitNewFloatingGroupedTieredPrice(newFloatingGroupedTieredPrice: NewFloatingGroupedTieredPrice): T

                fun visitNewFloatingTieredWithMinimumPrice(newFloatingTieredWithMinimumPrice: NewFloatingTieredWithMinimumPrice): T

                fun visitNewFloatingPackageWithAllocationPrice(newFloatingPackageWithAllocationPrice: NewFloatingPackageWithAllocationPrice): T

                fun visitNewFloatingTieredPackageWithMinimumPrice(newFloatingTieredPackageWithMinimumPrice: NewFloatingTieredPackageWithMinimumPrice): T

                fun visitNewFloatingUnitWithPercentPrice(newFloatingUnitWithPercentPrice: NewFloatingUnitWithPercentPrice): T

                fun visitNewFloatingTieredWithProrationPrice(newFloatingTieredWithProrationPrice: NewFloatingTieredWithProrationPrice): T

                fun visitNewFloatingUnitWithProrationPrice(newFloatingUnitWithProrationPrice: NewFloatingUnitWithProrationPrice): T

                fun visitNewFloatingGroupedAllocationPrice(newFloatingGroupedAllocationPrice: NewFloatingGroupedAllocationPrice): T

                fun visitNewFloatingBulkWithProrationPrice(newFloatingBulkWithProrationPrice: NewFloatingBulkWithProrationPrice): T
            ...
            class Deserializer : BaseDeserializer<Price>(Price::class) {
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): Price {
                  val json = JsonValue.fromJsonNode(node)
                  tryDeserialize(node, jacksonTypeRef<NewFloatingUnitPrice>()){ it.validate() }?.let {
                      return Price(newFloatingUnitPrice = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewFloatingPackagePrice>()){ it.validate() }?.let {
                      return Price(newFloatingPackagePrice = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewFloatingMatrixPrice>()){ it.validate() }?.let {
                      return Price(newFloatingMatrixPrice = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewFloatingMatrixWithAllocationPrice>()){ it.validate() }?.let {
                      return Price(newFloatingMatrixWithAllocationPrice = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewFloatingTieredPrice>()){ it.validate() }?.let {
                      return Price(newFloatingTieredPrice = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewFloatingTieredBpsPrice>()){ it.validate() }?.let {
                      return Price(newFloatingTieredBpsPrice = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewFloatingBpsPrice>()){ it.validate() }?.let {
                      return Price(newFloatingBpsPrice = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewFloatingBulkBpsPrice>()){ it.validate() }?.let {
                      return Price(newFloatingBulkBpsPrice = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewFloatingBulkPrice>()){ it.validate() }?.let {
                      return Price(newFloatingBulkPrice = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewFloatingThresholdTotalAmountPrice>()){ it.validate() }?.let {
                      return Price(newFloatingThresholdTotalAmountPrice = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewFloatingTieredPackagePrice>()){ it.validate() }?.let {
                      return Price(newFloatingTieredPackagePrice = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewFloatingGroupedTieredPrice>()){ it.validate() }?.let {
                      return Price(newFloatingGroupedTieredPrice = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewFloatingTieredWithMinimumPrice>()){ it.validate() }?.let {
                      return Price(newFloatingTieredWithMinimumPrice = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewFloatingPackageWithAllocationPrice>()){ it.validate() }?.let {
                      return Price(newFloatingPackageWithAllocationPrice = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewFloatingTieredPackageWithMinimumPrice>()){ it.validate() }?.let {
                      return Price(newFloatingTieredPackageWithMinimumPrice = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewFloatingUnitWithPercentPrice>()){ it.validate() }?.let {
                      return Price(newFloatingUnitWithPercentPrice = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewFloatingTieredWithProrationPrice>()){ it.validate() }?.let {
                      return Price(newFloatingTieredWithProrationPrice = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewFloatingUnitWithProrationPrice>()){ it.validate() }?.let {
                      return Price(newFloatingUnitWithProrationPrice = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewFloatingGroupedAllocationPrice>()){ it.validate() }?.let {
                      return Price(newFloatingGroupedAllocationPrice = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewFloatingBulkWithProrationPrice>()){ it.validate() }?.let {
            ...
            class Serializer : BaseSerializer<Price>(Price::class) {
                ...
                override fun serialize(value: Price, generator: JsonGenerator, provider: SerializerProvider) {
                  when {
                      value.newFloatingUnitPrice != null -> generator.writeObject(value.newFloatingUnitPrice)
                      value.newFloatingPackagePrice != null -> generator.writeObject(value.newFloatingPackagePrice)
                      value.newFloatingMatrixPrice != null -> generator.writeObject(value.newFloatingMatrixPrice)
                      value.newFloatingMatrixWithAllocationPrice != null -> generator.writeObject(value.newFloatingMatrixWithAllocationPrice)
                      value.newFloatingTieredPrice != null -> generator.writeObject(value.newFloatingTieredPrice)
                      value.newFloatingTieredBpsPrice != null -> generator.writeObject(value.newFloatingTieredBpsPrice)
                      value.newFloatingBpsPrice != null -> generator.writeObject(value.newFloatingBpsPrice)
                      value.newFloatingBulkBpsPrice != null -> generator.writeObject(value.newFloatingBulkBpsPrice)
                      value.newFloatingBulkPrice != null -> generator.writeObject(value.newFloatingBulkPrice)
                      value.newFloatingThresholdTotalAmountPrice != null -> generator.writeObject(value.newFloatingThresholdTotalAmountPrice)
                      value.newFloatingTieredPackagePrice != null -> generator.writeObject(value.newFloatingTieredPackagePrice)
                      value.newFloatingGroupedTieredPrice != null -> generator.writeObject(value.newFloatingGroupedTieredPrice)
                      value.newFloatingTieredWithMinimumPrice != null -> generator.writeObject(value.newFloatingTieredWithMinimumPrice)
                      value.newFloatingPackageWithAllocationPrice != null -> generator.writeObject(value.newFloatingPackageWithAllocationPrice)
                      value.newFloatingTieredPackageWithMinimumPrice != null -> generator.writeObject(value.newFloatingTieredPackageWithMinimumPrice)
                      value.newFloatingUnitWithPercentPrice != null -> generator.writeObject(value.newFloatingUnitWithPercentPrice)
                      value.newFloatingTieredWithProrationPrice != null -> generator.writeObject(value.newFloatingTieredWithProrationPrice)
                      value.newFloatingUnitWithProrationPrice != null -> generator.writeObject(value.newFloatingUnitWithProrationPrice)
                      value.newFloatingGroupedAllocationPrice != null -> generator.writeObject(value.newFloatingGroupedAllocationPrice)
                      value.newFloatingBulkWithProrationPrice != null -> generator.writeObject(value.newFloatingBulkWithProrationPrice)
                      value._json != null -> generator.writeObject(value._json)
                      else -> throw IllegalStateException("Invalid Price")
                  }
                }
            ...
            @NoAutoDetect
            class NewFloatingUnitPrice private constructor(
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                override fun toString() = "NewFloatingUnitPrice{metadata=$metadata, externalPriceId=$externalPriceId, name=$name, billableMetricId=$billableMetricId, itemId=$itemId, billedInAdvance=$billedInAdvance, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, cadence=$cadence, conversionRate=$conversionRate, modelType=$modelType, unitConfig=$unitConfig, currency=$currency, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    /** An alias for the price. */
                    fun externalPriceId(externalPriceId: String) = externalPriceId(JsonField.of(externalPriceId))
                     ...
                     * usage-based.
                     */
                    fun billableMetricId(billableMetricId: String) = billableMetricId(JsonField.of(billableMetricId))
                    ...
                    @JsonProperty("item_id")
                    @ExcludeMissing
                    fun itemId(itemId: JsonField<String>) = apply {
                        this.itemId = itemId
                    }
                     ...
                     * this is true, and in-arrears if this is false.
                     */
                    fun billedInAdvance(billedInAdvance: Boolean) = billedInAdvance(JsonField.of(billedInAdvance))
                     ...
                     * applied.
                     */
                    fun fixedPriceQuantity(fixedPriceQuantity: Double) = fixedPriceQuantity(JsonField.of(fixedPriceQuantity))
                    ...
                    /** The property used to group this price on an invoice */
                    fun invoiceGroupingKey(invoiceGroupingKey: String) = invoiceGroupingKey(JsonField.of(invoiceGroupingKey))
                    ...
                    @JsonProperty("cadence")
                    @ExcludeMissing
                    fun cadence(cadence: JsonField<Cadence>) = apply {
                        this.cadence = cadence
                    }
                    ...
                    fun build(): NewFloatingUnitPrice = NewFloatingUnitPrice(
                        metadata,
                        externalPriceId,
                        name,
                        billableMetricId,
                ...
                @NoAutoDetect
                class UnitConfig private constructor(private val unitAmount: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
                    ...
                    class Builder {
                        ...
                        fun build(): UnitConfig = UnitConfig(unitAmount, additionalProperties.toUnmodifiable())
                    }
                }
            ...
            @NoAutoDetect
            class NewFloatingPackagePrice private constructor(
              private val metadata: JsonField<Metadata>,
              private val externalPriceId: JsonField<String>,
              private val name: JsonField<String>,
              private val billableMetricId: JsonField<String>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                @ExcludeMissing
                fun _packageConfig() = packageConfig
                ...
                class Builder {
                    ...
                    fun build(): NewFloatingPackagePrice = NewFloatingPackagePrice(
                        metadata,
                        externalPriceId,
                        name,
                        billableMetricId,
                ...
                @NoAutoDetect
                class PackageConfig private constructor(private val packageAmount: JsonField<String>, private val packageSize: JsonField<Long>, private val additionalProperties: Map<String, JsonValue>, ) {
                    ...
                    class Builder {
                        ...
                        fun build(): PackageConfig = PackageConfig(
                            packageAmount,
                            packageSize,
                            additionalProperties.toUnmodifiable(),
                        )
            ...
            @NoAutoDetect
            class NewFloatingMatrixPrice private constructor(
              private val metadata: JsonField<Metadata>,
              private val externalPriceId: JsonField<String>,
              private val name: JsonField<String>,
              private val billableMetricId: JsonField<String>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                override fun toString() = "NewFloatingMatrixPrice{metadata=$metadata, externalPriceId=$externalPriceId, name=$name, billableMetricId=$billableMetricId, itemId=$itemId, billedInAdvance=$billedInAdvance, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, cadence=$cadence, conversionRate=$conversionRate, modelType=$modelType, matrixConfig=$matrixConfig, currency=$currency, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    fun build(): NewFloatingMatrixPrice = NewFloatingMatrixPrice(
                        metadata,
                        externalPriceId,
                        name,
                        billableMetricId,
                ...
                @NoAutoDetect
                class MatrixConfig private constructor(
                  ...
                  private val additionalProperties: Map<String, JsonValue>,
                    ...
                    override fun toString() = "MatrixConfig{dimensions=$dimensions, defaultUnitAmount=$defaultUnitAmount, matrixValues=$matrixValues, additionalProperties=$additionalProperties}"
                    ...
                    class Builder {
                        ...
                        fun build(): MatrixConfig = MatrixConfig(
                    ...
                    @NoAutoDetect
                    class MatrixValue private constructor(private val unitAmount: JsonField<String>, private val dimensionValues: JsonField<List<String?>>, private val additionalProperties: Map<String, JsonValue>, ) {
                        ...
                        override fun toString() = "MatrixValue{unitAmount=$unitAmount, dimensionValues=$dimensionValues, additionalProperties=$additionalProperties}"
                        ...
                        class Builder {
                            ...
                            fun build(): MatrixValue = MatrixValue(
                                unitAmount,
            ...
            @NoAutoDetect
            class NewFloatingMatrixWithAllocationPrice private constructor(
              private val metadata: JsonField<Metadata>,
              private val externalPriceId: JsonField<String>,
              private val name: JsonField<String>,
              private val billableMetricId: JsonField<String>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                fun matrixWithAllocationConfig(): MatrixWithAllocationConfig = matrixWithAllocationConfig.getRequired("matrix_with_allocation_config")
                ...
                override fun toString() = "NewFloatingMatrixWithAllocationPrice{metadata=$metadata, externalPriceId=$externalPriceId, name=$name, billableMetricId=$billableMetricId, itemId=$itemId, billedInAdvance=$billedInAdvance, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, cadence=$cadence, conversionRate=$conversionRate, modelType=$modelType, matrixWithAllocationConfig=$matrixWithAllocationConfig, currency=$currency, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    private var conversionRate: JsonField<Double> = JsonMissing.of()
                    private var modelType: JsonField<ModelType> = JsonMissing.of()
                    private var matrixWithAllocationConfig: JsonField<MatrixWithAllocationConfig> = JsonMissing.of()
                    private var currency: JsonField<String> = JsonMissing.of()
                    private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

                    internal fun from(newFloatingMatrixWithAllocationPrice: NewFloatingMatrixWithAllocationPrice) = apply {
                        ...
                        this.matrixWithAllocationConfig = newFloatingMatrixWithAllocationPrice.matrixWithAllocationConfig
                    ...
                    fun matrixWithAllocationConfig(matrixWithAllocationConfig: MatrixWithAllocationConfig) = matrixWithAllocationConfig(JsonField.of(matrixWithAllocationConfig))

                    @JsonProperty("matrix_with_allocation_config")
                    @ExcludeMissing
                    fun matrixWithAllocationConfig(matrixWithAllocationConfig: JsonField<MatrixWithAllocationConfig>) = apply {
                    ...
                    fun build(): NewFloatingMatrixWithAllocationPrice = NewFloatingMatrixWithAllocationPrice(
                        metadata,
                        externalPriceId,
                        name,
                        billableMetricId,
                ...
                @NoAutoDetect
                class MatrixWithAllocationConfig private constructor(
                  private val dimensions: JsonField<List<String?>>,
                  private val defaultUnitAmount: JsonField<String>,
                  private val matrixValues: JsonField<List<MatrixValue>>,
                  ...
                  private val additionalProperties: Map<String, JsonValue>,
                    ...
                    override fun toString() = "MatrixWithAllocationConfig{dimensions=$dimensions, defaultUnitAmount=$defaultUnitAmount, matrixValues=$matrixValues, allocation=$allocation, additionalProperties=$additionalProperties}"
                    ...
                    class Builder {
                        ...
                        fun build(): MatrixWithAllocationConfig = MatrixWithAllocationConfig(
                            dimensions.map { it.toUnmodifiable() },
                            defaultUnitAmount,
                            matrixValues.map { it.toUnmodifiable() },
                            allocation,
            ...
            @NoAutoDetect
            class NewFloatingTieredPrice private constructor(
              private val metadata: JsonField<Metadata>,
              private val externalPriceId: JsonField<String>,
              private val name: JsonField<String>,
              private val billableMetricId: JsonField<String>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                @ExcludeMissing
                fun _tieredConfig() = tieredConfig
                ...
                override fun toString() = "NewFloatingTieredPrice{metadata=$metadata, externalPriceId=$externalPriceId, name=$name, billableMetricId=$billableMetricId, itemId=$itemId, billedInAdvance=$billedInAdvance, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, cadence=$cadence, conversionRate=$conversionRate, modelType=$modelType, tieredConfig=$tieredConfig, currency=$currency, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    fun build(): NewFloatingTieredPrice = NewFloatingTieredPrice(
                        metadata,
                        externalPriceId,
                        name,
                        billableMetricId,
                ...
                @NoAutoDetect
                class TieredConfig private constructor(private val tiers: JsonField<List<Tier>>, private val additionalProperties: Map<String, JsonValue>, ) {
                    ...
                    class Builder {
                        ...
                        fun build(): TieredConfig = TieredConfig(tiers.map { it.toUnmodifiable() }, additionalProperties.toUnmodifiable())
                    }

                    @JsonDeserialize(builder = Tier.Builder::class)
                    @NoAutoDetect
                    class Tier private constructor(
                      ...
                      private val additionalProperties: Map<String, JsonValue>,
                        ...
                        override fun toString() = "Tier{firstUnit=$firstUnit, lastUnit=$lastUnit, unitAmount=$unitAmount, additionalProperties=$additionalProperties}"
            ...
            @NoAutoDetect
            class NewFloatingTieredBpsPrice private constructor(
              private val metadata: JsonField<Metadata>,
              private val externalPriceId: JsonField<String>,
              private val name: JsonField<String>,
              private val billableMetricId: JsonField<String>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                class Builder {
                    ...
                    fun build(): NewFloatingTieredBpsPrice = NewFloatingTieredBpsPrice(
                        metadata,
                        externalPriceId,
                        name,
                        billableMetricId,
                ...
                @NoAutoDetect
                class TieredBpsConfig private constructor(private val tiers: JsonField<List<Tier>>, private val additionalProperties: Map<String, JsonValue>, ) {
                    ...
                    class Builder {
                        ...
                        fun build(): TieredBpsConfig = TieredBpsConfig(tiers.map { it.toUnmodifiable() }, additionalProperties.toUnmodifiable())
                    }
                    ...
                    class Tier private constructor(
                      ...
                      private val additionalProperties: Map<String, JsonValue>,
                        ...
                        override fun toString() = "Tier{minimumAmount=$minimumAmount, maximumAmount=$maximumAmount, bps=$bps, perUnitMaximum=$perUnitMaximum, additionalProperties=$additionalProperties}"
                        ...
                        class Builder {
                            ...
                            @JsonProperty("bps")
                            @ExcludeMissing
                            fun bps(bps: JsonField<Double>) = apply {
                                this.bps = bps
                            }

                            /** Per unit maximum to charge */
                            fun perUnitMaximum(perUnitMaximum: String) = perUnitMaximum(JsonField.of(perUnitMaximum))
            ...
            @NoAutoDetect
            class NewFloatingBpsPrice private constructor(
              private val metadata: JsonField<Metadata>,
              private val externalPriceId: JsonField<String>,
              private val name: JsonField<String>,
              private val billableMetricId: JsonField<String>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                override fun toString() = "NewFloatingBpsPrice{metadata=$metadata, externalPriceId=$externalPriceId, name=$name, billableMetricId=$billableMetricId, itemId=$itemId, billedInAdvance=$billedInAdvance, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, cadence=$cadence, conversionRate=$conversionRate, modelType=$modelType, bpsConfig=$bpsConfig, currency=$currency, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    fun build(): NewFloatingBpsPrice = NewFloatingBpsPrice(
                        metadata,
                        externalPriceId,
                        name,
                        billableMetricId,
                ...
                @NoAutoDetect
                class BpsConfig private constructor(private val bps: JsonField<Double>, private val perUnitMaximum: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
            ...
            @NoAutoDetect
            class NewFloatingBulkBpsPrice private constructor(
              private val metadata: JsonField<Metadata>,
              private val externalPriceId: JsonField<String>,
              private val name: JsonField<String>,
              private val billableMetricId: JsonField<String>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                override fun toString() = "NewFloatingBulkBpsPrice{metadata=$metadata, externalPriceId=$externalPriceId, name=$name, billableMetricId=$billableMetricId, itemId=$itemId, billedInAdvance=$billedInAdvance, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, cadence=$cadence, conversionRate=$conversionRate, modelType=$modelType, bulkBpsConfig=$bulkBpsConfig, currency=$currency, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    fun build(): NewFloatingBulkBpsPrice = NewFloatingBulkBpsPrice(
                        metadata,
                        externalPriceId,
                        name,
                        billableMetricId,
                ...
                @NoAutoDetect
                class BulkBpsConfig private constructor(private val tiers: JsonField<List<Tier>>, private val additionalProperties: Map<String, JsonValue>, ) {
                    ...
                    class Builder {
                        ...
                        fun build(): BulkBpsConfig = BulkBpsConfig(tiers.map { it.toUnmodifiable() }, additionalProperties.toUnmodifiable())
                    }
                    ...
                    class Tier private constructor(
                      ...
                      private val additionalProperties: Map<String, JsonValue>,
                        ...
                        override fun toString() = "Tier{maximumAmount=$maximumAmount, bps=$bps, perUnitMaximum=$perUnitMaximum, additionalProperties=$additionalProperties}"
            ...
            @NoAutoDetect
            class NewFloatingBulkPrice private constructor(
              private val metadata: JsonField<Metadata>,
              private val externalPriceId: JsonField<String>,
              private val name: JsonField<String>,
              private val billableMetricId: JsonField<String>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                override fun toString() = "NewFloatingBulkPrice{metadata=$metadata, externalPriceId=$externalPriceId, name=$name, billableMetricId=$billableMetricId, itemId=$itemId, billedInAdvance=$billedInAdvance, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, cadence=$cadence, conversionRate=$conversionRate, modelType=$modelType, bulkConfig=$bulkConfig, currency=$currency, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    fun build(): NewFloatingBulkPrice = NewFloatingBulkPrice(
                        metadata,
                        externalPriceId,
                        name,
                        billableMetricId,
                ...
                @NoAutoDetect
                class BulkConfig private constructor(private val tiers: JsonField<List<Tier>>, private val additionalProperties: Map<String, JsonValue>, ) {
                    ...
                    class Builder {
                        ...
                        fun build(): BulkConfig = BulkConfig(tiers.map { it.toUnmodifiable() }, additionalProperties.toUnmodifiable())
                    }

                    @JsonDeserialize(builder = Tier.Builder::class)
                    @NoAutoDetect
                    class Tier private constructor(private val maximumUnits: JsonField<Double>, private val unitAmount: JsonField<String>, private val additionalProperties: Map<String, JsonValue>, ) {
                        ...
                        override fun toString() = "Tier{maximumUnits=$maximumUnits, unitAmount=$unitAmount, additionalProperties=$additionalProperties}"
                        ...
                        class Builder {
                            ...
                            /** Upper bound for this tier */
                            fun maximumUnits(maximumUnits: Double) = maximumUnits(JsonField.of(maximumUnits))
            ...
            @NoAutoDetect
            class NewFloatingThresholdTotalAmountPrice private constructor(
              private val metadata: JsonField<Metadata>,
              private val externalPriceId: JsonField<String>,
              private val name: JsonField<String>,
              private val billableMetricId: JsonField<String>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                class Builder {
                    ...
                    private var conversionRate: JsonField<Double> = JsonMissing.of()
                    private var modelType: JsonField<ModelType> = JsonMissing.of()
                    private var thresholdTotalAmountConfig: JsonField<ThresholdTotalAmountConfig> = JsonMissing.of()
                    private var currency: JsonField<String> = JsonMissing.of()
                    private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

                    internal fun from(newFloatingThresholdTotalAmountPrice: NewFloatingThresholdTotalAmountPrice) = apply {
                        ...
                        this.thresholdTotalAmountConfig = newFloatingThresholdTotalAmountPrice.thresholdTotalAmountConfig
                    ...
                    @JsonProperty("threshold_total_amount_config")
                    @ExcludeMissing
                    fun thresholdTotalAmountConfig(thresholdTotalAmountConfig: JsonField<ThresholdTotalAmountConfig>) = apply {
                    ...
                    fun build(): NewFloatingThresholdTotalAmountPrice = NewFloatingThresholdTotalAmountPrice(
                        metadata,
                        externalPriceId,
                        name,
                        billableMetricId,
                ...
                @NoAutoDetect
                class ThresholdTotalAmountConfig private constructor(private val additionalProperties: Map<String, JsonValue>, ) {
                    ...
                    class Builder {
                        ...
                        fun build(): ThresholdTotalAmountConfig = ThresholdTotalAmountConfig(additionalProperties.toUnmodifiable())
                    }
                }
            ...
            @NoAutoDetect
            class NewFloatingTieredPackagePrice private constructor(
              private val metadata: JsonField<Metadata>,
              private val externalPriceId: JsonField<String>,
              private val name: JsonField<String>,
              private val billableMetricId: JsonField<String>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                override fun toString() = "NewFloatingTieredPackagePrice{metadata=$metadata, externalPriceId=$externalPriceId, name=$name, billableMetricId=$billableMetricId, itemId=$itemId, billedInAdvance=$billedInAdvance, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, cadence=$cadence, conversionRate=$conversionRate, modelType=$modelType, tieredPackageConfig=$tieredPackageConfig, currency=$currency, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    internal fun from(newFloatingTieredPackagePrice: NewFloatingTieredPackagePrice) = apply {
                    ...
                    fun build(): NewFloatingTieredPackagePrice = NewFloatingTieredPackagePrice(
                        metadata,
                        externalPriceId,
                        name,
                        billableMetricId,
                ...
                @NoAutoDetect
                class TieredPackageConfig private constructor(private val additionalProperties: Map<String, JsonValue>, ) {
            ...
            @NoAutoDetect
            class NewFloatingGroupedTieredPrice private constructor(
              private val metadata: JsonField<Metadata>,
              private val externalPriceId: JsonField<String>,
              private val name: JsonField<String>,
              private val billableMetricId: JsonField<String>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                fun groupedTieredConfig(): GroupedTieredConfig = groupedTieredConfig.getRequired("grouped_tiered_config")
                ...
                override fun toString() = "NewFloatingGroupedTieredPrice{metadata=$metadata, externalPriceId=$externalPriceId, name=$name, billableMetricId=$billableMetricId, itemId=$itemId, billedInAdvance=$billedInAdvance, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, cadence=$cadence, conversionRate=$conversionRate, modelType=$modelType, groupedTieredConfig=$groupedTieredConfig, currency=$currency, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    internal fun from(newFloatingGroupedTieredPrice: NewFloatingGroupedTieredPrice) = apply {
                    ...
                    fun groupedTieredConfig(groupedTieredConfig: GroupedTieredConfig) = groupedTieredConfig(JsonField.of(groupedTieredConfig))
                    ...
                    fun build(): NewFloatingGroupedTieredPrice = NewFloatingGroupedTieredPrice(
                        metadata,
                        externalPriceId,
                        name,
                        billableMetricId,
                ...
                @NoAutoDetect
                class GroupedTieredConfig private constructor(private val additionalProperties: Map<String, JsonValue>, ) {
                    ...
                    class Builder {
                        ...
                        fun build(): GroupedTieredConfig = GroupedTieredConfig(additionalProperties.toUnmodifiable())
                    }
                }
            ...
            @NoAutoDetect
            class NewFloatingTieredWithMinimumPrice private constructor(
              private val metadata: JsonField<Metadata>,
              private val externalPriceId: JsonField<String>,
              private val name: JsonField<String>,
              private val billableMetricId: JsonField<String>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                override fun toString() = "NewFloatingTieredWithMinimumPrice{metadata=$metadata, externalPriceId=$externalPriceId, name=$name, billableMetricId=$billableMetricId, itemId=$itemId, billedInAdvance=$billedInAdvance, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, cadence=$cadence, conversionRate=$conversionRate, modelType=$modelType, tieredWithMinimumConfig=$tieredWithMinimumConfig, currency=$currency, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    private var conversionRate: JsonField<Double> = JsonMissing.of()
                    private var modelType: JsonField<ModelType> = JsonMissing.of()
                    private var tieredWithMinimumConfig: JsonField<TieredWithMinimumConfig> = JsonMissing.of()
                    private var currency: JsonField<String> = JsonMissing.of()
                    private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

                    internal fun from(newFloatingTieredWithMinimumPrice: NewFloatingTieredWithMinimumPrice) = apply {
                        ...
                        this.tieredWithMinimumConfig = newFloatingTieredWithMinimumPrice.tieredWithMinimumConfig
                    ...
                    @JsonProperty("tiered_with_minimum_config")
                    @ExcludeMissing
                    fun tieredWithMinimumConfig(tieredWithMinimumConfig: JsonField<TieredWithMinimumConfig>) = apply {
                ...
                @NoAutoDetect
                class TieredWithMinimumConfig private constructor(private val additionalProperties: Map<String, JsonValue>, ) {
                    ...
                    class Builder {
                        ...
                        fun build(): TieredWithMinimumConfig = TieredWithMinimumConfig(additionalProperties.toUnmodifiable())
                    }
                }
            ...
            @NoAutoDetect
            class NewFloatingPackageWithAllocationPrice private constructor(
              private val metadata: JsonField<Metadata>,
              private val externalPriceId: JsonField<String>,
              private val name: JsonField<String>,
              private val billableMetricId: JsonField<String>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                class Builder {
                    ...
                    private var conversionRate: JsonField<Double> = JsonMissing.of()
                    private var modelType: JsonField<ModelType> = JsonMissing.of()
                    private var packageWithAllocationConfig: JsonField<PackageWithAllocationConfig> = JsonMissing.of()
                    private var currency: JsonField<String> = JsonMissing.of()
                    private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

                    internal fun from(newFloatingPackageWithAllocationPrice: NewFloatingPackageWithAllocationPrice) = apply {
                        ...
                        this.packageWithAllocationConfig = newFloatingPackageWithAllocationPrice.packageWithAllocationConfig
                    ...
                    @JsonProperty("package_with_allocation_config")
                    @ExcludeMissing
                    fun packageWithAllocationConfig(packageWithAllocationConfig: JsonField<PackageWithAllocationConfig>) = apply {
                    ...
                    fun build(): NewFloatingPackageWithAllocationPrice = NewFloatingPackageWithAllocationPrice(
                        metadata,
                        externalPriceId,
                        name,
                        billableMetricId,
                ...
                @NoAutoDetect
                class PackageWithAllocationConfig private constructor(private val additionalProperties: Map<String, JsonValue>, ) {
            ...
            @NoAutoDetect
            class NewFloatingTieredPackageWithMinimumPrice private constructor(
              private val metadata: JsonField<Metadata>,
              private val externalPriceId: JsonField<String>,
              private val name: JsonField<String>,
              private val billableMetricId: JsonField<String>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                fun tieredPackageWithMinimumConfig(): TieredPackageWithMinimumConfig = tieredPackageWithMinimumConfig.getRequired("tiered_package_with_minimum_config")
                ...
                override fun toString() = "NewFloatingTieredPackageWithMinimumPrice{metadata=$metadata, externalPriceId=$externalPriceId, name=$name, billableMetricId=$billableMetricId, itemId=$itemId, billedInAdvance=$billedInAdvance, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, cadence=$cadence, conversionRate=$conversionRate, modelType=$modelType, tieredPackageWithMinimumConfig=$tieredPackageWithMinimumConfig, currency=$currency, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    private var conversionRate: JsonField<Double> = JsonMissing.of()
                    private var modelType: JsonField<ModelType> = JsonMissing.of()
                    private var tieredPackageWithMinimumConfig: JsonField<TieredPackageWithMinimumConfig> = JsonMissing.of()
                    private var currency: JsonField<String> = JsonMissing.of()
                    private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

                    internal fun from(newFloatingTieredPackageWithMinimumPrice: NewFloatingTieredPackageWithMinimumPrice) = apply {
                        ...
                        this.fixedPriceQuantity = newFloatingTieredPackageWithMinimumPrice.fixedPriceQuantity
                        this.invoiceGroupingKey = newFloatingTieredPackageWithMinimumPrice.invoiceGroupingKey
                        ...
                        this.tieredPackageWithMinimumConfig = newFloatingTieredPackageWithMinimumPrice.tieredPackageWithMinimumConfig
                    ...
                    fun tieredPackageWithMinimumConfig(tieredPackageWithMinimumConfig: TieredPackageWithMinimumConfig) = tieredPackageWithMinimumConfig(JsonField.of(tieredPackageWithMinimumConfig))

                    @JsonProperty("tiered_package_with_minimum_config")
                    @ExcludeMissing
                    fun tieredPackageWithMinimumConfig(tieredPackageWithMinimumConfig: JsonField<TieredPackageWithMinimumConfig>) = apply {
                    ...
                    fun build(): NewFloatingTieredPackageWithMinimumPrice = NewFloatingTieredPackageWithMinimumPrice(
                        metadata,
                        externalPriceId,
                        name,
                        billableMetricId,
                ...
                class ModelType @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                    ...
                    companion object {
                        ...
                        val TIERED_PACKAGE_WITH_MINIMUM = ModelType(JsonField.of("tiered_package_with_minimum"))
                ...
                @NoAutoDetect
                class TieredPackageWithMinimumConfig private constructor(private val additionalProperties: Map<String, JsonValue>, ) {
                    ...
                    override fun toString() = "TieredPackageWithMinimumConfig{additionalProperties=$additionalProperties}"
                    ...
                    class Builder {
                        ...
                        internal fun from(tieredPackageWithMinimumConfig: TieredPackageWithMinimumConfig) = apply {
            ...
            @NoAutoDetect
            class NewFloatingUnitWithPercentPrice private constructor(
              private val metadata: JsonField<Metadata>,
              private val externalPriceId: JsonField<String>,
              private val name: JsonField<String>,
              private val billableMetricId: JsonField<String>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                class Builder {
                    ...
                    internal fun from(newFloatingUnitWithPercentPrice: NewFloatingUnitWithPercentPrice) = apply {
                        ...
                        this.unitWithPercentConfig = newFloatingUnitWithPercentPrice.unitWithPercentConfig
                    ...
                    @JsonProperty("unit_with_percent_config")
                    @ExcludeMissing
                    fun unitWithPercentConfig(unitWithPercentConfig: JsonField<UnitWithPercentConfig>) = apply {
                    ...
                    fun build(): NewFloatingUnitWithPercentPrice = NewFloatingUnitWithPercentPrice(
                        metadata,
                        externalPriceId,
                        name,
                        billableMetricId,
                ...
                @NoAutoDetect
                class UnitWithPercentConfig private constructor(private val additionalProperties: Map<String, JsonValue>, ) {
            ...
            @NoAutoDetect
            class NewFloatingTieredWithProrationPrice private constructor(
              private val metadata: JsonField<Metadata>,
              private val externalPriceId: JsonField<String>,
              private val name: JsonField<String>,
              private val billableMetricId: JsonField<String>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                class Builder {
                    ...
                    private var conversionRate: JsonField<Double> = JsonMissing.of()
                    private var modelType: JsonField<ModelType> = JsonMissing.of()
                    private var tieredWithProrationConfig: JsonField<TieredWithProrationConfig> = JsonMissing.of()
                    private var currency: JsonField<String> = JsonMissing.of()
                    private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

                    internal fun from(newFloatingTieredWithProrationPrice: NewFloatingTieredWithProrationPrice) = apply {
                        ...
                        this.tieredWithProrationConfig = newFloatingTieredWithProrationPrice.tieredWithProrationConfig
                    ...
                    @JsonProperty("tiered_with_proration_config")
                    @ExcludeMissing
                    fun tieredWithProrationConfig(tieredWithProrationConfig: JsonField<TieredWithProrationConfig>) = apply {
                    ...
                    fun build(): NewFloatingTieredWithProrationPrice = NewFloatingTieredWithProrationPrice(
                        metadata,
                        externalPriceId,
                        name,
                        billableMetricId,
                ...
                @NoAutoDetect
                class TieredWithProrationConfig private constructor(private val additionalProperties: Map<String, JsonValue>, ) {
                    ...
                    class Builder {
                        ...
                        fun build(): TieredWithProrationConfig = TieredWithProrationConfig(additionalProperties.toUnmodifiable())
                    }
                }
            ...
            @NoAutoDetect
            class NewFloatingUnitWithProrationPrice private constructor(
              private val metadata: JsonField<Metadata>,
              private val externalPriceId: JsonField<String>,
              private val name: JsonField<String>,
              private val billableMetricId: JsonField<String>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                override fun toString() = "NewFloatingUnitWithProrationPrice{metadata=$metadata, externalPriceId=$externalPriceId, name=$name, billableMetricId=$billableMetricId, itemId=$itemId, billedInAdvance=$billedInAdvance, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, cadence=$cadence, conversionRate=$conversionRate, modelType=$modelType, unitWithProrationConfig=$unitWithProrationConfig, currency=$currency, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    private var conversionRate: JsonField<Double> = JsonMissing.of()
                    private var modelType: JsonField<ModelType> = JsonMissing.of()
                    private var unitWithProrationConfig: JsonField<UnitWithProrationConfig> = JsonMissing.of()
                    private var currency: JsonField<String> = JsonMissing.of()
                    private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

                    internal fun from(newFloatingUnitWithProrationPrice: NewFloatingUnitWithProrationPrice) = apply {
                        ...
                        this.unitWithProrationConfig = newFloatingUnitWithProrationPrice.unitWithProrationConfig
                    ...
                    @JsonProperty("unit_with_proration_config")
                    @ExcludeMissing
                    fun unitWithProrationConfig(unitWithProrationConfig: JsonField<UnitWithProrationConfig>) = apply {
                ...
                @NoAutoDetect
                class UnitWithProrationConfig private constructor(private val additionalProperties: Map<String, JsonValue>, ) {
                    ...
                    class Builder {
                        ...
                        fun build(): UnitWithProrationConfig = UnitWithProrationConfig(additionalProperties.toUnmodifiable())
                    }
                }
            ...
            @NoAutoDetect
            class NewFloatingGroupedAllocationPrice private constructor(
              private val metadata: JsonField<Metadata>,
              private val externalPriceId: JsonField<String>,
              private val name: JsonField<String>,
              private val billableMetricId: JsonField<String>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                override fun toString() = "NewFloatingGroupedAllocationPrice{metadata=$metadata, externalPriceId=$externalPriceId, name=$name, billableMetricId=$billableMetricId, itemId=$itemId, billedInAdvance=$billedInAdvance, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, cadence=$cadence, conversionRate=$conversionRate, modelType=$modelType, groupedAllocationConfig=$groupedAllocationConfig, currency=$currency, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    private var conversionRate: JsonField<Double> = JsonMissing.of()
                    private var modelType: JsonField<ModelType> = JsonMissing.of()
                    private var groupedAllocationConfig: JsonField<GroupedAllocationConfig> = JsonMissing.of()
                    private var currency: JsonField<String> = JsonMissing.of()
                    private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

                    internal fun from(newFloatingGroupedAllocationPrice: NewFloatingGroupedAllocationPrice) = apply {
                        ...
                        this.groupedAllocationConfig = newFloatingGroupedAllocationPrice.groupedAllocationConfig
                    ...
                    @JsonProperty("grouped_allocation_config")
                    @ExcludeMissing
                    fun groupedAllocationConfig(groupedAllocationConfig: JsonField<GroupedAllocationConfig>) = apply {
                    ...
                    fun build(): NewFloatingGroupedAllocationPrice = NewFloatingGroupedAllocationPrice(
                        metadata,
                        externalPriceId,
                        name,
                        billableMetricId,
                ...
                @NoAutoDetect
                class GroupedAllocationConfig private constructor(private val additionalProperties: Map<String, JsonValue>, ) {
                    ...
                    class Builder {
                        ...
                        fun build(): GroupedAllocationConfig = GroupedAllocationConfig(additionalProperties.toUnmodifiable())
                    }
                }
            ...
            @NoAutoDetect
            class NewFloatingBulkWithProrationPrice private constructor(
              private val metadata: JsonField<Metadata>,
              private val externalPriceId: JsonField<String>,
              private val name: JsonField<String>,
              private val billableMetricId: JsonField<String>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                class Builder {
                    ...
                    private var conversionRate: JsonField<Double> = JsonMissing.of()
                    private var modelType: JsonField<ModelType> = JsonMissing.of()
                    private var bulkWithProrationConfig: JsonField<BulkWithProrationConfig> = JsonMissing.of()
                    private var currency: JsonField<String> = JsonMissing.of()
                    private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

                    internal fun from(newFloatingBulkWithProrationPrice: NewFloatingBulkWithProrationPrice) = apply {
                        ...
                        this.bulkWithProrationConfig = newFloatingBulkWithProrationPrice.bulkWithProrationConfig
                    ...
                    @JsonProperty("bulk_with_proration_config")
                    @ExcludeMissing
                    fun bulkWithProrationConfig(bulkWithProrationConfig: JsonField<BulkWithProrationConfig>) = apply {
                    ...
                    fun build(): NewFloatingBulkWithProrationPrice = NewFloatingBulkWithProrationPrice(
                        metadata,
                        externalPriceId,
                        name,
                        billableMetricId,
                ...
                @NoAutoDetect
                class BulkWithProrationConfig private constructor(private val additionalProperties: Map<String, JsonValue>, ) {
                    ...
                    class Builder {
                        ...
                        fun build(): BulkWithProrationConfig = BulkWithProrationConfig(additionalProperties.toUnmodifiable())
                    }
                }
    ...
    @NoAutoDetect
    class AddAdjustment private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        fun adjustment(): Adjustment? = adjustment
        ...
        override fun toString() = "AddAdjustment{adjustment=$adjustment, startDate=$startDate, endDate=$endDate, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            /** The definition of a new adjustment to create and add to the subscription. */
            @JsonProperty("adjustment")
            fun adjustment(adjustment: Adjustment) = apply {
            ...
            fun build(): AddAdjustment = AddAdjustment(
                checkNotNull(adjustment) {
                    "`adjustment` is required but was not set"
                },
                checkNotNull(startDate) {
                    "`startDate` is required but was not set"
                },
        ...
        class Adjustment private constructor(
          ...
          private val _json: JsonValue? = null,
            ...
            fun newPercentageDiscount(): NewPercentageDiscount? = newPercentageDiscount
            fun newAmountDiscount(): NewAmountDiscount? = newAmountDiscount
            fun newMinimum(): NewMinimum? = newMinimum
            fun newMaximum(): NewMaximum? = newMaximum
            ...
            fun asNewPercentageDiscount(): NewPercentageDiscount = newPercentageDiscount.getOrThrow("newPercentageDiscount")
            fun asNewAmountDiscount(): NewAmountDiscount = newAmountDiscount.getOrThrow("newAmountDiscount")
            ...
            fun <T> accept(visitor: Visitor<T>): T {
              return when {
                  newPercentageDiscount != null -> visitor.visitNewPercentageDiscount(newPercentageDiscount)
            ...
            fun validate(): Adjustment = apply {
                if (!validated) {
                  if (newPercentageDiscount == null && newAmountDiscount == null && newMinimum == null && newMaximum == null) {
            ...
            override fun toString(): String {
              return when {
                  newPercentageDiscount != null -> "Adjustment{newPercentageDiscount=$newPercentageDiscount}"
            ...
            companion object {
                ...
                fun ofNewPercentageDiscount(newPercentageDiscount: NewPercentageDiscount) = Adjustment(newPercentageDiscount = newPercentageDiscount)

                fun ofNewAmountDiscount(newAmountDiscount: NewAmountDiscount) = Adjustment(newAmountDiscount = newAmountDiscount)
            ...
            class Deserializer : BaseDeserializer<Adjustment>(Adjustment::class) {
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): Adjustment {
                  val json = JsonValue.fromJsonNode(node)
                  tryDeserialize(node, jacksonTypeRef<NewPercentageDiscount>()){ it.validate() }?.let {
                      return Adjustment(newPercentageDiscount = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewAmountDiscount>()){ it.validate() }?.let {
                      return Adjustment(newAmountDiscount = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewMinimum>()){ it.validate() }?.let {
                      return Adjustment(newMinimum = it, _json = json)
                  }
                  tryDeserialize(node, jacksonTypeRef<NewMaximum>()){ it.validate() }?.let {
            ...
            class Serializer : BaseSerializer<Adjustment>(Adjustment::class) {
                ...
                override fun serialize(value: Adjustment, generator: JsonGenerator, provider: SerializerProvider) {
                  when {
                      value.newPercentageDiscount != null -> generator.writeObject(value.newPercentageDiscount)
                      value.newAmountDiscount != null -> generator.writeObject(value.newAmountDiscount)
            ...
            @NoAutoDetect
            class NewPercentageDiscount private constructor(
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                override fun toString() = "NewPercentageDiscount{appliesToPriceIds=$appliesToPriceIds, adjustmentType=$adjustmentType, percentageDiscount=$percentageDiscount, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    fun build(): NewPercentageDiscount = NewPercentageDiscount(
                ...
                class AdjustmentType @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
                    ...
                    override fun equals(other: Any?): Boolean {
                      ...
                      return other is AdjustmentType &&
                          this.value == other.value
                    }
            ...
            @NoAutoDetect
            class NewAmountDiscount private constructor(
              private val appliesToPriceIds: JsonField<List<String>>,
              private val adjustmentType: JsonField<AdjustmentType>,
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                override fun toString() = "NewAmountDiscount{appliesToPriceIds=$appliesToPriceIds, adjustmentType=$adjustmentType, amountDiscount=$amountDiscount, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    fun build(): NewAmountDiscount = NewAmountDiscount(
                        appliesToPriceIds.map { it.toUnmodifiable() },
                        adjustmentType,
                        amountDiscount,
                        additionalProperties.toUnmodifiable(),
            ...
            @NoAutoDetect
            class NewMinimum private constructor(
              private val appliesToPriceIds: JsonField<List<String>>,
              private val adjustmentType: JsonField<AdjustmentType>,
              private val minimumAmount: JsonField<String>,
              private val itemId: JsonField<String>,
              private val additionalProperties: Map<String, JsonValue>,
                ...
                override fun toString() = "NewMinimum{appliesToPriceIds=$appliesToPriceIds, adjustmentType=$adjustmentType, minimumAmount=$minimumAmount, itemId=$itemId, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    fun build(): NewMinimum = NewMinimum(
                        appliesToPriceIds.map { it.toUnmodifiable() },
                        adjustmentType,
                        minimumAmount,
                        itemId,
            ...
            @NoAutoDetect
            class NewMaximum private constructor(
              private val appliesToPriceIds: JsonField<List<String>>,
              private val adjustmentType: JsonField<AdjustmentType>,
              private val maximumAmount: JsonField<String>,
              private val additionalProperties: Map<String, JsonValue>,
                ...
                override fun toString() = "NewMaximum{appliesToPriceIds=$appliesToPriceIds, adjustmentType=$adjustmentType, maximumAmount=$maximumAmount, additionalProperties=$additionalProperties}"
                ...
                class Builder {
                    ...
                    fun build(): NewMaximum = NewMaximum(
                        appliesToPriceIds.map { it.toUnmodifiable() },
                        adjustmentType,
                        maximumAmount,
                        additionalProperties.toUnmodifiable(),
    ...
    class Edit private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        fun priceIntervalId(): String? = priceIntervalId
        ...
        fun billingCycleDay(): Long? = billingCycleDay
        ...
        override fun toString() = "Edit{priceIntervalId=$priceIntervalId, startDate=$startDate, endDate=$endDate, fixedFeeQuantityTransitions=$fixedFeeQuantityTransitions, billingCycleDay=$billingCycleDay, additionalProperties=$additionalProperties}"
    ...
    @NoAutoDetect
    class EditAdjustment private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        override fun toString() = "EditAdjustment{adjustmentIntervalId=$adjustmentIntervalId, startDate=$startDate, endDate=$endDate, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): EditAdjustment = EditAdjustment(

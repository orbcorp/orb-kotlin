...
class LicenseDeactivateResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LicenseDeactivateResponse].
         *
    ...
    /** A builder for [LicenseDeactivateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(licenseDeactivateResponse: LicenseDeactivateResponse) = apply {
            id = licenseDeactivateResponse.id
            endDate = licenseDeactivateResponse.endDate
            externalLicenseId = licenseDeactivateResponse.externalLicenseId
            licenseTypeId = licenseDeactivateResponse.licenseTypeId
            startDate = licenseDeactivateResponse.startDate
            status = licenseDeactivateResponse.status
            subscriptionId = licenseDeactivateResponse.subscriptionId
            additionalProperties = licenseDeactivateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LicenseDeactivateResponse].
         *
         ...
         */
        fun build(): LicenseDeactivateResponse =
     ...
     *   type.
     */
    fun validate(): LicenseDeactivateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LicenseDeactivateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "LicenseDeactivateResponse{id=$id, endDate=$endDate, externalLicenseId=$externalLicenseId, licenseTypeId=$licenseTypeId, startDate=$startDate, status=$status, subscriptionId=$subscriptionId, additionalProperties=$additionalProperties}"
}

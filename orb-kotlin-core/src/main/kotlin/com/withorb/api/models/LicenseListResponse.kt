...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LicenseListResponse].
         *
    ...
    /** A builder for [LicenseListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(licenseListResponse: LicenseListResponse) = apply {
            id = licenseListResponse.id
            endDate = licenseListResponse.endDate
            externalLicenseId = licenseListResponse.externalLicenseId
            licenseTypeId = licenseListResponse.licenseTypeId
            startDate = licenseListResponse.startDate
            status = licenseListResponse.status
            subscriptionId = licenseListResponse.subscriptionId
            additionalProperties = licenseListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LicenseListResponse].
         *
    ...
    fun validate(): LicenseListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "LicenseListResponse{id=$id, endDate=$endDate, externalLicenseId=$externalLicenseId, licenseTypeId=$licenseTypeId, startDate=$startDate, status=$status, subscriptionId=$subscriptionId, additionalProperties=$additionalProperties}"
}

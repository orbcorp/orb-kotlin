...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AlertRetrieveParams && this.alertId == other.alertId && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(alertId, additionalQueryParams, additionalHeaders) /* spotless:on */
    }

    override fun toString() =
        "AlertRetrieveParams{alertId=$alertId, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"

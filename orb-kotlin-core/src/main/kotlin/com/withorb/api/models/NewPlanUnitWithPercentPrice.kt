...
private constructor(
     ...
     *
     * Unlike [unitWithPercentConfig], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("unit_with_percent_config")
    @ExcludeMissing
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NewPlanUnitWithPercentPrice].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(newPlanUnitWithPercentPrice: NewPlanUnitWithPercentPrice) = apply {
            ...
            conversionRateConfig = newPlanUnitWithPercentPrice.conversionRateConfig
            currency = newPlanUnitWithPercentPrice.currency
            dimensionalPriceConfiguration =
                newPlanUnitWithPercentPrice.dimensionalPriceConfiguration
            ...
            licenseTypeId = newPlanUnitWithPercentPrice.licenseTypeId
            metadata = newPlanUnitWithPercentPrice.metadata
            referenceId = newPlanUnitWithPercentPrice.referenceId
         ...
         * [UnitWithPercentConfig] value instead. This method is primarily for setting the field to
    ...
    private constructor(
         ...
         */
        internal fun validity(): Int =
            (if (percent.asKnown() == null) 0 else 1) + (if (unitAmount.asKnown() == null) 0 else 1)

...
private constructor(
    ...
    class AutoPager(private val firstPage: SubscriptionListPageAsync) : Flow<SubscriptionModel> {

        override suspend fun collect(collector: FlowCollector<SubscriptionModel>) {
            var page = firstPage
            var index = 0
            while (true) {

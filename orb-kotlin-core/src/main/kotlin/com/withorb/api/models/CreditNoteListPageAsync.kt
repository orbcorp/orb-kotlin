...
class CreditNoteListPageAsync private constructor(private val creditNotesService: CreditNoteServiceAsync, private val params: CreditNoteListParams, private val response: Response, ) {
    ...
    override fun toString() = "CreditNoteListPageAsync{creditNotesService=$creditNotesService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): CreditNoteListParams? {
      ...
      return CreditNoteListParams.builder().from(params).apply {paginationMetadata().nextCursor()?.let{ this.cursor(it) } }.build()
    }

    suspend fun getNextPage(): CreditNoteListPageAsync? {
      return getNextPageParams()?.let {
          creditNotesService.list(it)
      }
    }
    ...
    companion object {
        ...
        fun of(creditNotesService: CreditNoteServiceAsync, params: CreditNoteListParams, response: Response) = CreditNoteListPageAsync(
            creditNotesService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<CreditNote>>, private val paginationMetadata: JsonField<PaginationMetadata>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        @JsonProperty("data")
        fun _data(): JsonField<List<CreditNote>>? = data
        ...
        override fun toString() = "CreditNoteListPageAsync.Response{data=$data, paginationMetadata=$paginationMetadata, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: CreditNoteListPageAsync, ) : Flow<CreditNote> {

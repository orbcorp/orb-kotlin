 ...
 */
class LicenseTypeCreateResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LicenseTypeCreateResponse].
         *
    ...
    /** A builder for [LicenseTypeCreateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(licenseTypeCreateResponse: LicenseTypeCreateResponse) = apply {
            id = licenseTypeCreateResponse.id
            groupingKey = licenseTypeCreateResponse.groupingKey
            name = licenseTypeCreateResponse.name
            additionalProperties = licenseTypeCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LicenseTypeCreateResponse].
         *
         ...
         */
        fun build(): LicenseTypeCreateResponse =
    ...
    fun validate(): LicenseTypeCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LicenseTypeCreateResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "LicenseTypeCreateResponse{id=$id, groupingKey=$groupingKey, name=$name, additionalProperties=$additionalProperties}"
}

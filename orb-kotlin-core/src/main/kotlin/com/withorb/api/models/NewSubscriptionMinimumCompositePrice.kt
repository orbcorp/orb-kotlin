...
class NewSubscriptionMinimumCompositePrice
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            billedInAdvance = newSubscriptionMinimumCompositePrice.billedInAdvance
            billingCycleConfiguration =
                newSubscriptionMinimumCompositePrice.billingCycleConfiguration
            conversionRate = newSubscriptionMinimumCompositePrice.conversionRate
            conversionRateConfig = newSubscriptionMinimumCompositePrice.conversionRateConfig
            currency = newSubscriptionMinimumCompositePrice.currency
            dimensionalPriceConfiguration =
                newSubscriptionMinimumCompositePrice.dimensionalPriceConfiguration
            externalPriceId = newSubscriptionMinimumCompositePrice.externalPriceId
            fixedPriceQuantity = newSubscriptionMinimumCompositePrice.fixedPriceQuantity
            invoiceGroupingKey = newSubscriptionMinimumCompositePrice.invoiceGroupingKey
            invoicingCycleConfiguration =
                newSubscriptionMinimumCompositePrice.invoicingCycleConfiguration
            licenseTypeId = newSubscriptionMinimumCompositePrice.licenseTypeId
            metadata = newSubscriptionMinimumCompositePrice.metadata
            referenceId = newSubscriptionMinimumCompositePrice.referenceId
            additionalProperties =
                newSubscriptionMinimumCompositePrice.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NewSubscriptionMinimumCompositePrice].
         *
         ...
         */
        fun build(): NewSubscriptionMinimumCompositePrice =
            NewSubscriptionMinimumCompositePrice(
     ...
     *   type.
     */
    fun validate(): NewSubscriptionMinimumCompositePrice = apply {
        if (validated) {
            return@apply
        }

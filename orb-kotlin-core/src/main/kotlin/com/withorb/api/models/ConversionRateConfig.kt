...
private constructor(
     ...
     * import com.withorb.api.core.JsonValue
     *
     * val result: String? = conversionRateConfig.accept(object : ConversionRateConfig.Visitor<String?> {
     *     override fun visitUnit(unit: UnitConversionRateConfig): String? = unit.toString()
     *
     *     // ...
     *

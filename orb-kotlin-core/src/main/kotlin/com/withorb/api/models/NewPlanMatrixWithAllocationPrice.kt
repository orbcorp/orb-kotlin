...
class NewPlanMatrixWithAllocationPrice
...
private constructor(
    ...
    /** A builder for [NewPlanMatrixWithAllocationPrice]. */
    class Builder internal constructor() {
        ...
        internal fun from(newPlanMatrixWithAllocationPrice: NewPlanMatrixWithAllocationPrice) =
            apply {
                cadence = newPlanMatrixWithAllocationPrice.cadence
                itemId = newPlanMatrixWithAllocationPrice.itemId
                matrixWithAllocationConfig =
                    newPlanMatrixWithAllocationPrice.matrixWithAllocationConfig
                modelType = newPlanMatrixWithAllocationPrice.modelType
                name = newPlanMatrixWithAllocationPrice.name
                billableMetricId = newPlanMatrixWithAllocationPrice.billableMetricId
                billedInAdvance = newPlanMatrixWithAllocationPrice.billedInAdvance
                billingCycleConfiguration =
                    newPlanMatrixWithAllocationPrice.billingCycleConfiguration
                conversionRate = newPlanMatrixWithAllocationPrice.conversionRate
                conversionRateConfig = newPlanMatrixWithAllocationPrice.conversionRateConfig
                currency = newPlanMatrixWithAllocationPrice.currency
                dimensionalPriceConfiguration =
                    newPlanMatrixWithAllocationPrice.dimensionalPriceConfiguration
                externalPriceId = newPlanMatrixWithAllocationPrice.externalPriceId
                fixedPriceQuantity = newPlanMatrixWithAllocationPrice.fixedPriceQuantity
                invoiceGroupingKey = newPlanMatrixWithAllocationPrice.invoiceGroupingKey
                invoicingCycleConfiguration =
                    newPlanMatrixWithAllocationPrice.invoicingCycleConfiguration
                licenseTypeId = newPlanMatrixWithAllocationPrice.licenseTypeId
                metadata = newPlanMatrixWithAllocationPrice.metadata
                referenceId = newPlanMatrixWithAllocationPrice.referenceId
                additionalProperties =
                    newPlanMatrixWithAllocationPrice.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [NewPlanMatrixWithAllocationPrice].
         *
         ...
         */
        fun build(): NewPlanMatrixWithAllocationPrice =
            NewPlanMatrixWithAllocationPrice(
     ...
     *   type.
     */
    fun validate(): NewPlanMatrixWithAllocationPrice = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NewPlanMatrixWithAllocationPrice &&
    ...
    override fun toString() =
        "NewPlanMatrixWithAllocationPrice{cadence=$cadence, itemId=$itemId, matrixWithAllocationConfig=$matrixWithAllocationConfig, modelType=$modelType, name=$name, billableMetricId=$billableMetricId, billedInAdvance=$billedInAdvance, billingCycleConfiguration=$billingCycleConfiguration, conversionRate=$conversionRate, conversionRateConfig=$conversionRateConfig, currency=$currency, dimensionalPriceConfiguration=$dimensionalPriceConfiguration, externalPriceId=$externalPriceId, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, invoicingCycleConfiguration=$invoicingCycleConfiguration, licenseTypeId=$licenseTypeId, metadata=$metadata, referenceId=$referenceId, additionalProperties=$additionalProperties}"
}

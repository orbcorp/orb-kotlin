 ...
 */
class CreditNoteCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        override fun toString() = "Body{lineItems=$lineItems, memo=$memo, reason=$reason, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(creditNoteCreateParams: CreditNoteCreateParams) =
            apply {
    ...
    class LineItem @JsonCreator private constructor(
        ...
        @JsonProperty("invoice_line_item_id") @ExcludeMissing private val invoiceLineItemId: JsonField<String> = JsonMissing.of(),
        @JsonAnySetter private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
        ...
        class Builder internal constructor() {
            ...
            /** The ID of the line item to credit. */
            fun invoiceLineItemId(invoiceLineItemId: String) = invoiceLineItemId(JsonField.of(invoiceLineItemId))

            /** The ID of the line item to credit. */
            fun invoiceLineItemId(invoiceLineItemId: JsonField<String>) =
                apply {
        ...
        override fun toString() = "LineItem{amount=$amount, invoiceLineItemId=$invoiceLineItemId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "CreditNoteCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

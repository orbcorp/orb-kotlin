 ...
 */
class CustomerBalanceTransactionCreateParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        override fun toString() = "Body{amount=$amount, type=$type, description=$description, additionalProperties=$additionalProperties}"
    }
    ...
    /** A builder for [CustomerBalanceTransactionCreateParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        internal fun from(customerBalanceTransactionCreateParams: CustomerBalanceTransactionCreateParams) =
            apply {
                ...
                additionalQueryParams = customerBalanceTransactionCreateParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() = "CustomerBalanceTransactionCreateParams{customerId=$customerId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

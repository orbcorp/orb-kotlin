...
class DimensionalPriceGroupListPageAsync private constructor(
    ...
    override fun toString() = "DimensionalPriceGroupListPageAsync{dimensionalPriceGroupsService=$dimensionalPriceGroupsService, params=$params, response=$response}"
    ...
    companion object {
        ...
        fun of(dimensionalPriceGroupsService: DimensionalPriceGroupServiceAsync, params: DimensionalPriceGroupListParams, response: Response) =

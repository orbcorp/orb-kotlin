...
class CustomerUsageUpdateParams
constructor(
    ...
    internal fun getBody(): CustomerUsageUpdateBody {
        return CustomerUsageUpdateBody(events, additionalBodyProperties)
    }
    ...
    @JsonDeserialize(builder = CustomerUsageUpdateBody.Builder::class)
    @NoAutoDetect
    class CustomerUsageUpdateBody
    internal constructor(
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is CustomerUsageUpdateBody &&
        ...
        override fun toString() =
            "CustomerUsageUpdateBody{events=$events, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            internal fun from(customerUsageUpdateBody: CustomerUsageUpdateBody) = apply {
                this.events = customerUsageUpdateBody.events
                additionalProperties(customerUsageUpdateBody.additionalProperties)
            }
            ...
            fun build(): CustomerUsageUpdateBody =
                CustomerUsageUpdateBody(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomerUsageUpdateParams &&
            this.id == other.id &&
            this.events == other.events &&
    ...
    override fun toString() =
        "CustomerUsageUpdateParams{id=$id, events=$events, timeframeEnd=$timeframeEnd, timeframeStart=$timeframeStart, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        internal fun from(customerUsageUpdateParams: CustomerUsageUpdateParams) = apply {
            this.id = customerUsageUpdateParams.id
            this.events(customerUsageUpdateParams.events)
            this.timeframeEnd = customerUsageUpdateParams.timeframeEnd
            this.timeframeStart = customerUsageUpdateParams.timeframeStart
            additionalQueryParams(customerUsageUpdateParams.additionalQueryParams)
            additionalHeaders(customerUsageUpdateParams.additionalHeaders)
            additionalBodyProperties(customerUsageUpdateParams.additionalBodyProperties)
        }
        ...
        fun build(): CustomerUsageUpdateParams =
            CustomerUsageUpdateParams(

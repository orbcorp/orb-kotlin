 ...
 * changes.
 */
class SubscriptionFetchSchedulePage private constructor(
    ...
    companion object {
        ...
        fun of(subscriptionsService: SubscriptionService, params: SubscriptionFetchScheduleParams, response: Response) =
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<SubscriptionFetchScheduleResponse> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {

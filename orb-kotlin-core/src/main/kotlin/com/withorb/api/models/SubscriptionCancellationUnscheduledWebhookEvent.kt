...
class SubscriptionCancellationUnscheduledWebhookEvent
...
private constructor(
    ...
    /** A builder for [SubscriptionCancellationUnscheduledWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = subscriptionCancellationUnscheduledWebhookEvent.id
            createdAt = subscriptionCancellationUnscheduledWebhookEvent.createdAt
            properties = subscriptionCancellationUnscheduledWebhookEvent.properties
            subscription = subscriptionCancellationUnscheduledWebhookEvent.subscription
            type = subscriptionCancellationUnscheduledWebhookEvent.type
            additionalProperties =
                subscriptionCancellationUnscheduledWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubscriptionCancellationUnscheduledWebhookEvent].
         *
         ...
         */
        fun build(): SubscriptionCancellationUnscheduledWebhookEvent =
            SubscriptionCancellationUnscheduledWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): SubscriptionCancellationUnscheduledWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        private val originalCancellationDate: JsonField<String>,
        private val additionalProperties: MutableMap<String, JsonValue>,
    ) {

        @JsonCreator
        private constructor(
            @JsonProperty("original_cancellation_date")
            @ExcludeMissing
            originalCancellationDate: JsonField<String> = JsonMissing.of()
        ) : this(originalCancellationDate, mutableMapOf())

        /**
         * @throws OrbInvalidDataException if the JSON field has an unexpected type or is
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun originalCancellationDate(): String =
            originalCancellationDate.getRequired("original_cancellation_date")

        /**
         * Returns the raw JSON value of [originalCancellationDate].
         *
         * Unlike [originalCancellationDate], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("original_cancellation_date")
        @ExcludeMissing
        fun _originalCancellationDate(): JsonField<String> = originalCancellationDate
        ...
        class Builder internal constructor() {
            ...
            private var originalCancellationDate: JsonField<String>? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            internal fun from(properties: Properties) = apply {
                originalCancellationDate = properties.originalCancellationDate
                additionalProperties = properties.additionalProperties.toMutableMap()
            }

            fun originalCancellationDate(originalCancellationDate: String) =
                originalCancellationDate(JsonField.of(originalCancellationDate))

            /**
             * Sets [Builder.originalCancellationDate] to an arbitrary JSON value.
             *
             * You should usually call [Builder.originalCancellationDate] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun originalCancellationDate(originalCancellationDate: JsonField<String>) = apply {
                this.originalCancellationDate = originalCancellationDate
            }
            ...
            fun build(): Properties =
                Properties(
                    checkRequired("originalCancellationDate", originalCancellationDate),
                    additionalProperties.toMutableMap(),
                )
        }
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (if (originalCancellationDate.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Properties &&
                originalCancellationDate == other.originalCancellationDate &&
                additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy {
            Objects.hash(originalCancellationDate, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Properties{originalCancellationDate=$originalCancellationDate, additionalProperties=$additionalProperties}"
    }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val SUBSCRIPTION_CANCELLATION_UNSCHEDULED = of("subscription.cancellation_unscheduled")
        ...
        fun value(): Value =
            when (this) {
                SUBSCRIPTION_CANCELLATION_UNSCHEDULED -> Value.SUBSCRIPTION_CANCELLATION_UNSCHEDULED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                SUBSCRIPTION_CANCELLATION_UNSCHEDULED -> Known.SUBSCRIPTION_CANCELLATION_UNSCHEDULED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionCancellationUnscheduledWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "SubscriptionCancellationUnscheduledWebhookEvent{id=$id, createdAt=$createdAt, properties=$properties, subscription=$subscription, type=$type, additionalProperties=$additionalProperties}"
}

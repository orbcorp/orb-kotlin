...
class CustomerAccountingSyncFailedWebhookEvent
...
private constructor(
    ...
    /** A builder for [CustomerAccountingSyncFailedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            customerAccountingSyncFailedWebhookEvent: CustomerAccountingSyncFailedWebhookEvent
        ) = apply {
            id = customerAccountingSyncFailedWebhookEvent.id
            accountingSyncRecord = customerAccountingSyncFailedWebhookEvent.accountingSyncRecord
            createdAt = customerAccountingSyncFailedWebhookEvent.createdAt
            customer = customerAccountingSyncFailedWebhookEvent.customer
            properties = customerAccountingSyncFailedWebhookEvent.properties
            type = customerAccountingSyncFailedWebhookEvent.type
            additionalProperties =
                customerAccountingSyncFailedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomerAccountingSyncFailedWebhookEvent].
         *
         ...
         */
        fun build(): CustomerAccountingSyncFailedWebhookEvent =
            CustomerAccountingSyncFailedWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): CustomerAccountingSyncFailedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val CUSTOMER_ACCOUNTING_SYNC_FAILED = of("customer.accounting_sync_failed")
        ...
        fun value(): Value =
            when (this) {
                CUSTOMER_ACCOUNTING_SYNC_FAILED -> Value.CUSTOMER_ACCOUNTING_SYNC_FAILED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CUSTOMER_ACCOUNTING_SYNC_FAILED -> Known.CUSTOMER_ACCOUNTING_SYNC_FAILED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomerAccountingSyncFailedWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "CustomerAccountingSyncFailedWebhookEvent{id=$id, accountingSyncRecord=$accountingSyncRecord, createdAt=$createdAt, customer=$customer, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}

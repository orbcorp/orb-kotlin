...
private constructor(
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun price(minimum: InnerPrice.Minimum) = price(InnerPrice.ofMinimum(minimum))
        ...
        private constructor(
            ...
            companion object {
                ...
                fun ofMinimum(minimum: Minimum) = InnerPrice(minimum = minimum)
                    ...
                    when (modelType) {
                        ...
                        "minimum" -> {
                            return tryDeserialize(node, jacksonTypeRef<Minimum>())?.let {
                                InnerPrice(minimum = it, _json = json)
                            } ?: InnerPrice(_json = json)
                        }
                        "minimum_composite" -> {
                            return tryDeserialize(

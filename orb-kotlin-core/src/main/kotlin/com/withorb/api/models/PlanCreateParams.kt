...
private constructor(
     ...
     */
    fun adjustments(): List<Adjustment>? = body.adjustments()
     ...
     *   responded with an unexpected value).
     */
    fun planPhases(): List<PlanPhase>? = body.planPhases()
    ...
    private constructor(
         ...
         */
        fun adjustments(): List<Adjustment>? = adjustments.getNullable("adjustments")
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun price(): InnerPrice? = price.getNullable("price")
        ...
        class Builder internal constructor() {
            ...
            /**
             * Alias for calling [price] with
             * `InnerPrice.ofDailyCreditAllowance(dailyCreditAllowance)`.
             */
            fun price(dailyCreditAllowance: InnerPrice.DailyCreditAllowance) =
                price(InnerPrice.ofDailyCreditAllowance(dailyCreditAllowance))
        ...
        private constructor(
            ...
            private constructor(
                 ...
                 */
                fun writeOffOverage(): Boolean? = writeOffOverage.getNullable("write_off_overage")
                ...
                internal fun validity(): Int =
                    (if (amount.asKnown() == null) 0 else 1) +
                        (if (currency.asKnown() == null) 0 else 1) +
                        (if (writeOffOverage.asKnown() == null) 0 else 1)
        ...
        private constructor(
             ...
             * import com.withorb.api.core.JsonValue
             *
             * val result: String? = innerPrice.accept(object : InnerPrice.Visitor<String?> {
             *     override fun visitUnit(unit: NewPlanUnitPrice): String? = unit.toString()
             *
             *     // ...
             *
            ...
            override fun toString(): String =
                when {
                    ...
                    dailyCreditAllowance != null ->
                        "InnerPrice{dailyCreditAllowance=$dailyCreditAllowance}"
            ...
            companion object {
                ...
                fun ofUnit(unit: NewPlanUnitPrice) = InnerPrice(unit = unit)

                fun ofTiered(tiered: NewPlanTieredPrice) = InnerPrice(tiered = tiered)

                fun ofBulk(bulk: NewPlanBulkPrice) = InnerPrice(bulk = bulk)
                ...
                fun ofMatrix(matrix: NewPlanMatrixPrice) = InnerPrice(matrix = matrix)
                ...
                fun ofPercent(percent: Percent) = InnerPrice(percent = percent)
                    ...
                    when (modelType) {
                        ...
                        "daily_credit_allowance" -> {
                            return tryDeserialize(node, jacksonTypeRef<DailyCreditAllowance>())
                                ?.let { InnerPrice(dailyCreditAllowance = it, _json = json) }
                                ?: InnerPrice(_json = json)
                        }
                        "minimum_composite" -> {
                            return tryDeserialize(
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(dailyCreditAllowance: DailyCreditAllowance) = apply {
                        ...
                        referenceId = dailyCreditAllowance.referenceId
                        additionalProperties =
                ...
                override fun toString() =
                    "DailyCreditAllowance{cadence=$cadence, dailyCreditAllowanceConfig=$dailyCreditAllowanceConfig, itemId=$itemId, modelType=$modelType, name=$name, billableMetricId=$billableMetricId, billedInAdvance=$billedInAdvance, billingCycleConfiguration=$billingCycleConfiguration, conversionRate=$conversionRate, conversionRateConfig=$conversionRateConfig, currency=$currency, dimensionalPriceConfiguration=$dimensionalPriceConfiguration, externalPriceId=$externalPriceId, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, invoicingCycleConfiguration=$invoicingCycleConfiguration, licenseTypeId=$licenseTypeId, metadata=$metadata, referenceId=$referenceId, additionalProperties=$additionalProperties}"
            }
    ...
    private constructor(
        ...
        private constructor(
             ...
             * import com.withorb.api.core.JsonValue
             *
             * val result: String? = innerAdjustment.accept(object : InnerAdjustment.Visitor<String?> {
            ...
            companion object {
                ...
                fun ofMinimum(minimum: NewMinimum) = InnerAdjustment(minimum = minimum)

                fun ofMaximum(maximum: NewMaximum) = InnerAdjustment(maximum = maximum)
            }
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun alignBillingWithPhaseStartDate(): Boolean? =
            alignBillingWithPhaseStartDate.getNullable("align_billing_with_phase_start_date")
        ...
        internal fun validity(): Int =
            (if (order.asKnown() == null) 0 else 1) +
                (if (alignBillingWithPhaseStartDate.asKnown() == null) 0 else 1) +

...
class SubscriptionCancellationScheduledWebhookEvent
...
private constructor(
    ...
    /** A builder for [SubscriptionCancellationScheduledWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = subscriptionCancellationScheduledWebhookEvent.id
            createdAt = subscriptionCancellationScheduledWebhookEvent.createdAt
            properties = subscriptionCancellationScheduledWebhookEvent.properties
            subscription = subscriptionCancellationScheduledWebhookEvent.subscription
            type = subscriptionCancellationScheduledWebhookEvent.type
            additionalProperties =
                subscriptionCancellationScheduledWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubscriptionCancellationScheduledWebhookEvent].
         *
         ...
         */
        fun build(): SubscriptionCancellationScheduledWebhookEvent =
            SubscriptionCancellationScheduledWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): SubscriptionCancellationScheduledWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        private val cancellationDate: JsonField<String>,
        private val additionalProperties: MutableMap<String, JsonValue>,
    ) {
        ...
        private constructor(
            ...
            @ExcludeMissing
            cancellationDate: JsonField<String> = JsonMissing.of()
        ) : this(cancellationDate, mutableMapOf())

        /**
         * @throws OrbInvalidDataException if the JSON field has an unexpected type or is
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun cancellationDate(): String = cancellationDate.getRequired("cancellation_date")
        ...
        @JsonProperty("cancellation_date")
        @ExcludeMissing
        fun _cancellationDate(): JsonField<String> = cancellationDate
        ...
        class Builder internal constructor() {
            ...
            private var cancellationDate: JsonField<String>? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            internal fun from(properties: Properties) = apply {
                cancellationDate = properties.cancellationDate
                additionalProperties = properties.additionalProperties.toMutableMap()
            }

            fun cancellationDate(cancellationDate: String) =
                cancellationDate(JsonField.of(cancellationDate))

            /**
             * Sets [Builder.cancellationDate] to an arbitrary JSON value.
             *
             * You should usually call [Builder.cancellationDate] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun cancellationDate(cancellationDate: JsonField<String>) = apply {
            ...
            fun build(): Properties =
                Properties(
                    checkRequired("cancellationDate", cancellationDate),
                    additionalProperties.toMutableMap(),
                )
        }
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (if (cancellationDate.asKnown() == null) 0 else 1)
        ...
        private val hashCode: Int by lazy { Objects.hash(cancellationDate, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Properties{cancellationDate=$cancellationDate, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionCancellationScheduledWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "SubscriptionCancellationScheduledWebhookEvent{id=$id, createdAt=$createdAt, properties=$properties, subscription=$subscription, type=$type, additionalProperties=$additionalProperties}"
}

...
private constructor(
    ...
    private constructor(
        ...
        companion object {
            ...
            fun ofUnit(unit: Unit) = ConversionRateConfig(unit = unit)

            fun ofTiered(tiered: Tiered) = ConversionRateConfig(tiered = tiered)
        }
        ...
        private constructor(
            ...
            private constructor(
                ...
                private constructor(
                     ...
                     */
                    internal fun validity(): Int =
                        (if (firstUnit.asKnown() == null) 0 else 1) +
                            (if (unitAmount.asKnown() == null) 0 else 1) +
                            (if (lastUnit.asKnown() == null) 0 else 1)
    ...
    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(cadence, itemId, modelType, name, tieredPackageWithMinimumConfig, billableMetricId, billedInAdvance, billingCycleConfiguration, conversionRate, conversionRateConfig, currency, dimensionalPriceConfiguration, externalPriceId, fixedPriceQuantity, invoiceGroupingKey, invoicingCycleConfiguration, metadata, referenceId, additionalProperties) }
    /* spotless:on */

...
private constructor(
    ...
    /**
     * The ID of the license type to associate with this price. On a usage price this also marks the
     * price as eligible to draw down from that license type's allocation; a usage price created
     * without it is billed normally. Usage prices with a license type must use the `unit` model,
     * and only draw down when their currency matches the allocation's.
     *
     * @throws OrbInvalidDataException if the JSON field has an unexpected type (e.g. if the server
     *   responded with an unexpected value).
     */
     ...
     *
     * Unlike [tieredPackageWithMinimumConfig], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("tiered_package_with_minimum_config")
    @ExcludeMissing
    ...
    /** A builder for [NewSubscriptionTieredPackageWithMinimumPrice]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            cadence = newSubscriptionTieredPackageWithMinimumPrice.cadence
            itemId = newSubscriptionTieredPackageWithMinimumPrice.itemId
            modelType = newSubscriptionTieredPackageWithMinimumPrice.modelType
            name = newSubscriptionTieredPackageWithMinimumPrice.name
            tieredPackageWithMinimumConfig =
                newSubscriptionTieredPackageWithMinimumPrice.tieredPackageWithMinimumConfig
            billableMetricId = newSubscriptionTieredPackageWithMinimumPrice.billableMetricId
            billedInAdvance = newSubscriptionTieredPackageWithMinimumPrice.billedInAdvance
            billingCycleConfiguration =
                newSubscriptionTieredPackageWithMinimumPrice.billingCycleConfiguration
            conversionRate = newSubscriptionTieredPackageWithMinimumPrice.conversionRate
            conversionRateConfig = newSubscriptionTieredPackageWithMinimumPrice.conversionRateConfig
            currency = newSubscriptionTieredPackageWithMinimumPrice.currency
            dimensionalPriceConfiguration =
                newSubscriptionTieredPackageWithMinimumPrice.dimensionalPriceConfiguration
            externalPriceId = newSubscriptionTieredPackageWithMinimumPrice.externalPriceId
            fixedPriceQuantity = newSubscriptionTieredPackageWithMinimumPrice.fixedPriceQuantity
            invoiceGroupingKey = newSubscriptionTieredPackageWithMinimumPrice.invoiceGroupingKey
            invoicingCycleConfiguration =
                newSubscriptionTieredPackageWithMinimumPrice.invoicingCycleConfiguration
            licenseTypeId = newSubscriptionTieredPackageWithMinimumPrice.licenseTypeId
            metadata = newSubscriptionTieredPackageWithMinimumPrice.metadata
            referenceId = newSubscriptionTieredPackageWithMinimumPrice.referenceId
            additionalProperties =
                newSubscriptionTieredPackageWithMinimumPrice.additionalProperties.toMutableMap()
        }
         ...
         * [TieredPackageWithMinimumConfig] value instead. This method is primarily for setting the
        ...
        /**
         * The ID of the license type to associate with this price. On a usage price this also marks
         * the price as eligible to draw down from that license type's allocation; a usage price
         * created without it is billed normally. Usage prices with a license type must use the
         * `unit` model, and only draw down when their currency matches the allocation's.
         */
        ...
        /**
         * Returns an immutable instance of [NewSubscriptionTieredPackageWithMinimumPrice].
         *
         ...
         */
        fun build(): NewSubscriptionTieredPackageWithMinimumPrice =
            NewSubscriptionTieredPackageWithMinimumPrice(
     ...
     *   type.
     */
    fun validate(): NewSubscriptionTieredPackageWithMinimumPrice = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NewSubscriptionTieredPackageWithMinimumPrice &&
    ...
    override fun toString() =
        "NewSubscriptionTieredPackageWithMinimumPrice{cadence=$cadence, itemId=$itemId, modelType=$modelType, name=$name, tieredPackageWithMinimumConfig=$tieredPackageWithMinimumConfig, billableMetricId=$billableMetricId, billedInAdvance=$billedInAdvance, billingCycleConfiguration=$billingCycleConfiguration, conversionRate=$conversionRate, conversionRateConfig=$conversionRateConfig, currency=$currency, dimensionalPriceConfiguration=$dimensionalPriceConfiguration, externalPriceId=$externalPriceId, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, invoicingCycleConfiguration=$invoicingCycleConfiguration, licenseTypeId=$licenseTypeId, metadata=$metadata, referenceId=$referenceId, additionalProperties=$additionalProperties}"
}

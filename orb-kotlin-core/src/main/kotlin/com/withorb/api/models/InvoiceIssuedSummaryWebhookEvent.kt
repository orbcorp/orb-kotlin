...
/**
 * A lightweight variant of invoice.issued for accounts configured to receive a summarized invoice
 * payload.
 */
class InvoiceIssuedSummaryWebhookEvent
...
private constructor(
    ...
    /** A builder for [InvoiceIssuedSummaryWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(invoiceIssuedSummaryWebhookEvent: InvoiceIssuedSummaryWebhookEvent) =
            apply {
                id = invoiceIssuedSummaryWebhookEvent.id
                createdAt = invoiceIssuedSummaryWebhookEvent.createdAt
                invoice = invoiceIssuedSummaryWebhookEvent.invoice
                properties = invoiceIssuedSummaryWebhookEvent.properties
                type = invoiceIssuedSummaryWebhookEvent.type
                additionalProperties =
                    invoiceIssuedSummaryWebhookEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [InvoiceIssuedSummaryWebhookEvent].
         *
         ...
         */
        fun build(): InvoiceIssuedSummaryWebhookEvent =
            InvoiceIssuedSummaryWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): InvoiceIssuedSummaryWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        private val automaticallyMarkedAsPaid: JsonField<Boolean>,
        private val additionalProperties: MutableMap<String, JsonValue>,
    ) {

        @JsonCreator
        private constructor(
            @JsonProperty("automatically_marked_as_paid")
            @ExcludeMissing
            automaticallyMarkedAsPaid: JsonField<Boolean> = JsonMissing.of()
        ) : this(automaticallyMarkedAsPaid, mutableMapOf())

        /**
         * @throws OrbInvalidDataException if the JSON field has an unexpected type or is
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun automaticallyMarkedAsPaid(): Boolean =
            automaticallyMarkedAsPaid.getRequired("automatically_marked_as_paid")

        /**
         * Returns the raw JSON value of [automaticallyMarkedAsPaid].
         *
         * Unlike [automaticallyMarkedAsPaid], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("automatically_marked_as_paid")
        @ExcludeMissing
        fun _automaticallyMarkedAsPaid(): JsonField<Boolean> = automaticallyMarkedAsPaid
        ...
        class Builder internal constructor() {
            ...
            private var automaticallyMarkedAsPaid: JsonField<Boolean>? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            internal fun from(properties: Properties) = apply {
                automaticallyMarkedAsPaid = properties.automaticallyMarkedAsPaid
                additionalProperties = properties.additionalProperties.toMutableMap()
            }

            fun automaticallyMarkedAsPaid(automaticallyMarkedAsPaid: Boolean) =
                automaticallyMarkedAsPaid(JsonField.of(automaticallyMarkedAsPaid))

            /**
             * Sets [Builder.automaticallyMarkedAsPaid] to an arbitrary JSON value.
             *
             * You should usually call [Builder.automaticallyMarkedAsPaid] with a well-typed
             * [Boolean] value instead. This method is primarily for setting the field to an
             * undocumented or not yet supported value.
             */
            fun automaticallyMarkedAsPaid(automaticallyMarkedAsPaid: JsonField<Boolean>) = apply {
                this.automaticallyMarkedAsPaid = automaticallyMarkedAsPaid
            }
            ...
            fun build(): Properties =
                Properties(
                    checkRequired("automaticallyMarkedAsPaid", automaticallyMarkedAsPaid),
                    additionalProperties.toMutableMap(),
                )
        }
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (if (automaticallyMarkedAsPaid.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Properties &&
                automaticallyMarkedAsPaid == other.automaticallyMarkedAsPaid &&
                additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy {
            Objects.hash(automaticallyMarkedAsPaid, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Properties{automaticallyMarkedAsPaid=$automaticallyMarkedAsPaid, additionalProperties=$additionalProperties}"
    }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val INVOICE_ISSUED_SUMMARY = of("invoice.issued_summary")
        ...
        fun value(): Value =
            when (this) {
                INVOICE_ISSUED_SUMMARY -> Value.INVOICE_ISSUED_SUMMARY
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                INVOICE_ISSUED_SUMMARY -> Known.INVOICE_ISSUED_SUMMARY
                else -> throw OrbInvalidDataException("Unknown Type: $value")
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InvoiceIssuedSummaryWebhookEvent &&
            id == other.id &&
            createdAt == other.createdAt &&
            invoice == other.invoice &&
    ...
    override fun toString() =
        "InvoiceIssuedSummaryWebhookEvent{id=$id, createdAt=$createdAt, invoice=$invoice, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}

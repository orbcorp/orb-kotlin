...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NewBillingCycleConfiguration].
         *
    ...
    /** A builder for [NewBillingCycleConfiguration]. */
    class Builder internal constructor() {
        ...
        internal fun from(newBillingCycleConfiguration: NewBillingCycleConfiguration) = apply {
            duration = newBillingCycleConfiguration.duration
            durationUnit = newBillingCycleConfiguration.durationUnit
            additionalProperties = newBillingCycleConfiguration.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NewBillingCycleConfiguration].
         *
         ...
         */
        fun build(): NewBillingCycleConfiguration =
    ...
    fun validate(): NewBillingCycleConfiguration = apply {
        if (validated) {
            return@apply
        }
    ...
    internal fun validity(): Int =
        (if (duration.asKnown() == null) 0 else 1) + (durationUnit.asKnown()?.validity() ?: 0)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is NewBillingCycleConfiguration && duration == other.duration && durationUnit == other.durationUnit && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "NewBillingCycleConfiguration{duration=$duration, durationUnit=$durationUnit, additionalProperties=$additionalProperties}"
}

 ...
 */
class DimensionalPriceGroupCreateParams private constructor(
    ...
    fun _externalDimensionalPriceGroupId(): JsonField<String> = body._externalDimensionalPriceGroupId()
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("external_dimensional_price_group_id") @ExcludeMissing private val externalDimensionalPriceGroupId: JsonField<String> = JsonMissing.of(),
        ...
        fun externalDimensionalPriceGroupId(): String? = externalDimensionalPriceGroupId.getNullable("external_dimensional_price_group_id")
        ...
        class Builder internal constructor() {
            ...
            fun externalDimensionalPriceGroupId(externalDimensionalPriceGroupId: String?) = externalDimensionalPriceGroupId(JsonField.ofNullable(externalDimensionalPriceGroupId))
        ...
        override fun toString() = "Body{billableMetricId=$billableMetricId, dimensions=$dimensions, name=$name, externalDimensionalPriceGroupId=$externalDimensionalPriceGroupId, metadata=$metadata, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(dimensionalPriceGroupCreateParams: DimensionalPriceGroupCreateParams) =
            apply {
                ...
                additionalQueryParams = dimensionalPriceGroupCreateParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun toString() = "DimensionalPriceGroupCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

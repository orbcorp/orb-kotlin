 ...
 */
class SubscriptionUpdateFixedFeeQuantityParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        @JsonProperty("change_option") @ExcludeMissing private val changeOption: JsonField<ChangeOption> = JsonMissing.of(),
         ...
         * existing invoices to be changed.
         */
        fun allowInvoiceCreditOrVoid(): Boolean? = allowInvoiceCreditOrVoid.getNullable("allow_invoice_credit_or_void")
         ...
         * `immediate` unless it's explicitly set to `upcoming_invoice`.
         */
        fun changeOption(): ChangeOption? = changeOption.getNullable("change_option")
        ...
        class Builder internal constructor() {
             ...
             * `immediate` unless it's explicitly set to `upcoming_invoice`.
             */
            fun changeOption(changeOption: JsonField<ChangeOption>) =
                apply {
        ...
        override fun toString() = "Body{priceId=$priceId, quantity=$quantity, allowInvoiceCreditOrVoid=$allowInvoiceCreditOrVoid, changeOption=$changeOption, effectiveDate=$effectiveDate, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionUpdateFixedFeeQuantityParams: SubscriptionUpdateFixedFeeQuantityParams) =
            apply {
                ...
                additionalHeaders = subscriptionUpdateFixedFeeQuantityParams.additionalHeaders.toBuilder()
                additionalQueryParams = subscriptionUpdateFixedFeeQuantityParams.additionalQueryParams.toBuilder()
            }
     ...
     * `immediate` unless it's explicitly set to `upcoming_invoice`.
     */
    class ChangeOption @JsonCreator private constructor(
        ...
        /**
         * An enum containing [ChangeOption]'s known values, as well as an [_UNKNOWN]
         * member.
         *
        ...
        enum class Value {
            ...
            EFFECTIVE_DATE,
            /**
             * An enum member indicating that [ChangeOption] was instantiated with an unknown
             * value.
             */
            _UNKNOWN,
        }
    ...
    override fun toString() = "SubscriptionUpdateFixedFeeQuantityParams{subscriptionId=$subscriptionId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

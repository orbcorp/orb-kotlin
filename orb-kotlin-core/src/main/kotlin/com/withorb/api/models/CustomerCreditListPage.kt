 ...
 */
class CustomerCreditListPage private constructor(
    ...
    companion object {
        ...
        fun of(creditsService: CreditService, params: CustomerCreditListParams, response: Response) =
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<CustomerCreditListResponse> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {

...
class EventBackfillListPageAsync private constructor(private val backfillsService: BackfillServiceAsync, private val params: EventBackfillListParams, private val response: Response, ) {
    ...
    override fun toString() = "EventBackfillListPageAsync{backfillsService=$backfillsService, params=$params, response=$response}"
    ...
    companion object {
        ...
        fun of(backfillsService: BackfillServiceAsync, params: EventBackfillListParams, response: Response) = EventBackfillListPageAsync(
            backfillsService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<EventBackfillListResponse>>, private val paginationMetadata: JsonField<PaginationMetadata>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "EventBackfillListPageAsync.Response{data=$data, paginationMetadata=$paginationMetadata, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: EventBackfillListPageAsync, ) : Flow<EventBackfillListResponse> {

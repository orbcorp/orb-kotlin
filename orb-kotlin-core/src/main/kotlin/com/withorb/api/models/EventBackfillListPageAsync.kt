...
private constructor(
    ...
    constructor(
        ...
        @JsonProperty("data") fun _data(): JsonField<List<BackfillModel>>? = data
    ...
    class AutoPager(private val firstPage: EventBackfillListPageAsync) : Flow<BackfillModel> {

        override suspend fun collect(collector: FlowCollector<BackfillModel>) {
            var page = firstPage
            var index = 0
            while (true) {

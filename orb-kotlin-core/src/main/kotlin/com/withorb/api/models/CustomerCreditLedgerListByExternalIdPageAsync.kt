...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CustomerCreditLedgerListByExternalIdPageAsync && this.ledgerService == other.ledgerService && this.params == other.params && this.response == other.response /* spotless:on */
    }
    ...
    suspend fun getNextPage(): CustomerCreditLedgerListByExternalIdPageAsync? {
        return getNextPageParams()?.let { ledgerService.listByExternalId(it) }
    }
    ...
    constructor(
        ...
        override fun toString() =
            "CustomerCreditLedgerListByExternalIdPageAsync.Response{data=$data, paginationMetadata=$paginationMetadata, additionalProperties=$additionalProperties}"

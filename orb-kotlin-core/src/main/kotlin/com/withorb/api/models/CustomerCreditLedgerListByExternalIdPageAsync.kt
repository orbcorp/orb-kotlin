 ...
 */
class CustomerCreditLedgerListByExternalIdPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(ledgerService: LedgerServiceAsync, params: CustomerCreditLedgerListByExternalIdParams, response: Response) =

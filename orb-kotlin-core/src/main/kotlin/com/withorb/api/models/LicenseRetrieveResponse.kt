...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LicenseRetrieveResponse].
         *
    ...
    /** A builder for [LicenseRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(licenseRetrieveResponse: LicenseRetrieveResponse) = apply {
            id = licenseRetrieveResponse.id
            endDate = licenseRetrieveResponse.endDate
            externalLicenseId = licenseRetrieveResponse.externalLicenseId
            licenseTypeId = licenseRetrieveResponse.licenseTypeId
            startDate = licenseRetrieveResponse.startDate
            status = licenseRetrieveResponse.status
            subscriptionId = licenseRetrieveResponse.subscriptionId
            additionalProperties = licenseRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LicenseRetrieveResponse].
         *
         ...
         */
        fun build(): LicenseRetrieveResponse =
    ...
    fun validate(): LicenseRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LicenseRetrieveResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "LicenseRetrieveResponse{id=$id, endDate=$endDate, externalLicenseId=$externalLicenseId, licenseTypeId=$licenseTypeId, startDate=$startDate, status=$status, subscriptionId=$subscriptionId, additionalProperties=$additionalProperties}"
}

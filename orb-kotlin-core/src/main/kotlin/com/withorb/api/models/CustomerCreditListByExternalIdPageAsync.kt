 ...
 */
class CustomerCreditListByExternalIdPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(creditsService: CreditServiceAsync, params: CustomerCreditListByExternalIdParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<CustomerCreditListByExternalIdResponse>> = JsonMissing.of(),

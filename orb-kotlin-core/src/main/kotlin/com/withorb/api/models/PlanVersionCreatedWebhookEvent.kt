...
class PlanVersionCreatedWebhookEvent
...
private constructor(
    ...
    /** A builder for [PlanVersionCreatedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(planVersionCreatedWebhookEvent: PlanVersionCreatedWebhookEvent) = apply {
            id = planVersionCreatedWebhookEvent.id
            createdAt = planVersionCreatedWebhookEvent.createdAt
            plan = planVersionCreatedWebhookEvent.plan
            properties = planVersionCreatedWebhookEvent.properties
            type = planVersionCreatedWebhookEvent.type
            additionalProperties =
                planVersionCreatedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PlanVersionCreatedWebhookEvent].
         *
         ...
         */
        fun build(): PlanVersionCreatedWebhookEvent =
            PlanVersionCreatedWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): PlanVersionCreatedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        private val planVersionDescription: JsonField<String>,
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("plan_version_description")
            @ExcludeMissing
            planVersionDescription: JsonField<String> = JsonMissing.of(),
            @JsonProperty("plan_version_number")
            @ExcludeMissing
            planVersionNumber: JsonField<Long> = JsonMissing.of(),
        ) : this(planVersionDescription, planVersionNumber, mutableMapOf())

        /**
         * @throws OrbInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         */
        fun planVersionDescription(): String? =
            planVersionDescription.getNullable("plan_version_description")

        /**
         * @throws OrbInvalidDataException if the JSON field has an unexpected type or is
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun planVersionNumber(): Long = planVersionNumber.getRequired("plan_version_number")

        /**
         * Returns the raw JSON value of [planVersionDescription].
         *
         * Unlike [planVersionDescription], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("plan_version_description")
        @ExcludeMissing
        fun _planVersionDescription(): JsonField<String> = planVersionDescription
        ...
        class Builder internal constructor() {
            ...
            private var planVersionDescription: JsonField<String>? = null
            private var planVersionNumber: JsonField<Long>? = null
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            internal fun from(properties: Properties) = apply {
                planVersionDescription = properties.planVersionDescription
                planVersionNumber = properties.planVersionNumber
                additionalProperties = properties.additionalProperties.toMutableMap()
            }

            fun planVersionDescription(planVersionDescription: String?) =
                planVersionDescription(JsonField.ofNullable(planVersionDescription))

            /**
             * Sets [Builder.planVersionDescription] to an arbitrary JSON value.
             *
             * You should usually call [Builder.planVersionDescription] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun planVersionDescription(planVersionDescription: JsonField<String>) = apply {
                this.planVersionDescription = planVersionDescription
            }

            fun planVersionNumber(planVersionNumber: Long) =
                planVersionNumber(JsonField.of(planVersionNumber))
            ...
            fun build(): Properties =
                Properties(
                    checkRequired("planVersionDescription", planVersionDescription),
                    checkRequired("planVersionNumber", planVersionNumber),
                    additionalProperties.toMutableMap(),
                )
        }
         ...
         */
        internal fun validity(): Int =
            (if (planVersionDescription.asKnown() == null) 0 else 1) +
                (if (planVersionNumber.asKnown() == null) 0 else 1)
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Properties &&
                planVersionDescription == other.planVersionDescription &&
                planVersionNumber == other.planVersionNumber &&
                additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy {
            Objects.hash(planVersionDescription, planVersionNumber, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Properties{planVersionDescription=$planVersionDescription, planVersionNumber=$planVersionNumber, additionalProperties=$additionalProperties}"
    }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val PLAN_VERSION_CREATED = of("plan.version_created")
        ...
        fun value(): Value =
            when (this) {
                PLAN_VERSION_CREATED -> Value.PLAN_VERSION_CREATED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                PLAN_VERSION_CREATED -> Known.PLAN_VERSION_CREATED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PlanVersionCreatedWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "PlanVersionCreatedWebhookEvent{id=$id, createdAt=$createdAt, plan=$plan, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}

...
class SubscriptionCreatedWebhookEvent
...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = subscriptionCreatedWebhookEvent.properties().convert(MyClass::class.java)
     * ```
     */
    ...
    /** A builder for [SubscriptionCreatedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionCreatedWebhookEvent: SubscriptionCreatedWebhookEvent) =
            apply {
                id = subscriptionCreatedWebhookEvent.id
                createdAt = subscriptionCreatedWebhookEvent.createdAt
                properties = subscriptionCreatedWebhookEvent.properties
                subscription = subscriptionCreatedWebhookEvent.subscription
                type = subscriptionCreatedWebhookEvent.type
                additionalProperties =
                    subscriptionCreatedWebhookEvent.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SubscriptionCreatedWebhookEvent].
         *
         ...
         */
        fun build(): SubscriptionCreatedWebhookEvent =
            SubscriptionCreatedWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): SubscriptionCreatedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val SUBSCRIPTION_CREATED = of("subscription.created")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionCreatedWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "SubscriptionCreatedWebhookEvent{id=$id, createdAt=$createdAt, properties=$properties, subscription=$subscription, type=$type, additionalProperties=$additionalProperties}"
}

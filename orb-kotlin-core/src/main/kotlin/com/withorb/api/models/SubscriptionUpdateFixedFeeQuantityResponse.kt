...
@NoAutoDetect
class SubscriptionUpdateFixedFeeQuantityResponse @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionUpdateFixedFeeQuantityResponse: SubscriptionUpdateFixedFeeQuantityResponse) =
            apply {
                ...
                adjustmentIntervals = subscriptionUpdateFixedFeeQuantityResponse.adjustmentIntervals.map { it.toMutableList() }
                autoCollection = subscriptionUpdateFixedFeeQuantityResponse.autoCollection
                billingCycleAnchorConfiguration = subscriptionUpdateFixedFeeQuantityResponse.billingCycleAnchorConfiguration
                ...
                currentBillingPeriodEndDate = subscriptionUpdateFixedFeeQuantityResponse.currentBillingPeriodEndDate
                currentBillingPeriodStartDate = subscriptionUpdateFixedFeeQuantityResponse.currentBillingPeriodStartDate
                ...
                discountIntervals = subscriptionUpdateFixedFeeQuantityResponse.discountIntervals.map { it.toMutableList() }
                endDate = subscriptionUpdateFixedFeeQuantityResponse.endDate
                fixedFeeQuantitySchedule = subscriptionUpdateFixedFeeQuantityResponse.fixedFeeQuantitySchedule.map { it.toMutableList() }
                invoicingThreshold = subscriptionUpdateFixedFeeQuantityResponse.invoicingThreshold
                maximumIntervals = subscriptionUpdateFixedFeeQuantityResponse.maximumIntervals.map { it.toMutableList() }
                metadata = subscriptionUpdateFixedFeeQuantityResponse.metadata
                minimumIntervals = subscriptionUpdateFixedFeeQuantityResponse.minimumIntervals.map { it.toMutableList() }
                netTerms = subscriptionUpdateFixedFeeQuantityResponse.netTerms
                plan = subscriptionUpdateFixedFeeQuantityResponse.plan
                priceIntervals = subscriptionUpdateFixedFeeQuantityResponse.priceIntervals.map { it.toMutableList() }
                ...
                additionalProperties = subscriptionUpdateFixedFeeQuantityResponse.additionalProperties.toMutableMap()
            }

...
class CustomerCreditLedgerCreateEntryParams constructor(
  ...
  private val additionalHeaders: Map<String, List<String>>,
    ...
    class CustomerCreditLedgerCreateEntryBody internal constructor(
      ...
      private val _json: JsonValue? = null,
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is CustomerCreditLedgerCreateEntryBody &&
        ...
        override fun toString(): String {
          return when {
              addIncrementCreditLedgerEntryRequestParams != null -> "CustomerCreditLedgerCreateEntryBody{addIncrementCreditLedgerEntryRequestParams=$addIncrementCreditLedgerEntryRequestParams}"
              addDecrementCreditLedgerEntryRequestParams != null -> "CustomerCreditLedgerCreateEntryBody{addDecrementCreditLedgerEntryRequestParams=$addDecrementCreditLedgerEntryRequestParams}"
              addExpirationChangeCreditLedgerEntryRequestParams != null -> "CustomerCreditLedgerCreateEntryBody{addExpirationChangeCreditLedgerEntryRequestParams=$addExpirationChangeCreditLedgerEntryRequestParams}"
              addVoidCreditLedgerEntryRequestParams != null -> "CustomerCreditLedgerCreateEntryBody{addVoidCreditLedgerEntryRequestParams=$addVoidCreditLedgerEntryRequestParams}"
              addAmendmentCreditLedgerEntryRequestParams != null -> "CustomerCreditLedgerCreateEntryBody{addAmendmentCreditLedgerEntryRequestParams=$addAmendmentCreditLedgerEntryRequestParams}"
        ...
        companion object {
            ...
            fun ofAddIncrementCreditLedgerEntryRequestParams(addIncrementCreditLedgerEntryRequestParams: AddIncrementCreditLedgerEntryRequestParams) = CustomerCreditLedgerCreateEntryBody(addIncrementCreditLedgerEntryRequestParams = addIncrementCreditLedgerEntryRequestParams)

            fun ofAddDecrementCreditLedgerEntryRequestParams(addDecrementCreditLedgerEntryRequestParams: AddDecrementCreditLedgerEntryRequestParams) = CustomerCreditLedgerCreateEntryBody(addDecrementCreditLedgerEntryRequestParams = addDecrementCreditLedgerEntryRequestParams)

            fun ofAddExpirationChangeCreditLedgerEntryRequestParams(addExpirationChangeCreditLedgerEntryRequestParams: AddExpirationChangeCreditLedgerEntryRequestParams) = CustomerCreditLedgerCreateEntryBody(addExpirationChangeCreditLedgerEntryRequestParams = addExpirationChangeCreditLedgerEntryRequestParams)

            fun ofAddVoidCreditLedgerEntryRequestParams(addVoidCreditLedgerEntryRequestParams: AddVoidCreditLedgerEntryRequestParams) = CustomerCreditLedgerCreateEntryBody(addVoidCreditLedgerEntryRequestParams = addVoidCreditLedgerEntryRequestParams)

            fun ofAddAmendmentCreditLedgerEntryRequestParams(addAmendmentCreditLedgerEntryRequestParams: AddAmendmentCreditLedgerEntryRequestParams) = CustomerCreditLedgerCreateEntryBody(addAmendmentCreditLedgerEntryRequestParams = addAmendmentCreditLedgerEntryRequestParams)
        }
        ...
        class Deserializer : BaseDeserializer<CustomerCreditLedgerCreateEntryBody>(CustomerCreditLedgerCreateEntryBody::class) {

            override fun ObjectCodec.deserialize(node: JsonNode): CustomerCreditLedgerCreateEntryBody {
              val json = JsonValue.fromJsonNode(node)
              tryDeserialize(node, jacksonTypeRef<AddIncrementCreditLedgerEntryRequestParams>())?.let {
                  return CustomerCreditLedgerCreateEntryBody(addIncrementCreditLedgerEntryRequestParams = it, _json = json)
              }
              tryDeserialize(node, jacksonTypeRef<AddDecrementCreditLedgerEntryRequestParams>())?.let {
                  return CustomerCreditLedgerCreateEntryBody(addDecrementCreditLedgerEntryRequestParams = it, _json = json)
              }
              tryDeserialize(node, jacksonTypeRef<AddExpirationChangeCreditLedgerEntryRequestParams>())?.let {
                  return CustomerCreditLedgerCreateEntryBody(addExpirationChangeCreditLedgerEntryRequestParams = it, _json = json)
              }
              tryDeserialize(node, jacksonTypeRef<AddVoidCreditLedgerEntryRequestParams>())?.let {
                  return CustomerCreditLedgerCreateEntryBody(addVoidCreditLedgerEntryRequestParams = it, _json = json)
              }
              tryDeserialize(node, jacksonTypeRef<AddAmendmentCreditLedgerEntryRequestParams>())?.let {
                  return CustomerCreditLedgerCreateEntryBody(addAmendmentCreditLedgerEntryRequestParams = it, _json = json)
              }
        ...
        class Serializer : BaseSerializer<CustomerCreditLedgerCreateEntryBody>(CustomerCreditLedgerCreateEntryBody::class) {

            override fun serialize(value: CustomerCreditLedgerCreateEntryBody, generator: JsonGenerator, provider: SerializerProvider) {
              when {
    ...
    class Builder {
        ...
        internal fun from(customerCreditLedgerCreateEntryParams: CustomerCreditLedgerCreateEntryParams) = apply {
            this.customerId = customerCreditLedgerCreateEntryParams.customerId
            this.addIncrementCreditLedgerEntryRequestParams = customerCreditLedgerCreateEntryParams.addIncrementCreditLedgerEntryRequestParams
            this.addDecrementCreditLedgerEntryRequestParams = customerCreditLedgerCreateEntryParams.addDecrementCreditLedgerEntryRequestParams
            this.addExpirationChangeCreditLedgerEntryRequestParams = customerCreditLedgerCreateEntryParams.addExpirationChangeCreditLedgerEntryRequestParams
            this.addVoidCreditLedgerEntryRequestParams = customerCreditLedgerCreateEntryParams.addVoidCreditLedgerEntryRequestParams
            this.addAmendmentCreditLedgerEntryRequestParams = customerCreditLedgerCreateEntryParams.addAmendmentCreditLedgerEntryRequestParams
        ...
        fun build(): CustomerCreditLedgerCreateEntryParams = CustomerCreditLedgerCreateEntryParams(

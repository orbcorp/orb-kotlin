...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionChangeApplyResponse: SubscriptionChangeApplyResponse) =
            apply {
                ...
                changeType = subscriptionChangeApplyResponse.changeType
                ...
                billingCycleAlignment = subscriptionChangeApplyResponse.billingCycleAlignment
                cancelledAt = subscriptionChangeApplyResponse.cancelledAt
                changeOption = subscriptionChangeApplyResponse.changeOption
                effectiveDate = subscriptionChangeApplyResponse.effectiveDate
                planId = subscriptionChangeApplyResponse.planId
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionChangeApplyResponse &&
            id == other.id &&

...
private constructor(
    ...
    private constructor(
         ...
         */
        fun activePlanPhaseOrder(): Long? =
            activePlanPhaseOrder.getNullable("active_plan_phase_order")
        ...
        fun changedResources(): ChangedResources? =
            changedResources.getNullable("changed_resources")
         ...
         *
         * Unlike [activePlanPhaseOrder], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("active_plan_phase_order")
        @ExcludeMissing
         ...
         *
         * Unlike [adjustmentIntervals], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("adjustment_intervals")
        @ExcludeMissing
         ...
         *
         * Unlike [priceIntervals], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("price_intervals")
        @ExcludeMissing
         ...
         *
         * Unlike [redeemedCoupon], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("redeemed_coupon")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            private var fixedFeeQuantitySchedule:
                JsonField<MutableList<FixedFeeQuantitySchedule>>? =
                null
            ...
            internal fun from(subscription: Subscription) = apply {
                ...
                changedResources = subscription.changedResources
             ...
             * `List<AdjustmentInterval>` value instead. This method is primarily for setting the
             ...
             * plan's behavior. If null, defaults to the customer's setting.
             */
            ...
            /**
             * The end of the current billing period. This is an exclusive timestamp, such that the
             * instant returned is not part of the billing period. Set to null for subscriptions
             ...
             * instant returned is exactly the beginning of the billing period. Set to null if the
             ...
             * relationship.
             *
             * In Orb, customers are assigned system generated identifiers automatically, but it's
             * often desirable to have these match existing identifiers in your system. To avoid
             * having to denormalize Orb ID information, you can pass in an `external_customer_id`
             * with your own identifier. See
             * [Customer ID Aliases](/events-and-metrics/customer-aliases) for further information
             * about how these aliases work in Orb.
             *
             * In addition to having an identifier in your system, a customer may exist in a payment
             * provider solution like Stripe. Use the `payment_provider_id` and the
             * `payment_provider` enum field to express this mapping.
             *
             * A customer also has a timezone (from the standard
             * [IANA timezone database](https://www.iana.org/time-zones)), which defaults to your
             * account's timezone. See [Timezone localization](/essentials/timezones) for
             ...
             * `List<DiscountInterval>` value instead. This method is primarily for setting the
             * field to an undocumented or not yet supported value.
             */
            @Deprecated("deprecated")
             ...
             * `List<FixedFeeQuantitySchedule>` value instead. This method is primarily for setting
             * the field to an undocumented or not yet supported value.
             */
             ...
             * `List<MaximumInterval>` value instead. This method is primarily for setting the field
             ...
             * `List<MinimumInterval>` value instead. This method is primarily for setting the field
             * to an undocumented or not yet supported value.
             */
            @Deprecated("deprecated")
             ...
             * [PendingSubscriptionChange] value instead. This method is primarily for setting the
             * field to an undocumented or not yet supported value.
             */
            ...
            /**
             * The [Plan](/core-concepts#plan-and-price) resource represents a plan that can be
             * subscribed to by a customer. Plans define the billing behavior of the subscription.
             * You can see more about how to configure prices in the
             ...
             *
             * You should usually call [Builder.priceIntervals] with a well-typed
             * `List<PriceInterval>` value instead. This method is primarily for setting the field
             * to an undocumented or not yet supported value.
             */
             ...
             *
             * You should usually call [Builder.redeemedCoupon] with a well-typed [RedeemedCoupon]
             ...
             *
             * You should usually call [Builder.trialInfo] with a well-typed [TrialInfo] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            ...
            /**
             * The resources that were changed as part of this operation. Only present when fetched
             * through the subscription changes API or if the `include_changed_resources` parameter
             ...
             * [ChangedResources] value instead. This method is primarily for setting the field to
            ...
            fun build(): Subscription =
                Subscription(
                    ...
                    checkRequired("adjustmentIntervals", adjustmentIntervals).map {
                        it.toImmutable()
                    },
        ...
        internal fun validity(): Int =
            (if (id.asKnown() == null) 0 else 1) +
                (if (activePlanPhaseOrder.asKnown() == null) 0 else 1) +
                (adjustmentIntervals.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
                ...
                (discountIntervals.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
                (if (endDate.asKnown() == null) 0 else 1) +
                (fixedFeeQuantitySchedule.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
                (if (invoicingThreshold.asKnown() == null) 0 else 1) +
                (maximumIntervals.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
                ...
                (status.asKnown()?.validity() ?: 0) +
                (trialInfo.asKnown()?.validity() ?: 0) +
                (changedResources.asKnown()?.validity() ?: 0)
        ...
        private constructor(
             ...
             *
             * Unlike [adjustment], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("adjustment")
            @ExcludeMissing
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    class Builder internal constructor() {
                        ...
                        /**
                         * True for adjustments that apply to an entire invocice, false for
                         ...
                         *
                         * You should usually call [Builder.usageDiscount] with a well-typed
                ...
                private constructor(
                    ...
                    class Builder internal constructor() {
                         ...
                         *
                         * You should usually call [Builder.amountDiscount] with a well-typed
                ...
                private constructor(
                     ...
                     *
                     * Unlike [percentageDiscount], this method doesn't throw if the JSON field has
                     * an unexpected type.
                     */
                    @JsonProperty("percentage_discount")
                    @ExcludeMissing
                    ...
                    class Builder internal constructor() {
                         ...
                         * price intervals this adjustment applies to in a given billing period.
                         */
                ...
                private constructor(
                     ...
                     *
                     * Unlike [itemId], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("item_id")
                    @ExcludeMissing
                    ...
                    class Builder internal constructor() {
                        ...
                        /**
                         * The minimum amount to charge in a given billing period for the prices
                ...
                private constructor(
                    ...
                    class Builder internal constructor() {
                        ...
                        /**
                         * The maximum amount to charge in a given billing period for the prices
                         * this adjustment applies to.
                         */
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.day] with a well-typed [Long] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.month] with a well-typed [Long] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
             ...
             */
            internal fun validity(): Int =
                (if (day.asKnown() == null) 0 else 1) +
                    (if (month.asKnown() == null) 0 else 1) +
        ...
        private constructor(
            ...
            internal class Deserializer :
                BaseDeserializer<DiscountInterval>(DiscountInterval::class) {
            ...
            private constructor(
                 ...
                 * Returns the raw JSON value of [appliesToPriceIntervalIds].
                 *
                 * Unlike [appliesToPriceIntervalIds], this method doesn't throw if the JSON field
                 * has an unexpected type.
                 */
                @JsonProperty("applies_to_price_interval_ids")
                @ExcludeMissing
                fun _appliesToPriceIntervalIds(): JsonField<List<String>> =
                    appliesToPriceIntervalIds
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(amount: Amount) = apply {
                        ...
                        filters = amount.filters.map { it.toMutableList() }
                     ...
                     * to an undocumented or not yet supported value.
                     */
                    fun appliesToPriceIntervalIds(
                        appliesToPriceIntervalIds: JsonField<List<String>>
                    ) = apply {
                        this.appliesToPriceIntervalIds =
                            appliesToPriceIntervalIds.map { it.toMutableList() }
                    }
                    ...
                    fun build(): Amount =
                        Amount(
                            checkRequired("amountDiscount", amountDiscount),
                            checkRequired("appliesToPriceIntervalIds", appliesToPriceIntervalIds)
                                .map { it.toImmutable() },
                            discountType,
                            checkRequired("endDate", endDate),
                            checkRequired("filters", filters).map { it.toImmutable() },
                ...
                override fun equals(other: Any?): Boolean {
                    ...
                    return /* spotless:off */ other is Amount && amountDiscount == other.amountDiscount && appliesToPriceIntervalIds == other.appliesToPriceIntervalIds && discountType == other.discountType && endDate == other.endDate && filters == other.filters && startDate == other.startDate && additionalProperties == other.additionalProperties /* spotless:on */
                }
                ...
                override fun toString() =
                    "Amount{amountDiscount=$amountDiscount, appliesToPriceIntervalIds=$appliesToPriceIntervalIds, discountType=$discountType, endDate=$endDate, filters=$filters, startDate=$startDate, additionalProperties=$additionalProperties}"
            }
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(percentage: Percentage) = apply {
                        ...
                        filters = percentage.filters.map { it.toMutableList() }
                ...
                override fun toString() =
                    "Percentage{appliesToPriceIntervalIds=$appliesToPriceIntervalIds, discountType=$discountType, endDate=$endDate, filters=$filters, percentageDiscount=$percentageDiscount, startDate=$startDate, additionalProperties=$additionalProperties}"
            }
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(usage: Usage) = apply {
                        ...
                        filters = usage.filters.map { it.toMutableList() }
                ...
                override fun equals(other: Any?): Boolean {
                    ...
                    return /* spotless:off */ other is Usage && appliesToPriceIntervalIds == other.appliesToPriceIntervalIds && discountType == other.discountType && endDate == other.endDate && filters == other.filters && startDate == other.startDate && usageDiscount == other.usageDiscount && additionalProperties == other.additionalProperties /* spotless:on */
                }
                ...
                override fun toString() =
                    "Usage{appliesToPriceIntervalIds=$appliesToPriceIntervalIds, discountType=$discountType, endDate=$endDate, filters=$filters, startDate=$startDate, usageDiscount=$usageDiscount, additionalProperties=$additionalProperties}"
            }
        }
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                internal fun from(fixedFeeQuantitySchedule: FixedFeeQuantitySchedule) = apply {
                    ...
                    additionalProperties =
                        fixedFeeQuantitySchedule.additionalProperties.toMutableMap()
                }
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                internal fun from(pendingSubscriptionChange: PendingSubscriptionChange) = apply {
                    ...
                    additionalProperties =
                        pendingSubscriptionChange.additionalProperties.toMutableMap()
                }
        ...
        private constructor(
             ...
             * Returns the raw JSON value of [billingCycleDay].
             *
             * Unlike [billingCycleDay], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("billing_cycle_day")
            @ExcludeMissing
             ...
             * Returns the raw JSON value of [currentBillingPeriodEndDate].
             *
             * Unlike [currentBillingPeriodEndDate], this method doesn't throw if the JSON field has
             * an unexpected type.
             */
            @JsonProperty("current_billing_period_end_date")
            @ExcludeMissing
            fun _currentBillingPeriodEndDate(): JsonField<OffsetDateTime> =
                currentBillingPeriodEndDate

            /**
             * Returns the raw JSON value of [currentBillingPeriodStartDate].
             *
             * Unlike [currentBillingPeriodStartDate], this method doesn't throw if the JSON field
             * has an unexpected type.
             */
            @JsonProperty("current_billing_period_start_date")
            @ExcludeMissing
             ...
             *
             * Unlike [fixedFeeQuantityTransitions], this method doesn't throw if the JSON field has
             * an unexpected type.
             */
            @JsonProperty("fixed_fee_quantity_transitions")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                /**
                 * The start date of the current billing period. This is an inclusive timestamp; the
                 * instant returned is exactly the beginning of the billing period. Set to null if
                 * this price interval is not currently active.
                 */
                fun currentBillingPeriodStartDate(currentBillingPeriodStartDate: OffsetDateTime?) =
                    currentBillingPeriodStartDate(
                        JsonField.ofNullable(currentBillingPeriodStartDate)
                    )
                ...
                fun build(): PriceInterval =
                    PriceInterval(
                        ...
                        checkRequired("fixedFeeQuantityTransitions", fixedFeeQuantityTransitions)
                            .map { it.toImmutable() },
            ...
            private constructor(
                 ...
                 *
                 * Unlike [effectiveDate], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("effective_date")
                @ExcludeMissing
                 ...
                 * Returns the raw JSON value of [priceId].
                 *
                 * Unlike [priceId], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                @JsonProperty("price_id")
                @ExcludeMissing
        ...
        private constructor(
             ...
             *
             * Unlike [couponId], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.couponId] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
        ...
        private constructor(
             ...
             * Used for best match union deserialization.
             */
            internal fun validity(): Int = (if (endDate.asKnown() == null) 0 else 1)
        ...
        private constructor(
             ...
             *
             * Unlike [createdInvoices], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("created_invoices")
            @ExcludeMissing
             ...
             *
             * Unlike [voidedCreditNotes], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("voided_credit_notes")
            @ExcludeMissing
             ...
             *
             * Unlike [voidedInvoices], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("voided_invoices")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                internal fun from(changedResources: ChangedResources) = apply {
                    createdCreditNotes =
                        changedResources.createdCreditNotes.map { it.toMutableList() }
                    createdInvoices = changedResources.createdInvoices.map { it.toMutableList() }
                    voidedCreditNotes =
                        changedResources.voidedCreditNotes.map { it.toMutableList() }
                 ...
                 * `List<CreditNote>` value instead. This method is primarily for setting the field
                 * to an undocumented or not yet supported value.
                 */
                 ...
                 * `List<Invoice>` value instead. This method is primarily for setting the field to
                 * an undocumented or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.voidedInvoices] with a well-typed
                 * `List<Invoice>` value instead. This method is primarily for setting the field to
                 * an undocumented or not yet supported value.
                 */
                ...
                fun build(): ChangedResources =
                    ChangedResources(
                        ...
                        checkRequired("voidedCreditNotes", voidedCreditNotes).map {
                            it.toImmutable()
                        },
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is SubscriptionChangeApplyResponse && id == other.id && expirationTime == other.expirationTime && status == other.status && subscription == other.subscription && appliedAt == other.appliedAt && cancelledAt == other.cancelledAt && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "SubscriptionChangeApplyResponse{id=$id, expirationTime=$expirationTime, status=$status, subscription=$subscription, appliedAt=$appliedAt, cancelledAt=$cancelledAt, additionalProperties=$additionalProperties}"
}

 ...
 */
@NoAutoDetect
class EventBackfillFetchResponse @JsonCreator private constructor(
    ...
    fun validate(): EventBackfillFetchResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    /** A builder for [EventBackfillFetchResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(eventBackfillFetchResponse: EventBackfillFetchResponse) =
            apply {
                ...
                replaceExistingEvents = eventBackfillFetchResponse.replaceExistingEvents

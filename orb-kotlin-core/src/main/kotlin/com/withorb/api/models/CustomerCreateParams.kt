...
class CustomerCreateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class CustomerCreateBody internal constructor(
      private val email: String?,
      private val name: String?,
      private val accountingSyncConfiguration: AccountingSyncConfiguration?,
      private val additionalEmails: List<String>?,
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
             ...
             */
            @JsonProperty("timezone")
            fun timezone(timezone: String) = apply {
            ...
            fun build(): CustomerCreateBody = CustomerCreateBody(
                checkNotNull(email) {
    ...
    class Builder {
        ...
        fun build(): CustomerCreateParams = CustomerCreateParams(
            checkNotNull(email) {
                "`email` is required but was not set"
            },
            checkNotNull(name) {

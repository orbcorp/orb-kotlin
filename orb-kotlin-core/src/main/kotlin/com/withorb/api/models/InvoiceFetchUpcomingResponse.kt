...
@NoAutoDetect
class InvoiceFetchUpcomingResponse @JsonCreator private constructor(
    ...
    @JsonProperty("target_date") @ExcludeMissing private val targetDate: JsonField<OffsetDateTime> = JsonMissing.of(),
    ...
    fun validate(): InvoiceFetchUpcomingResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(invoiceFetchUpcomingResponse: InvoiceFetchUpcomingResponse) =
            apply {
                ...
                customerBalanceTransactions = invoiceFetchUpcomingResponse.customerBalanceTransactions.map { it.toMutableList() }
                ...
                paymentAttempts = invoiceFetchUpcomingResponse.paymentAttempts.map { it.toMutableList() }
        ...
        /** The scheduled date of the invoice */
        fun targetDate(targetDate: JsonField<OffsetDateTime>) =
            apply {
    ...
    class CustomerBalanceTransaction @JsonCreator private constructor(
        ...
        @JsonProperty("invoice") @ExcludeMissing private val invoice: JsonField<Invoice> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            fun invoice(invoice: JsonField<Invoice>) =
                apply {

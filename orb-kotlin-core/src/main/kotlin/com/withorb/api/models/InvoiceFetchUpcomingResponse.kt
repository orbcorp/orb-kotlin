...
@NoAutoDetect
class InvoiceFetchUpcomingResponse private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    class Builder {
        ...
        internal fun from(invoiceFetchUpcomingResponse: InvoiceFetchUpcomingResponse) = apply {
            ...
            this.customerBalanceTransactions = invoiceFetchUpcomingResponse.customerBalanceTransactions
        ...
        fun build(): InvoiceFetchUpcomingResponse = InvoiceFetchUpcomingResponse(
            metadata,
            voidedAt,
            paidAt,
            issuedAt,

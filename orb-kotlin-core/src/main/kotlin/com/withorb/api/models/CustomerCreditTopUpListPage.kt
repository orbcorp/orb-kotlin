...
/** List top-ups */
class CustomerCreditTopUpListPage private constructor(
    ...
    companion object {
        ...
        fun of(topUpsService: TopUpService, params: CustomerCreditTopUpListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<CustomerCreditTopUpListResponse>> = JsonMissing.of(),
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<CustomerCreditTopUpListResponse> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {

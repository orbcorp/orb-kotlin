...
class CustomerCreditTopUpListByExternalIdPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(topUpsService: TopUpServiceAsync, params: CustomerCreditTopUpListByExternalIdParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<CustomerCreditTopUpListByExternalIdResponse>> = JsonMissing.of(),

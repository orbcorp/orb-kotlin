...
private constructor(private val value: JsonField<String>) : Enum {
     ...
     * member.
     *
     * An instance of [BillingCycleRelativeDate] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        END_OF_TERM,
        /**
         * An enum member indicating that [BillingCycleRelativeDate] was instantiated with an
         * unknown value.
         */
        _UNKNOWN,
    }

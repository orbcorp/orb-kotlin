...
class BillingCycleRelativeDate @JsonCreator private constructor(
    ...
    /** An enum containing [BillingCycleRelativeDate]'s known values. */
    enum class Known {
        START_OF_TERM,
        END_OF_TERM,
    }
    ...
    /**
     * An enum containing [BillingCycleRelativeDate]'s known values, as well as an
     * [_UNKNOWN] member.
     *
     * An instance of [BillingCycleRelativeDate] can contain an unknown value in a
     * couple of cases:
     *
    ...
    enum class Value {
        ...
        END_OF_TERM,
        /**
         * An enum member indicating that [BillingCycleRelativeDate] was instantiated with
         * an unknown value.
         */
        _UNKNOWN,
    }

 ...
 */
@NoAutoDetect
class Coupon @JsonCreator private constructor(
    ...
    @JsonProperty("times_redeemed") @ExcludeMissing private val timesRedeemed: JsonField<Long> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        internal fun from(coupon: Coupon) =
            apply {
                id = coupon.id
        ...
        /** The number of times this coupon has been redeemed. */
        fun timesRedeemed(timesRedeemed: JsonField<Long>) =
            apply {
    ...
    override fun toString() = "Coupon{id=$id, archivedAt=$archivedAt, discount=$discount, durationInMonths=$durationInMonths, maxRedemptions=$maxRedemptions, redemptionCode=$redemptionCode, timesRedeemed=$timesRedeemed, additionalProperties=$additionalProperties}"
}

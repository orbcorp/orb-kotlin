 ...
 */
class InvoiceRegenerateInvoicePdfParams
private constructor(
    ...
    companion object {
        ...
        fun none(): InvoiceRegenerateInvoicePdfParams = builder().build()
    ...
    /** A builder for [InvoiceRegenerateInvoicePdfParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(invoiceRegenerateInvoicePdfParams: InvoiceRegenerateInvoicePdfParams) =
            apply {
                invoiceId = invoiceRegenerateInvoicePdfParams.invoiceId
                additionalHeaders = invoiceRegenerateInvoicePdfParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    invoiceRegenerateInvoicePdfParams.additionalQueryParams.toBuilder()
                additionalBodyProperties =
                    invoiceRegenerateInvoicePdfParams.additionalBodyProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [InvoiceRegenerateInvoicePdfParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): InvoiceRegenerateInvoicePdfParams =
            InvoiceRegenerateInvoicePdfParams(
                invoiceId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InvoiceRegenerateInvoicePdfParams &&
    ...
    override fun toString() =
        "InvoiceRegenerateInvoicePdfParams{invoiceId=$invoiceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}

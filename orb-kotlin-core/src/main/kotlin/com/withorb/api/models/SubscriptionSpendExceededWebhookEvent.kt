 ...
 */
class SubscriptionSpendExceededWebhookEvent
...
private constructor(
    ...
    /** A builder for [SubscriptionSpendExceededWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            subscriptionSpendExceededWebhookEvent: SubscriptionSpendExceededWebhookEvent
        ) = apply {
            id = subscriptionSpendExceededWebhookEvent.id
            createdAt = subscriptionSpendExceededWebhookEvent.createdAt
            properties = subscriptionSpendExceededWebhookEvent.properties
            subscription = subscriptionSpendExceededWebhookEvent.subscription
            type = subscriptionSpendExceededWebhookEvent.type
            additionalProperties =
                subscriptionSpendExceededWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubscriptionSpendExceededWebhookEvent].
         *
         ...
         */
        fun build(): SubscriptionSpendExceededWebhookEvent =
            SubscriptionSpendExceededWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): SubscriptionSpendExceededWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val SUBSCRIPTION_SPEND_EXCEEDED = of("subscription.spend_exceeded")
        ...
        fun value(): Value =
            when (this) {
                SUBSCRIPTION_SPEND_EXCEEDED -> Value.SUBSCRIPTION_SPEND_EXCEEDED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                SUBSCRIPTION_SPEND_EXCEEDED -> Known.SUBSCRIPTION_SPEND_EXCEEDED
                else -> throw OrbInvalidDataException("Unknown Type: $value")
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionSpendExceededWebhookEvent &&
            id == other.id &&
            createdAt == other.createdAt &&
    ...
    override fun toString() =
        "SubscriptionSpendExceededWebhookEvent{id=$id, createdAt=$createdAt, properties=$properties, subscription=$subscription, type=$type, additionalProperties=$additionalProperties}"
}

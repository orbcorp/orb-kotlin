...
@NoAutoDetect
class CustomerCostListByExternalIdResponse @JsonCreator private constructor(
    ...
    fun validate(): CustomerCostListByExternalIdResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(customerCostListByExternalIdResponse: CustomerCostListByExternalIdResponse) =
            apply {
                data = customerCostListByExternalIdResponse.data.map { it.toMutableList() }
                additionalProperties = customerCostListByExternalIdResponse.additionalProperties.toMutableMap()
            }
    ...
    class Data @JsonCreator private constructor(
        @JsonProperty("per_price_costs") @ExcludeMissing private val perPriceCosts: JsonField<List<PerPriceCost>> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
            ...
            fun perPriceCosts(perPriceCosts: List<PerPriceCost>) = perPriceCosts(JsonField.of(perPriceCosts))

            fun perPriceCosts(perPriceCosts: JsonField<List<PerPriceCost>>) =
                apply {
                    this.perPriceCosts = perPriceCosts.map { it.toMutableList() }
                }

            fun addPerPriceCost(perPriceCost: PerPriceCost) =
                apply {
                    perPriceCosts = (perPriceCosts ?: JsonField.of(mutableListOf())).also {
        ...
        @NoAutoDetect
        class PerPriceCost @JsonCreator private constructor(
            ...
            class Builder internal constructor() {
                ...
                internal fun from(perPriceCost: PerPriceCost) =
                    apply {
            ...
            override fun toString() = "PerPriceCost{price=$price, priceId=$priceId, subtotal=$subtotal, total=$total, quantity=$quantity, additionalProperties=$additionalProperties}"
        }
        ...
        override fun toString() = "Data{perPriceCosts=$perPriceCosts, subtotal=$subtotal, timeframeEnd=$timeframeEnd, timeframeStart=$timeframeStart, total=$total, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() = "CustomerCostListByExternalIdResponse{data=$data, additionalProperties=$additionalProperties}"
}

...
@JsonDeserialize(builder = CustomerCostListByExternalIdResponse.Builder::class)
@NoAutoDetect
class CustomerCostListByExternalIdResponse private constructor(private val data: JsonField<List<Data>>, private val additionalProperties: Map<String, JsonValue>, ) {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is CustomerCostListByExternalIdResponse &&
    ...
    class Builder {
        ...
        internal fun from(customerCostListByExternalIdResponse: CustomerCostListByExternalIdResponse) = apply {
        ...
        fun build(): CustomerCostListByExternalIdResponse = CustomerCostListByExternalIdResponse(data.map { it.toUnmodifiable() }, additionalProperties.toUnmodifiable())
    }
    ...
    class Data private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        @ExcludeMissing
        fun _perPriceCosts() = perPriceCosts
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is Data &&
              ...
              this.perPriceCosts == other.perPriceCosts &&
              this.additionalProperties == other.additionalProperties
        }
        ...
        override fun toString() = "Data{subtotal=$subtotal, total=$total, timeframeStart=$timeframeStart, timeframeEnd=$timeframeEnd, perPriceCosts=$perPriceCosts, additionalProperties=$additionalProperties}"
        ...
        @NoAutoDetect
        class PerPriceCost private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            override fun toString() = "PerPriceCost{quantity=$quantity, subtotal=$subtotal, total=$total, price=$price, additionalProperties=$additionalProperties}"
            ...
            class Builder {
                ...
                fun build(): PerPriceCost = PerPriceCost(
                    quantity,
                    subtotal,
                    total,
                    price,

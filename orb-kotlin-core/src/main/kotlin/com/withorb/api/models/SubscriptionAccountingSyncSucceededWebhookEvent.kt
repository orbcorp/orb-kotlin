...
class SubscriptionAccountingSyncSucceededWebhookEvent
...
private constructor(
    ...
    /** A builder for [SubscriptionAccountingSyncSucceededWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = subscriptionAccountingSyncSucceededWebhookEvent.id
            accountingSyncRecord =
                subscriptionAccountingSyncSucceededWebhookEvent.accountingSyncRecord
            createdAt = subscriptionAccountingSyncSucceededWebhookEvent.createdAt
            properties = subscriptionAccountingSyncSucceededWebhookEvent.properties
            subscription = subscriptionAccountingSyncSucceededWebhookEvent.subscription
            type = subscriptionAccountingSyncSucceededWebhookEvent.type
            additionalProperties =
                subscriptionAccountingSyncSucceededWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubscriptionAccountingSyncSucceededWebhookEvent].
         *
         ...
         */
        fun build(): SubscriptionAccountingSyncSucceededWebhookEvent =
            SubscriptionAccountingSyncSucceededWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): SubscriptionAccountingSyncSucceededWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val SUBSCRIPTION_ACCOUNTING_SYNC_SUCCEEDED =
                of("subscription.accounting_sync_succeeded")
        ...
        fun value(): Value =
            when (this) {
                SUBSCRIPTION_ACCOUNTING_SYNC_SUCCEEDED ->
                    Value.SUBSCRIPTION_ACCOUNTING_SYNC_SUCCEEDED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                SUBSCRIPTION_ACCOUNTING_SYNC_SUCCEEDED ->
                    Known.SUBSCRIPTION_ACCOUNTING_SYNC_SUCCEEDED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionAccountingSyncSucceededWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "SubscriptionAccountingSyncSucceededWebhookEvent{id=$id, accountingSyncRecord=$accountingSyncRecord, createdAt=$createdAt, properties=$properties, subscription=$subscription, type=$type, additionalProperties=$additionalProperties}"
}

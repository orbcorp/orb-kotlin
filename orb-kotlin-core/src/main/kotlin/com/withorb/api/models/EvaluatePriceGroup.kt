...
@NoAutoDetect
class EvaluatePriceGroup private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    @ExcludeMissing
    fun _groupingValues() = groupingValues
    ...
    override fun toString() = "EvaluatePriceGroup{groupingValues=$groupingValues, quantity=$quantity, amount=$amount, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        fun build(): EvaluatePriceGroup = EvaluatePriceGroup(

...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(newSubscriptionUnitPrice: NewSubscriptionUnitPrice) = apply {
            ...
            dimensionalPriceConfiguration = newSubscriptionUnitPrice.dimensionalPriceConfiguration
         ...
         * supported value.
         */
        fun unitConfig(unitConfig: JsonField<UnitConfig>) = apply { this.unitConfig = unitConfig }
        ...
        /**
         * Returns an immutable instance of [NewSubscriptionUnitPrice].
         *

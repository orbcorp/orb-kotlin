...
private constructor(
    ...
    fun validate(): CouponModel = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CouponModel].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(couponModel: CouponModel) = apply {
            id = couponModel.id
            archivedAt = couponModel.archivedAt
            discount = couponModel.discount
            durationInMonths = couponModel.durationInMonths
            maxRedemptions = couponModel.maxRedemptions
            redemptionCode = couponModel.redemptionCode
            timesRedeemed = couponModel.timesRedeemed
            additionalProperties = couponModel.additionalProperties.toMutableMap()
        }
    ...
    override fun toString() =
        "CouponModel{id=$id, archivedAt=$archivedAt, discount=$discount, durationInMonths=$durationInMonths, maxRedemptions=$maxRedemptions, redemptionCode=$redemptionCode, timesRedeemed=$timesRedeemed, additionalProperties=$additionalProperties}"
}

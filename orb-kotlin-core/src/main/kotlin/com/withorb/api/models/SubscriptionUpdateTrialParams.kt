 ...
 * extended).
 */
class SubscriptionUpdateTrialParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("trial_end_date") @ExcludeMissing private val trialEndDate: JsonField<TrialEndDate> = JsonMissing.of(),
        @JsonProperty("shift") @ExcludeMissing private val shift: JsonField<Boolean> = JsonMissing.of(),
         ...
         * durations, but adjusting their absolute dates).
         */
        fun shift(): Boolean? = shift.getNullable("shift")
        ...
        @JsonProperty("shift")
        @ExcludeMissing
        fun _shift(): JsonField<Boolean> = shift
        ...
        class Builder internal constructor() {
             ...
             * the trial immediately.
             */
            fun trialEndDate(trialEndDate: JsonField<TrialEndDate>) =
                apply {
             ...
             * the trial immediately.
             */
            fun trialEndDate(offsetDateTime: OffsetDateTime) = trialEndDate(TrialEndDate.ofOffsetDateTime(offsetDateTime))

            /**
             * The new date that the trial should end, or the literal string `immediate` to end
             * the trial immediately.
             */
            fun trialEndDate(unionMember1: TrialEndDate.UnionMember1) = trialEndDate(TrialEndDate.ofUnionMember1(unionMember1))
             ...
             * durations, but adjusting their absolute dates).
             */
            fun shift(shift: JsonField<Boolean>) =
                apply {
                    this.shift = shift
                }
        ...
        override fun toString() = "Body{trialEndDate=$trialEndDate, shift=$shift, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionUpdateTrialParams: SubscriptionUpdateTrialParams) =
            apply {
    ...
    class TrialEndDate private constructor(
        ...
        companion object {
            ...
            fun ofOffsetDateTime(offsetDateTime: OffsetDateTime) = TrialEndDate(offsetDateTime = offsetDateTime)

            fun ofUnionMember1(unionMember1: UnionMember1) = TrialEndDate(unionMember1 = unionMember1)
        }

        /**
         * An interface that defines how to map each variant of [TrialEndDate] to a value
         * of type [T].
         */
        interface Visitor<out T> {
             ...
             *
             * An instance of [TrialEndDate] can contain an unknown variant if it was
        ...
        internal class Serializer : BaseSerializer<TrialEndDate>(TrialEndDate::class) {
            ...
            override fun serialize(value: TrialEndDate, generator: JsonGenerator, provider: SerializerProvider) {
              when {
    ...
    override fun toString() = "SubscriptionUpdateTrialParams{subscriptionId=$subscriptionId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

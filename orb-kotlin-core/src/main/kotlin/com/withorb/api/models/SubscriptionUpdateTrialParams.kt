...
private constructor(
    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (trialEndDate.asKnown()?.validity() ?: 0) + (if (shift.asKnown() == null) 0 else 1)
    ...
    private constructor(
         ...
         * import com.withorb.api.core.JsonValue
         *
         * val result: String? = trialEndDate.accept(object : TrialEndDate.Visitor<String?> {
         *     override fun visitOffsetDateTime(offsetDateTime: OffsetDateTime): String? = offsetDateTime.toString()
         *
         *     // ...
         *

...
@NoAutoDetect
class CustomerCreditTopUpCreateResponse private constructor(
  ...
  private val additionalProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "CustomerCreditTopUpCreateResponse{id=$id, currency=$currency, threshold=$threshold, amount=$amount, perUnitCostBasis=$perUnitCostBasis, invoiceSettings=$invoiceSettings, expiresAfter=$expiresAfter, expiresAfterUnit=$expiresAfterUnit, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(customerCreditTopUpCreateResponse: CustomerCreditTopUpCreateResponse) = apply {
        ...
        fun build(): CustomerCreditTopUpCreateResponse = CustomerCreditTopUpCreateResponse(
            id,
            currency,
            threshold,
            amount,

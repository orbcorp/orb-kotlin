...
@NoAutoDetect
class CustomerCreditTopUpCreateResponse @JsonCreator private constructor(
    ...
    fun validate(): CustomerCreditTopUpCreateResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(customerCreditTopUpCreateResponse: CustomerCreditTopUpCreateResponse) =
            apply {
                ...
                additionalProperties = customerCreditTopUpCreateResponse.additionalProperties.toMutableMap()
            }
    ...
    override fun toString() = "CustomerCreditTopUpCreateResponse{id=$id, amount=$amount, currency=$currency, invoiceSettings=$invoiceSettings, perUnitCostBasis=$perUnitCostBasis, threshold=$threshold, expiresAfter=$expiresAfter, expiresAfterUnit=$expiresAfterUnit, additionalProperties=$additionalProperties}"
}

...
private constructor(
    ...
    @ExcludeMissing
    private val maximumAmountAdjustment: JsonField<CreditNoteDiscountModel> = JsonMissing.of(),
    ...
    @ExcludeMissing
    private val discounts: JsonField<List<CreditNoteDiscountModel>> = JsonMissing.of(),
    ...
    fun maximumAmountAdjustment(): CreditNoteDiscountModel? =
    ...
    fun discounts(): List<CreditNoteDiscountModel>? = discounts.getNullable("discounts")
    ...
    @JsonProperty("maximum_amount_adjustment")
    @ExcludeMissing
    fun _maximumAmountAdjustment(): JsonField<CreditNoteDiscountModel> = maximumAmountAdjustment
    ...
    @JsonProperty("discounts")
    @ExcludeMissing
    fun _discounts(): JsonField<List<CreditNoteDiscountModel>> = discounts
    ...
    fun validate(): CreditNoteModel = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreditNoteModel].
         *
    ...
    class Builder internal constructor() {
        ...
        private var maximumAmountAdjustment: JsonField<CreditNoteDiscountModel>? = null
        ...
        private var discounts: JsonField<MutableList<CreditNoteDiscountModel>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(creditNoteModel: CreditNoteModel) = apply {
            id = creditNoteModel.id
            createdAt = creditNoteModel.createdAt
            creditNoteNumber = creditNoteModel.creditNoteNumber
            creditNotePdf = creditNoteModel.creditNotePdf
            customer = creditNoteModel.customer
            invoiceId = creditNoteModel.invoiceId
            lineItems = creditNoteModel.lineItems.map { it.toMutableList() }
            maximumAmountAdjustment = creditNoteModel.maximumAmountAdjustment
            memo = creditNoteModel.memo
            minimumAmountRefunded = creditNoteModel.minimumAmountRefunded
            reason = creditNoteModel.reason
            subtotal = creditNoteModel.subtotal
            total = creditNoteModel.total
            type = creditNoteModel.type
            voidedAt = creditNoteModel.voidedAt
            discounts = creditNoteModel.discounts.map { it.toMutableList() }
            additionalProperties = creditNoteModel.additionalProperties.toMutableMap()
        }
        ...
        /** The maximum amount applied on the original invoice */
        fun maximumAmountAdjustment(maximumAmountAdjustment: CreditNoteDiscountModel?) =
            maximumAmountAdjustment(JsonField.ofNullable(maximumAmountAdjustment))

        /** The maximum amount applied on the original invoice */
        fun maximumAmountAdjustment(maximumAmountAdjustment: JsonField<CreditNoteDiscountModel>) =
            apply {
        ...
        /** Any discounts applied on the original invoice. */
        fun discounts(discounts: List<CreditNoteDiscountModel>) = discounts(JsonField.of(discounts))

        /** Any discounts applied on the original invoice. */
        fun discounts(discounts: JsonField<List<CreditNoteDiscountModel>>) = apply {
            this.discounts = discounts.map { it.toMutableList() }
        }

        /** Any discounts applied on the original invoice. */
        fun addDiscount(discount: CreditNoteDiscountModel) = apply {
            discounts =

...
class ItemCreateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(itemCreateParams: ItemCreateParams) =
            apply {
    ...
    override fun toString() = "ItemCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

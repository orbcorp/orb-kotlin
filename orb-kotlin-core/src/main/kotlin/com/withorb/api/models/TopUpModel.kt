...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TopUpModel].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(topUpModel: TopUpModel) = apply {
            id = topUpModel.id
            amount = topUpModel.amount
            currency = topUpModel.currency
            invoiceSettings = topUpModel.invoiceSettings
            perUnitCostBasis = topUpModel.perUnitCostBasis
            threshold = topUpModel.threshold
            expiresAfter = topUpModel.expiresAfter
            expiresAfterUnit = topUpModel.expiresAfterUnit
            additionalProperties = topUpModel.additionalProperties.toMutableMap()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TopUpModel && id == other.id && amount == other.amount && currency == other.currency && invoiceSettings == other.invoiceSettings && perUnitCostBasis == other.perUnitCostBasis && threshold == other.threshold && expiresAfter == other.expiresAfter && expiresAfterUnit == other.expiresAfterUnit && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "TopUpModel{id=$id, amount=$amount, currency=$currency, invoiceSettings=$invoiceSettings, perUnitCostBasis=$perUnitCostBasis, threshold=$threshold, expiresAfter=$expiresAfter, expiresAfterUnit=$expiresAfterUnit, additionalProperties=$additionalProperties}"
}

...
class SubscriptionLicenseBalanceThresholdReachedWebhookEvent
...
private constructor(
    ...
    /** A builder for [SubscriptionLicenseBalanceThresholdReachedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = subscriptionLicenseBalanceThresholdReachedWebhookEvent.id
            createdAt = subscriptionLicenseBalanceThresholdReachedWebhookEvent.createdAt
            ...
            type = subscriptionLicenseBalanceThresholdReachedWebhookEvent.type
            additionalProperties =
                subscriptionLicenseBalanceThresholdReachedWebhookEvent.additionalProperties
                    .toMutableMap()
        }
         ...
         */
        fun build(): SubscriptionLicenseBalanceThresholdReachedWebhookEvent =
            SubscriptionLicenseBalanceThresholdReachedWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): SubscriptionLicenseBalanceThresholdReachedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        ) : this(alertConfiguration, licenses, timeframeEnd, timeframeStart, mutableMapOf())
        ...
        class Builder internal constructor() {
            ...
            internal fun from(properties: Properties) = apply {
                ...
                licenses = properties.licenses.map { it.toMutableList() }
        ...
        internal fun validity(): Int =
            (alertConfiguration.asKnown()?.validity() ?: 0) +
                (licenses.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
        ...
        private constructor(
            ...
            private val thresholdPercentage: JsonField<String>,
            private val additionalProperties: MutableMap<String, JsonValue>,
        ) {
            ...
            private constructor(
                ...
                @ExcludeMissing
                thresholdPercentage: JsonField<String> = JsonMissing.of(),
            ) : this(externalLicenseId, licenseTypeId, thresholdPercentage, mutableMapOf())
             ...
             *   value).
             */
            fun thresholdPercentage(): String =
                thresholdPercentage.getRequired("threshold_percentage")

            /**
             * Returns the raw JSON value of [externalLicenseId].
             *
             * Unlike [externalLicenseId], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("external_license_id")
            @ExcludeMissing
            ...
            /**
             * Returns the raw JSON value of [thresholdPercentage].
             *
             * Unlike [thresholdPercentage], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("threshold_percentage")
            @ExcludeMissing
            fun _thresholdPercentage(): JsonField<String> = thresholdPercentage
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.externalLicenseId] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                ...
                fun thresholdPercentage(thresholdPercentage: String) =
                    thresholdPercentage(JsonField.of(thresholdPercentage))

                /**
                 * Sets [Builder.thresholdPercentage] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.thresholdPercentage] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                fun thresholdPercentage(thresholdPercentage: JsonField<String>) = apply {
                ...
                fun build(): License =
                    License(
                        ...
                        checkRequired("thresholdPercentage", thresholdPercentage),
                        additionalProperties.toMutableMap(),
                    )
            }
             ...
             */
            internal fun validity(): Int =
                (if (externalLicenseId.asKnown() == null) 0 else 1) +
                    (if (licenseTypeId.asKnown() == null) 0 else 1) +
                    (if (thresholdPercentage.asKnown() == null) 0 else 1)
            ...
            override fun toString() =
                "License{externalLicenseId=$externalLicenseId, licenseTypeId=$licenseTypeId, thresholdPercentage=$thresholdPercentage, additionalProperties=$additionalProperties}"
        }
        ...
        override fun toString() =
            "Properties{alertConfiguration=$alertConfiguration, licenses=$licenses, timeframeEnd=$timeframeEnd, timeframeStart=$timeframeStart, additionalProperties=$additionalProperties}"
    }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val SUBSCRIPTION_LICENSE_BALANCE_THRESHOLD_REACHED =
                of("subscription.license_balance_threshold_reached")
        ...
        fun value(): Value =
            when (this) {
                SUBSCRIPTION_LICENSE_BALANCE_THRESHOLD_REACHED ->
                    Value.SUBSCRIPTION_LICENSE_BALANCE_THRESHOLD_REACHED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                SUBSCRIPTION_LICENSE_BALANCE_THRESHOLD_REACHED ->
                    Known.SUBSCRIPTION_LICENSE_BALANCE_THRESHOLD_REACHED
                else -> throw OrbInvalidDataException("Unknown Type: $value")
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionLicenseBalanceThresholdReachedWebhookEvent &&
            id == other.id &&
            createdAt == other.createdAt &&
    ...
    override fun toString() =
        "SubscriptionLicenseBalanceThresholdReachedWebhookEvent{id=$id, createdAt=$createdAt, properties=$properties, subscription=$subscription, type=$type, additionalProperties=$additionalProperties}"
}

...
@JsonDeserialize(builder = SubscriptionUnscheduleCancellationResponse.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(
            ...
            this.metadata = subscriptionUnscheduleCancellationResponse.metadata
            this.id = subscriptionUnscheduleCancellationResponse.id
            this.customer = subscriptionUnscheduleCancellationResponse.customer
            this.plan = subscriptionUnscheduleCancellationResponse.plan
            this.startDate = subscriptionUnscheduleCancellationResponse.startDate
            this.endDate = subscriptionUnscheduleCancellationResponse.endDate
            this.createdAt = subscriptionUnscheduleCancellationResponse.createdAt
            ...
            this.status = subscriptionUnscheduleCancellationResponse.status
            this.trialInfo = subscriptionUnscheduleCancellationResponse.trialInfo
            this.activePlanPhaseOrder =
                subscriptionUnscheduleCancellationResponse.activePlanPhaseOrder
            this.fixedFeeQuantitySchedule =
                subscriptionUnscheduleCancellationResponse.fixedFeeQuantitySchedule
            this.defaultInvoiceMemo = subscriptionUnscheduleCancellationResponse.defaultInvoiceMemo
            this.autoCollection = subscriptionUnscheduleCancellationResponse.autoCollection
            this.netTerms = subscriptionUnscheduleCancellationResponse.netTerms
            this.redeemedCoupon = subscriptionUnscheduleCancellationResponse.redeemedCoupon
            this.billingCycleDay = subscriptionUnscheduleCancellationResponse.billingCycleDay
            this.billingCycleAnchorConfiguration =
                subscriptionUnscheduleCancellationResponse.billingCycleAnchorConfiguration
            this.invoicingThreshold = subscriptionUnscheduleCancellationResponse.invoicingThreshold
            this.priceIntervals = subscriptionUnscheduleCancellationResponse.priceIntervals
            this.adjustmentIntervals =
                subscriptionUnscheduleCancellationResponse.adjustmentIntervals
            this.discountIntervals = subscriptionUnscheduleCancellationResponse.discountIntervals
            this.minimumIntervals = subscriptionUnscheduleCancellationResponse.minimumIntervals
            this.maximumIntervals = subscriptionUnscheduleCancellationResponse.maximumIntervals
            additionalProperties(subscriptionUnscheduleCancellationResponse.additionalProperties)
        }

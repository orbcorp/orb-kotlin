...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            subscriptionUnscheduleCancellationResponse: SubscriptionUnscheduleCancellationResponse
        ) = apply {
            ...
            adjustmentIntervals =
                subscriptionUnscheduleCancellationResponse.adjustmentIntervals.map {
                    it.toMutableList()
                }
            ...
            currentBillingPeriodEndDate =
                subscriptionUnscheduleCancellationResponse.currentBillingPeriodEndDate
            currentBillingPeriodStartDate =
            ...
            discountIntervals =
                subscriptionUnscheduleCancellationResponse.discountIntervals.map {
                    it.toMutableList()
                }
            endDate = subscriptionUnscheduleCancellationResponse.endDate
            fixedFeeQuantitySchedule =
                subscriptionUnscheduleCancellationResponse.fixedFeeQuantitySchedule.map {
                    it.toMutableList()
                }
            invoicingThreshold = subscriptionUnscheduleCancellationResponse.invoicingThreshold
            maximumIntervals =
                subscriptionUnscheduleCancellationResponse.maximumIntervals.map {
                    it.toMutableList()
                }
            metadata = subscriptionUnscheduleCancellationResponse.metadata
            minimumIntervals =
                subscriptionUnscheduleCancellationResponse.minimumIntervals.map {
                    it.toMutableList()
                }
            name = subscriptionUnscheduleCancellationResponse.name
            netTerms = subscriptionUnscheduleCancellationResponse.netTerms
            pendingSubscriptionChange =
                subscriptionUnscheduleCancellationResponse.pendingSubscriptionChange
            plan = subscriptionUnscheduleCancellationResponse.plan
            priceIntervals =
                subscriptionUnscheduleCancellationResponse.priceIntervals.map { it.toMutableList() }
            ...
            changedResources = subscriptionUnscheduleCancellationResponse.changedResources
            additionalProperties =
                subscriptionUnscheduleCancellationResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubscriptionUnscheduleCancellationResponse].
         *
    ...
    fun validate(): SubscriptionUnscheduleCancellationResponse = apply {
        if (validated) {
            return@apply
        }

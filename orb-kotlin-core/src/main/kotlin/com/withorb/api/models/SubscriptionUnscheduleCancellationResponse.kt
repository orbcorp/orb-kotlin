...
@NoAutoDetect
class SubscriptionUnscheduleCancellationResponse @JsonCreator private constructor(
    ...
    fun validate(): SubscriptionUnscheduleCancellationResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    /** A builder for [SubscriptionUnscheduleCancellationResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionUnscheduleCancellationResponse: SubscriptionUnscheduleCancellationResponse) =
            apply {
                id = subscriptionUnscheduleCancellationResponse.id
                activePlanPhaseOrder = subscriptionUnscheduleCancellationResponse.activePlanPhaseOrder
                adjustmentIntervals = subscriptionUnscheduleCancellationResponse.adjustmentIntervals.map { it.toMutableList() }
                autoCollection = subscriptionUnscheduleCancellationResponse.autoCollection
                billingCycleAnchorConfiguration = subscriptionUnscheduleCancellationResponse.billingCycleAnchorConfiguration
                billingCycleDay = subscriptionUnscheduleCancellationResponse.billingCycleDay
                createdAt = subscriptionUnscheduleCancellationResponse.createdAt
                currentBillingPeriodEndDate = subscriptionUnscheduleCancellationResponse.currentBillingPeriodEndDate
                currentBillingPeriodStartDate = subscriptionUnscheduleCancellationResponse.currentBillingPeriodStartDate
                customer = subscriptionUnscheduleCancellationResponse.customer
                defaultInvoiceMemo = subscriptionUnscheduleCancellationResponse.defaultInvoiceMemo
                discountIntervals = subscriptionUnscheduleCancellationResponse.discountIntervals.map { it.toMutableList() }
                endDate = subscriptionUnscheduleCancellationResponse.endDate
                fixedFeeQuantitySchedule = subscriptionUnscheduleCancellationResponse.fixedFeeQuantitySchedule.map { it.toMutableList() }
                invoicingThreshold = subscriptionUnscheduleCancellationResponse.invoicingThreshold
                maximumIntervals = subscriptionUnscheduleCancellationResponse.maximumIntervals.map { it.toMutableList() }
                metadata = subscriptionUnscheduleCancellationResponse.metadata
                minimumIntervals = subscriptionUnscheduleCancellationResponse.minimumIntervals.map { it.toMutableList() }
                netTerms = subscriptionUnscheduleCancellationResponse.netTerms
                plan = subscriptionUnscheduleCancellationResponse.plan
                priceIntervals = subscriptionUnscheduleCancellationResponse.priceIntervals.map { it.toMutableList() }
                redeemedCoupon = subscriptionUnscheduleCancellationResponse.redeemedCoupon
                startDate = subscriptionUnscheduleCancellationResponse.startDate
                status = subscriptionUnscheduleCancellationResponse.status
                trialInfo = subscriptionUnscheduleCancellationResponse.trialInfo
                additionalProperties = subscriptionUnscheduleCancellationResponse.additionalProperties.toMutableMap()
            }
        ...
        fun build(): SubscriptionUnscheduleCancellationResponse =
            SubscriptionUnscheduleCancellationResponse(
              checkRequired(
                "id", id
              ),

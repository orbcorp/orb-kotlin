...
private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Alert>> = JsonMissing.of(),
     ...
     */
    fun data(): List<Alert> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Alert>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<Alert>>? = null
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<Alert>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<Alert>>) = apply {

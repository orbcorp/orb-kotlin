...
@NoAutoDetect
class CustomerCreditListByExternalIdResponse @JsonCreator private constructor(
    ...
    fun validate(): CustomerCreditListByExternalIdResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(customerCreditListByExternalIdResponse: CustomerCreditListByExternalIdResponse) =
            apply {
                ...
                additionalProperties = customerCreditListByExternalIdResponse.additionalProperties.toMutableMap()
            }
    ...
    override fun toString() = "CustomerCreditListByExternalIdResponse{id=$id, balance=$balance, effectiveDate=$effectiveDate, expiryDate=$expiryDate, maximumInitialBalance=$maximumInitialBalance, perUnitCostBasis=$perUnitCostBasis, status=$status, additionalProperties=$additionalProperties}"
}

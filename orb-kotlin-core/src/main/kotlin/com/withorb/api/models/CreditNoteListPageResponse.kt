...
private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<CreditNote>> = JsonMissing.of(),
     ...
     */
    fun data(): List<CreditNote> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<CreditNote>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<CreditNote>>? = null
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<CreditNote>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<CreditNote>>) = apply {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreditNoteListPageResponse &&
            data == other.data &&

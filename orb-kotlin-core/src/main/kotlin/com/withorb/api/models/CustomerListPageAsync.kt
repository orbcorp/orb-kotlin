 ...
 */
class CustomerListPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(customersService: CustomerServiceAsync, params: CustomerListParams, response: Response) =
    ...
    class AutoPager(
        private val firstPage: CustomerListPageAsync,

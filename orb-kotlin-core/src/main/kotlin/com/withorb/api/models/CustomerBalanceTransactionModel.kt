...
@NoAutoDetect
class CustomerBalanceTransactionModel
@JsonCreator
private constructor(
    ...
    fun validate(): CustomerBalanceTransactionModel = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [CustomerBalanceTransactionModel]. */
    class Builder internal constructor() {
        ...
        internal fun from(customerBalanceTransactionModel: CustomerBalanceTransactionModel) =
            apply {
                id = customerBalanceTransactionModel.id
                action = customerBalanceTransactionModel.action
                amount = customerBalanceTransactionModel.amount
                createdAt = customerBalanceTransactionModel.createdAt
                creditNote = customerBalanceTransactionModel.creditNote
                description = customerBalanceTransactionModel.description
                endingBalance = customerBalanceTransactionModel.endingBalance
                invoice = customerBalanceTransactionModel.invoice
                startingBalance = customerBalanceTransactionModel.startingBalance
                type = customerBalanceTransactionModel.type
                additionalProperties =
                    customerBalanceTransactionModel.additionalProperties.toMutableMap()
            }
        ...
        fun build(): CustomerBalanceTransactionModel =
            CustomerBalanceTransactionModel(
                checkRequired("id", id),
    ...
    override fun toString() =
        "CustomerBalanceTransactionModel{id=$id, action=$action, amount=$amount, createdAt=$createdAt, creditNote=$creditNote, description=$description, endingBalance=$endingBalance, invoice=$invoice, startingBalance=$startingBalance, type=$type, additionalProperties=$additionalProperties}"
}

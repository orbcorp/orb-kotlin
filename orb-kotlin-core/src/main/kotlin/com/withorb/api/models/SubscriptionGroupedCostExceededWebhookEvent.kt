...
class SubscriptionGroupedCostExceededWebhookEvent
...
private constructor(
    ...
    /**
     * Every group that crossed a threshold for one alert, batched into a single message.
     *
     * @throws OrbInvalidDataException if the JSON field has an unexpected type or is unexpectedly
     *   missing or null (e.g. if the server responded with an unexpected value).
     */
    ...
    /** A builder for [SubscriptionGroupedCostExceededWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            subscriptionGroupedCostExceededWebhookEvent: SubscriptionGroupedCostExceededWebhookEvent
        ) = apply {
            id = subscriptionGroupedCostExceededWebhookEvent.id
            createdAt = subscriptionGroupedCostExceededWebhookEvent.createdAt
            ...
            type = subscriptionGroupedCostExceededWebhookEvent.type
            additionalProperties =
                subscriptionGroupedCostExceededWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubscriptionGroupedCostExceededWebhookEvent].
         *
         ...
         */
        fun build(): SubscriptionGroupedCostExceededWebhookEvent =
            SubscriptionGroupedCostExceededWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): SubscriptionGroupedCostExceededWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
         */
        fun groupingKeys(): List<String> = groupingKeys.getRequired("grouping_keys")
        ...
        class Builder internal constructor() {
            ...
            internal fun from(properties: Properties) = apply {
                ...
                groupingKeys = properties.groupingKeys.map { it.toMutableList() }
                groups = properties.groups.map { it.toMutableList() }
            ...
            fun build(): Properties =
                Properties(
                    ...
                    checkRequired("groupingKeys", groupingKeys).map { it.toImmutable() },
        ...
        private constructor(
            ...
            private constructor(
                ...
                @ExcludeMissing
                groupValues: JsonField<List<String>> = JsonMissing.of(),
            ) : this(amountThreshold, evaluatedAmount, groupValues, mutableMapOf())

            /**
             * @throws OrbInvalidDataException if the JSON field has an unexpected type (e.g. if the
             *   server responded with an unexpected value).
             */
            fun amountThreshold(): String? = amountThreshold.getNullable("amount_threshold")

            /**
             * @throws OrbInvalidDataException if the JSON field has an unexpected type (e.g. if the
             *   server responded with an unexpected value).
             */
            fun evaluatedAmount(): String? = evaluatedAmount.getNullable("evaluated_amount")
             ...
             *
             * Unlike [amountThreshold], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("amount_threshold")
            @ExcludeMissing
             ...
             *
             * Unlike [evaluatedAmount], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("evaluated_amount")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                internal fun from(group: Group) = apply {
                    amountThreshold = group.amountThreshold
                    evaluatedAmount = group.evaluatedAmount
                    groupValues = group.groupValues.map { it.toMutableList() }
                 ...
                 *
                 * You should usually call [Builder.amountThreshold] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.evaluatedAmount] with a well-typed [String]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
             ...
             */
            internal fun validity(): Int =
                (if (amountThreshold.asKnown() == null) 0 else 1) +
                    (if (evaluatedAmount.asKnown() == null) 0 else 1) +
                    (groupValues.asKnown()?.size ?: 0)
            ...
            private val hashCode: Int by lazy {
                Objects.hash(amountThreshold, evaluatedAmount, groupValues, additionalProperties)
            }

            override fun hashCode(): Int = hashCode

            override fun toString() =
                "Group{amountThreshold=$amountThreshold, evaluatedAmount=$evaluatedAmount, groupValues=$groupValues, additionalProperties=$additionalProperties}"
        }
        ...
        override fun toString() =
            "Properties{alertConfiguration=$alertConfiguration, groupingKeys=$groupingKeys, groups=$groups, timeframeEnd=$timeframeEnd, timeframeStart=$timeframeStart, additionalProperties=$additionalProperties}"
    }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val SUBSCRIPTION_GROUPED_COST_EXCEEDED = of("subscription.grouped_cost_exceeded")
        ...
        fun value(): Value =
            when (this) {
                SUBSCRIPTION_GROUPED_COST_EXCEEDED -> Value.SUBSCRIPTION_GROUPED_COST_EXCEEDED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                SUBSCRIPTION_GROUPED_COST_EXCEEDED -> Known.SUBSCRIPTION_GROUPED_COST_EXCEEDED
                else -> throw OrbInvalidDataException("Unknown Type: $value")
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionGroupedCostExceededWebhookEvent &&
            id == other.id &&
            createdAt == other.createdAt &&
    ...
    override fun toString() =
        "SubscriptionGroupedCostExceededWebhookEvent{id=$id, createdAt=$createdAt, properties=$properties, subscription=$subscription, type=$type, additionalProperties=$additionalProperties}"
}

...
class CustomerCreditListPageAsync private constructor(private val creditsService: CreditServiceAsync, private val params: CustomerCreditListParams, private val response: Response, ) {
    ...
    override fun toString() = "CustomerCreditListPageAsync{creditsService=$creditsService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): CustomerCreditListParams? {
      ...
      return CustomerCreditListParams.builder().from(params).apply {paginationMetadata().nextCursor()?.let{ this.cursor(it) } }.build()
    }

    suspend fun getNextPage(): CustomerCreditListPageAsync? {
      return getNextPageParams()?.let {
          creditsService.list(it)
      }
    }
    ...
    companion object {
        ...
        fun of(creditsService: CreditServiceAsync, params: CustomerCreditListParams, response: Response) = CustomerCreditListPageAsync(
            creditsService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<CustomerCreditListResponse>>, private val paginationMetadata: JsonField<PaginationMetadata>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "CustomerCreditListPageAsync.Response{data=$data, paginationMetadata=$paginationMetadata, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: CustomerCreditListPageAsync, ) : Flow<CustomerCreditListResponse> {

 ...
 * providers, etc).
 */
class InvoiceIssueParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        @JsonProperty("synchronous") @ExcludeMissing private val synchronous: JsonField<Boolean> = JsonMissing.of(),
        ...
        class Builder internal constructor() {
             ...
             * present in the provider.
             */
            fun synchronous(synchronous: JsonField<Boolean>) =
                apply {
            ...
            fun build(): Body =
                Body(
                  synchronous, additionalProperties.toImmutable()
                )
        }
        ...
        override fun toString() = "Body{synchronous=$synchronous, additionalProperties=$additionalProperties}"
    }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(invoiceIssueParams: InvoiceIssueParams) =
            apply {
    ...
    override fun toString() = "InvoiceIssueParams{invoiceId=$invoiceId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

...
class CustomerCreditLedgerListByExternalIdResponse private constructor(
    ...
    fun validate(): CustomerCreditLedgerListByExternalIdResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    interface Visitor<out T> {
        ...
        /**
         * Maps an unknown variant of [CustomerCreditLedgerListByExternalIdResponse] to a
         * value of type [T].
         *
         * An instance of [CustomerCreditLedgerListByExternalIdResponse] can contain an
    ...
    internal class Deserializer : BaseDeserializer<CustomerCreditLedgerListByExternalIdResponse>(CustomerCreditLedgerListByExternalIdResponse::class) {
    ...
    internal class Serializer : BaseSerializer<CustomerCreditLedgerListByExternalIdResponse>(CustomerCreditLedgerListByExternalIdResponse::class) {

...
class CustomerCreditLedgerListByExternalIdResponse private constructor(
  ...
  private val _json: JsonValue? = null,
    ...
    fun validate(): CustomerCreditLedgerListByExternalIdResponse = apply {
        if (!validated) {
          if (incrementLedgerEntry == null && decrementLedgerEntry == null && expirationChangeLedgerEntry == null && creditBlockExpiryLedgerEntry == null && voidLedgerEntry == null && voidInitiatedLedgerEntry == null && amendmentLedgerEntry == null) {
            throw OrbInvalidDataException("Unknown CustomerCreditLedgerListByExternalIdResponse: $_json")
          }
    ...
    override fun toString(): String {
      return when {
          incrementLedgerEntry != null -> "CustomerCreditLedgerListByExternalIdResponse{incrementLedgerEntry=$incrementLedgerEntry}"
          decrementLedgerEntry != null -> "CustomerCreditLedgerListByExternalIdResponse{decrementLedgerEntry=$decrementLedgerEntry}"
          expirationChangeLedgerEntry != null -> "CustomerCreditLedgerListByExternalIdResponse{expirationChangeLedgerEntry=$expirationChangeLedgerEntry}"
          creditBlockExpiryLedgerEntry != null -> "CustomerCreditLedgerListByExternalIdResponse{creditBlockExpiryLedgerEntry=$creditBlockExpiryLedgerEntry}"
          voidLedgerEntry != null -> "CustomerCreditLedgerListByExternalIdResponse{voidLedgerEntry=$voidLedgerEntry}"
          voidInitiatedLedgerEntry != null -> "CustomerCreditLedgerListByExternalIdResponse{voidInitiatedLedgerEntry=$voidInitiatedLedgerEntry}"
          amendmentLedgerEntry != null -> "CustomerCreditLedgerListByExternalIdResponse{amendmentLedgerEntry=$amendmentLedgerEntry}"
          _json != null -> "CustomerCreditLedgerListByExternalIdResponse{_unknown=$_json}"
          else -> throw IllegalStateException("Invalid CustomerCreditLedgerListByExternalIdResponse")
      }
    }

    companion object {

        fun ofIncrementLedgerEntry(incrementLedgerEntry: IncrementLedgerEntry) = CustomerCreditLedgerListByExternalIdResponse(incrementLedgerEntry = incrementLedgerEntry)

        fun ofDecrementLedgerEntry(decrementLedgerEntry: DecrementLedgerEntry) = CustomerCreditLedgerListByExternalIdResponse(decrementLedgerEntry = decrementLedgerEntry)

        fun ofExpirationChangeLedgerEntry(expirationChangeLedgerEntry: ExpirationChangeLedgerEntry) = CustomerCreditLedgerListByExternalIdResponse(expirationChangeLedgerEntry = expirationChangeLedgerEntry)

        fun ofCreditBlockExpiryLedgerEntry(creditBlockExpiryLedgerEntry: CreditBlockExpiryLedgerEntry) = CustomerCreditLedgerListByExternalIdResponse(creditBlockExpiryLedgerEntry = creditBlockExpiryLedgerEntry)

        fun ofVoidLedgerEntry(voidLedgerEntry: VoidLedgerEntry) = CustomerCreditLedgerListByExternalIdResponse(voidLedgerEntry = voidLedgerEntry)

        fun ofVoidInitiatedLedgerEntry(voidInitiatedLedgerEntry: VoidInitiatedLedgerEntry) = CustomerCreditLedgerListByExternalIdResponse(voidInitiatedLedgerEntry = voidInitiatedLedgerEntry)

        fun ofAmendmentLedgerEntry(amendmentLedgerEntry: AmendmentLedgerEntry) = CustomerCreditLedgerListByExternalIdResponse(amendmentLedgerEntry = amendmentLedgerEntry)
    }
    ...
    interface Visitor<out T> {
        ...
        fun unknown(json: JsonValue?): T {
          throw OrbInvalidDataException("Unknown CustomerCreditLedgerListByExternalIdResponse: $json")
        }
    }

    class Deserializer : BaseDeserializer<CustomerCreditLedgerListByExternalIdResponse>(CustomerCreditLedgerListByExternalIdResponse::class) {

        override fun ObjectCodec.deserialize(node: JsonNode): CustomerCreditLedgerListByExternalIdResponse {
          val json = JsonValue.fromJsonNode(node)
          tryDeserialize(node, jacksonTypeRef<IncrementLedgerEntry>()){ it.validate() }?.let {
              return CustomerCreditLedgerListByExternalIdResponse(incrementLedgerEntry = it, _json = json)
          }
          tryDeserialize(node, jacksonTypeRef<DecrementLedgerEntry>()){ it.validate() }?.let {
              return CustomerCreditLedgerListByExternalIdResponse(decrementLedgerEntry = it, _json = json)
          }
          tryDeserialize(node, jacksonTypeRef<ExpirationChangeLedgerEntry>()){ it.validate() }?.let {
              return CustomerCreditLedgerListByExternalIdResponse(expirationChangeLedgerEntry = it, _json = json)
          }
          tryDeserialize(node, jacksonTypeRef<CreditBlockExpiryLedgerEntry>()){ it.validate() }?.let {
              return CustomerCreditLedgerListByExternalIdResponse(creditBlockExpiryLedgerEntry = it, _json = json)
          }
          tryDeserialize(node, jacksonTypeRef<VoidLedgerEntry>()){ it.validate() }?.let {
              return CustomerCreditLedgerListByExternalIdResponse(voidLedgerEntry = it, _json = json)
          }
          tryDeserialize(node, jacksonTypeRef<VoidInitiatedLedgerEntry>()){ it.validate() }?.let {
              return CustomerCreditLedgerListByExternalIdResponse(voidInitiatedLedgerEntry = it, _json = json)
          }
          tryDeserialize(node, jacksonTypeRef<AmendmentLedgerEntry>()){ it.validate() }?.let {
              return CustomerCreditLedgerListByExternalIdResponse(amendmentLedgerEntry = it, _json = json)
          }
    ...
    class Serializer : BaseSerializer<CustomerCreditLedgerListByExternalIdResponse>(CustomerCreditLedgerListByExternalIdResponse::class) {

        override fun serialize(value: CustomerCreditLedgerListByExternalIdResponse, generator: JsonGenerator, provider: SerializerProvider) {
          when {

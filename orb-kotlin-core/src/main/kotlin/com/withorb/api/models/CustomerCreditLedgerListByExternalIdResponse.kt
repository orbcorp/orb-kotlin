...
private constructor(
     ...
     * import com.withorb.api.core.JsonValue
     *
     * val result: String? = customerCreditLedgerListByExternalIdResponse.accept(object : CustomerCreditLedgerListByExternalIdResponse.Visitor<String?> {
     *     override fun visitIncrement(increment: IncrementLedgerEntry): String? = increment.toString()
     *
     *     // ...
     *

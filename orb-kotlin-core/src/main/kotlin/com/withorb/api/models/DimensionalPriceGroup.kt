 ...
 */
@NoAutoDetect
class DimensionalPriceGroup @JsonCreator private constructor(
    ...
    fun validate(): DimensionalPriceGroup =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(dimensionalPriceGroup: DimensionalPriceGroup) =
            apply {
    ...
    override fun toString() = "DimensionalPriceGroup{id=$id, billableMetricId=$billableMetricId, dimensions=$dimensions, externalDimensionalPriceGroupId=$externalDimensionalPriceGroupId, metadata=$metadata, name=$name, additionalProperties=$additionalProperties}"
}

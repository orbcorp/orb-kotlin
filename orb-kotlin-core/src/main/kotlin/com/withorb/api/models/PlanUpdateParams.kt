...
constructor(
    ...
    internal constructor(
        ...
        class Builder {
            ...
            internal fun from(planUpdateBody: PlanUpdateBody) = apply {
                this.externalPlanId = planUpdateBody.externalPlanId
                this.metadata = planUpdateBody.metadata
                additionalProperties(planUpdateBody.additionalProperties)
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is PlanUpdateBody && this.externalPlanId == other.externalPlanId && this.metadata == other.metadata && this.additionalProperties == other.additionalProperties /* spotless:on */
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PlanUpdateParams && this.planId == other.planId && this.externalPlanId == other.externalPlanId && this.metadata == other.metadata && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders && this.additionalBodyProperties == other.additionalBodyProperties /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(planId, externalPlanId, metadata, additionalQueryParams, additionalHeaders, additionalBodyProperties) /* spotless:on */
    }

    override fun toString() =
        "PlanUpdateParams{planId=$planId, externalPlanId=$externalPlanId, metadata=$metadata, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"

 ...
 */
class PlanUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(planUpdateParams: PlanUpdateParams) =
            apply {
    ...
    override fun toString() = "PlanUpdateParams{planId=$planId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

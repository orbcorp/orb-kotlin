...
class NewPlanGroupedTieredPrice
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [NewPlanGroupedTieredPrice].
         *
    ...
    /** A builder for [NewPlanGroupedTieredPrice]. */
    class Builder internal constructor() {
        ...
        internal fun from(newPlanGroupedTieredPrice: NewPlanGroupedTieredPrice) = apply {
            cadence = newPlanGroupedTieredPrice.cadence
            groupedTieredConfig = newPlanGroupedTieredPrice.groupedTieredConfig
            itemId = newPlanGroupedTieredPrice.itemId
            modelType = newPlanGroupedTieredPrice.modelType
            name = newPlanGroupedTieredPrice.name
            billableMetricId = newPlanGroupedTieredPrice.billableMetricId
            billedInAdvance = newPlanGroupedTieredPrice.billedInAdvance
            billingCycleConfiguration = newPlanGroupedTieredPrice.billingCycleConfiguration
            conversionRate = newPlanGroupedTieredPrice.conversionRate
            currency = newPlanGroupedTieredPrice.currency
            dimensionalPriceConfiguration = newPlanGroupedTieredPrice.dimensionalPriceConfiguration
            externalPriceId = newPlanGroupedTieredPrice.externalPriceId
            fixedPriceQuantity = newPlanGroupedTieredPrice.fixedPriceQuantity
            invoiceGroupingKey = newPlanGroupedTieredPrice.invoiceGroupingKey
            invoicingCycleConfiguration = newPlanGroupedTieredPrice.invoicingCycleConfiguration
            metadata = newPlanGroupedTieredPrice.metadata
            additionalProperties = newPlanGroupedTieredPrice.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NewPlanGroupedTieredPrice].
         *
         ...
         */
        fun build(): NewPlanGroupedTieredPrice =
    ...
    fun validate(): NewPlanGroupedTieredPrice = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is NewPlanGroupedTieredPrice && cadence == other.cadence && groupedTieredConfig == other.groupedTieredConfig && itemId == other.itemId && modelType == other.modelType && name == other.name && billableMetricId == other.billableMetricId && billedInAdvance == other.billedInAdvance && billingCycleConfiguration == other.billingCycleConfiguration && conversionRate == other.conversionRate && currency == other.currency && dimensionalPriceConfiguration == other.dimensionalPriceConfiguration && externalPriceId == other.externalPriceId && fixedPriceQuantity == other.fixedPriceQuantity && invoiceGroupingKey == other.invoiceGroupingKey && invoicingCycleConfiguration == other.invoicingCycleConfiguration && metadata == other.metadata && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(cadence, groupedTieredConfig, itemId, modelType, name, billableMetricId, billedInAdvance, billingCycleConfiguration, conversionRate, currency, dimensionalPriceConfiguration, externalPriceId, fixedPriceQuantity, invoiceGroupingKey, invoicingCycleConfiguration, metadata, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "NewPlanGroupedTieredPrice{cadence=$cadence, groupedTieredConfig=$groupedTieredConfig, itemId=$itemId, modelType=$modelType, name=$name, billableMetricId=$billableMetricId, billedInAdvance=$billedInAdvance, billingCycleConfiguration=$billingCycleConfiguration, conversionRate=$conversionRate, currency=$currency, dimensionalPriceConfiguration=$dimensionalPriceConfiguration, externalPriceId=$externalPriceId, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, invoicingCycleConfiguration=$invoicingCycleConfiguration, metadata=$metadata, additionalProperties=$additionalProperties}"
}

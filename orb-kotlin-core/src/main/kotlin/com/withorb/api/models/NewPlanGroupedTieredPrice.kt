...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(newPlanGroupedTieredPrice: NewPlanGroupedTieredPrice) = apply {
            ...
            conversionRateConfig = newPlanGroupedTieredPrice.conversionRateConfig
            ...
            licenseTypeId = newPlanGroupedTieredPrice.licenseTypeId
            metadata = newPlanGroupedTieredPrice.metadata
            referenceId = newPlanGroupedTieredPrice.referenceId
    ...
    private constructor(
        ...
        private val hashCode: Int by lazy { Objects.hash(groupingKey, tiers, additionalProperties) }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is NewPlanGroupedTieredPrice &&

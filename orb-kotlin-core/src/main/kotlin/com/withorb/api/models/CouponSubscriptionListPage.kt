...
private constructor(
    ...
    constructor(
        ...
        @JsonProperty("data") fun _data(): JsonField<List<SubscriptionModel>>? = data
    ...
    class AutoPager(private val firstPage: CouponSubscriptionListPage) :
        Sequence<SubscriptionModel> {

        override fun iterator(): Iterator<SubscriptionModel> = iterator {
            var page = firstPage
            var index = 0
            while (true) {

...
class CouponSubscriptionListPage private constructor(private val subscriptionsService: SubscriptionService, private val params: CouponSubscriptionListParams, private val response: Response, ) {
    ...
    override fun toString() = "CouponSubscriptionListPage{subscriptionsService=$subscriptionsService, params=$params, response=$response}"
    ...
    companion object {
        ...
        fun of(subscriptionsService: SubscriptionService, params: CouponSubscriptionListParams, response: Response) = CouponSubscriptionListPage(
            subscriptionsService,
            params,
            response,
        )
    ...
    class Response constructor(private val data: JsonField<List<Subscription>>, private val paginationMetadata: JsonField<PaginationMetadata>, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun toString() = "CouponSubscriptionListPage.Response{data=$data, paginationMetadata=$paginationMetadata, additionalProperties=$additionalProperties}"
    ...
    class AutoPager constructor(private val firstPage: CouponSubscriptionListPage, ) : Sequence<Subscription> {

 ...
 * price.
 */
class PriceUpdateParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(priceUpdateParams: PriceUpdateParams) =
            apply {
    ...
    override fun toString() = "PriceUpdateParams{priceId=$priceId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

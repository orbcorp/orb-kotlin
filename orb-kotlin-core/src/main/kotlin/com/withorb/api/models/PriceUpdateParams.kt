...
class PriceUpdateParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    @NoAutoDetect
    class PriceUpdateBody internal constructor(private val metadata: Metadata?, private val additionalProperties: Map<String, JsonValue>, ) {
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is PriceUpdateBody &&
        ...
        override fun toString() = "PriceUpdateBody{metadata=$metadata, additionalProperties=$additionalProperties}"
        ...
        class Builder {
            ...
            fun build(): PriceUpdateBody = PriceUpdateBody(metadata, additionalProperties.toUnmodifiable())
        }
    }
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is PriceUpdateParams &&
    ...
    override fun toString() = "PriceUpdateParams{priceId=$priceId, metadata=$metadata, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        fun build(): PriceUpdateParams = PriceUpdateParams(

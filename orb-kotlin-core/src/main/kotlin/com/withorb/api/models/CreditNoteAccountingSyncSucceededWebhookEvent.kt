...
class CreditNoteAccountingSyncSucceededWebhookEvent
...
private constructor(
    ...
    /** A builder for [CreditNoteAccountingSyncSucceededWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = creditNoteAccountingSyncSucceededWebhookEvent.id
            accountingSyncRecord =
                creditNoteAccountingSyncSucceededWebhookEvent.accountingSyncRecord
            createdAt = creditNoteAccountingSyncSucceededWebhookEvent.createdAt
            creditNote = creditNoteAccountingSyncSucceededWebhookEvent.creditNote
            properties = creditNoteAccountingSyncSucceededWebhookEvent.properties
            type = creditNoteAccountingSyncSucceededWebhookEvent.type
            additionalProperties =
                creditNoteAccountingSyncSucceededWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CreditNoteAccountingSyncSucceededWebhookEvent].
         *
         ...
         */
        fun build(): CreditNoteAccountingSyncSucceededWebhookEvent =
            CreditNoteAccountingSyncSucceededWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): CreditNoteAccountingSyncSucceededWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         * Used for best match union deserialization.
         */
        internal fun validity(): Int = (if (connectionType.asKnown() == null) 0 else 1)
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val CREDIT_NOTE_ACCOUNTING_SYNC_SUCCEEDED = of("credit_note.accounting_sync_succeeded")
        ...
        fun value(): Value =
            when (this) {
                CREDIT_NOTE_ACCOUNTING_SYNC_SUCCEEDED -> Value.CREDIT_NOTE_ACCOUNTING_SYNC_SUCCEEDED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CREDIT_NOTE_ACCOUNTING_SYNC_SUCCEEDED -> Known.CREDIT_NOTE_ACCOUNTING_SYNC_SUCCEEDED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreditNoteAccountingSyncSucceededWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "CreditNoteAccountingSyncSucceededWebhookEvent{id=$id, accountingSyncRecord=$accountingSyncRecord, createdAt=$createdAt, creditNote=$creditNote, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}

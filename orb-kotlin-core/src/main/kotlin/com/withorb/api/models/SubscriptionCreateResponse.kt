...
@NoAutoDetect
class SubscriptionCreateResponse @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionCreateResponse: SubscriptionCreateResponse) =
            apply {
                ...
                adjustmentIntervals = subscriptionCreateResponse.adjustmentIntervals.map { it.toMutableList() }
                autoCollection = subscriptionCreateResponse.autoCollection
                billingCycleAnchorConfiguration = subscriptionCreateResponse.billingCycleAnchorConfiguration
                ...
                discountIntervals = subscriptionCreateResponse.discountIntervals.map { it.toMutableList() }
                endDate = subscriptionCreateResponse.endDate
                fixedFeeQuantitySchedule = subscriptionCreateResponse.fixedFeeQuantitySchedule.map { it.toMutableList() }
                invoicingThreshold = subscriptionCreateResponse.invoicingThreshold
                maximumIntervals = subscriptionCreateResponse.maximumIntervals.map { it.toMutableList() }
                metadata = subscriptionCreateResponse.metadata
                minimumIntervals = subscriptionCreateResponse.minimumIntervals.map { it.toMutableList() }

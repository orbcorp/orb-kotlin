...
@JsonDeserialize(builder = SubscriptionCreateResponse.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(subscriptionCreateResponse: SubscriptionCreateResponse) = apply {
            this.metadata = subscriptionCreateResponse.metadata
            this.id = subscriptionCreateResponse.id
            this.customer = subscriptionCreateResponse.customer
            this.plan = subscriptionCreateResponse.plan
            this.startDate = subscriptionCreateResponse.startDate
            this.endDate = subscriptionCreateResponse.endDate
            this.createdAt = subscriptionCreateResponse.createdAt
            this.currentBillingPeriodStartDate =
                subscriptionCreateResponse.currentBillingPeriodStartDate
            this.currentBillingPeriodEndDate =
                subscriptionCreateResponse.currentBillingPeriodEndDate
            this.status = subscriptionCreateResponse.status
            this.trialInfo = subscriptionCreateResponse.trialInfo
            this.activePlanPhaseOrder = subscriptionCreateResponse.activePlanPhaseOrder
            this.fixedFeeQuantitySchedule = subscriptionCreateResponse.fixedFeeQuantitySchedule
            this.defaultInvoiceMemo = subscriptionCreateResponse.defaultInvoiceMemo
            this.autoCollection = subscriptionCreateResponse.autoCollection
            this.netTerms = subscriptionCreateResponse.netTerms
            this.redeemedCoupon = subscriptionCreateResponse.redeemedCoupon
            this.billingCycleDay = subscriptionCreateResponse.billingCycleDay
            this.billingCycleAnchorConfiguration =
                subscriptionCreateResponse.billingCycleAnchorConfiguration
            this.invoicingThreshold = subscriptionCreateResponse.invoicingThreshold
            this.priceIntervals = subscriptionCreateResponse.priceIntervals
            this.adjustmentIntervals = subscriptionCreateResponse.adjustmentIntervals
            this.discountIntervals = subscriptionCreateResponse.discountIntervals
            this.minimumIntervals = subscriptionCreateResponse.minimumIntervals
            this.maximumIntervals = subscriptionCreateResponse.maximumIntervals
            additionalProperties(subscriptionCreateResponse.additionalProperties)
        }

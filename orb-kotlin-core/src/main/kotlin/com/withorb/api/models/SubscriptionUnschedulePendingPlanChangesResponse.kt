...
@NoAutoDetect
class SubscriptionUnschedulePendingPlanChangesResponse @JsonCreator private constructor(
    ...
    fun validate(): SubscriptionUnschedulePendingPlanChangesResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionUnschedulePendingPlanChangesResponse: SubscriptionUnschedulePendingPlanChangesResponse) =
            apply {
                id = subscriptionUnschedulePendingPlanChangesResponse.id
                activePlanPhaseOrder = subscriptionUnschedulePendingPlanChangesResponse.activePlanPhaseOrder
                adjustmentIntervals = subscriptionUnschedulePendingPlanChangesResponse.adjustmentIntervals.map { it.toMutableList() }
                autoCollection = subscriptionUnschedulePendingPlanChangesResponse.autoCollection
                billingCycleAnchorConfiguration = subscriptionUnschedulePendingPlanChangesResponse.billingCycleAnchorConfiguration
                ...
                currentBillingPeriodEndDate = subscriptionUnschedulePendingPlanChangesResponse.currentBillingPeriodEndDate
                currentBillingPeriodStartDate = subscriptionUnschedulePendingPlanChangesResponse.currentBillingPeriodStartDate
                ...
                discountIntervals = subscriptionUnschedulePendingPlanChangesResponse.discountIntervals.map { it.toMutableList() }
                endDate = subscriptionUnschedulePendingPlanChangesResponse.endDate
                fixedFeeQuantitySchedule = subscriptionUnschedulePendingPlanChangesResponse.fixedFeeQuantitySchedule.map { it.toMutableList() }
                invoicingThreshold = subscriptionUnschedulePendingPlanChangesResponse.invoicingThreshold
                maximumIntervals = subscriptionUnschedulePendingPlanChangesResponse.maximumIntervals.map { it.toMutableList() }
                metadata = subscriptionUnschedulePendingPlanChangesResponse.metadata
                minimumIntervals = subscriptionUnschedulePendingPlanChangesResponse.minimumIntervals.map { it.toMutableList() }
                ...
                priceIntervals = subscriptionUnschedulePendingPlanChangesResponse.priceIntervals.map { it.toMutableList() }
                ...
                additionalProperties = subscriptionUnschedulePendingPlanChangesResponse.additionalProperties.toMutableMap()
            }

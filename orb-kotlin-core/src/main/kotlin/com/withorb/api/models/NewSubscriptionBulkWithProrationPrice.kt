...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            bulkWithProrationConfig = newSubscriptionBulkWithProrationPrice.bulkWithProrationConfig
            ...
            conversionRateConfig = newSubscriptionBulkWithProrationPrice.conversionRateConfig
            currency = newSubscriptionBulkWithProrationPrice.currency
            dimensionalPriceConfiguration =
                newSubscriptionBulkWithProrationPrice.dimensionalPriceConfiguration
            ...
            licenseTypeId = newSubscriptionBulkWithProrationPrice.licenseTypeId
         ...
         * [BulkWithProrationConfig] value instead. This method is primarily for setting the field
        ...
        /**
         * Returns an immutable instance of [NewSubscriptionBulkWithProrationPrice].
         *
    ...
    override fun toString() =
        "NewSubscriptionBulkWithProrationPrice{bulkWithProrationConfig=$bulkWithProrationConfig, cadence=$cadence, itemId=$itemId, modelType=$modelType, name=$name, billableMetricId=$billableMetricId, billedInAdvance=$billedInAdvance, billingCycleConfiguration=$billingCycleConfiguration, conversionRate=$conversionRate, conversionRateConfig=$conversionRateConfig, currency=$currency, dimensionalPriceConfiguration=$dimensionalPriceConfiguration, externalPriceId=$externalPriceId, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, invoicingCycleConfiguration=$invoicingCycleConfiguration, licenseTypeId=$licenseTypeId, metadata=$metadata, referenceId=$referenceId, additionalProperties=$additionalProperties}"
}

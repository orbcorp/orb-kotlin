...
class InvoiceIssueFailedWebhookEvent
...
private constructor(
    ...
    /** A builder for [InvoiceIssueFailedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(invoiceIssueFailedWebhookEvent: InvoiceIssueFailedWebhookEvent) = apply {
            id = invoiceIssueFailedWebhookEvent.id
            createdAt = invoiceIssueFailedWebhookEvent.createdAt
            invoice = invoiceIssueFailedWebhookEvent.invoice
            properties = invoiceIssueFailedWebhookEvent.properties
            type = invoiceIssueFailedWebhookEvent.type
            additionalProperties =
                invoiceIssueFailedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InvoiceIssueFailedWebhookEvent].
         *
         ...
         */
        fun build(): InvoiceIssueFailedWebhookEvent =
            InvoiceIssueFailedWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): InvoiceIssueFailedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            fun build(): Properties =
                Properties(checkRequired("reason", reason), additionalProperties.toMutableMap())
        }
        ...
        override fun toString() =
            "Properties{reason=$reason, additionalProperties=$additionalProperties}"
    }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val INVOICE_ISSUE_FAILED = of("invoice.issue_failed")
        ...
        fun value(): Value =
            when (this) {
                INVOICE_ISSUE_FAILED -> Value.INVOICE_ISSUE_FAILED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                INVOICE_ISSUE_FAILED -> Known.INVOICE_ISSUE_FAILED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InvoiceIssueFailedWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "InvoiceIssueFailedWebhookEvent{id=$id, createdAt=$createdAt, invoice=$invoice, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}

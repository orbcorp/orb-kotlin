 ...
 */
class CustomerCreditLedgerListPageAsync private constructor(
    ...
    companion object {
        ...
        fun of(ledgerService: LedgerServiceAsync, params: CustomerCreditLedgerListParams, response: Response) =
    ...
    class Response @JsonCreator constructor(
        @JsonProperty("data") private val data: JsonField<List<CustomerCreditLedgerListResponse>> = JsonMissing.of(),

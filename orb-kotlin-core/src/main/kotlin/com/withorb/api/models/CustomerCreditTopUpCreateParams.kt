...
private constructor(
    ...
    /**
     * Returns the raw JSON value of [activeFrom].
     *
     * Unlike [activeFrom], this method doesn't throw if the JSON field has an unexpected type.
     */
    ...
    class Builder internal constructor() {
        ...
        /**
         * Sets [Builder.activeFrom] to an arbitrary JSON value.
         *
         * You should usually call [Builder.activeFrom] with a well-typed [OffsetDateTime] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /**
         * Returns an immutable instance of [CustomerCreditTopUpCreateParams].
         *
    ...
    private constructor(
        ...
        private val activeFrom: JsonField<OffsetDateTime>,
        ...
        private constructor(
            ...
            @ExcludeMissing
            activeFrom: JsonField<OffsetDateTime> = JsonMissing.of(),
         ...
         *   server responded with an unexpected value).
         */
        fun expiresAfterUnit(): ExpiresAfterUnit? =
            expiresAfterUnit.getNullable("expires_after_unit")
         ...
         * Returns the raw JSON value of [invoiceSettings].
         *
         * Unlike [invoiceSettings], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("invoice_settings")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             * Sets [Builder.expiresAfter] to an arbitrary JSON value.
             *
             * You should usually call [Builder.expiresAfter] with a well-typed [Long] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             * Sets [Builder.expiresAfterUnit] to an arbitrary JSON value.
             *
             * You should usually call [Builder.expiresAfterUnit] with a well-typed
             * [ExpiresAfterUnit] value instead. This method is primarily for setting the field to
    ...
    override fun toString() =
        "CustomerCreditTopUpCreateParams{customerId=$customerId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

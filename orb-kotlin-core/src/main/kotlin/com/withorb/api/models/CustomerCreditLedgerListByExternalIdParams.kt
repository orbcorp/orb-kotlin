...
class CustomerCreditLedgerListByExternalIdParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    class Builder {
        ...
        internal fun from(customerCreditLedgerListByExternalIdParams: CustomerCreditLedgerListByExternalIdParams) = apply {
            ...
            additionalBodyProperties(customerCreditLedgerListByExternalIdParams.additionalBodyProperties)
        }
        ...
        fun build(): CustomerCreditLedgerListByExternalIdParams = CustomerCreditLedgerListByExternalIdParams(

 ...
 */
class CustomerBalanceTransactionListParams private constructor(
    ...
    override fun _queryParams(): QueryParams {
      ...
      this.operationTimeGt?.let {
          queryParams.put(
            "operation_time[gt]", listOf(DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(it))
          )
      }
      this.operationTimeGte?.let {
          queryParams.put(
            "operation_time[gte]", listOf(DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(it))
          )
      }
      this.operationTimeLt?.let {
          queryParams.put(
            "operation_time[lt]", listOf(DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(it))
          )
      }
      this.operationTimeLte?.let {
          queryParams.put(
            "operation_time[lte]", listOf(DateTimeFormatter.ISO_OFFSET_DATE_TIME.format(it))
          )
      }
    ...
    class Builder internal constructor() {
        ...
        internal fun from(customerBalanceTransactionListParams: CustomerBalanceTransactionListParams) =
            apply {
                ...
                additionalQueryParams = customerBalanceTransactionListParams.additionalQueryParams.toBuilder()
            }
        ...
        fun operationTimeGt(operationTimeGt: OffsetDateTime?) =
            apply {
                this.operationTimeGt = operationTimeGt
            }

        fun operationTimeGte(operationTimeGte: OffsetDateTime?) =
            apply {
                this.operationTimeGte = operationTimeGte
            }

        fun operationTimeLt(operationTimeLt: OffsetDateTime?) =
            apply {
                this.operationTimeLt = operationTimeLt
            }

        fun operationTimeLte(operationTimeLte: OffsetDateTime?) =
            apply {

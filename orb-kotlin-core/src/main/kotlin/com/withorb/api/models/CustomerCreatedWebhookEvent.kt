...
class CustomerCreatedWebhookEvent
...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = customerCreatedWebhookEvent.properties().convert(MyClass::class.java)
     * ```
     */
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CustomerCreatedWebhookEvent].
         *
    ...
    /** A builder for [CustomerCreatedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(customerCreatedWebhookEvent: CustomerCreatedWebhookEvent) = apply {
            id = customerCreatedWebhookEvent.id
            createdAt = customerCreatedWebhookEvent.createdAt
            customer = customerCreatedWebhookEvent.customer
            properties = customerCreatedWebhookEvent.properties
            type = customerCreatedWebhookEvent.type
            additionalProperties = customerCreatedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomerCreatedWebhookEvent].
         *
         ...
         */
        fun build(): CustomerCreatedWebhookEvent =
     ...
     *   type.
     */
    fun validate(): CustomerCreatedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val CUSTOMER_CREATED = of("customer.created")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomerCreatedWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "CustomerCreatedWebhookEvent{id=$id, createdAt=$createdAt, customer=$customer, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}

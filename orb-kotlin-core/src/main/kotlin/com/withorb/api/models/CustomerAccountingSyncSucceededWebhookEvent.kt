...
class CustomerAccountingSyncSucceededWebhookEvent
...
private constructor(
    ...
    ) : this(id, accountingSyncRecord, createdAt, customer, properties, type, mutableMapOf())
    ...
    /** A builder for [CustomerAccountingSyncSucceededWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            customerAccountingSyncSucceededWebhookEvent: CustomerAccountingSyncSucceededWebhookEvent
        ) = apply {
            id = customerAccountingSyncSucceededWebhookEvent.id
            accountingSyncRecord = customerAccountingSyncSucceededWebhookEvent.accountingSyncRecord
            createdAt = customerAccountingSyncSucceededWebhookEvent.createdAt
            customer = customerAccountingSyncSucceededWebhookEvent.customer
            properties = customerAccountingSyncSucceededWebhookEvent.properties
            type = customerAccountingSyncSucceededWebhookEvent.type
            additionalProperties =
                customerAccountingSyncSucceededWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomerAccountingSyncSucceededWebhookEvent].
         *
         ...
         */
        fun build(): CustomerAccountingSyncSucceededWebhookEvent =
            CustomerAccountingSyncSucceededWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): CustomerAccountingSyncSucceededWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        override fun toString() =
            "AccountingSyncRecord{id=$id, customerId=$customerId, recordType=$recordType, errorDetails=$errorDetails, providerCustomerId=$providerCustomerId, status=$status, syncAction=$syncAction, additionalProperties=$additionalProperties}"
    }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val CUSTOMER_ACCOUNTING_SYNC_SUCCEEDED = of("customer.accounting_sync_succeeded")
        ...
        fun value(): Value =
            when (this) {
                CUSTOMER_ACCOUNTING_SYNC_SUCCEEDED -> Value.CUSTOMER_ACCOUNTING_SYNC_SUCCEEDED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                CUSTOMER_ACCOUNTING_SYNC_SUCCEEDED -> Known.CUSTOMER_ACCOUNTING_SYNC_SUCCEEDED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomerAccountingSyncSucceededWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "CustomerAccountingSyncSucceededWebhookEvent{id=$id, accountingSyncRecord=$accountingSyncRecord, createdAt=$createdAt, customer=$customer, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}

...
private constructor(
     ...
     *
     * Unlike [tieredPackageConfig], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("tiered_package_config")
    @ExcludeMissing
    ...
    class Builder internal constructor() {
        ...
        internal fun from(newFloatingTieredPackagePrice: NewFloatingTieredPackagePrice) = apply {
            ...
            billingCycleConfiguration = newFloatingTieredPackagePrice.billingCycleConfiguration
            conversionRate = newFloatingTieredPackagePrice.conversionRate
            conversionRateConfig = newFloatingTieredPackagePrice.conversionRateConfig
            dimensionalPriceConfiguration =
                newFloatingTieredPackagePrice.dimensionalPriceConfiguration
            ...
            invoicingCycleConfiguration = newFloatingTieredPackagePrice.invoicingCycleConfiguration
            licenseTypeId = newFloatingTieredPackagePrice.licenseTypeId
            metadata = newFloatingTieredPackagePrice.metadata
            additionalProperties = newFloatingTieredPackagePrice.additionalProperties.toMutableMap()
        }
         ...
         * [TieredPackageConfig] value instead. This method is primarily for setting the field to an

...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionPriceIntervalsResponse: SubscriptionPriceIntervalsResponse) =
            apply {
                ...
                adjustmentIntervals =
                    subscriptionPriceIntervalsResponse.adjustmentIntervals.map {
                        it.toMutableList()
                    }
                autoCollection = subscriptionPriceIntervalsResponse.autoCollection
                billingCycleAnchorConfiguration =
                    subscriptionPriceIntervalsResponse.billingCycleAnchorConfiguration
                ...
                currentBillingPeriodStartDate =
                    subscriptionPriceIntervalsResponse.currentBillingPeriodStartDate
                ...
                discountIntervals =
                    subscriptionPriceIntervalsResponse.discountIntervals.map { it.toMutableList() }
                endDate = subscriptionPriceIntervalsResponse.endDate
                fixedFeeQuantitySchedule =
                    subscriptionPriceIntervalsResponse.fixedFeeQuantitySchedule.map {
                        it.toMutableList()
                    }
                invoicingThreshold = subscriptionPriceIntervalsResponse.invoicingThreshold
                maximumIntervals =
                    subscriptionPriceIntervalsResponse.maximumIntervals.map { it.toMutableList() }
                metadata = subscriptionPriceIntervalsResponse.metadata
                minimumIntervals =
                    subscriptionPriceIntervalsResponse.minimumIntervals.map { it.toMutableList() }
                name = subscriptionPriceIntervalsResponse.name
                netTerms = subscriptionPriceIntervalsResponse.netTerms
                pendingSubscriptionChange =
                    subscriptionPriceIntervalsResponse.pendingSubscriptionChange
                plan = subscriptionPriceIntervalsResponse.plan
                priceIntervals =
                    subscriptionPriceIntervalsResponse.priceIntervals.map { it.toMutableList() }
                ...
                changedResources = subscriptionPriceIntervalsResponse.changedResources
                additionalProperties =
                    subscriptionPriceIntervalsResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [SubscriptionPriceIntervalsResponse].
         *
    ...
    fun validate(): SubscriptionPriceIntervalsResponse = apply {
        if (validated) {
            return@apply
        }

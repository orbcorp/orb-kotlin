...
@JsonDeserialize(builder = SubscriptionPriceIntervalsResponse.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(subscriptionPriceIntervalsResponse: SubscriptionPriceIntervalsResponse) =
            apply {
                this.metadata = subscriptionPriceIntervalsResponse.metadata
                this.id = subscriptionPriceIntervalsResponse.id
                this.customer = subscriptionPriceIntervalsResponse.customer
                this.plan = subscriptionPriceIntervalsResponse.plan
                this.startDate = subscriptionPriceIntervalsResponse.startDate
                this.endDate = subscriptionPriceIntervalsResponse.endDate
                this.createdAt = subscriptionPriceIntervalsResponse.createdAt
                ...
                this.status = subscriptionPriceIntervalsResponse.status
                this.trialInfo = subscriptionPriceIntervalsResponse.trialInfo
                this.activePlanPhaseOrder = subscriptionPriceIntervalsResponse.activePlanPhaseOrder
                this.fixedFeeQuantitySchedule =
                    subscriptionPriceIntervalsResponse.fixedFeeQuantitySchedule
                this.defaultInvoiceMemo = subscriptionPriceIntervalsResponse.defaultInvoiceMemo
                this.autoCollection = subscriptionPriceIntervalsResponse.autoCollection
                this.netTerms = subscriptionPriceIntervalsResponse.netTerms
                this.redeemedCoupon = subscriptionPriceIntervalsResponse.redeemedCoupon
                this.billingCycleDay = subscriptionPriceIntervalsResponse.billingCycleDay
                this.billingCycleAnchorConfiguration =
                    subscriptionPriceIntervalsResponse.billingCycleAnchorConfiguration
                this.invoicingThreshold = subscriptionPriceIntervalsResponse.invoicingThreshold
                this.priceIntervals = subscriptionPriceIntervalsResponse.priceIntervals
                this.adjustmentIntervals = subscriptionPriceIntervalsResponse.adjustmentIntervals
                this.discountIntervals = subscriptionPriceIntervalsResponse.discountIntervals
                this.minimumIntervals = subscriptionPriceIntervalsResponse.minimumIntervals
                this.maximumIntervals = subscriptionPriceIntervalsResponse.maximumIntervals
                additionalProperties(subscriptionPriceIntervalsResponse.additionalProperties)
            }

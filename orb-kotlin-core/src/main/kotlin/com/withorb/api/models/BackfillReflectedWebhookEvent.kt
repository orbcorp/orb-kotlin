...
class BackfillReflectedWebhookEvent
...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = backfillReflectedWebhookEvent.properties().convert(MyClass::class.java)
     * ```
     */
    ...
    /** A builder for [BackfillReflectedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(backfillReflectedWebhookEvent: BackfillReflectedWebhookEvent) = apply {
            id = backfillReflectedWebhookEvent.id
            backfill = backfillReflectedWebhookEvent.backfill
            createdAt = backfillReflectedWebhookEvent.createdAt
            properties = backfillReflectedWebhookEvent.properties
            type = backfillReflectedWebhookEvent.type
            additionalProperties = backfillReflectedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BackfillReflectedWebhookEvent].
         *
         ...
         */
        fun build(): BackfillReflectedWebhookEvent =
            BackfillReflectedWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): BackfillReflectedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val BACKFILL_REFLECTED = of("backfill.reflected")
        ...
        fun value(): Value =
            when (this) {
                BACKFILL_REFLECTED -> Value.BACKFILL_REFLECTED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                BACKFILL_REFLECTED -> Known.BACKFILL_REFLECTED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BackfillReflectedWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "BackfillReflectedWebhookEvent{id=$id, backfill=$backfill, createdAt=$createdAt, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}

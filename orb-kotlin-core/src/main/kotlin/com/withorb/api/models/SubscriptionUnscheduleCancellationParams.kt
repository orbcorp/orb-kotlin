 ...
 */
class SubscriptionUnscheduleCancellationParams private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionUnscheduleCancellationParams: SubscriptionUnscheduleCancellationParams) =
            apply {
                subscriptionId = subscriptionUnscheduleCancellationParams.subscriptionId
                additionalHeaders = subscriptionUnscheduleCancellationParams.additionalHeaders.toBuilder()
                additionalQueryParams = subscriptionUnscheduleCancellationParams.additionalQueryParams.toBuilder()
                additionalBodyProperties = subscriptionUnscheduleCancellationParams.additionalBodyProperties.toMutableMap()
            }
    ...
    override fun toString() = "SubscriptionUnscheduleCancellationParams{subscriptionId=$subscriptionId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}

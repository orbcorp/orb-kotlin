...
class InvoiceManuallyMarkedAsVoidWebhookEvent
...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = invoiceManuallyMarkedAsVoidWebhookEvent.properties().convert(MyClass::class.java)
     * ```
     */
    ...
    /** A builder for [InvoiceManuallyMarkedAsVoidWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            invoiceManuallyMarkedAsVoidWebhookEvent: InvoiceManuallyMarkedAsVoidWebhookEvent
        ) = apply {
            id = invoiceManuallyMarkedAsVoidWebhookEvent.id
            createdAt = invoiceManuallyMarkedAsVoidWebhookEvent.createdAt
            invoice = invoiceManuallyMarkedAsVoidWebhookEvent.invoice
            properties = invoiceManuallyMarkedAsVoidWebhookEvent.properties
            type = invoiceManuallyMarkedAsVoidWebhookEvent.type
            additionalProperties =
                invoiceManuallyMarkedAsVoidWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InvoiceManuallyMarkedAsVoidWebhookEvent].
         *
         ...
         */
        fun build(): InvoiceManuallyMarkedAsVoidWebhookEvent =
            InvoiceManuallyMarkedAsVoidWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): InvoiceManuallyMarkedAsVoidWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val INVOICE_MANUALLY_MARKED_AS_VOID = of("invoice.manually_marked_as_void")
        ...
        enum class Known {
            INVOICE_MANUALLY_MARKED_AS_VOID
        }
        ...
        fun value(): Value =
            when (this) {
                INVOICE_MANUALLY_MARKED_AS_VOID -> Value.INVOICE_MANUALLY_MARKED_AS_VOID
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                INVOICE_MANUALLY_MARKED_AS_VOID -> Known.INVOICE_MANUALLY_MARKED_AS_VOID
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InvoiceManuallyMarkedAsVoidWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "InvoiceManuallyMarkedAsVoidWebhookEvent{id=$id, createdAt=$createdAt, invoice=$invoice, properties=$properties, type=$type, additionalProperties=$additionalProperties}"
}

...
@NoAutoDetect
class SubscriptionTriggerPhaseResponse @JsonCreator private constructor(
    ...
    fun validate(): SubscriptionTriggerPhaseResponse =
        apply {
            if (validated) {
              return@apply
            }
    ...
    /** A builder for [SubscriptionTriggerPhaseResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionTriggerPhaseResponse: SubscriptionTriggerPhaseResponse) =
            apply {
                id = subscriptionTriggerPhaseResponse.id
                activePlanPhaseOrder = subscriptionTriggerPhaseResponse.activePlanPhaseOrder
                adjustmentIntervals = subscriptionTriggerPhaseResponse.adjustmentIntervals.map { it.toMutableList() }
                autoCollection = subscriptionTriggerPhaseResponse.autoCollection
                billingCycleAnchorConfiguration = subscriptionTriggerPhaseResponse.billingCycleAnchorConfiguration
                billingCycleDay = subscriptionTriggerPhaseResponse.billingCycleDay
                createdAt = subscriptionTriggerPhaseResponse.createdAt
                currentBillingPeriodEndDate = subscriptionTriggerPhaseResponse.currentBillingPeriodEndDate
                currentBillingPeriodStartDate = subscriptionTriggerPhaseResponse.currentBillingPeriodStartDate
                customer = subscriptionTriggerPhaseResponse.customer
                defaultInvoiceMemo = subscriptionTriggerPhaseResponse.defaultInvoiceMemo
                discountIntervals = subscriptionTriggerPhaseResponse.discountIntervals.map { it.toMutableList() }
                endDate = subscriptionTriggerPhaseResponse.endDate
                fixedFeeQuantitySchedule = subscriptionTriggerPhaseResponse.fixedFeeQuantitySchedule.map { it.toMutableList() }
                invoicingThreshold = subscriptionTriggerPhaseResponse.invoicingThreshold
                maximumIntervals = subscriptionTriggerPhaseResponse.maximumIntervals.map { it.toMutableList() }
                metadata = subscriptionTriggerPhaseResponse.metadata
                minimumIntervals = subscriptionTriggerPhaseResponse.minimumIntervals.map { it.toMutableList() }
                netTerms = subscriptionTriggerPhaseResponse.netTerms
                plan = subscriptionTriggerPhaseResponse.plan
                priceIntervals = subscriptionTriggerPhaseResponse.priceIntervals.map { it.toMutableList() }
                redeemedCoupon = subscriptionTriggerPhaseResponse.redeemedCoupon
                startDate = subscriptionTriggerPhaseResponse.startDate
                status = subscriptionTriggerPhaseResponse.status
                trialInfo = subscriptionTriggerPhaseResponse.trialInfo
                additionalProperties = subscriptionTriggerPhaseResponse.additionalProperties.toMutableMap()
            }
        ...
        fun build(): SubscriptionTriggerPhaseResponse =
            SubscriptionTriggerPhaseResponse(
              checkRequired(
                "id", id
              ),

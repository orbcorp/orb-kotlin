...
class SubscriptionAccountingSyncFailedWebhookEvent
...
private constructor(
    ...
    ) : this(id, accountingSyncRecord, createdAt, properties, subscription, type, mutableMapOf())
    ...
    /** A builder for [SubscriptionAccountingSyncFailedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = subscriptionAccountingSyncFailedWebhookEvent.id
            accountingSyncRecord = subscriptionAccountingSyncFailedWebhookEvent.accountingSyncRecord
            createdAt = subscriptionAccountingSyncFailedWebhookEvent.createdAt
            properties = subscriptionAccountingSyncFailedWebhookEvent.properties
            subscription = subscriptionAccountingSyncFailedWebhookEvent.subscription
            type = subscriptionAccountingSyncFailedWebhookEvent.type
            additionalProperties =
                subscriptionAccountingSyncFailedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubscriptionAccountingSyncFailedWebhookEvent].
         *
         ...
         */
        fun build(): SubscriptionAccountingSyncFailedWebhookEvent =
            SubscriptionAccountingSyncFailedWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): SubscriptionAccountingSyncFailedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(accountingSyncRecord: AccountingSyncRecord) = apply {
                ...
                subscriptionId = accountingSyncRecord.subscriptionId
        ...
        override fun toString() =
            "AccountingSyncRecord{id=$id, customerId=$customerId, recordType=$recordType, errorDetails=$errorDetails, providerCustomerId=$providerCustomerId, status=$status, subscriptionId=$subscriptionId, syncAction=$syncAction, additionalProperties=$additionalProperties}"
    }
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val SUBSCRIPTION_ACCOUNTING_SYNC_FAILED = of("subscription.accounting_sync_failed")
        ...
        fun value(): Value =
            when (this) {
                SUBSCRIPTION_ACCOUNTING_SYNC_FAILED -> Value.SUBSCRIPTION_ACCOUNTING_SYNC_FAILED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                SUBSCRIPTION_ACCOUNTING_SYNC_FAILED -> Known.SUBSCRIPTION_ACCOUNTING_SYNC_FAILED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionAccountingSyncFailedWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "SubscriptionAccountingSyncFailedWebhookEvent{id=$id, accountingSyncRecord=$accountingSyncRecord, createdAt=$createdAt, properties=$properties, subscription=$subscription, type=$type, additionalProperties=$additionalProperties}"
}

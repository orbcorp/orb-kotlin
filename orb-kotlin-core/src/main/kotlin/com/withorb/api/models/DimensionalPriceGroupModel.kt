 ...
 */
@NoAutoDetect
class DimensionalPriceGroupModel
@JsonCreator
private constructor(
    ...
    fun externalDimensionalPriceGroupId(): String? =
    ...
    fun validate(): DimensionalPriceGroupModel = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DimensionalPriceGroupModel].
         *
    ...
    /** A builder for [DimensionalPriceGroupModel]. */
    class Builder internal constructor() {
        ...
        internal fun from(dimensionalPriceGroupModel: DimensionalPriceGroupModel) = apply {
            id = dimensionalPriceGroupModel.id
            billableMetricId = dimensionalPriceGroupModel.billableMetricId
            dimensions = dimensionalPriceGroupModel.dimensions.map { it.toMutableList() }
            externalDimensionalPriceGroupId =
                dimensionalPriceGroupModel.externalDimensionalPriceGroupId
            metadata = dimensionalPriceGroupModel.metadata
            name = dimensionalPriceGroupModel.name
            additionalProperties = dimensionalPriceGroupModel.additionalProperties.toMutableMap()
        }
        ...
        fun build(): DimensionalPriceGroupModel =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DimensionalPriceGroupModel && id == other.id && billableMetricId == other.billableMetricId && dimensions == other.dimensions && externalDimensionalPriceGroupId == other.externalDimensionalPriceGroupId && metadata == other.metadata && name == other.name && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "DimensionalPriceGroupModel{id=$id, billableMetricId=$billableMetricId, dimensions=$dimensions, externalDimensionalPriceGroupId=$externalDimensionalPriceGroupId, metadata=$metadata, name=$name, additionalProperties=$additionalProperties}"
}

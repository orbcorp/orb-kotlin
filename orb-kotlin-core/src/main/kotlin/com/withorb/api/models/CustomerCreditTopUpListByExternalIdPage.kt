...
class CustomerCreditTopUpListByExternalIdPage private constructor(
    ...
    companion object {
        ...
        fun of(topUpsService: TopUpService, params: CustomerCreditTopUpListByExternalIdParams, response: Response) =
    ...
    class AutoPager(
        ...
        override fun iterator(): Iterator<CustomerCreditTopUpListByExternalIdResponse> =
            iterator {
                var page = firstPage
                var index = 0
                while (true) {

...
private constructor(
    ...
    fun validate(): BillableMetricModel = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BillableMetricModel].
         *
    ...
    /** A builder for [BillableMetricModel]. */
    class Builder internal constructor() {
        ...
        internal fun from(billableMetricModel: BillableMetricModel) = apply {
            id = billableMetricModel.id
            description = billableMetricModel.description
            item = billableMetricModel.item
            metadata = billableMetricModel.metadata
            name = billableMetricModel.name
            status = billableMetricModel.status
            additionalProperties = billableMetricModel.additionalProperties.toMutableMap()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BillableMetricModel && id == other.id && description == other.description && item == other.item && metadata == other.metadata && name == other.name && status == other.status && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "BillableMetricModel{id=$id, description=$description, item=$item, metadata=$metadata, name=$name, status=$status, additionalProperties=$additionalProperties}"
}

...
class NewPlanTieredPackageWithMinimumPrice
private constructor(
    ...
    /** A builder for [NewPlanTieredPackageWithMinimumPrice]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            cadence = newPlanTieredPackageWithMinimumPrice.cadence
            itemId = newPlanTieredPackageWithMinimumPrice.itemId
            modelType = newPlanTieredPackageWithMinimumPrice.modelType
            name = newPlanTieredPackageWithMinimumPrice.name
            tieredPackageWithMinimumConfig =
                newPlanTieredPackageWithMinimumPrice.tieredPackageWithMinimumConfig
            billableMetricId = newPlanTieredPackageWithMinimumPrice.billableMetricId
            billedInAdvance = newPlanTieredPackageWithMinimumPrice.billedInAdvance
            billingCycleConfiguration =
                newPlanTieredPackageWithMinimumPrice.billingCycleConfiguration
            conversionRate = newPlanTieredPackageWithMinimumPrice.conversionRate
            currency = newPlanTieredPackageWithMinimumPrice.currency
            dimensionalPriceConfiguration =
                newPlanTieredPackageWithMinimumPrice.dimensionalPriceConfiguration
            externalPriceId = newPlanTieredPackageWithMinimumPrice.externalPriceId
            fixedPriceQuantity = newPlanTieredPackageWithMinimumPrice.fixedPriceQuantity
            invoiceGroupingKey = newPlanTieredPackageWithMinimumPrice.invoiceGroupingKey
            invoicingCycleConfiguration =
                newPlanTieredPackageWithMinimumPrice.invoicingCycleConfiguration
            metadata = newPlanTieredPackageWithMinimumPrice.metadata
            additionalProperties =
                newPlanTieredPackageWithMinimumPrice.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [NewPlanTieredPackageWithMinimumPrice].
         *
         ...
         */
        fun build(): NewPlanTieredPackageWithMinimumPrice =
            NewPlanTieredPackageWithMinimumPrice(
    ...
    fun validate(): NewPlanTieredPackageWithMinimumPrice = apply {
        if (validated) {
            return@apply
        }

...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            appliesToPriceIds =
                monetaryPercentageDiscountAdjustment.appliesToPriceIds.map { it.toMutableList() }
            filters = monetaryPercentageDiscountAdjustment.filters.map { it.toMutableList() }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MonetaryPercentageDiscountAdjustment &&
            id == other.id &&

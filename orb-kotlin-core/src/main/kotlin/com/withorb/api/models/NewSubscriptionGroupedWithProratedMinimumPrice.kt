...
private constructor(
     ...
     *
     * Unlike [groupedWithProratedMinimumConfig], this method doesn't throw if the JSON field has an
     * unexpected type.
     */
    @JsonProperty("grouped_with_prorated_minimum_config")
    @ExcludeMissing
    ...
    class Builder internal constructor() {
        ...
        private var groupedWithProratedMinimumConfig: JsonField<GroupedWithProratedMinimumConfig>? =
            null
        ...
        internal fun from(
            ...
            dimensionalPriceConfiguration =
                newSubscriptionGroupedWithProratedMinimumPrice.dimensionalPriceConfiguration
            externalPriceId = newSubscriptionGroupedWithProratedMinimumPrice.externalPriceId
            fixedPriceQuantity = newSubscriptionGroupedWithProratedMinimumPrice.fixedPriceQuantity
            invoiceGroupingKey = newSubscriptionGroupedWithProratedMinimumPrice.invoiceGroupingKey
            invoicingCycleConfiguration =
            ...
            additionalProperties =
                newSubscriptionGroupedWithProratedMinimumPrice.additionalProperties.toMutableMap()
        }
         ...
         * [GroupedWithProratedMinimumConfig] value instead. This method is primarily for setting
        ...
        /**
         * Returns an immutable instance of [NewSubscriptionGroupedWithProratedMinimumPrice].
         *
        ...
        fun build(): NewSubscriptionGroupedWithProratedMinimumPrice =
            NewSubscriptionGroupedWithProratedMinimumPrice(
                ...
                checkRequired("groupedWithProratedMinimumConfig", groupedWithProratedMinimumConfig),
    ...
    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(cadence, groupedWithProratedMinimumConfig, itemId, modelType, name, billableMetricId, billedInAdvance, billingCycleConfiguration, conversionRate, currency, dimensionalPriceConfiguration, externalPriceId, fixedPriceQuantity, invoiceGroupingKey, invoicingCycleConfiguration, metadata, referenceId, additionalProperties) }
    /* spotless:on */

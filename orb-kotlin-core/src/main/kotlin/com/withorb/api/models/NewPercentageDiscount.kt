...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(newPercentageDiscount: NewPercentageDiscount) = apply {
            ...
            appliesToAll = newPercentageDiscount.appliesToAll
            appliesToItemIds = newPercentageDiscount.appliesToItemIds.map { it.toMutableList() }
            appliesToPriceIds = newPercentageDiscount.appliesToPriceIds.map { it.toMutableList() }
            currency = newPercentageDiscount.currency
            filters = newPercentageDiscount.filters.map { it.toMutableList() }
            isInvoiceLevel = newPercentageDiscount.isInvoiceLevel
            priceType = newPercentageDiscount.priceType

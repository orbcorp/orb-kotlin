 ...
 * providers, etc).
 *
 * This is a lighter-weight alternative to the issue invoice endpoint, returning an invoice summary
 * without any line item details.
 */
class InvoiceIssueSummaryParams
private constructor(
    ...
    companion object {
        ...
        fun none(): InvoiceIssueSummaryParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [InvoiceIssueSummaryParams].
         */
        fun builder() = Builder()
    }

    /** A builder for [InvoiceIssueSummaryParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(invoiceIssueSummaryParams: InvoiceIssueSummaryParams) = apply {
            invoiceId = invoiceIssueSummaryParams.invoiceId
            body = invoiceIssueSummaryParams.body.toBuilder()
            additionalHeaders = invoiceIssueSummaryParams.additionalHeaders.toBuilder()
            additionalQueryParams = invoiceIssueSummaryParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [InvoiceIssueSummaryParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): InvoiceIssueSummaryParams =
    ...
    private constructor(
         ...
         */
        internal fun validity(): Int = (if (synchronous.asKnown() == null) 0 else 1)
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InvoiceIssueSummaryParams &&
    ...
    override fun toString() =
        "InvoiceIssueSummaryParams{invoiceId=$invoiceId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

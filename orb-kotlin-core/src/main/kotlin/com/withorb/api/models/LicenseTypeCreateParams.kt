...
private constructor(
     ...
     */
    fun groupingKey(): String = body.groupingKey()
     ...
     */
    fun _groupingKey(): JsonField<String> = body._groupingKey()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LicenseTypeCreateParams].
         *
    ...
    /** A builder for [LicenseTypeCreateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(licenseTypeCreateParams: LicenseTypeCreateParams) = apply {
            body = licenseTypeCreateParams.body.toBuilder()
            additionalHeaders = licenseTypeCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = licenseTypeCreateParams.additionalQueryParams.toBuilder()
        }
         ...
         * field.
         */
        fun groupingKey(groupingKey: String) = apply { body.groupingKey(groupingKey) }
         ...
         * value.
         */
        fun groupingKey(groupingKey: JsonField<String>) = apply { body.groupingKey(groupingKey) }
        ...
        /**
         * Returns an immutable instance of [LicenseTypeCreateParams].
         *
         ...
         */
        fun build(): LicenseTypeCreateParams =
    ...
    private constructor(
        ...
        ) : this(groupingKey, name, mutableMapOf())
        ...
        internal fun validity(): Int =
            (if (groupingKey.asKnown() == null) 0 else 1) + (if (name.asKnown() == null) 0 else 1)
        ...
        private val hashCode: Int by lazy { Objects.hash(groupingKey, name, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{groupingKey=$groupingKey, name=$name, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LicenseTypeCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "LicenseTypeCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(newFloatingGroupedTieredPrice: NewFloatingGroupedTieredPrice) = apply {
            ...
            billingCycleConfiguration = newFloatingGroupedTieredPrice.billingCycleConfiguration
            conversionRate = newFloatingGroupedTieredPrice.conversionRate
            conversionRateConfig = newFloatingGroupedTieredPrice.conversionRateConfig
            dimensionalPriceConfiguration =
                newFloatingGroupedTieredPrice.dimensionalPriceConfiguration
            ...
            invoicingCycleConfiguration = newFloatingGroupedTieredPrice.invoicingCycleConfiguration
            licenseTypeId = newFloatingGroupedTieredPrice.licenseTypeId
            metadata = newFloatingGroupedTieredPrice.metadata
            additionalProperties = newFloatingGroupedTieredPrice.additionalProperties.toMutableMap()
        }

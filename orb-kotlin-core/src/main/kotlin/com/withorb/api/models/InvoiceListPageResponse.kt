...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InvoiceListPageResponse].
         *
    ...
    /** A builder for [InvoiceListPageResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(invoiceListPageResponse: InvoiceListPageResponse) = apply {
            data = invoiceListPageResponse.data.map { it.toMutableList() }
            paginationMetadata = invoiceListPageResponse.paginationMetadata
            additionalProperties = invoiceListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InvoiceListPageResponse].
         *
         ...
         */
        fun build(): InvoiceListPageResponse =
    ...
    fun validate(): InvoiceListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is InvoiceListPageResponse && data == other.data && paginationMetadata == other.paginationMetadata && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "InvoiceListPageResponse{data=$data, paginationMetadata=$paginationMetadata, additionalProperties=$additionalProperties}"
}

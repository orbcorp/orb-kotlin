...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            conversionRateConfig = newSubscriptionPackageWithAllocationPrice.conversionRateConfig
            currency = newSubscriptionPackageWithAllocationPrice.currency
            dimensionalPriceConfiguration =
                newSubscriptionPackageWithAllocationPrice.dimensionalPriceConfiguration
            ...
            licenseTypeId = newSubscriptionPackageWithAllocationPrice.licenseTypeId
        ...
        /**
         * Returns an immutable instance of [NewSubscriptionPackageWithAllocationPrice].
         *
    ...
    override fun toString() =
        "NewSubscriptionPackageWithAllocationPrice{cadence=$cadence, itemId=$itemId, modelType=$modelType, name=$name, packageWithAllocationConfig=$packageWithAllocationConfig, billableMetricId=$billableMetricId, billedInAdvance=$billedInAdvance, billingCycleConfiguration=$billingCycleConfiguration, conversionRate=$conversionRate, conversionRateConfig=$conversionRateConfig, currency=$currency, dimensionalPriceConfiguration=$dimensionalPriceConfiguration, externalPriceId=$externalPriceId, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, invoicingCycleConfiguration=$invoicingCycleConfiguration, licenseTypeId=$licenseTypeId, metadata=$metadata, referenceId=$referenceId, additionalProperties=$additionalProperties}"
}

...
@NoAutoDetect
class SubscriptionCancelResponse @JsonCreator private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionCancelResponse: SubscriptionCancelResponse) =
            apply {
                id = subscriptionCancelResponse.id
                activePlanPhaseOrder = subscriptionCancelResponse.activePlanPhaseOrder
                adjustmentIntervals = subscriptionCancelResponse.adjustmentIntervals.map { it.toMutableList() }
                autoCollection = subscriptionCancelResponse.autoCollection
                billingCycleAnchorConfiguration = subscriptionCancelResponse.billingCycleAnchorConfiguration
                ...
                discountIntervals = subscriptionCancelResponse.discountIntervals.map { it.toMutableList() }
                endDate = subscriptionCancelResponse.endDate
                fixedFeeQuantitySchedule = subscriptionCancelResponse.fixedFeeQuantitySchedule.map { it.toMutableList() }
                invoicingThreshold = subscriptionCancelResponse.invoicingThreshold
                maximumIntervals = subscriptionCancelResponse.maximumIntervals.map { it.toMutableList() }
                metadata = subscriptionCancelResponse.metadata
                minimumIntervals = subscriptionCancelResponse.minimumIntervals.map { it.toMutableList() }

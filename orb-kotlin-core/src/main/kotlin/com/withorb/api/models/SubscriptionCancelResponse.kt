...
@JsonDeserialize(builder = SubscriptionCancelResponse.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(subscriptionCancelResponse: SubscriptionCancelResponse) = apply {
            this.metadata = subscriptionCancelResponse.metadata
            this.id = subscriptionCancelResponse.id
            this.customer = subscriptionCancelResponse.customer
            this.plan = subscriptionCancelResponse.plan
            this.startDate = subscriptionCancelResponse.startDate
            this.endDate = subscriptionCancelResponse.endDate
            this.createdAt = subscriptionCancelResponse.createdAt
            ...
            this.currentBillingPeriodEndDate =
                subscriptionCancelResponse.currentBillingPeriodEndDate
            this.status = subscriptionCancelResponse.status
            this.trialInfo = subscriptionCancelResponse.trialInfo
            this.activePlanPhaseOrder = subscriptionCancelResponse.activePlanPhaseOrder
            this.fixedFeeQuantitySchedule = subscriptionCancelResponse.fixedFeeQuantitySchedule
            this.defaultInvoiceMemo = subscriptionCancelResponse.defaultInvoiceMemo
            this.autoCollection = subscriptionCancelResponse.autoCollection
            this.netTerms = subscriptionCancelResponse.netTerms
            this.redeemedCoupon = subscriptionCancelResponse.redeemedCoupon
            this.billingCycleDay = subscriptionCancelResponse.billingCycleDay
            this.billingCycleAnchorConfiguration =
                subscriptionCancelResponse.billingCycleAnchorConfiguration
            this.invoicingThreshold = subscriptionCancelResponse.invoicingThreshold
            this.priceIntervals = subscriptionCancelResponse.priceIntervals
            this.adjustmentIntervals = subscriptionCancelResponse.adjustmentIntervals
            this.discountIntervals = subscriptionCancelResponse.discountIntervals
            this.minimumIntervals = subscriptionCancelResponse.minimumIntervals
            this.maximumIntervals = subscriptionCancelResponse.maximumIntervals
            additionalProperties(subscriptionCancelResponse.additionalProperties)
        }

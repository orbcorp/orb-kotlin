...
private constructor(
    ...
    /** A builder for [PriceEvaluatePreviewEventsResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<Data>>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(priceEvaluatePreviewEventsResponse: PriceEvaluatePreviewEventsResponse) =
            apply {
                data = priceEvaluatePreviewEventsResponse.data.map { it.toMutableList() }
                additionalProperties =
                    priceEvaluatePreviewEventsResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [PriceEvaluatePreviewEventsResponse].
         *
         ...
         */
        fun build(): PriceEvaluatePreviewEventsResponse =
            PriceEvaluatePreviewEventsResponse(
    ...
    fun validate(): PriceEvaluatePreviewEventsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
         ...
         *   server responded with an unexpected value).
         */
        fun inlinePriceIndex(): Long? = inlinePriceIndex.getNullable("inline_price_index")
        ...
        internal fun validity(): Int =
            (if (currency.asKnown() == null) 0 else 1) +
                (priceGroups.asKnown()?.sumOf { it.validity().toInt() } ?: 0) +
                (if (externalPriceId.asKnown() == null) 0 else 1) +
                (if (inlinePriceIndex.asKnown() == null) 0 else 1) +
    ...
    override fun toString() =
        "PriceEvaluatePreviewEventsResponse{data=$data, additionalProperties=$additionalProperties}"
}

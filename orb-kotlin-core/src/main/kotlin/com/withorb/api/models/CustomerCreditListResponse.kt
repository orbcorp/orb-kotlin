...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(customerCreditListResponse: CustomerCreditListResponse) = apply {
            ...
            creditBlockSource = customerCreditListResponse.creditBlockSource
            ...
            creditAllocation = customerCreditListResponse.creditAllocation
            creditCommitment = customerCreditListResponse.creditCommitment
    ...
    override fun toString() =
        "CustomerCreditListResponse{id=$id, balance=$balance, creditBlockSource=$creditBlockSource, effectiveDate=$effectiveDate, expiryDate=$expiryDate, filters=$filters, maximumInitialBalance=$maximumInitialBalance, metadata=$metadata, perUnitCostBasis=$perUnitCostBasis, status=$status, creditAllocation=$creditAllocation, creditCommitment=$creditCommitment, additionalProperties=$additionalProperties}"
}

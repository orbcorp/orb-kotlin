...
class PriceCreateParams constructor(
  ...
  private val newFloatingGroupedWithProratedMinimumPrice: NewFloatingGroupedWithProratedMinimumPrice?,
  ...
  private val additionalHeaders: Map<String, List<String>>,
    ...
    fun newFloatingGroupedWithProratedMinimumPrice(): NewFloatingGroupedWithProratedMinimumPrice? = newFloatingGroupedWithProratedMinimumPrice
    ...
    class PriceCreateBody internal constructor(
      ...
      private val newFloatingGroupedWithProratedMinimumPrice: NewFloatingGroupedWithProratedMinimumPrice? = null,
      ...
      private val _json: JsonValue? = null,
        ...
        fun isNewFloatingGroupedWithProratedMinimumPrice(): Boolean = newFloatingGroupedWithProratedMinimumPrice != null
        ...
        fun asNewFloatingGroupedWithProratedMinimumPrice(): NewFloatingGroupedWithProratedMinimumPrice = newFloatingGroupedWithProratedMinimumPrice.getOrThrow("newFloatingGroupedWithProratedMinimumPrice")
        ...
        fun <T> accept(visitor: Visitor<T>): T {
          return when {
              ...
              newFloatingGroupedWithProratedMinimumPrice != null -> visitor.visitNewFloatingGroupedWithProratedMinimumPrice(newFloatingGroupedWithProratedMinimumPrice)
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is PriceCreateBody &&
              ...
              this.newFloatingGroupedWithProratedMinimumPrice == other.newFloatingGroupedWithProratedMinimumPrice &&
        ...
        override fun toString(): String {
          return when {
              newFloatingUnitPrice != null -> "PriceCreateBody{newFloatingUnitPrice=$newFloatingUnitPrice}"
              newFloatingPackagePrice != null -> "PriceCreateBody{newFloatingPackagePrice=$newFloatingPackagePrice}"
              newFloatingMatrixPrice != null -> "PriceCreateBody{newFloatingMatrixPrice=$newFloatingMatrixPrice}"
              newFloatingMatrixWithAllocationPrice != null -> "PriceCreateBody{newFloatingMatrixWithAllocationPrice=$newFloatingMatrixWithAllocationPrice}"
              newFloatingTieredPrice != null -> "PriceCreateBody{newFloatingTieredPrice=$newFloatingTieredPrice}"
              newFloatingTieredBpsPrice != null -> "PriceCreateBody{newFloatingTieredBpsPrice=$newFloatingTieredBpsPrice}"
              newFloatingBpsPrice != null -> "PriceCreateBody{newFloatingBpsPrice=$newFloatingBpsPrice}"
              newFloatingBulkBpsPrice != null -> "PriceCreateBody{newFloatingBulkBpsPrice=$newFloatingBulkBpsPrice}"
              newFloatingBulkPrice != null -> "PriceCreateBody{newFloatingBulkPrice=$newFloatingBulkPrice}"
              newFloatingThresholdTotalAmountPrice != null -> "PriceCreateBody{newFloatingThresholdTotalAmountPrice=$newFloatingThresholdTotalAmountPrice}"
              newFloatingTieredPackagePrice != null -> "PriceCreateBody{newFloatingTieredPackagePrice=$newFloatingTieredPackagePrice}"
              newFloatingGroupedTieredPrice != null -> "PriceCreateBody{newFloatingGroupedTieredPrice=$newFloatingGroupedTieredPrice}"
              newFloatingTieredWithMinimumPrice != null -> "PriceCreateBody{newFloatingTieredWithMinimumPrice=$newFloatingTieredWithMinimumPrice}"
              newFloatingPackageWithAllocationPrice != null -> "PriceCreateBody{newFloatingPackageWithAllocationPrice=$newFloatingPackageWithAllocationPrice}"
              newFloatingTieredPackageWithMinimumPrice != null -> "PriceCreateBody{newFloatingTieredPackageWithMinimumPrice=$newFloatingTieredPackageWithMinimumPrice}"
              newFloatingUnitWithPercentPrice != null -> "PriceCreateBody{newFloatingUnitWithPercentPrice=$newFloatingUnitWithPercentPrice}"
              newFloatingTieredWithProrationPrice != null -> "PriceCreateBody{newFloatingTieredWithProrationPrice=$newFloatingTieredWithProrationPrice}"
              newFloatingUnitWithProrationPrice != null -> "PriceCreateBody{newFloatingUnitWithProrationPrice=$newFloatingUnitWithProrationPrice}"
              newFloatingGroupedAllocationPrice != null -> "PriceCreateBody{newFloatingGroupedAllocationPrice=$newFloatingGroupedAllocationPrice}"
              newFloatingGroupedWithProratedMinimumPrice != null -> "PriceCreateBody{newFloatingGroupedWithProratedMinimumPrice=$newFloatingGroupedWithProratedMinimumPrice}"
              newFloatingBulkWithProrationPrice != null -> "PriceCreateBody{newFloatingBulkWithProrationPrice=$newFloatingBulkWithProrationPrice}"
        ...
        companion object {
            ...
            fun ofNewFloatingUnitPrice(newFloatingUnitPrice: NewFloatingUnitPrice) = PriceCreateBody(newFloatingUnitPrice = newFloatingUnitPrice)

            fun ofNewFloatingPackagePrice(newFloatingPackagePrice: NewFloatingPackagePrice) = PriceCreateBody(newFloatingPackagePrice = newFloatingPackagePrice)

            fun ofNewFloatingMatrixPrice(newFloatingMatrixPrice: NewFloatingMatrixPrice) = PriceCreateBody(newFloatingMatrixPrice = newFloatingMatrixPrice)

            fun ofNewFloatingMatrixWithAllocationPrice(newFloatingMatrixWithAllocationPrice: NewFloatingMatrixWithAllocationPrice) = PriceCreateBody(newFloatingMatrixWithAllocationPrice = newFloatingMatrixWithAllocationPrice)

            fun ofNewFloatingTieredPrice(newFloatingTieredPrice: NewFloatingTieredPrice) = PriceCreateBody(newFloatingTieredPrice = newFloatingTieredPrice)

            fun ofNewFloatingTieredBpsPrice(newFloatingTieredBpsPrice: NewFloatingTieredBpsPrice) = PriceCreateBody(newFloatingTieredBpsPrice = newFloatingTieredBpsPrice)

            fun ofNewFloatingBpsPrice(newFloatingBpsPrice: NewFloatingBpsPrice) = PriceCreateBody(newFloatingBpsPrice = newFloatingBpsPrice)

            fun ofNewFloatingBulkBpsPrice(newFloatingBulkBpsPrice: NewFloatingBulkBpsPrice) = PriceCreateBody(newFloatingBulkBpsPrice = newFloatingBulkBpsPrice)

            fun ofNewFloatingBulkPrice(newFloatingBulkPrice: NewFloatingBulkPrice) = PriceCreateBody(newFloatingBulkPrice = newFloatingBulkPrice)

            fun ofNewFloatingThresholdTotalAmountPrice(newFloatingThresholdTotalAmountPrice: NewFloatingThresholdTotalAmountPrice) = PriceCreateBody(newFloatingThresholdTotalAmountPrice = newFloatingThresholdTotalAmountPrice)

            fun ofNewFloatingTieredPackagePrice(newFloatingTieredPackagePrice: NewFloatingTieredPackagePrice) = PriceCreateBody(newFloatingTieredPackagePrice = newFloatingTieredPackagePrice)

            fun ofNewFloatingGroupedTieredPrice(newFloatingGroupedTieredPrice: NewFloatingGroupedTieredPrice) = PriceCreateBody(newFloatingGroupedTieredPrice = newFloatingGroupedTieredPrice)

            fun ofNewFloatingTieredWithMinimumPrice(newFloatingTieredWithMinimumPrice: NewFloatingTieredWithMinimumPrice) = PriceCreateBody(newFloatingTieredWithMinimumPrice = newFloatingTieredWithMinimumPrice)

            fun ofNewFloatingPackageWithAllocationPrice(newFloatingPackageWithAllocationPrice: NewFloatingPackageWithAllocationPrice) = PriceCreateBody(newFloatingPackageWithAllocationPrice = newFloatingPackageWithAllocationPrice)

            fun ofNewFloatingTieredPackageWithMinimumPrice(newFloatingTieredPackageWithMinimumPrice: NewFloatingTieredPackageWithMinimumPrice) = PriceCreateBody(newFloatingTieredPackageWithMinimumPrice = newFloatingTieredPackageWithMinimumPrice)

            fun ofNewFloatingUnitWithPercentPrice(newFloatingUnitWithPercentPrice: NewFloatingUnitWithPercentPrice) = PriceCreateBody(newFloatingUnitWithPercentPrice = newFloatingUnitWithPercentPrice)

            fun ofNewFloatingTieredWithProrationPrice(newFloatingTieredWithProrationPrice: NewFloatingTieredWithProrationPrice) = PriceCreateBody(newFloatingTieredWithProrationPrice = newFloatingTieredWithProrationPrice)

            fun ofNewFloatingUnitWithProrationPrice(newFloatingUnitWithProrationPrice: NewFloatingUnitWithProrationPrice) = PriceCreateBody(newFloatingUnitWithProrationPrice = newFloatingUnitWithProrationPrice)

            fun ofNewFloatingGroupedAllocationPrice(newFloatingGroupedAllocationPrice: NewFloatingGroupedAllocationPrice) = PriceCreateBody(newFloatingGroupedAllocationPrice = newFloatingGroupedAllocationPrice)

            fun ofNewFloatingGroupedWithProratedMinimumPrice(newFloatingGroupedWithProratedMinimumPrice: NewFloatingGroupedWithProratedMinimumPrice) = PriceCreateBody(newFloatingGroupedWithProratedMinimumPrice = newFloatingGroupedWithProratedMinimumPrice)

            fun ofNewFloatingBulkWithProrationPrice(newFloatingBulkWithProrationPrice: NewFloatingBulkWithProrationPrice) = PriceCreateBody(newFloatingBulkWithProrationPrice = newFloatingBulkWithProrationPrice)
        }
        ...
        interface Visitor<out T> {
            ...
            fun visitNewFloatingGroupedWithProratedMinimumPrice(newFloatingGroupedWithProratedMinimumPrice: NewFloatingGroupedWithProratedMinimumPrice): T
        ...
        class Deserializer : BaseDeserializer<PriceCreateBody>(PriceCreateBody::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): PriceCreateBody {
              ...
              tryDeserialize(node, jacksonTypeRef<NewFloatingTieredPackageWithMinimumPrice>())?.let {
                  return PriceCreateBody(newFloatingTieredPackageWithMinimumPrice = it, _json = json)
              }
              ...
              tryDeserialize(node, jacksonTypeRef<NewFloatingGroupedWithProratedMinimumPrice>())?.let {
                  return PriceCreateBody(newFloatingGroupedWithProratedMinimumPrice = it, _json = json)
              }
        ...
        class Serializer : BaseSerializer<PriceCreateBody>(PriceCreateBody::class) {
            ...
            override fun serialize(value: PriceCreateBody, generator: JsonGenerator, provider: SerializerProvider) {
              when {
                  ...
                  value.newFloatingGroupedWithProratedMinimumPrice != null -> generator.writeObject(value.newFloatingGroupedWithProratedMinimumPrice)
    ...
    class Builder {
        ...
        private var newFloatingMatrixWithAllocationPrice: NewFloatingMatrixWithAllocationPrice? = null
        ...
        private var newFloatingThresholdTotalAmountPrice: NewFloatingThresholdTotalAmountPrice? = null
        ...
        private var newFloatingPackageWithAllocationPrice: NewFloatingPackageWithAllocationPrice? = null
        private var newFloatingTieredPackageWithMinimumPrice: NewFloatingTieredPackageWithMinimumPrice? = null
        ...
        private var newFloatingGroupedWithProratedMinimumPrice: NewFloatingGroupedWithProratedMinimumPrice? = null
        ...
        internal fun from(priceCreateParams: PriceCreateParams) = apply {
            ...
            this.newFloatingMatrixWithAllocationPrice = priceCreateParams.newFloatingMatrixWithAllocationPrice
            ...
            this.newFloatingThresholdTotalAmountPrice = priceCreateParams.newFloatingThresholdTotalAmountPrice
            ...
            this.newFloatingTieredWithMinimumPrice = priceCreateParams.newFloatingTieredWithMinimumPrice
            this.newFloatingPackageWithAllocationPrice = priceCreateParams.newFloatingPackageWithAllocationPrice
            this.newFloatingTieredPackageWithMinimumPrice = priceCreateParams.newFloatingTieredPackageWithMinimumPrice
            this.newFloatingUnitWithPercentPrice = priceCreateParams.newFloatingUnitWithPercentPrice
            this.newFloatingTieredWithProrationPrice = priceCreateParams.newFloatingTieredWithProrationPrice
            this.newFloatingUnitWithProrationPrice = priceCreateParams.newFloatingUnitWithProrationPrice
            this.newFloatingGroupedAllocationPrice = priceCreateParams.newFloatingGroupedAllocationPrice
            this.newFloatingGroupedWithProratedMinimumPrice = priceCreateParams.newFloatingGroupedWithProratedMinimumPrice
        ...
        fun forNewFloatingMatrixWithAllocationPrice(newFloatingMatrixWithAllocationPrice: NewFloatingMatrixWithAllocationPrice) = apply {
            this.newFloatingUnitPrice = null
            this.newFloatingPackagePrice = null
            this.newFloatingMatrixPrice = null
        ...
        fun forNewFloatingTieredBpsPrice(newFloatingTieredBpsPrice: NewFloatingTieredBpsPrice) = apply {
            this.newFloatingUnitPrice = null
            this.newFloatingPackagePrice = null
            this.newFloatingMatrixPrice = null
            this.newFloatingMatrixWithAllocationPrice = null
        ...
        fun forNewFloatingThresholdTotalAmountPrice(newFloatingThresholdTotalAmountPrice: NewFloatingThresholdTotalAmountPrice) = apply {
            this.newFloatingUnitPrice = null
            this.newFloatingPackagePrice = null
            this.newFloatingMatrixPrice = null
            this.newFloatingMatrixWithAllocationPrice = null
        ...
        fun forNewFloatingTieredPackagePrice(newFloatingTieredPackagePrice: NewFloatingTieredPackagePrice) = apply {
            this.newFloatingUnitPrice = null
            this.newFloatingPackagePrice = null
            this.newFloatingMatrixPrice = null
            this.newFloatingMatrixWithAllocationPrice = null
        ...
        fun forNewFloatingGroupedTieredPrice(newFloatingGroupedTieredPrice: NewFloatingGroupedTieredPrice) = apply {
            this.newFloatingUnitPrice = null
            this.newFloatingPackagePrice = null
            this.newFloatingMatrixPrice = null
            this.newFloatingMatrixWithAllocationPrice = null
        ...
        fun forNewFloatingTieredWithMinimumPrice(newFloatingTieredWithMinimumPrice: NewFloatingTieredWithMinimumPrice) = apply {
            this.newFloatingUnitPrice = null
            this.newFloatingPackagePrice = null
            this.newFloatingMatrixPrice = null
            this.newFloatingMatrixWithAllocationPrice = null
        ...
        fun forNewFloatingPackageWithAllocationPrice(newFloatingPackageWithAllocationPrice: NewFloatingPackageWithAllocationPrice) = apply {
            this.newFloatingUnitPrice = null
            this.newFloatingPackagePrice = null
            this.newFloatingMatrixPrice = null
            this.newFloatingMatrixWithAllocationPrice = null
        ...
        fun forNewFloatingTieredPackageWithMinimumPrice(newFloatingTieredPackageWithMinimumPrice: NewFloatingTieredPackageWithMinimumPrice) = apply {
            this.newFloatingUnitPrice = null
            this.newFloatingPackagePrice = null
            this.newFloatingMatrixPrice = null
            this.newFloatingMatrixWithAllocationPrice = null
        ...
        fun forNewFloatingUnitWithPercentPrice(newFloatingUnitWithPercentPrice: NewFloatingUnitWithPercentPrice) = apply {
            this.newFloatingUnitPrice = null
            this.newFloatingPackagePrice = null
            this.newFloatingMatrixPrice = null
            this.newFloatingMatrixWithAllocationPrice = null
        ...
        fun forNewFloatingTieredWithProrationPrice(newFloatingTieredWithProrationPrice: NewFloatingTieredWithProrationPrice) = apply {
            this.newFloatingUnitPrice = null
            this.newFloatingPackagePrice = null
            this.newFloatingMatrixPrice = null
            this.newFloatingMatrixWithAllocationPrice = null
        ...
        fun forNewFloatingUnitWithProrationPrice(newFloatingUnitWithProrationPrice: NewFloatingUnitWithProrationPrice) = apply {
            this.newFloatingUnitPrice = null
            this.newFloatingPackagePrice = null
            this.newFloatingMatrixPrice = null
            this.newFloatingMatrixWithAllocationPrice = null
        ...
        fun forNewFloatingGroupedAllocationPrice(newFloatingGroupedAllocationPrice: NewFloatingGroupedAllocationPrice) = apply {
            this.newFloatingUnitPrice = null
            this.newFloatingPackagePrice = null
            this.newFloatingMatrixPrice = null
            this.newFloatingMatrixWithAllocationPrice = null
        ...
        fun forNewFloatingGroupedWithProratedMinimumPrice(newFloatingGroupedWithProratedMinimumPrice: NewFloatingGroupedWithProratedMinimumPrice) = apply {
            this.newFloatingUnitPrice = null
            this.newFloatingPackagePrice = null
            this.newFloatingMatrixPrice = null
            this.newFloatingMatrixWithAllocationPrice = null
            ...
            this.newFloatingUnitWithProrationPrice = null
            this.newFloatingGroupedAllocationPrice = null
            this.newFloatingGroupedWithProratedMinimumPrice = newFloatingGroupedWithProratedMinimumPrice
            this.newFloatingBulkWithProrationPrice = null
        }

        fun forNewFloatingBulkWithProrationPrice(newFloatingBulkWithProrationPrice: NewFloatingBulkWithProrationPrice) = apply {
            this.newFloatingUnitPrice = null
            this.newFloatingPackagePrice = null
            this.newFloatingMatrixPrice = null
            this.newFloatingMatrixWithAllocationPrice = null
        ...
        fun build(): PriceCreateParams = PriceCreateParams(
            newFloatingUnitPrice,
            newFloatingPackagePrice,
            newFloatingMatrixPrice,
            newFloatingMatrixWithAllocationPrice,
    ...
    class NewFloatingUnitPrice private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        fun billedInAdvance(): Boolean? = billedInAdvance
        ...
        fun fixedPriceQuantity(): Double? = fixedPriceQuantity

        /** The property used to group this price on an invoice */
        @JsonProperty("invoice_grouping_key")
        fun invoiceGroupingKey(): String? = invoiceGroupingKey
        ...
        fun invoicingCycleConfiguration(): InvoicingCycleConfiguration? = invoicingCycleConfiguration

        /** The per unit conversion rate of the price currency to the invoicing currency. */
        @JsonProperty("conversion_rate")
        fun conversionRate(): Double? = conversionRate
        ...
        class Builder {
             ...
             */
            @JsonProperty("billing_cycle_configuration")
            fun billingCycleConfiguration(billingCycleConfiguration: BillingCycleConfiguration) = apply {
             ...
             */
            @JsonProperty("invoicing_cycle_configuration")
            fun invoicingCycleConfiguration(invoicingCycleConfiguration: InvoicingCycleConfiguration) = apply {
        ...
        @NoAutoDetect
        class BillingCycleConfiguration private constructor(private val duration: Long?, private val durationUnit: DurationUnit?, private val additionalProperties: Map<String, JsonValue>, ) {
            ...
            class Builder {
                ...
                fun build(): BillingCycleConfiguration = BillingCycleConfiguration(
                    checkNotNull(duration) {
                        "`duration` is required but was not set"
                    },
            ...
            class DurationUnit @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
        ...
        @NoAutoDetect
        class InvoicingCycleConfiguration private constructor(private val duration: Long?, private val durationUnit: DurationUnit?, private val additionalProperties: Map<String, JsonValue>, ) {
            ...
            class Builder {
                ...
                internal fun from(invoicingCycleConfiguration: InvoicingCycleConfiguration) = apply {
                ...
                fun build(): InvoicingCycleConfiguration = InvoicingCycleConfiguration(
                    checkNotNull(duration) {
                        "`duration` is required but was not set"
                    },
                    checkNotNull(durationUnit) {
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
            ...
            internal fun from(newFloatingPackagePrice: NewFloatingPackagePrice) = apply {
                ...
                this.invoicingCycleConfiguration = newFloatingPackagePrice.invoicingCycleConfiguration
        ...
        @NoAutoDetect
        class PackageConfig private constructor(private val packageAmount: String?, private val packageSize: Long?, private val additionalProperties: Map<String, JsonValue>, ) {
            ...
            fun packageSize(): Long? = packageSize
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
            ...
            internal fun from(newFloatingMatrixPrice: NewFloatingMatrixPrice) = apply {
                ...
                this.invoicingCycleConfiguration = newFloatingMatrixPrice.invoicingCycleConfiguration
        ...
        class MatrixConfig private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            @NoAutoDetect
            class MatrixValue private constructor(private val unitAmount: String?, private val dimensionValues: List<String?>?, private val additionalProperties: Map<String, JsonValue>, ) {
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
            ...
            internal fun from(newFloatingMatrixWithAllocationPrice: NewFloatingMatrixWithAllocationPrice) = apply {
                ...
                this.billingCycleConfiguration = newFloatingMatrixWithAllocationPrice.billingCycleConfiguration
                this.invoicingCycleConfiguration = newFloatingMatrixWithAllocationPrice.invoicingCycleConfiguration
            ...
            @JsonProperty("matrix_with_allocation_config")
            fun matrixWithAllocationConfig(matrixWithAllocationConfig: MatrixWithAllocationConfig) = apply {
        ...
        class MatrixWithAllocationConfig private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            fun allocation(): Double? = allocation
            ...
            class Builder {
                ...
                /** Allocation to be used to calculate the price */
                @JsonProperty("allocation")
                fun allocation(allocation: Double) = apply {
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
            ...
            internal fun from(newFloatingTieredPrice: NewFloatingTieredPrice) = apply {
                ...
                this.invoicingCycleConfiguration = newFloatingTieredPrice.invoicingCycleConfiguration
        ...
        @NoAutoDetect
        class TieredConfig private constructor(private val tiers: List<Tier>?, private val additionalProperties: Map<String, JsonValue>, ) {

            private var hashCode: Int = 0

            /** Tiers for rating based on total usage quantities into the specified tier */
            @JsonProperty("tiers")
            fun tiers(): List<Tier>? = tiers
            ...
            class Builder {
                ...
                fun build(): TieredConfig = TieredConfig(checkNotNull(tiers) {
                    "`tiers` is required but was not set"
            ...
            class Tier private constructor(
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                fun firstUnit(): Double? = firstUnit

                /** Exclusive tier ending value. If null, this is treated as the last tier */
                @JsonProperty("last_unit")
                fun lastUnit(): Double? = lastUnit
                ...
                class Builder {
                    ...
                    /** Inclusive tier starting value */
                    @JsonProperty("first_unit")
                    fun firstUnit(firstUnit: Double) = apply {
                        this.firstUnit = firstUnit
                    }

                    /** Exclusive tier ending value. If null, this is treated as the last tier */
                    @JsonProperty("last_unit")
                    fun lastUnit(lastUnit: Double) = apply {
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
            ...
            internal fun from(newFloatingTieredBpsPrice: NewFloatingTieredBpsPrice) = apply {
                ...
                this.invoicingCycleConfiguration = newFloatingTieredBpsPrice.invoicingCycleConfiguration
        ...
        @NoAutoDetect
        class TieredBpsConfig private constructor(private val tiers: List<Tier>?, private val additionalProperties: Map<String, JsonValue>, ) {
            ...
            class Builder {
                ...
                fun build(): TieredBpsConfig = TieredBpsConfig(checkNotNull(tiers) {
                    "`tiers` is required but was not set"
                }.toUnmodifiable(), additionalProperties.toUnmodifiable())
            }
            ...
            class Tier private constructor(
              ...
              private val additionalProperties: Map<String, JsonValue>,
                ...
                fun maximumAmount(): String? = maximumAmount
                ...
                fun perUnitMaximum(): String? = perUnitMaximum
                ...
                class Builder {
                    ...
                    fun build(): Tier = Tier(
                        ...
                        maximumAmount,
                        checkNotNull(bps) {
                            "`bps` is required but was not set"
                        },
                        perUnitMaximum,
                        additionalProperties.toUnmodifiable(),
                    )
    ...
    class NewFloatingBpsPrice private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        fun bpsConfig(): BpsConfig? = bpsConfig
        ...
        class Builder {
            ...
            @JsonProperty("bps_config")
            fun bpsConfig(bpsConfig: BpsConfig) = apply {
            ...
            fun build(): NewFloatingBpsPrice = NewFloatingBpsPrice(
                ...
                checkNotNull(bpsConfig) {
                    "`bpsConfig` is required but was not set"
                },
                checkNotNull(currency) {
                    "`currency` is required but was not set"
                },
        ...
        @NoAutoDetect
        class BpsConfig private constructor(private val bps: Double?, private val perUnitMaximum: String?, private val additionalProperties: Map<String, JsonValue>, ) {
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
            ...
            internal fun from(newFloatingBulkBpsPrice: NewFloatingBulkBpsPrice) = apply {
                ...
                this.invoicingCycleConfiguration = newFloatingBulkBpsPrice.invoicingCycleConfiguration
        ...
        @NoAutoDetect
        class BulkBpsConfig private constructor(private val tiers: List<Tier>?, private val additionalProperties: Map<String, JsonValue>, ) {
            ...
            class Builder {
                ...
                fun build(): BulkBpsConfig = BulkBpsConfig(checkNotNull(tiers) {
                    "`tiers` is required but was not set"
                }.toUnmodifiable(), additionalProperties.toUnmodifiable())
            }
    ...
    class NewFloatingBulkPrice private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        fun bulkConfig(): BulkConfig? = bulkConfig
        ...
        class Builder {
            ...
            @JsonProperty("bulk_config")
            fun bulkConfig(bulkConfig: BulkConfig) = apply {
            ...
            fun build(): NewFloatingBulkPrice = NewFloatingBulkPrice(
                ...
                checkNotNull(bulkConfig) {
                    "`bulkConfig` is required but was not set"
                },
                checkNotNull(currency) {
                    "`currency` is required but was not set"
                },
        ...
        @NoAutoDetect
        class BulkConfig private constructor(private val tiers: List<Tier>?, private val additionalProperties: Map<String, JsonValue>, ) {
            ...
            class Builder {
                ...
                fun build(): BulkConfig = BulkConfig(checkNotNull(tiers) {
                    "`tiers` is required but was not set"
                }.toUnmodifiable(), additionalProperties.toUnmodifiable())
            }
            ...
            @JsonDeserialize(builder = Tier.Builder::class)
            @NoAutoDetect
            class Tier private constructor(private val maximumUnits: Double?, private val unitAmount: String?, private val additionalProperties: Map<String, JsonValue>, ) {

                private var hashCode: Int = 0

                /** Upper bound for this tier */
                @JsonProperty("maximum_units")
                fun maximumUnits(): Double? = maximumUnits
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
            ...
            internal fun from(newFloatingThresholdTotalAmountPrice: NewFloatingThresholdTotalAmountPrice) = apply {
                ...
                this.billingCycleConfiguration = newFloatingThresholdTotalAmountPrice.billingCycleConfiguration
                this.invoicingCycleConfiguration = newFloatingThresholdTotalAmountPrice.invoicingCycleConfiguration
            ...
            @JsonProperty("threshold_total_amount_config")
            fun thresholdTotalAmountConfig(thresholdTotalAmountConfig: ThresholdTotalAmountConfig) = apply {
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
            ...
            internal fun from(newFloatingTieredPackagePrice: NewFloatingTieredPackagePrice) = apply {
                ...
                this.billingCycleConfiguration = newFloatingTieredPackagePrice.billingCycleConfiguration
                this.invoicingCycleConfiguration = newFloatingTieredPackagePrice.invoicingCycleConfiguration
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
            ...
            internal fun from(newFloatingGroupedTieredPrice: NewFloatingGroupedTieredPrice) = apply {
                ...
                this.billingCycleConfiguration = newFloatingGroupedTieredPrice.billingCycleConfiguration
                this.invoicingCycleConfiguration = newFloatingGroupedTieredPrice.invoicingCycleConfiguration
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
            ...
            internal fun from(newFloatingTieredWithMinimumPrice: NewFloatingTieredWithMinimumPrice) = apply {
                ...
                this.billingCycleConfiguration = newFloatingTieredWithMinimumPrice.billingCycleConfiguration
                this.invoicingCycleConfiguration = newFloatingTieredWithMinimumPrice.invoicingCycleConfiguration
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
            ...
            internal fun from(newFloatingPackageWithAllocationPrice: NewFloatingPackageWithAllocationPrice) = apply {
                ...
                this.billingCycleConfiguration = newFloatingPackageWithAllocationPrice.billingCycleConfiguration
                this.invoicingCycleConfiguration = newFloatingPackageWithAllocationPrice.invoicingCycleConfiguration
            ...
            @JsonProperty("package_with_allocation_config")
            fun packageWithAllocationConfig(packageWithAllocationConfig: PackageWithAllocationConfig) = apply {
    ...
    class NewFloatingTieredPackageWithMinimumPrice private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        fun tieredPackageWithMinimumConfig(): TieredPackageWithMinimumConfig? = tieredPackageWithMinimumConfig
        ...
        class Builder {
            ...
            internal fun from(newFloatingTieredPackageWithMinimumPrice: NewFloatingTieredPackageWithMinimumPrice) = apply {
                ...
                this.billingCycleConfiguration = newFloatingTieredPackageWithMinimumPrice.billingCycleConfiguration
                this.invoicingCycleConfiguration = newFloatingTieredPackageWithMinimumPrice.invoicingCycleConfiguration
            ...
            @JsonProperty("tiered_package_with_minimum_config")
            fun tieredPackageWithMinimumConfig(tieredPackageWithMinimumConfig: TieredPackageWithMinimumConfig) = apply {
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
            ...
            internal fun from(newFloatingUnitWithPercentPrice: NewFloatingUnitWithPercentPrice) = apply {
                ...
                this.billingCycleConfiguration = newFloatingUnitWithPercentPrice.billingCycleConfiguration
                this.invoicingCycleConfiguration = newFloatingUnitWithPercentPrice.invoicingCycleConfiguration
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
            ...
            internal fun from(newFloatingTieredWithProrationPrice: NewFloatingTieredWithProrationPrice) = apply {
                ...
                this.billingCycleConfiguration = newFloatingTieredWithProrationPrice.billingCycleConfiguration
                this.invoicingCycleConfiguration = newFloatingTieredWithProrationPrice.invoicingCycleConfiguration
            ...
            @JsonProperty("tiered_with_proration_config")
            fun tieredWithProrationConfig(tieredWithProrationConfig: TieredWithProrationConfig) = apply {
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
            ...
            internal fun from(newFloatingUnitWithProrationPrice: NewFloatingUnitWithProrationPrice) = apply {
                ...
                this.billingCycleConfiguration = newFloatingUnitWithProrationPrice.billingCycleConfiguration
                this.invoicingCycleConfiguration = newFloatingUnitWithProrationPrice.invoicingCycleConfiguration
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
            ...
            internal fun from(newFloatingGroupedAllocationPrice: NewFloatingGroupedAllocationPrice) = apply {
                ...
                this.billingCycleConfiguration = newFloatingGroupedAllocationPrice.billingCycleConfiguration
                this.invoicingCycleConfiguration = newFloatingGroupedAllocationPrice.invoicingCycleConfiguration
    ...
    @NoAutoDetect
    class NewFloatingGroupedWithProratedMinimumPrice private constructor(
      private val metadata: Metadata?,
      private val externalPriceId: String?,
      private val name: String?,
      private val billableMetricId: String?,
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        fun groupedWithProratedMinimumConfig(): GroupedWithProratedMinimumConfig? = groupedWithProratedMinimumConfig
        ...
        override fun equals(other: Any?): Boolean {
          ...
          return other is NewFloatingGroupedWithProratedMinimumPrice &&
              this.metadata == other.metadata &&
              this.externalPriceId == other.externalPriceId &&
              this.name == other.name &&
              this.billableMetricId == other.billableMetricId &&
        ...
        class Builder {
            ...
            internal fun from(newFloatingGroupedWithProratedMinimumPrice: NewFloatingGroupedWithProratedMinimumPrice) = apply {
                ...
                this.fixedPriceQuantity = newFloatingGroupedWithProratedMinimumPrice.fixedPriceQuantity
                this.invoiceGroupingKey = newFloatingGroupedWithProratedMinimumPrice.invoiceGroupingKey
                this.cadence = newFloatingGroupedWithProratedMinimumPrice.cadence
                this.billingCycleConfiguration = newFloatingGroupedWithProratedMinimumPrice.billingCycleConfiguration
                this.invoicingCycleConfiguration = newFloatingGroupedWithProratedMinimumPrice.invoicingCycleConfiguration
                ...
                this.groupedWithProratedMinimumConfig = newFloatingGroupedWithProratedMinimumPrice.groupedWithProratedMinimumConfig
                this.currency = newFloatingGroupedWithProratedMinimumPrice.currency
                additionalProperties(newFloatingGroupedWithProratedMinimumPrice.additionalProperties)
            }
            ...
            @JsonProperty("grouped_with_prorated_minimum_config")
            fun groupedWithProratedMinimumConfig(groupedWithProratedMinimumConfig: GroupedWithProratedMinimumConfig) = apply {
            ...
            fun build(): NewFloatingGroupedWithProratedMinimumPrice = NewFloatingGroupedWithProratedMinimumPrice(
                metadata,
                externalPriceId,
                checkNotNull(name) {
                    "`name` is required but was not set"
        ...
        @NoAutoDetect
        class GroupedWithProratedMinimumConfig private constructor(private val additionalProperties: Map<String, JsonValue>, ) {
            ...
            class Builder {
                ...
                internal fun from(groupedWithProratedMinimumConfig: GroupedWithProratedMinimumConfig) = apply {
                ...
                fun build(): GroupedWithProratedMinimumConfig = GroupedWithProratedMinimumConfig(additionalProperties.toUnmodifiable())
            }
        }
        ...
        class ModelType @JsonCreator private constructor(private val value: JsonField<String>, ) : Enum {
            ...
            companion object {
                ...
                val GROUPED_WITH_PRORATED_MINIMUM = ModelType(JsonField.of("grouped_with_prorated_minimum"))
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        class Builder {
            ...
            internal fun from(newFloatingBulkWithProrationPrice: NewFloatingBulkWithProrationPrice) = apply {
                ...
                this.billingCycleConfiguration = newFloatingBulkWithProrationPrice.billingCycleConfiguration
                this.invoicingCycleConfiguration = newFloatingBulkWithProrationPrice.invoicingCycleConfiguration

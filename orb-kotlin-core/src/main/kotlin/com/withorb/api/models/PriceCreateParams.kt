...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [body] with `Body.ofGroupedTieredMatrix(groupedTieredMatrix)`. */
        fun body(groupedTieredMatrix: Body.GroupedTieredMatrix) =
            body(Body.ofGroupedTieredMatrix(groupedTieredMatrix))
        ...
        /**
         * Alias for calling [body] with
         * `Body.ofTieredMatrixWithAllocation(tieredMatrixWithAllocation)`.
         */
        fun body(tieredMatrixWithAllocation: Body.TieredMatrixWithAllocation) =
            body(Body.ofTieredMatrixWithAllocation(tieredMatrixWithAllocation))

        /**
         * Alias for calling [body] with
         * `Body.ofMatrixWithThresholdDiscounts(matrixWithThresholdDiscounts)`.
         */
        fun body(matrixWithThresholdDiscounts: Body.MatrixWithThresholdDiscounts) =
            body(Body.ofMatrixWithThresholdDiscounts(matrixWithThresholdDiscounts))
        ...
        /** Alias for calling [body] with `Body.ofMeteredAllowance(meteredAllowance)`. */
        fun body(meteredAllowance: Body.MeteredAllowance) =
            body(Body.ofMeteredAllowance(meteredAllowance))
    ...
    private constructor(
        ...
        private val groupedTieredMatrix: GroupedTieredMatrix? = null,
        ...
        private val tieredMatrixWithAllocation: TieredMatrixWithAllocation? = null,
        ...
        fun groupedTieredMatrix(): GroupedTieredMatrix? = groupedTieredMatrix
        ...
        fun tieredMatrixWithAllocation(): TieredMatrixWithAllocation? = tieredMatrixWithAllocation

        fun matrixWithThresholdDiscounts(): MatrixWithThresholdDiscounts? =
        ...
        fun dailyCreditAllowance(): DailyCreditAllowance? = dailyCreditAllowance

        fun meteredAllowance(): MeteredAllowance? = meteredAllowance
        ...
        fun isGroupedTieredMatrix(): Boolean = groupedTieredMatrix != null
        ...
        fun isTieredMatrixWithAllocation(): Boolean = tieredMatrixWithAllocation != null
        ...
        fun asGroupedTieredMatrix(): GroupedTieredMatrix =
            groupedTieredMatrix.getOrThrow("groupedTieredMatrix")
        ...
        fun asTieredMatrixWithAllocation(): TieredMatrixWithAllocation =
            tieredMatrixWithAllocation.getOrThrow("tieredMatrixWithAllocation")
        ...
        fun asMeteredAllowance(): MeteredAllowance = meteredAllowance.getOrThrow("meteredAllowance")
         ...
         *     override fun visitUnit(unit: NewFloatingUnitPrice): String? = unit.toString()
         *
         *     // ...
         *
        ...
        fun <T> accept(visitor: Visitor<T>): T =
            when {
                ...
                groupedTieredMatrix != null -> visitor.visitGroupedTieredMatrix(groupedTieredMatrix)
                ...
                tieredMatrixWithAllocation != null ->
                    visitor.visitTieredMatrixWithAllocation(tieredMatrixWithAllocation)
        ...
        fun validate(): Body = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    ...
                    override fun visitGroupedTieredMatrix(
                        groupedTieredMatrix: GroupedTieredMatrix
                    ) {
                        groupedTieredMatrix.validate()
                    }
                    ...
                    override fun visitTieredMatrixWithAllocation(
                        tieredMatrixWithAllocation: TieredMatrixWithAllocation
                    ) {
                        tieredMatrixWithAllocation.validate()
                    }
        ...
        internal fun validity(): Int =
            accept(
                object : Visitor<Int> {
                    ...
                    override fun visitTieredMatrixWithAllocation(
                        tieredMatrixWithAllocation: TieredMatrixWithAllocation
                    ) = tieredMatrixWithAllocation.validity()
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Body &&
                ...
                groupedTieredMatrix == other.groupedTieredMatrix &&
                ...
                tieredMatrixWithAllocation == other.tieredMatrixWithAllocation &&
        ...
        override fun toString(): String =
            when {
                ...
                groupedTieredMatrix != null -> "Body{groupedTieredMatrix=$groupedTieredMatrix}"
                tieredPackageWithMinimum != null ->
                ...
                tieredMatrixWithAllocation != null ->
                    "Body{tieredMatrixWithAllocation=$tieredMatrixWithAllocation}"
                matrixWithThresholdDiscounts != null ->
                    "Body{matrixWithThresholdDiscounts=$matrixWithThresholdDiscounts}"
                ...
                meteredAllowance != null -> "Body{meteredAllowance=$meteredAllowance}"
        ...
        companion object {
            ...
            fun ofGroupedTieredMatrix(groupedTieredMatrix: GroupedTieredMatrix) =
                Body(groupedTieredMatrix = groupedTieredMatrix)
        ...
        interface Visitor<out T> {
            ...
            fun visitGroupedTieredMatrix(groupedTieredMatrix: GroupedTieredMatrix): T
            ...
            fun visitTieredMatrixWithAllocation(
                tieredMatrixWithAllocation: TieredMatrixWithAllocation
            ): T
        ...
        internal class Deserializer : BaseDeserializer<Body>(Body::class) {
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): Body {
                ...
                when (modelType) {
                    ...
                    "grouped_tiered_matrix" -> {
                        return tryDeserialize(node, jacksonTypeRef<GroupedTieredMatrix>())?.let {
                            Body(groupedTieredMatrix = it, _json = json)
                        } ?: Body(_json = json)
                    }
                    ...
                    "tiered_matrix_with_allocation" -> {
                        return tryDeserialize(node, jacksonTypeRef<TieredMatrixWithAllocation>())
                            ?.let { Body(tieredMatrixWithAllocation = it, _json = json) }
                            ?: Body(_json = json)
                    }
                    "matrix_with_threshold_discounts" -> {
                        return tryDeserialize(node, jacksonTypeRef<MatrixWithThresholdDiscounts>())
                            ?.let { Body(matrixWithThresholdDiscounts = it, _json = json) }
                            ?: Body(_json = json)
                    }
                    ...
                    "metered_allowance" -> {
                        return tryDeserialize(node, jacksonTypeRef<MeteredAllowance>())?.let {
                            Body(meteredAllowance = it, _json = json)
                        } ?: Body(_json = json)
                    }
                    "minimum_composite" -> {
                        return tryDeserialize(
        ...
        internal class Serializer : BaseSerializer<Body>(Body::class) {
            ...
            override fun serialize(
                ...
                when {
                    ...
                    value.groupedTieredMatrix != null ->
                        generator.writeObject(value.groupedTieredMatrix)
                    ...
                    value.tieredMatrixWithAllocation != null ->
                        generator.writeObject(value.tieredMatrixWithAllocation)
                    ...
                    value.meteredAllowance != null -> generator.writeObject(value.meteredAllowance)
        ...
        private constructor(
            ...
            /**
             * The ID of the license type to associate with this price. On a usage price this also
             * marks the price as eligible to draw down from that license type's allocation; a usage
             * price created without it is billed normally. Usage prices with a license type must
             * use the `unit` model, and only draw down when their currency matches the
             * allocation's.
             *
             * @throws OrbInvalidDataException if the JSON field has an unexpected type (e.g. if the
             *   server responded with an unexpected value).
        ...
        class GroupedTieredMatrix
        @JsonCreator(mode = JsonCreator.Mode.DISABLED)
        private constructor(
            private val cadence: JsonField<Cadence>,
            private val currency: JsonField<String>,
            private val groupedTieredMatrixConfig: JsonField<GroupedTieredMatrixConfig>,
            private val itemId: JsonField<String>,
            private val modelType: JsonValue,
            private val name: JsonField<String>,
            private val billableMetricId: JsonField<String>,
            ...
            private constructor(
                ...
                @ExcludeMissing
                currency: JsonField<String> = JsonMissing.of(),
                @JsonProperty("grouped_tiered_matrix_config")
                @ExcludeMissing
                groupedTieredMatrixConfig: JsonField<GroupedTieredMatrixConfig> = JsonMissing.of(),
                @JsonProperty("item_id")
                @ExcludeMissing
                itemId: JsonField<String> = JsonMissing.of(),
                @JsonProperty("model_type") @ExcludeMissing modelType: JsonValue = JsonMissing.of(),
             ...
             *   value).
             */
            fun groupedTieredMatrixConfig(): GroupedTieredMatrixConfig =
                groupedTieredMatrixConfig.getRequired("grouped_tiered_matrix_config")
             ...
             * Expected to always return the following:
             * ```kotlin
             * JsonValue.from("grouped_tiered_matrix")
             * ```
             *
             * However, this method can be useful for debugging and logging (e.g. if the server
             * responded with an unexpected value).
            ...
            /**
             * Returns the raw JSON value of [groupedTieredMatrixConfig].
             *
             * Unlike [groupedTieredMatrixConfig], this method doesn't throw if the JSON field has
             * an unexpected type.
             */
            @JsonProperty("grouped_tiered_matrix_config")
            @ExcludeMissing
            fun _groupedTieredMatrixConfig(): JsonField<GroupedTieredMatrixConfig> =
                groupedTieredMatrixConfig
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [GroupedTieredMatrix].
                 *
                 * The following fields are required:
                 * ```kotlin
                 * .cadence()
            ...
            /** A builder for [GroupedTieredMatrix]. */
            class Builder internal constructor() {

                private var cadence: JsonField<Cadence>? = null
                private var currency: JsonField<String>? = null
                private var groupedTieredMatrixConfig: JsonField<GroupedTieredMatrixConfig>? = null
                private var itemId: JsonField<String>? = null
                private var modelType: JsonValue = JsonValue.from("grouped_tiered_matrix")
                private var name: JsonField<String>? = null
                private var billableMetricId: JsonField<String> = JsonMissing.of()
                private var billedInAdvance: JsonField<Boolean> = JsonMissing.of()
                private var billingCycleConfiguration: JsonField<NewBillingCycleConfiguration> =
                ...
                internal fun from(groupedTieredMatrix: GroupedTieredMatrix) = apply {
                    cadence = groupedTieredMatrix.cadence
                    currency = groupedTieredMatrix.currency
                    groupedTieredMatrixConfig = groupedTieredMatrix.groupedTieredMatrixConfig
                    itemId = groupedTieredMatrix.itemId
                    modelType = groupedTieredMatrix.modelType
                    name = groupedTieredMatrix.name
                    billableMetricId = groupedTieredMatrix.billableMetricId
                    billedInAdvance = groupedTieredMatrix.billedInAdvance
                    billingCycleConfiguration = groupedTieredMatrix.billingCycleConfiguration
                    conversionRate = groupedTieredMatrix.conversionRate
                    conversionRateConfig = groupedTieredMatrix.conversionRateConfig
                    dimensionalPriceConfiguration =
                        groupedTieredMatrix.dimensionalPriceConfiguration
                    externalPriceId = groupedTieredMatrix.externalPriceId
                    fixedPriceQuantity = groupedTieredMatrix.fixedPriceQuantity
                    invoiceGroupingKey = groupedTieredMatrix.invoiceGroupingKey
                    invoicingCycleConfiguration = groupedTieredMatrix.invoicingCycleConfiguration
                    licenseTypeId = groupedTieredMatrix.licenseTypeId
                    metadata = groupedTieredMatrix.metadata
                    additionalProperties = groupedTieredMatrix.additionalProperties.toMutableMap()
                }
                ...
                /** Configuration for grouped_tiered_matrix pricing */
                fun groupedTieredMatrixConfig(
                    groupedTieredMatrixConfig: GroupedTieredMatrixConfig
                ) = groupedTieredMatrixConfig(JsonField.of(groupedTieredMatrixConfig))

                /**
                 * Sets [Builder.groupedTieredMatrixConfig] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.groupedTieredMatrixConfig] with a well-typed
                 * [GroupedTieredMatrixConfig] value instead. This method is primarily for setting
                 * the field to an undocumented or not yet supported value.
                 */
                fun groupedTieredMatrixConfig(
                    groupedTieredMatrixConfig: JsonField<GroupedTieredMatrixConfig>
                ) = apply { this.groupedTieredMatrixConfig = groupedTieredMatrixConfig }
                ...
                /**
                 * Returns an immutable instance of [GroupedTieredMatrix].
                 *
                 * Further updates to this [Builder] will not mutate the returned instance.
                 *
                 * The following fields are required:
                 ...
                 * @throws IllegalStateException if any required field is unset.
                 */
                fun build(): GroupedTieredMatrix =
                    GroupedTieredMatrix(
                        checkRequired("cadence", cadence),
                        checkRequired("currency", currency),
                        checkRequired("groupedTieredMatrixConfig", groupedTieredMatrixConfig),
                        checkRequired("itemId", itemId),
                        modelType,
                        checkRequired("name", name),
                        billableMetricId,
             ...
             *   expected type.
             */
            fun validate(): GroupedTieredMatrix = apply {
                if (validated) {
                    return@apply
                }
                ...
                cadence().validate()
                currency()
                groupedTieredMatrixConfig().validate()
                itemId()
                _modelType().let {
                    if (it != JsonValue.from("grouped_tiered_matrix")) {
                        throw OrbInvalidDataException("'modelType' is invalid, received $it")
                    }
                }
                name()
            ...
            internal fun validity(): Int =
                (cadence.asKnown()?.validity() ?: 0) +
                    (if (currency.asKnown() == null) 0 else 1) +
                    (groupedTieredMatrixConfig.asKnown()?.validity() ?: 0) +
                    (if (itemId.asKnown() == null) 0 else 1) +
                    modelType.let { if (it == JsonValue.from("grouped_tiered_matrix")) 1 else 0 } +
                    (if (name.asKnown() == null) 0 else 1) +
                    (if (billableMetricId.asKnown() == null) 0 else 1) +
                    (if (billedInAdvance.asKnown() == null) 0 else 1) +
                    (billingCycleConfiguration.asKnown()?.validity() ?: 0) +
            ...
            /** Configuration for grouped_tiered_matrix pricing */
            class GroupedTieredMatrixConfig
            @JsonCreator(mode = JsonCreator.Mode.DISABLED)
            private constructor(
                ...
                private constructor(
                    ...
                    @ExcludeMissing
                    tiers: JsonField<List<Tier>> = JsonMissing.of(),
                ) : this(defaultUnitAmount, dimension, tiers, mutableMapOf())
                ...
                /** A builder for [GroupedTieredMatrixConfig]. */
                class Builder internal constructor() {
                    ...
                    internal fun from(groupedTieredMatrixConfig: GroupedTieredMatrixConfig) =
                        apply {
                            defaultUnitAmount = groupedTieredMatrixConfig.defaultUnitAmount
                            dimension = groupedTieredMatrixConfig.dimension
                            tiers = groupedTieredMatrixConfig.tiers.map { it.toMutableList() }
                            additionalProperties =
                                groupedTieredMatrixConfig.additionalProperties.toMutableMap()
                        }
                     ...
                     * not yet supported value.
                     */
                    fun dimension(dimension: JsonField<String>) = apply {
                    ...
                    /**
                     * Returns an immutable instance of [GroupedTieredMatrixConfig].
                     *
                     * Further updates to this [Builder] will not mutate the returned instance.
                     *
                     * The following fields are required:
                     ...
                     * @throws IllegalStateException if any required field is unset.
                     */
                    fun build(): GroupedTieredMatrixConfig =
                        GroupedTieredMatrixConfig(
                 ...
                 *   its expected type.
                 */
                fun validate(): GroupedTieredMatrixConfig = apply {
                    if (validated) {
                        return@apply
                    }
                ...
                private constructor(
                    ...
                    private constructor(
                        ...
                        @ExcludeMissing
                        unitAmount: JsonField<String> = JsonMissing.of(),
                    ) : this(dimensionValue, tierLowerBound, unitAmount, mutableMapOf())
                    ...
                    class Builder internal constructor() {
                        ...
                        internal fun from(tier: Tier) = apply {
                            dimensionValue = tier.dimensionValue
                            tierLowerBound = tier.tierLowerBound
                            unitAmount = tier.unitAmount
                            additionalProperties = tier.additionalProperties.toMutableMap()
                        }
                         ...
                         *
                         * You should usually call [Builder.dimensionValue] with a well-typed
                         * [String] value instead. This method is primarily for setting the field to
                         * an undocumented or not yet supported value.
                         */
                    ...
                    override fun toString() =
                        "Tier{dimensionValue=$dimensionValue, tierLowerBound=$tierLowerBound, unitAmount=$unitAmount, additionalProperties=$additionalProperties}"
                }
                ...
                override fun equals(other: Any?): Boolean {
                    ...
                    return other is GroupedTieredMatrixConfig &&
                ...
                private val hashCode: Int by lazy {
                    Objects.hash(defaultUnitAmount, dimension, tiers, additionalProperties)
                }

                override fun hashCode(): Int = hashCode

                override fun toString() =
                    "GroupedTieredMatrixConfig{defaultUnitAmount=$defaultUnitAmount, dimension=$dimension, tiers=$tiers, additionalProperties=$additionalProperties}"
            }
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is GroupedTieredMatrix &&
                    cadence == other.cadence &&
                    currency == other.currency &&
                    groupedTieredMatrixConfig == other.groupedTieredMatrixConfig &&
                    itemId == other.itemId &&
                    modelType == other.modelType &&
                    name == other.name &&
                    billableMetricId == other.billableMetricId &&
        ...
        private constructor(
            ...
            private val modelType: JsonValue,
            private val name: JsonField<String>,
            private val tieredMatrixWithAllocationConfig:
                JsonField<TieredMatrixWithAllocationConfig>,
            private val billableMetricId: JsonField<String>,
            private val billedInAdvance: JsonField<Boolean>,
            private val billingCycleConfiguration: JsonField<NewBillingCycleConfiguration>,
            private val conversionRate: JsonField<Double>,
            ...
            private constructor(
                ...
                @JsonProperty("model_type") @ExcludeMissing modelType: JsonValue = JsonMissing.of(),
                @JsonProperty("name") @ExcludeMissing name: JsonField<String> = JsonMissing.of(),
                @JsonProperty("tiered_matrix_with_allocation_config")
                @ExcludeMissing
                tieredMatrixWithAllocationConfig: JsonField<TieredMatrixWithAllocationConfig> =
                    JsonMissing.of(),
                @JsonProperty("billable_metric_id")
                @ExcludeMissing
                billableMetricId: JsonField<String> = JsonMissing.of(),
             ...
             * Expected to always return the following:
             * ```kotlin
             * JsonValue.from("tiered_matrix_with_allocation")
             * ```
             *
             * However, this method can be useful for debugging and logging (e.g. if the server
             * responded with an unexpected value).
             ...
             *   value).
             */
            fun tieredMatrixWithAllocationConfig(): TieredMatrixWithAllocationConfig =
                tieredMatrixWithAllocationConfig.getRequired("tiered_matrix_with_allocation_config")
            ...
            /**
             * Returns the raw JSON value of [tieredMatrixWithAllocationConfig].
             *
             * Unlike [tieredMatrixWithAllocationConfig], this method doesn't throw if the JSON
             * field has an unexpected type.
             */
            @JsonProperty("tiered_matrix_with_allocation_config")
            @ExcludeMissing
            fun _tieredMatrixWithAllocationConfig(): JsonField<TieredMatrixWithAllocationConfig> =
                tieredMatrixWithAllocationConfig
            ...
            /** A builder for [TieredMatrixWithAllocation]. */
            class Builder internal constructor() {

                private var cadence: JsonField<Cadence>? = null
                private var currency: JsonField<String>? = null
                private var itemId: JsonField<String>? = null
                private var modelType: JsonValue = JsonValue.from("tiered_matrix_with_allocation")
                private var name: JsonField<String>? = null
                private var tieredMatrixWithAllocationConfig:
                    JsonField<TieredMatrixWithAllocationConfig>? =
                    null
                private var billableMetricId: JsonField<String> = JsonMissing.of()
                private var billedInAdvance: JsonField<Boolean> = JsonMissing.of()
                ...
                internal fun from(tieredMatrixWithAllocation: TieredMatrixWithAllocation) = apply {
                    cadence = tieredMatrixWithAllocation.cadence
                    currency = tieredMatrixWithAllocation.currency
                    itemId = tieredMatrixWithAllocation.itemId
                    modelType = tieredMatrixWithAllocation.modelType
                    name = tieredMatrixWithAllocation.name
                    tieredMatrixWithAllocationConfig =
                        tieredMatrixWithAllocation.tieredMatrixWithAllocationConfig
                    billableMetricId = tieredMatrixWithAllocation.billableMetricId
                    billedInAdvance = tieredMatrixWithAllocation.billedInAdvance
                    billingCycleConfiguration = tieredMatrixWithAllocation.billingCycleConfiguration
                    conversionRate = tieredMatrixWithAllocation.conversionRate
                    conversionRateConfig = tieredMatrixWithAllocation.conversionRateConfig
                    dimensionalPriceConfiguration =
                        tieredMatrixWithAllocation.dimensionalPriceConfiguration
                    externalPriceId = tieredMatrixWithAllocation.externalPriceId
                    fixedPriceQuantity = tieredMatrixWithAllocation.fixedPriceQuantity
                    invoiceGroupingKey = tieredMatrixWithAllocation.invoiceGroupingKey
                    invoicingCycleConfiguration =
                        tieredMatrixWithAllocation.invoicingCycleConfiguration
                    licenseTypeId = tieredMatrixWithAllocation.licenseTypeId
                    metadata = tieredMatrixWithAllocation.metadata
                    additionalProperties =
                        tieredMatrixWithAllocation.additionalProperties.toMutableMap()
                }
                ...
                /** Configuration for tiered_matrix_with_allocation pricing */
                fun tieredMatrixWithAllocationConfig(
                    tieredMatrixWithAllocationConfig: TieredMatrixWithAllocationConfig
                ) = tieredMatrixWithAllocationConfig(JsonField.of(tieredMatrixWithAllocationConfig))

                /**
                 * Sets [Builder.tieredMatrixWithAllocationConfig] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.tieredMatrixWithAllocationConfig] with a
                 * well-typed [TieredMatrixWithAllocationConfig] value instead. This method is
                 * primarily for setting the field to an undocumented or not yet supported value.
                 */
                fun tieredMatrixWithAllocationConfig(
                    tieredMatrixWithAllocationConfig: JsonField<TieredMatrixWithAllocationConfig>
                ) = apply {
                    this.tieredMatrixWithAllocationConfig = tieredMatrixWithAllocationConfig
                }
                ...
                /**
                 * Returns an immutable instance of [TieredMatrixWithAllocation].
                 *
                 * Further updates to this [Builder] will not mutate the returned instance.
                 *
                 * The following fields are required:
                 ...
                 * @throws IllegalStateException if any required field is unset.
                 */
                fun build(): TieredMatrixWithAllocation =
                    TieredMatrixWithAllocation(
                        checkRequired("cadence", cadence),
                        checkRequired("currency", currency),
                        checkRequired("itemId", itemId),
             ...
             *   expected type.
             */
            fun validate(): TieredMatrixWithAllocation = apply {
                if (validated) {
                    return@apply
                }
                ...
                itemId()
                _modelType().let {
                    if (it != JsonValue.from("tiered_matrix_with_allocation")) {
                        throw OrbInvalidDataException("'modelType' is invalid, received $it")
                    }
                }
                name()
                tieredMatrixWithAllocationConfig().validate()
                billableMetricId()
                billedInAdvance()
                billingCycleConfiguration()?.validate()
                conversionRate()
            ...
            internal fun validity(): Int =
                (cadence.asKnown()?.validity() ?: 0) +
                    ...
                    (if (itemId.asKnown() == null) 0 else 1) +
                    modelType.let {
                        if (it == JsonValue.from("tiered_matrix_with_allocation")) 1 else 0
                    } +
                    (if (name.asKnown() == null) 0 else 1) +
                    (tieredMatrixWithAllocationConfig.asKnown()?.validity() ?: 0) +
                    (if (billableMetricId.asKnown() == null) 0 else 1) +
                    (if (billedInAdvance.asKnown() == null) 0 else 1) +
                    (billingCycleConfiguration.asKnown()?.validity() ?: 0) +
                    (if (conversionRate.asKnown() == null) 0 else 1) +
            ...
            /** Configuration for tiered_matrix_with_allocation pricing */
            class TieredMatrixWithAllocationConfig
            @JsonCreator(mode = JsonCreator.Mode.DISABLED)
            private constructor(
                ...
                private constructor(
                    ...
                    @ExcludeMissing
                    tiers: JsonField<List<Tier>> = JsonMissing.of(),
                ) : this(allocation, defaultUnitAmount, dimensions, tiers, mutableMapOf())
                ...
                /** A builder for [TieredMatrixWithAllocationConfig]. */
                class Builder internal constructor() {
                    ...
                    internal fun from(
                        ...
                        allocation = tieredMatrixWithAllocationConfig.allocation
                        defaultUnitAmount = tieredMatrixWithAllocationConfig.defaultUnitAmount
                        dimensions =
                            tieredMatrixWithAllocationConfig.dimensions.map { it.toMutableList() }
                        tiers = tieredMatrixWithAllocationConfig.tiers.map { it.toMutableList() }
                        additionalProperties =
                            tieredMatrixWithAllocationConfig.additionalProperties.toMutableMap()
                    }
                    ...
                    /**
                     * Graduated tiers keyed by matrix cell; usage in a cell is tiered only against
                     * its own rows
                     */
                    fun tiers(tiers: List<Tier>) = tiers(JsonField.of(tiers))
                    ...
                    /**
                     * Returns an immutable instance of [TieredMatrixWithAllocationConfig].
                     *
                     * Further updates to this [Builder] will not mutate the returned instance.
                     *
                     * The following fields are required:
                     ...
                     * @throws IllegalStateException if any required field is unset.
                     */
                    fun build(): TieredMatrixWithAllocationConfig =
                        TieredMatrixWithAllocationConfig(
                 ...
                 *   its expected type.
                 */
                fun validate(): TieredMatrixWithAllocationConfig = apply {
                    if (validated) {
                        return@apply
                    }
                ...
                private constructor(
                    ...
                    private constructor(
                        ...
                        @ExcludeMissing
                        unitAmount: JsonField<String> = JsonMissing.of(),
                    ) : this(dimensionValues, tierLowerBound, unitAmount, mutableMapOf())
                    ...
                    /**
                     * Exclusive tier starting value. The tier runs up to and including the next
                     * bound configured for the same matrix cell.
                     *
                     * @throws OrbInvalidDataException if the JSON field has an unexpected type or
                     *   is unexpectedly missing or null (e.g. if the server responded with an
                     *   unexpected value).
                    ...
                    class Builder internal constructor() {
                        ...
                        internal fun from(tier: Tier) = apply {
                            dimensionValues = tier.dimensionValues.map { it.toMutableList() }
                            tierLowerBound = tier.tierLowerBound
                            unitAmount = tier.unitAmount
                            additionalProperties = tier.additionalProperties.toMutableMap()
                        }
                     ...
                     */
                    internal fun validity(): Int =
                        (dimensionValues.asKnown()?.size ?: 0) +
                            (if (tierLowerBound.asKnown() == null) 0 else 1) +
                            (if (unitAmount.asKnown() == null) 0 else 1)
                    ...
                    override fun toString() =
                        "Tier{dimensionValues=$dimensionValues, tierLowerBound=$tierLowerBound, unitAmount=$unitAmount, additionalProperties=$additionalProperties}"
                }
                ...
                override fun equals(other: Any?): Boolean {
                    ...
                    return other is TieredMatrixWithAllocationConfig &&
                ...
                override fun toString() =
                    "TieredMatrixWithAllocationConfig{allocation=$allocation, defaultUnitAmount=$defaultUnitAmount, dimensions=$dimensions, tiers=$tiers, additionalProperties=$additionalProperties}"
            }
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is TieredMatrixWithAllocation &&
                    cadence == other.cadence &&
                    currency == other.currency &&
                    itemId == other.itemId &&
                    modelType == other.modelType &&
                    name == other.name &&
                    tieredMatrixWithAllocationConfig == other.tieredMatrixWithAllocationConfig &&
                    billableMetricId == other.billableMetricId &&
                    billedInAdvance == other.billedInAdvance &&
                    billingCycleConfiguration == other.billingCycleConfiguration &&
                    conversionRate == other.conversionRate &&
            ...
            override fun toString() =
                "TieredMatrixWithAllocation{cadence=$cadence, currency=$currency, itemId=$itemId, modelType=$modelType, name=$name, tieredMatrixWithAllocationConfig=$tieredMatrixWithAllocationConfig, billableMetricId=$billableMetricId, billedInAdvance=$billedInAdvance, billingCycleConfiguration=$billingCycleConfiguration, conversionRate=$conversionRate, conversionRateConfig=$conversionRateConfig, dimensionalPriceConfiguration=$dimensionalPriceConfiguration, externalPriceId=$externalPriceId, fixedPriceQuantity=$fixedPriceQuantity, invoiceGroupingKey=$invoiceGroupingKey, invoicingCycleConfiguration=$invoicingCycleConfiguration, licenseTypeId=$licenseTypeId, metadata=$metadata, additionalProperties=$additionalProperties}"
        }
        ...
        private constructor(
            ...
            private constructor(
                ...
                @ExcludeMissing
                matrixWithThresholdDiscountsConfig: JsonField<MatrixWithThresholdDiscountsConfig> =
                    JsonMissing.of(),
                @JsonProperty("model_type") @ExcludeMissing modelType: JsonValue = JsonMissing.of(),
                @JsonProperty("name") @ExcludeMissing name: JsonField<String> = JsonMissing.of(),
                @JsonProperty("billable_metric_id")
             ...
             *
             * Unlike [matrixWithThresholdDiscountsConfig], this method doesn't throw if the JSON
             * field has an unexpected type.
             */
            @JsonProperty("matrix_with_threshold_discounts_config")
            @ExcludeMissing
            fun _matrixWithThresholdDiscountsConfig():
                JsonField<MatrixWithThresholdDiscountsConfig> = matrixWithThresholdDiscountsConfig
            ...
            class Builder internal constructor() {
                ...
                private var matrixWithThresholdDiscountsConfig:
                    JsonField<MatrixWithThresholdDiscountsConfig>? =
                    null
                private var modelType: JsonValue = JsonValue.from("matrix_with_threshold_discounts")
                private var name: JsonField<String>? = null
                private var billableMetricId: JsonField<String> = JsonMissing.of()
                private var billedInAdvance: JsonField<Boolean> = JsonMissing.of()
                private var billingCycleConfiguration: JsonField<NewBillingCycleConfiguration> =
            ...
            internal fun validity(): Int =
                (cadence.asKnown()?.validity() ?: 0) +
                    (if (currency.asKnown() == null) 0 else 1) +
                    (if (itemId.asKnown() == null) 0 else 1) +
                    (matrixWithThresholdDiscountsConfig.asKnown()?.validity() ?: 0) +
                    modelType.let {
            ...
            private constructor(
                 ...
                 *   the server responded with an unexpected value).
                 */
                fun thresholdDiscountGroups(): List<ThresholdDiscountGroup>? =
                    thresholdDiscountGroups.getNullable("threshold_discount_groups")
                 ...
                 *
                 * Unlike [thresholdDiscountGroups], this method doesn't throw if the JSON field has
                 * an unexpected type.
                 */
                @JsonProperty("threshold_discount_groups")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(
                        ...
                        additionalProperties =
                            matrixWithThresholdDiscountsConfig.additionalProperties.toMutableMap()
                    }
                     ...
                     *
                     * You should usually call [Builder.firstDimension] with a well-typed [String]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.thresholdDiscountGroups] with a well-typed
                     * `List<ThresholdDiscountGroup>` value instead. This method is primarily for
                     * setting the field to an undocumented or not yet supported value.
                     */
                    fun thresholdDiscountGroups(
                        thresholdDiscountGroups: JsonField<List<ThresholdDiscountGroup>>
                     ...
                     * @throws IllegalStateException if the field was previously set to a non-list.
                     */
                    fun addThresholdDiscountGroup(thresholdDiscountGroup: ThresholdDiscountGroup) =
                        apply {
                            thresholdDiscountGroups =
                    ...
                    fun build(): MatrixWithThresholdDiscountsConfig =
                        MatrixWithThresholdDiscountsConfig(
                            ...
                            secondDimension,
                            (thresholdDiscountGroups ?: JsonMissing.of()).map { it.toImmutable() },
                            additionalProperties.toMutableMap(),
                        )
                }
                ...
                fun validate(): MatrixWithThresholdDiscountsConfig = apply {
                    ...
                    secondDimension()
                    thresholdDiscountGroups()?.forEach { it.validate() }
                    validated = true
                }
                ...
                internal fun validity(): Int =
                    (if (defaultUnitAmount.asKnown() == null) 0 else 1) +
                        ...
                        (thresholdDiscountGroups.asKnown()?.sumOf { it.validity().toInt() } ?: 0)
                ...
                private constructor(
                    ...
                    ) : this(firstDimensionValue, unitAmount, secondDimensionValue, mutableMapOf())
                     ...
                     *
                     * Unlike [firstDimensionValue], this method doesn't throw if the JSON field has
                     * an unexpected type.
                     */
                    @JsonProperty("first_dimension_value")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [secondDimensionValue], this method doesn't throw if the JSON field
                     * has an unexpected type.
                     */
                    @JsonProperty("second_dimension_value")
                    @ExcludeMissing
                ...
                private constructor(
                     ...
                     *   unexpected value).
                     */
                    fun cellCoordinates(): String = cellCoordinates.getRequired("cell_coordinates")
                     ...
                     *
                     * Unlike [aboveThresholdDiscountPercentage], this method doesn't throw if the
                     ...
                     *
                     * Unlike [belowThresholdDiscountPercentage], this method doesn't throw if the
                     * JSON field has an unexpected type.
                     */
                    @JsonProperty("below_threshold_discount_percentage")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [cellCoordinates], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("cell_coordinates")
                    @ExcludeMissing
                    ...
                    class Builder internal constructor() {
                        ...
                        internal fun from(thresholdDiscountGroup: ThresholdDiscountGroup) = apply {
                            aboveThresholdDiscountPercentage =
                         ...
                         * value.
                         *
                         * You should usually call [Builder.aboveThresholdDiscountPercentage] with a
                        ...
                        fun aboveThresholdDiscountPercentage(
                            ...
                            this.aboveThresholdDiscountPercentage = aboveThresholdDiscountPercentage
                        }
                         ...
                         * value.
                         *
                         * You should usually call [Builder.belowThresholdDiscountPercentage] with a
                         * well-typed [String] value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                        fun belowThresholdDiscountPercentage(
                            ...
                            this.belowThresholdDiscountPercentage = belowThresholdDiscountPercentage
                        }
                     ...
                     */
                    internal fun validity(): Int =
                        (if (aboveThresholdDiscountPercentage.asKnown() == null) 0 else 1) +
                            (if (belowThresholdDiscountPercentage.asKnown() == null) 0 else 1) +
                            (if (cellCoordinates.asKnown() == null) 0 else 1) +
        ...
        private constructor(
            ...
            internal fun validity(): Int =
                (cadence.asKnown()?.validity() ?: 0) +
                    (if (currency.asKnown() == null) 0 else 1) +
                    (dailyCreditAllowanceConfig.asKnown()?.validity() ?: 0) +
                    (if (itemId.asKnown() == null) 0 else 1) +
            ...
            private constructor(
                 ...
                 */
                internal fun validity(): Int =
                    (if (dailyAllowance.asKnown() == null) 0 else 1) +
                        (if (defaultUnitAmount.asKnown() == null) 0 else 1) +
                        (dimensions.asKnown()?.sumOf { (if (it == null) 0 else 1).toInt() } ?: 0) +
                        (if (eventDayProperty.asKnown() == null) 0 else 1) +
                        (matrixValues.asKnown()?.sumOf { it.validity().toInt() } ?: 0)
                ...
                private constructor(
                     ...
                     */
                    internal fun validity(): Int =
                        (dimensionValues.asKnown()?.sumOf { (if (it == null) 0 else 1).toInt() }
                            ?: 0) + (if (unitAmount.asKnown() == null) 0 else 1)
        ...
        private constructor(
             ...
             *
             * Unlike [meteredAllowanceConfig], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("metered_allowance_config")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                ...
                internal fun from(meteredAllowance: MeteredAllowance) = apply {
                    ...
                    dimensionalPriceConfiguration = meteredAllowance.dimensionalPriceConfiguration
                 ...
                 * [MeteredAllowanceConfig] value instead. This method is primarily for setting the
                 * field to an undocumented or not yet supported value.
                 */
            ...
            internal fun validity(): Int =
                (cadence.asKnown()?.validity() ?: 0) +
                    (if (currency.asKnown() == null) 0 else 1) +
                    (if (itemId.asKnown() == null) 0 else 1) +
                    (meteredAllowanceConfig.asKnown()?.validity() ?: 0) +
            ...
            private constructor(
                 ...
                 *   the server responded with an unexpected value).
                 */
                fun allowanceDisplayName(): String? =
                    allowanceDisplayName.getNullable("allowance_display_name")
                 ...
                 *   the server responded with an unexpected value).
                 */
                fun consumptionDisplayName(): String? =
                    consumptionDisplayName.getNullable("consumption_display_name")

                /**
                 * Returns the raw JSON value of [allowanceGroupingValue].
                 *
                 * Unlike [allowanceGroupingValue], this method doesn't throw if the JSON field has
                 * an unexpected type.
                 */
                @JsonProperty("allowance_grouping_value")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [consumptionGroupingValue], this method doesn't throw if the JSON field
                 * has an unexpected type.
                 */
                @JsonProperty("consumption_grouping_value")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [allowanceDisplayName], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("allowance_display_name")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [consumptionDisplayName], this method doesn't throw if the JSON field has
                 * an unexpected type.
                 */
                @JsonProperty("consumption_display_name")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(meteredAllowanceConfig: MeteredAllowanceConfig) = apply {
                        ...
                        consumptionGroupingValue = meteredAllowanceConfig.consumptionGroupingValue
                     ...
                     *
                     * You should usually call [Builder.allowanceGroupingValue] with a well-typed
                     * [String] value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    fun allowanceGroupingValue(allowanceGroupingValue: JsonField<String>) = apply {
                     ...
                     *
                     * You should usually call [Builder.consumptionGroupingValue] with a well-typed
                     * [String] value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.consumptionDisplayName] with a well-typed
                     * [String] value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    fun consumptionDisplayName(consumptionDisplayName: JsonField<String>) = apply {
                 ...
                 */
                internal fun validity(): Int =
                    (if (allowanceGroupingValue.asKnown() == null) 0 else 1) +
                        (if (consumptionGroupingValue.asKnown() == null) 0 else 1) +
                        (if (groupingKey.asKnown() == null) 0 else 1) +
                        (if (unitAmount.asKnown() == null) 0 else 1) +
                        (if (allowanceDisplayName.asKnown() == null) 0 else 1) +
                        (if (consumptionDisplayName.asKnown() == null) 0 else 1)

...
class SubscriptionPlanVersionChangedWebhookEvent
...
private constructor(
    ...
    /** A builder for [SubscriptionPlanVersionChangedWebhookEvent]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            subscriptionPlanVersionChangedWebhookEvent: SubscriptionPlanVersionChangedWebhookEvent
        ) = apply {
            id = subscriptionPlanVersionChangedWebhookEvent.id
            createdAt = subscriptionPlanVersionChangedWebhookEvent.createdAt
            properties = subscriptionPlanVersionChangedWebhookEvent.properties
            subscription = subscriptionPlanVersionChangedWebhookEvent.subscription
            type = subscriptionPlanVersionChangedWebhookEvent.type
            additionalProperties =
                subscriptionPlanVersionChangedWebhookEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubscriptionPlanVersionChangedWebhookEvent].
         *
         ...
         */
        fun build(): SubscriptionPlanVersionChangedWebhookEvent =
            SubscriptionPlanVersionChangedWebhookEvent(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): SubscriptionPlanVersionChangedWebhookEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        internal fun validity(): Int =
            (if (effectiveDate.asKnown() == null) 0 else 1) +
                (if (newPlanVersionNumber.asKnown() == null) 0 else 1) +
                (if (previousPlanVersionNumber.asKnown() == null) 0 else 1)
    ...
    class Type @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            val SUBSCRIPTION_PLAN_VERSION_CHANGED = of("subscription.plan_version_changed")
        ...
        fun value(): Value =
            when (this) {
                SUBSCRIPTION_PLAN_VERSION_CHANGED -> Value.SUBSCRIPTION_PLAN_VERSION_CHANGED
                else -> Value._UNKNOWN
            }
        ...
        fun known(): Known =
            when (this) {
                SUBSCRIPTION_PLAN_VERSION_CHANGED -> Known.SUBSCRIPTION_PLAN_VERSION_CHANGED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionPlanVersionChangedWebhookEvent &&
            id == other.id &&
    ...
    override fun toString() =
        "SubscriptionPlanVersionChangedWebhookEvent{id=$id, createdAt=$createdAt, properties=$properties, subscription=$subscription, type=$type, additionalProperties=$additionalProperties}"
}

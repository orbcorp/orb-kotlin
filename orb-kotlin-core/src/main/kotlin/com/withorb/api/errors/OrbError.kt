...
@NoAutoDetect
class OrbError @JsonCreator private constructor(
    @JsonAnyGetter @ExcludeMissing @JsonAnySetter val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
    ...
    class Builder internal constructor() {
        ...
        internal fun from(orbError: OrbError) =
            apply {

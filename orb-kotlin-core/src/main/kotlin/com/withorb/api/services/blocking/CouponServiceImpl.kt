...
class CouponServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : CouponService {

    private val withRawResponse: CouponService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: CouponCreateParams, requestOptions: RequestOptions): HttpResponseFor<Coupon> {
        ...
        private val listHandler: Handler<CouponListPage.Response> = jsonHandler<CouponListPage.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override fun list(params: CouponListParams, requestOptions: RequestOptions): HttpResponseFor<CouponListPage> {
          val request = HttpRequest.builder()
          ...
          return response.parseable {
              ...
              .let {
                  CouponListPage.of(CouponServiceImpl(clientOptions), params, it)
              }
          }
        }
        ...
        override fun archive(params: CouponArchiveParams, requestOptions: RequestOptions): HttpResponseFor<Coupon> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun fetch(params: CouponFetchParams, requestOptions: RequestOptions): HttpResponseFor<Coupon> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)

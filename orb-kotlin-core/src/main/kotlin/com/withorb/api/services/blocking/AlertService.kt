...
interface AlertService {
     ...
     */
    fun list(params: AlertListParams = AlertListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): AlertListPage

    /** @see [list] */
    fun list(requestOptions: RequestOptions): AlertListPage = list(AlertListParams.none(), requestOptions)
    ...
    /**
     * A view of [AlertService] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * same as [AlertService.retrieve].
         */
        @MustBeClosed
        fun retrieve(params: AlertRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Alert>

        /**
         * Returns a raw HTTP response for `put /alerts/{alert_configuration_id}`, but is
         * otherwise the same as [AlertService.update].
         */
        @MustBeClosed
        fun update(params: AlertUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Alert>
         ...
         */
        @MustBeClosed
        fun list(params: AlertListParams = AlertListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<AlertListPage>

        /** @see [list] */
        @MustBeClosed
        fun list(requestOptions: RequestOptions): HttpResponseFor<AlertListPage> = list(AlertListParams.none(), requestOptions)
         ...
         */
        @MustBeClosed
        fun createForCustomer(params: AlertCreateForCustomerParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Alert>

        /**
         * Returns a raw HTTP response for
         * `post /alerts/external_customer_id/{external_customer_id}`, but is otherwise the
         * same as [AlertService.createForExternalCustomer].
         */
        @MustBeClosed
        fun createForExternalCustomer(params: AlertCreateForExternalCustomerParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Alert>
         ...
         */
        @MustBeClosed
        fun createForSubscription(params: AlertCreateForSubscriptionParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Alert>

        /**
         * Returns a raw HTTP response for `post /alerts/{alert_configuration_id}/disable`,
         * but is otherwise the same as [AlertService.disable].
         */
        @MustBeClosed
        fun disable(params: AlertDisableParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Alert>

        /**
         * Returns a raw HTTP response for `post /alerts/{alert_configuration_id}/enable`,
         * but is otherwise the same as [AlertService.enable].
         */
        @MustBeClosed
        fun enable(params: AlertEnableParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Alert>
    }
}

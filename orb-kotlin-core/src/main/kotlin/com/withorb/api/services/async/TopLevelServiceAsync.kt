...
interface TopLevelServiceAsync {
     ...
     */
    suspend fun ping(params: TopLevelPingParams = TopLevelPingParams.none(), requestOptions: RequestOptions = RequestOptions.none()): TopLevelPingResponse

    /** @see [ping] */
    suspend fun ping(requestOptions: RequestOptions): TopLevelPingResponse = ping(TopLevelPingParams.none(), requestOptions)
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun ping(params: TopLevelPingParams = TopLevelPingParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<TopLevelPingResponse>

        /** @see [ping] */
        @MustBeClosed
        suspend fun ping(requestOptions: RequestOptions): HttpResponseFor<TopLevelPingResponse> = ping(TopLevelPingParams.none(), requestOptions)
    }
}

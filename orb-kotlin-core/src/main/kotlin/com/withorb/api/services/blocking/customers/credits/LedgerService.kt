...
interface LedgerService {
     ...
     */
    fun list(params: CustomerCreditLedgerListParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerCreditLedgerListPage
     ...
     */
    fun createEntry(params: CustomerCreditLedgerCreateEntryParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerCreditLedgerCreateEntryResponse
     ...
     * return to the customer, up to the block's initial balance.
     */
    fun createEntryByExternalId(params: CustomerCreditLedgerCreateEntryByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerCreditLedgerCreateEntryByExternalIdResponse
     ...
     * entry will be added to the ledger to indicate the adjustment of credits.
     */
    fun listByExternalId(params: CustomerCreditLedgerListByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerCreditLedgerListByExternalIdPage

    /**
     * A view of [LedgerService] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * but is otherwise the same as [LedgerService.list].
         */
        @MustBeClosed
        fun list(params: CustomerCreditLedgerListParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerCreditLedgerListPage>

        /**
         * Returns a raw HTTP response for
         * `post /customers/{customer_id}/credits/ledger_entry`, but is otherwise the same
         * as [LedgerService.createEntry].
         */
        @MustBeClosed
        fun createEntry(params: CustomerCreditLedgerCreateEntryParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerCreditLedgerCreateEntryResponse>

        /**
         * Returns a raw HTTP response for
         * `post /customers/external_customer_id/{external_customer_id}/credits/ledger_entry`,
         * but is otherwise the same as [LedgerService.createEntryByExternalId].
         */
        @MustBeClosed
        fun createEntryByExternalId(params: CustomerCreditLedgerCreateEntryByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerCreditLedgerCreateEntryByExternalIdResponse>

        /**
         * Returns a raw HTTP response for
         * `get /customers/external_customer_id/{external_customer_id}/credits/ledger`, but
         * is otherwise the same as [LedgerService.listByExternalId].
         */
        @MustBeClosed
        fun listByExternalId(params: CustomerCreditLedgerListByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerCreditLedgerListByExternalIdPage>
    }
}

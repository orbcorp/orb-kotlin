...
class ExternalPlanIdServiceAsyncImpl internal constructor(
    ...
    override suspend fun update(params: PlanExternalPlanIdUpdateParams, requestOptions: RequestOptions): Plan =
        // put /plans/external_plan_id/{external_plan_id}
        withRawResponse().update(params, requestOptions).parse()

    override suspend fun fetch(params: PlanExternalPlanIdFetchParams, requestOptions: RequestOptions): Plan =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun update(params: PlanExternalPlanIdUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Plan> {
        ...
        override suspend fun fetch(params: PlanExternalPlanIdFetchParams, requestOptions: RequestOptions): HttpResponseFor<Plan> {
          val request = HttpRequest.builder()

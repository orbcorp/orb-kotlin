...
interface VolumeServiceAsync {
     ...
     */
    suspend fun list(params: EventVolumeListParams, requestOptions: RequestOptions = RequestOptions.none()): EventVolumes
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun list(params: EventVolumeListParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<EventVolumes>
    }
}

...
class SubscriptionServiceImpl constructor(private val clientOptions: ClientOptions, ) : SubscriptionService {
     ...
     */
    override fun create(params: SubscriptionCreateParams, requestOptions: RequestOptions): Subscription {
    ...
    override fun list(params: SubscriptionListParams, requestOptions: RequestOptions): SubscriptionListPage {
      ...
      .let { response -> 
          ...
          .let {
              SubscriptionListPage.of(this, params, it)
          }
      }
    }
     ...
     */
    override fun cancel(params: SubscriptionCancelParams, requestOptions: RequestOptions): Subscription {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
    ...
    override fun fetchSchedule(params: SubscriptionFetchScheduleParams, requestOptions: RequestOptions): SubscriptionFetchSchedulePage {
      ...
      .let { response -> 
          ...
          .let {
              SubscriptionFetchSchedulePage.of(this, params, it)
          }
      }
    }
     ...
     * intervals.
     */
    override fun priceIntervals(params: SubscriptionPriceIntervalsParams, requestOptions: RequestOptions): Subscription {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun schedulePlanChange(params: SubscriptionSchedulePlanChangeParams, requestOptions: RequestOptions): Subscription {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     * specified).
     */
    override fun triggerPhase(params: SubscriptionTriggerPhaseParams, requestOptions: RequestOptions): Subscription {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun unscheduleCancellation(params: SubscriptionUnscheduleCancellationParams, requestOptions: RequestOptions): Subscription {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun unscheduleFixedFeeQuantityUpdates(params: SubscriptionUnscheduleFixedFeeQuantityUpdatesParams, requestOptions: RequestOptions): Subscription {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     * subscription.
     */
    override fun unschedulePendingPlanChanges(params: SubscriptionUnschedulePendingPlanChangesParams, requestOptions: RequestOptions): Subscription {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun updateFixedFeeQuantity(params: SubscriptionUpdateFixedFeeQuantityParams, requestOptions: RequestOptions): Subscription {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)

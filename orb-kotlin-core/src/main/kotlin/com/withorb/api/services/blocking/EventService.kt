...
interface EventService {
     ...
     */
    fun update(params: EventUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): EventUpdateResponse
     ...
     *   [event backfill](create-backfill) endpoint.
     */
    fun deprecate(params: EventDeprecateParams, requestOptions: RequestOptions = RequestOptions.none()): EventDeprecateResponse
     ...
     * ```
     */
    fun ingest(params: EventIngestParams, requestOptions: RequestOptions = RequestOptions.none()): EventIngestResponse
     ...
     */
    fun search(params: EventSearchParams, requestOptions: RequestOptions = RequestOptions.none()): EventSearchResponse
    ...
    interface WithRawResponse {
         ...
         * same as [EventService.update].
         */
        @MustBeClosed
        fun update(params: EventUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<EventUpdateResponse>

        /**
         * Returns a raw HTTP response for `put /events/{event_id}/deprecate`, but is
         * otherwise the same as [EventService.deprecate].
         */
        @MustBeClosed
        fun deprecate(params: EventDeprecateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<EventDeprecateResponse>
         ...
         */
        @MustBeClosed
        fun ingest(params: EventIngestParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<EventIngestResponse>

        /**
         * Returns a raw HTTP response for `post /events/search`, but is otherwise the same
         * as [EventService.search].
         */
        @MustBeClosed
        fun search(params: EventSearchParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<EventSearchResponse>
    }
}

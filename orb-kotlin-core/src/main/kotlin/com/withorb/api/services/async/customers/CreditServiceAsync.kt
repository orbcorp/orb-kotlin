...
interface CreditServiceAsync {
     ...
     */
    suspend fun list(params: CustomerCreditListParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerCreditListPageAsync
     ...
     * currency, set `currency` to an ISO 4217 string.
     */
    suspend fun listByExternalId(params: CustomerCreditListByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerCreditListByExternalIdPageAsync

    /**
     * A view of [CreditServiceAsync] that provides access to raw HTTP responses for
     * each method.
     */
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun list(params: CustomerCreditListParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerCreditListPageAsync>

        /**
         * Returns a raw HTTP response for
         * `get /customers/external_customer_id/{external_customer_id}/credits`, but is
         * otherwise the same as [CreditServiceAsync.listByExternalId].
         */
        @MustBeClosed
        suspend fun listByExternalId(params: CustomerCreditListByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerCreditListByExternalIdPageAsync>
    }
}

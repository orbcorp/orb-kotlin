...
class VolumeServiceAsyncImpl internal constructor(
    ...
    override suspend fun list(params: EventVolumeListParams, requestOptions: RequestOptions): EventVolumes =
        // get /events/volume
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun list(params: EventVolumeListParams, requestOptions: RequestOptions): HttpResponseFor<EventVolumes> {

...
class CreditNoteServiceAsyncImpl internal constructor(
    ...
    override suspend fun create(params: CreditNoteCreateParams, requestOptions: RequestOptions): CreditNote =
        // post /credit_notes
        withRawResponse().create(params, requestOptions).parse()

    override suspend fun list(params: CreditNoteListParams, requestOptions: RequestOptions): CreditNoteListPageAsync =
        // get /credit_notes
        withRawResponse().list(params, requestOptions).parse()

    override suspend fun fetch(params: CreditNoteFetchParams, requestOptions: RequestOptions): CreditNote =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: CreditNoteCreateParams, requestOptions: RequestOptions): HttpResponseFor<CreditNote> {
        ...
        override suspend fun list(params: CreditNoteListParams, requestOptions: RequestOptions): HttpResponseFor<CreditNoteListPageAsync> {
          val request = HttpRequest.builder()
        ...
        override suspend fun fetch(params: CreditNoteFetchParams, requestOptions: RequestOptions): HttpResponseFor<CreditNote> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)

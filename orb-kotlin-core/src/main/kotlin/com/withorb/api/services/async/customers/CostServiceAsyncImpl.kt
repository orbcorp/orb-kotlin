...
class CostServiceAsyncImpl internal constructor(
    ...
    override suspend fun list(params: CustomerCostListParams, requestOptions: RequestOptions): CustomerCostListResponse =
        // get /customers/{customer_id}/costs
        withRawResponse().list(params, requestOptions).parse()

    override suspend fun listByExternalId(params: CustomerCostListByExternalIdParams, requestOptions: RequestOptions): CustomerCostListByExternalIdResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun list(params: CustomerCostListParams, requestOptions: RequestOptions): HttpResponseFor<CustomerCostListResponse> {
        ...
        override suspend fun listByExternalId(params: CustomerCostListByExternalIdParams, requestOptions: RequestOptions): HttpResponseFor<CustomerCostListByExternalIdResponse> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)

...
interface BalanceTransactionServiceAsync {
     ...
     */
    suspend fun create(params: CustomerBalanceTransactionCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerBalanceTransactionCreateResponse
     ...
     */
    suspend fun list(params: CustomerBalanceTransactionListParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerBalanceTransactionListPageAsync

    /**
     * A view of [BalanceTransactionServiceAsync] that provides access to raw HTTP
    ...
    interface WithRawResponse {
         ...
         * `post /customers/{customer_id}/balance_transactions`, but is otherwise the same
         * as [BalanceTransactionServiceAsync.create].
         */
        @MustBeClosed
        suspend fun create(params: CustomerBalanceTransactionCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerBalanceTransactionCreateResponse>

        /**
         * Returns a raw HTTP response for
         * `get /customers/{customer_id}/balance_transactions`, but is otherwise the same
         * as [BalanceTransactionServiceAsync.list].
         */
        @MustBeClosed
        suspend fun list(params: CustomerBalanceTransactionListParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerBalanceTransactionListPageAsync>
    }
}

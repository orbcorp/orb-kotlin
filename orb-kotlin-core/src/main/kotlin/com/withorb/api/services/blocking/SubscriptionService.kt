...
interface SubscriptionService {
     ...
     */
    fun create(params: SubscriptionCreateParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription
     ...
     */
    fun list(params: SubscriptionListParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionListPage
     ...
     */
    fun cancel(params: SubscriptionCancelParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription
     ...
     * intervals.
     */
    fun priceIntervals(params: SubscriptionPriceIntervalsParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription
     ...
     */
    fun schedulePlanChange(params: SubscriptionSchedulePlanChangeParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription

    /**
     * Manually trigger a phase, effective the given date (or the current time, if not
     * specified).
     */
    fun triggerPhase(params: SubscriptionTriggerPhaseParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription
     ...
     */
    fun unscheduleCancellation(params: SubscriptionUnscheduleCancellationParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription
     ...
     */
    fun unscheduleFixedFeeQuantityUpdates(params: SubscriptionUnscheduleFixedFeeQuantityUpdatesParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription

    /**
     * This endpoint can be used to unschedule any pending plan changes on an existing
     * subscription.
     */
    fun unschedulePendingPlanChanges(params: SubscriptionUnschedulePendingPlanChangesParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription
     ...
     */
    fun updateFixedFeeQuantity(params: SubscriptionUpdateFixedFeeQuantityParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription
}

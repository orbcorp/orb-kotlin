...
interface SubscriptionService {
    ...
    /** @see [list] */
    fun list(requestOptions: RequestOptions): SubscriptionListPage = list(SubscriptionListParams.none(), requestOptions)
     ...
     */
    fun cancel(params: SubscriptionCancelParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionCancelResponse

    /**
     * This endpoint is used to fetch a [Subscription](/core-concepts##subscription)
     * given an identifier.
     */
    fun fetch(params: SubscriptionFetchParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription
     ...
     * same day).
     */
    fun fetchCosts(params: SubscriptionFetchCostsParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionFetchCostsResponse
     ...
     * changes.
     */
    fun fetchSchedule(params: SubscriptionFetchScheduleParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionFetchSchedulePage
     ...
     */
    fun fetchUsage(params: SubscriptionFetchUsageParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionUsage
     ...
     * intervals.
     */
    fun priceIntervals(params: SubscriptionPriceIntervalsParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionPriceIntervalsResponse
     ...
     */
    fun schedulePlanChange(params: SubscriptionSchedulePlanChangeParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionSchedulePlanChangeResponse

    /**
     * Manually trigger a phase, effective the given date (or the current time, if not
     * specified).
     */
    fun triggerPhase(params: SubscriptionTriggerPhaseParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionTriggerPhaseResponse
     ...
     */
    fun unscheduleCancellation(params: SubscriptionUnscheduleCancellationParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionUnscheduleCancellationResponse
     ...
     */
    fun unscheduleFixedFeeQuantityUpdates(params: SubscriptionUnscheduleFixedFeeQuantityUpdatesParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse

    /**
     * This endpoint can be used to unschedule any pending plan changes on an existing
     * subscription.
     */
    fun unschedulePendingPlanChanges(params: SubscriptionUnschedulePendingPlanChangesParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionUnschedulePendingPlanChangesResponse
     ...
     */
    fun updateFixedFeeQuantity(params: SubscriptionUpdateFixedFeeQuantityParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionUpdateFixedFeeQuantityResponse
     ...
     * extended).
     */
    fun updateTrial(params: SubscriptionUpdateTrialParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionUpdateTrialResponse
    ...
    interface WithRawResponse {
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(requestOptions: RequestOptions): HttpResponseFor<SubscriptionListPage> = list(SubscriptionListParams.none(), requestOptions)

        /**
         * Returns a raw HTTP response for `post /subscriptions/{subscription_id}/cancel`,
         * but is otherwise the same as [SubscriptionService.cancel].
         */
        @MustBeClosed
        fun cancel(params: SubscriptionCancelParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionCancelResponse>

        /**
         * Returns a raw HTTP response for `get /subscriptions/{subscription_id}`, but is
         * otherwise the same as [SubscriptionService.fetch].
         */
        @MustBeClosed
        fun fetch(params: SubscriptionFetchParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Subscription>

        /**
         * Returns a raw HTTP response for `get /subscriptions/{subscription_id}/costs`,
         * but is otherwise the same as [SubscriptionService.fetchCosts].
         */
        @MustBeClosed
        fun fetchCosts(params: SubscriptionFetchCostsParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionFetchCostsResponse>

        /**
         * Returns a raw HTTP response for `get /subscriptions/{subscription_id}/schedule`,
         * but is otherwise the same as [SubscriptionService.fetchSchedule].
         */
        @MustBeClosed
        fun fetchSchedule(params: SubscriptionFetchScheduleParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionFetchSchedulePage>

        /**
         * Returns a raw HTTP response for `get /subscriptions/{subscription_id}/usage`,
         * but is otherwise the same as [SubscriptionService.fetchUsage].
         */
        @MustBeClosed
        fun fetchUsage(params: SubscriptionFetchUsageParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionUsage>

        /**
         * Returns a raw HTTP response for
         * `post /subscriptions/{subscription_id}/price_intervals`, but is otherwise the
         * same as [SubscriptionService.priceIntervals].
         */
        @MustBeClosed
        fun priceIntervals(params: SubscriptionPriceIntervalsParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionPriceIntervalsResponse>

        /**
         * Returns a raw HTTP response for
         * `post /subscriptions/{subscription_id}/schedule_plan_change`, but is otherwise
         * the same as [SubscriptionService.schedulePlanChange].
         */
        @MustBeClosed
        fun schedulePlanChange(params: SubscriptionSchedulePlanChangeParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionSchedulePlanChangeResponse>

        /**
         * Returns a raw HTTP response for
         * `post /subscriptions/{subscription_id}/trigger_phase`, but is otherwise the same
         * as [SubscriptionService.triggerPhase].
         */
        @MustBeClosed
        fun triggerPhase(params: SubscriptionTriggerPhaseParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionTriggerPhaseResponse>

        /**
         * Returns a raw HTTP response for
         * `post /subscriptions/{subscription_id}/unschedule_cancellation`, but is
         * otherwise the same as [SubscriptionService.unscheduleCancellation].
         */
        @MustBeClosed
        fun unscheduleCancellation(params: SubscriptionUnscheduleCancellationParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionUnscheduleCancellationResponse>
         ...
         */
        @MustBeClosed
        fun unscheduleFixedFeeQuantityUpdates(params: SubscriptionUnscheduleFixedFeeQuantityUpdatesParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse>

        /**
         * Returns a raw HTTP response for
         * `post /subscriptions/{subscription_id}/unschedule_pending_plan_changes`, but is
         * otherwise the same as [SubscriptionService.unschedulePendingPlanChanges].
         */
        @MustBeClosed
        fun unschedulePendingPlanChanges(params: SubscriptionUnschedulePendingPlanChangesParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionUnschedulePendingPlanChangesResponse>

        /**
         * Returns a raw HTTP response for
         * `post /subscriptions/{subscription_id}/update_fixed_fee_quantity`, but is
         * otherwise the same as [SubscriptionService.updateFixedFeeQuantity].
         */
        @MustBeClosed
        fun updateFixedFeeQuantity(params: SubscriptionUpdateFixedFeeQuantityParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionUpdateFixedFeeQuantityResponse>

        /**
         * Returns a raw HTTP response for
         * `post /subscriptions/{subscription_id}/update_trial`, but is otherwise the same
         * as [SubscriptionService.updateTrial].
         */
        @MustBeClosed
        fun updateTrial(params: SubscriptionUpdateTrialParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionUpdateTrialResponse>
    }
}

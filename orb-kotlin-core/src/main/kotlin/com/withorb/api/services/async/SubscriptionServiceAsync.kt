...
interface SubscriptionServiceAsync {
     ...
     */
    suspend fun create(params: SubscriptionCreateParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription
     ...
     * parameters.
     */
    suspend fun list(params: SubscriptionListParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionListPageAsync
     ...
     */
    suspend fun cancel(params: SubscriptionCancelParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription
     ...
     * intervals.
     */
    suspend fun priceIntervals(params: SubscriptionPriceIntervalsParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription
     ...
     */
    suspend fun schedulePlanChange(params: SubscriptionSchedulePlanChangeParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription

    /**
     * Manually trigger a phase, effective the given date (or the current time, if not
     * specified).
     */
    suspend fun triggerPhase(params: SubscriptionTriggerPhaseParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription
     ...
     */
    suspend fun unscheduleCancellation(params: SubscriptionUnscheduleCancellationParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription
     ...
     */
    suspend fun unscheduleFixedFeeQuantityUpdates(params: SubscriptionUnscheduleFixedFeeQuantityUpdatesParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription

    /**
     * This endpoint can be used to unschedule any pending plan changes on an existing
     * subscription.
     */
    suspend fun unschedulePendingPlanChanges(params: SubscriptionUnschedulePendingPlanChangesParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription
     ...
     */
    suspend fun updateFixedFeeQuantity(params: SubscriptionUpdateFixedFeeQuantityParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription
}

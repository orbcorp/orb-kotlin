...
interface SubscriptionServiceAsync {
     ...
     */
    suspend fun create(params: SubscriptionCreateParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionCreateResponse
     ...
     * on a subscription.
     */
    suspend fun update(params: SubscriptionUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription
     ...
     * parameters.
     */
    suspend fun list(params: SubscriptionListParams = SubscriptionListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): SubscriptionListPageAsync

    /** @see [list] */
    suspend fun list(requestOptions: RequestOptions): SubscriptionListPageAsync = list(SubscriptionListParams.none(), requestOptions)
     ...
     */
    suspend fun cancel(params: SubscriptionCancelParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionCancelResponse

    /**
     * This endpoint is used to fetch a [Subscription](/core-concepts##subscription)
     * given an identifier.
     */
    suspend fun fetch(params: SubscriptionFetchParams, requestOptions: RequestOptions = RequestOptions.none()): Subscription
     ...
     * same day).
     */
    suspend fun fetchCosts(params: SubscriptionFetchCostsParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionFetchCostsResponse
     ...
     * changes.
     */
    suspend fun fetchSchedule(params: SubscriptionFetchScheduleParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionFetchSchedulePageAsync
     ...
     */
    suspend fun fetchUsage(params: SubscriptionFetchUsageParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionUsage
     ...
     * intervals.
     */
    suspend fun priceIntervals(params: SubscriptionPriceIntervalsParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionPriceIntervalsResponse
     ...
     */
    suspend fun schedulePlanChange(params: SubscriptionSchedulePlanChangeParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionSchedulePlanChangeResponse

    /**
     * Manually trigger a phase, effective the given date (or the current time, if not
     * specified).
     */
    suspend fun triggerPhase(params: SubscriptionTriggerPhaseParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionTriggerPhaseResponse
     ...
     */
    suspend fun unscheduleCancellation(params: SubscriptionUnscheduleCancellationParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionUnscheduleCancellationResponse
     ...
     */
    suspend fun unscheduleFixedFeeQuantityUpdates(params: SubscriptionUnscheduleFixedFeeQuantityUpdatesParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse

    /**
     * This endpoint can be used to unschedule any pending plan changes on an existing
     * subscription.
     */
    suspend fun unschedulePendingPlanChanges(params: SubscriptionUnschedulePendingPlanChangesParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionUnschedulePendingPlanChangesResponse
     ...
     */
    suspend fun updateFixedFeeQuantity(params: SubscriptionUpdateFixedFeeQuantityParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionUpdateFixedFeeQuantityResponse
     ...
     * extended).
     */
    suspend fun updateTrial(params: SubscriptionUpdateTrialParams, requestOptions: RequestOptions = RequestOptions.none()): SubscriptionUpdateTrialResponse
    ...
    interface WithRawResponse {
        ...
        /**
         * Returns a raw HTTP response for `post /subscriptions`, but is otherwise the same
         * as [SubscriptionServiceAsync.create].
         */
        @MustBeClosed
        suspend fun create(params: SubscriptionCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionCreateResponse>

        /**
         * Returns a raw HTTP response for `put /subscriptions/{subscription_id}`, but is
         * otherwise the same as [SubscriptionServiceAsync.update].
         */
        @MustBeClosed
        suspend fun update(params: SubscriptionUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Subscription>

        /**
         * Returns a raw HTTP response for `get /subscriptions`, but is otherwise the same
         * as [SubscriptionServiceAsync.list].
         */
        @MustBeClosed
        suspend fun list(params: SubscriptionListParams = SubscriptionListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionListPageAsync>

        /** @see [list] */
        @MustBeClosed
        suspend fun list(requestOptions: RequestOptions): HttpResponseFor<SubscriptionListPageAsync> = list(SubscriptionListParams.none(), requestOptions)

        /**
         * Returns a raw HTTP response for `post /subscriptions/{subscription_id}/cancel`,
         * but is otherwise the same as [SubscriptionServiceAsync.cancel].
         */
        @MustBeClosed
        suspend fun cancel(params: SubscriptionCancelParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionCancelResponse>

        /**
         * Returns a raw HTTP response for `get /subscriptions/{subscription_id}`, but is
         * otherwise the same as [SubscriptionServiceAsync.fetch].
         */
        @MustBeClosed
        suspend fun fetch(params: SubscriptionFetchParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Subscription>

        /**
         * Returns a raw HTTP response for `get /subscriptions/{subscription_id}/costs`,
         * but is otherwise the same as [SubscriptionServiceAsync.fetchCosts].
         */
        @MustBeClosed
        suspend fun fetchCosts(params: SubscriptionFetchCostsParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionFetchCostsResponse>

        /**
         * Returns a raw HTTP response for `get /subscriptions/{subscription_id}/schedule`,
         * but is otherwise the same as [SubscriptionServiceAsync.fetchSchedule].
         */
        @MustBeClosed
        suspend fun fetchSchedule(params: SubscriptionFetchScheduleParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionFetchSchedulePageAsync>

        /**
         * Returns a raw HTTP response for `get /subscriptions/{subscription_id}/usage`,
         * but is otherwise the same as [SubscriptionServiceAsync.fetchUsage].
         */
        @MustBeClosed
        suspend fun fetchUsage(params: SubscriptionFetchUsageParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionUsage>

        /**
         * Returns a raw HTTP response for
         * `post /subscriptions/{subscription_id}/price_intervals`, but is otherwise the
         * same as [SubscriptionServiceAsync.priceIntervals].
         */
        @MustBeClosed
        suspend fun priceIntervals(params: SubscriptionPriceIntervalsParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionPriceIntervalsResponse>

        /**
         * Returns a raw HTTP response for
         * `post /subscriptions/{subscription_id}/schedule_plan_change`, but is otherwise
         * the same as [SubscriptionServiceAsync.schedulePlanChange].
         */
        @MustBeClosed
        suspend fun schedulePlanChange(params: SubscriptionSchedulePlanChangeParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionSchedulePlanChangeResponse>

        /**
         * Returns a raw HTTP response for
         * `post /subscriptions/{subscription_id}/trigger_phase`, but is otherwise the same
         * as [SubscriptionServiceAsync.triggerPhase].
         */
        @MustBeClosed
        suspend fun triggerPhase(params: SubscriptionTriggerPhaseParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionTriggerPhaseResponse>

        /**
         * Returns a raw HTTP response for
         * `post /subscriptions/{subscription_id}/unschedule_cancellation`, but is
         * otherwise the same as [SubscriptionServiceAsync.unscheduleCancellation].
         */
        @MustBeClosed
        suspend fun unscheduleCancellation(params: SubscriptionUnscheduleCancellationParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionUnscheduleCancellationResponse>
         ...
         */
        @MustBeClosed
        suspend fun unscheduleFixedFeeQuantityUpdates(params: SubscriptionUnscheduleFixedFeeQuantityUpdatesParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse>

        /**
         * Returns a raw HTTP response for
         * `post /subscriptions/{subscription_id}/unschedule_pending_plan_changes`, but is
         * otherwise the same as [SubscriptionServiceAsync.unschedulePendingPlanChanges].
         */
        @MustBeClosed
        suspend fun unschedulePendingPlanChanges(params: SubscriptionUnschedulePendingPlanChangesParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionUnschedulePendingPlanChangesResponse>

        /**
         * Returns a raw HTTP response for
         * `post /subscriptions/{subscription_id}/update_fixed_fee_quantity`, but is
         * otherwise the same as [SubscriptionServiceAsync.updateFixedFeeQuantity].
         */
        @MustBeClosed
        suspend fun updateFixedFeeQuantity(params: SubscriptionUpdateFixedFeeQuantityParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionUpdateFixedFeeQuantityResponse>

        /**
         * Returns a raw HTTP response for
         * `post /subscriptions/{subscription_id}/update_trial`, but is otherwise the same
         * as [SubscriptionServiceAsync.updateTrial].
         */
        @MustBeClosed
        suspend fun updateTrial(params: SubscriptionUpdateTrialParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<SubscriptionUpdateTrialResponse>
    }
}

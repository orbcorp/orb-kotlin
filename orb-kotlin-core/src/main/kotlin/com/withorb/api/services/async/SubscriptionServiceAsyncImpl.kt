...
class SubscriptionServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : SubscriptionServiceAsync {
     ...
     */
    override suspend fun create(params: SubscriptionCreateParams, requestOptions: RequestOptions): Subscription {
    ...
    override suspend fun list(params: SubscriptionListParams, requestOptions: RequestOptions): SubscriptionListPageAsync {
      ...
      .let { response -> 
          ...
          .let {
              SubscriptionListPageAsync.of(this, params, it)
          }
      }
    }
     ...
     */
    override suspend fun cancel(params: SubscriptionCancelParams, requestOptions: RequestOptions): Subscription {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
    ...
    override suspend fun fetchSchedule(params: SubscriptionFetchScheduleParams, requestOptions: RequestOptions): SubscriptionFetchSchedulePageAsync {
      ...
      .let { response -> 
          ...
          .let {
              SubscriptionFetchSchedulePageAsync.of(this, params, it)
          }
      }
    }
     ...
     * intervals.
     */
    override suspend fun priceIntervals(params: SubscriptionPriceIntervalsParams, requestOptions: RequestOptions): Subscription {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override suspend fun schedulePlanChange(params: SubscriptionSchedulePlanChangeParams, requestOptions: RequestOptions): Subscription {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     * specified).
     */
    override suspend fun triggerPhase(params: SubscriptionTriggerPhaseParams, requestOptions: RequestOptions): Subscription {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override suspend fun unscheduleCancellation(params: SubscriptionUnscheduleCancellationParams, requestOptions: RequestOptions): Subscription {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override suspend fun unscheduleFixedFeeQuantityUpdates(params: SubscriptionUnscheduleFixedFeeQuantityUpdatesParams, requestOptions: RequestOptions): Subscription {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     * subscription.
     */
    override suspend fun unschedulePendingPlanChanges(params: SubscriptionUnschedulePendingPlanChangesParams, requestOptions: RequestOptions): Subscription {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override suspend fun updateFixedFeeQuantity(params: SubscriptionUpdateFixedFeeQuantityParams, requestOptions: RequestOptions): Subscription {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)

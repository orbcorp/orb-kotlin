...
class ItemServiceAsyncImpl internal constructor(
    ...
    override suspend fun list(params: ItemListParams, requestOptions: RequestOptions): ItemListPageAsync =
        // get /items
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override suspend fun create(params: ItemCreateParams, requestOptions: RequestOptions): HttpResponseFor<Item> {
        ...
        override suspend fun update(params: ItemUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Item> {
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<ItemListPageAsync.Response> = jsonHandler<ItemListPageAsync.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override suspend fun list(params: ItemListParams, requestOptions: RequestOptions): HttpResponseFor<ItemListPageAsync> {
          val request = HttpRequest.builder()
          ...
          return response.parseable {
              ...
              .let {
                  ItemListPageAsync.of(ItemServiceAsyncImpl(clientOptions), params, it)
              }
          }
        }
        ...
        override suspend fun fetch(params: ItemFetchParams, requestOptions: RequestOptions): HttpResponseFor<Item> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("items", params.getPathParam(0))
            .build()

...
interface CreditNoteServiceAsync {
     ...
     */
    suspend fun create(params: CreditNoteCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CreditNote
     ...
     */
    suspend fun list(params: CreditNoteListParams = CreditNoteListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CreditNoteListPageAsync

    /** @see [list] */
    suspend fun list(requestOptions: RequestOptions): CreditNoteListPageAsync = list(CreditNoteListParams.none(), requestOptions)

    /**
     * This endpoint is used to fetch a single [`Credit Note`](/invoicing/credit-notes)
     * given an identifier.
     */
    suspend fun fetch(params: CreditNoteFetchParams, requestOptions: RequestOptions = RequestOptions.none()): CreditNote
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun create(params: CreditNoteCreateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CreditNote>
         ...
         */
        @MustBeClosed
        suspend fun list(params: CreditNoteListParams = CreditNoteListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CreditNoteListPageAsync>

        /** @see [list] */
        @MustBeClosed
        suspend fun list(requestOptions: RequestOptions): HttpResponseFor<CreditNoteListPageAsync> = list(CreditNoteListParams.none(), requestOptions)
         ...
         */
        @MustBeClosed
        suspend fun fetch(params: CreditNoteFetchParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CreditNote>
    }
}

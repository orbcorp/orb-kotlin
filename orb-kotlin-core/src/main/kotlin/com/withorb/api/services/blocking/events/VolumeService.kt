...
interface VolumeService {
     ...
     */
    fun list(params: EventVolumeListParams, requestOptions: RequestOptions = RequestOptions.none()): EventVolumes

    /**
     * A view of [VolumeService] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * as [VolumeService.list].
         */
        @MustBeClosed
        fun list(params: EventVolumeListParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<EventVolumes>
    }
}

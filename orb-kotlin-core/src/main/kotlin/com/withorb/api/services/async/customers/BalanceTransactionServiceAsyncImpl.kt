...
class BalanceTransactionServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : BalanceTransactionServiceAsync {
    ...
    override suspend fun list(params: CustomerBalanceTransactionListParams, requestOptions: RequestOptions): CustomerBalanceTransactionListPageAsync {
      ...
      .let { response -> 
          ...
          .let {
              CustomerBalanceTransactionListPageAsync.of(this, params, it)
          }
      }
    }
}

...
interface LedgerServiceAsync {
     ...
     */
    suspend fun list(params: CustomerCreditLedgerListParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerCreditLedgerListPageAsync
     ...
     */
    suspend fun createEntry(params: CustomerCreditLedgerCreateEntryParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerCreditLedgerCreateEntryResponse
     ...
     * return to the customer, up to the block's initial balance.
     */
    suspend fun createEntryByExternalId(params: CustomerCreditLedgerCreateEntryByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerCreditLedgerCreateEntryByExternalIdResponse
     ...
     * entry will be added to the ledger to indicate the adjustment of credits.
     */
    suspend fun listByExternalId(params: CustomerCreditLedgerListByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerCreditLedgerListByExternalIdPageAsync

    /**
     * A view of [LedgerServiceAsync] that provides access to raw HTTP responses for
     * each method.
     */
    interface WithRawResponse {

        /**
         * Returns a raw HTTP response for `get /customers/{customer_id}/credits/ledger`,
         * but is otherwise the same as [LedgerServiceAsync.list].
         */
        @MustBeClosed
        suspend fun list(params: CustomerCreditLedgerListParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerCreditLedgerListPageAsync>

        /**
         * Returns a raw HTTP response for
         * `post /customers/{customer_id}/credits/ledger_entry`, but is otherwise the same
         * as [LedgerServiceAsync.createEntry].
         */
        @MustBeClosed
        suspend fun createEntry(params: CustomerCreditLedgerCreateEntryParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerCreditLedgerCreateEntryResponse>

        /**
         * Returns a raw HTTP response for
         * `post /customers/external_customer_id/{external_customer_id}/credits/ledger_entry`,
         * but is otherwise the same as [LedgerServiceAsync.createEntryByExternalId].
         */
        @MustBeClosed
        suspend fun createEntryByExternalId(params: CustomerCreditLedgerCreateEntryByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerCreditLedgerCreateEntryByExternalIdResponse>

        /**
         * Returns a raw HTTP response for
         * `get /customers/external_customer_id/{external_customer_id}/credits/ledger`, but
         * is otherwise the same as [LedgerServiceAsync.listByExternalId].
         */
        @MustBeClosed
        suspend fun listByExternalId(params: CustomerCreditLedgerListByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerCreditLedgerListByExternalIdPageAsync>
    }
}

...
class LedgerServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : LedgerServiceAsync {
    ...
    override suspend fun list(params: CustomerCreditLedgerListParams, requestOptions: RequestOptions): CustomerCreditLedgerListPageAsync {
      ...
      .let { response -> 
          ...
          .let {
              CustomerCreditLedgerListPageAsync.of(this, params, it)
          }
      }
    }
    ...
    private val createEntryByExternalIdHandler: Handler<CustomerCreditLedgerCreateEntryByExternalIdResponse> =
    ...
    private val listByExternalIdHandler: Handler<CustomerCreditLedgerListByExternalIdPageAsync.Response> =
    jsonHandler<CustomerCreditLedgerListByExternalIdPageAsync.Response>(clientOptions.jsonMapper)
    .withErrorHandler(errorHandler)
    ...
    override suspend fun listByExternalId(params: CustomerCreditLedgerListByExternalIdParams, requestOptions: RequestOptions): CustomerCreditLedgerListByExternalIdPageAsync {
      ...
      .let { response -> 
          ...
          .let {
              CustomerCreditLedgerListByExternalIdPageAsync.of(this, params, it)
          }
      }
    }
}

...
interface EventServiceAsync {
     ...
     */
    suspend fun update(params: EventUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): EventUpdateResponse
     ...
     *   [event backfill](create-backfill) endpoint.
     */
    suspend fun deprecate(params: EventDeprecateParams, requestOptions: RequestOptions = RequestOptions.none()): EventDeprecateResponse
     ...
     * ```
     */
    suspend fun ingest(params: EventIngestParams, requestOptions: RequestOptions = RequestOptions.none()): EventIngestResponse
     ...
     */
    suspend fun search(params: EventSearchParams, requestOptions: RequestOptions = RequestOptions.none()): EventSearchResponse
    ...
    interface WithRawResponse {
         ...
         * same as [EventServiceAsync.update].
         */
        @MustBeClosed
        suspend fun update(params: EventUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<EventUpdateResponse>

        /**
         * Returns a raw HTTP response for `put /events/{event_id}/deprecate`, but is
         * otherwise the same as [EventServiceAsync.deprecate].
         */
        @MustBeClosed
        suspend fun deprecate(params: EventDeprecateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<EventDeprecateResponse>
         ...
         */
        @MustBeClosed
        suspend fun ingest(params: EventIngestParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<EventIngestResponse>

        /**
         * Returns a raw HTTP response for `post /events/search`, but is otherwise the same
         * as [EventServiceAsync.search].
         */
        @MustBeClosed
        suspend fun search(params: EventSearchParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<EventSearchResponse>
    }
}

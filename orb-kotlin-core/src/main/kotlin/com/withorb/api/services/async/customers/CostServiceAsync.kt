...
interface CostServiceAsync {
     ...
     */
    suspend fun list(params: CustomerCostListParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerCostListResponse
     ...
     * `grouping_value` and `secondary_grouping_value` available.
     */
    suspend fun listByExternalId(params: CustomerCostListByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerCostListByExternalIdResponse

    /**
     * A view of [CostServiceAsync] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {

        /**
         * Returns a raw HTTP response for `get /customers/{customer_id}/costs`, but is
         * otherwise the same as [CostServiceAsync.list].
         */
        @MustBeClosed
        suspend fun list(params: CustomerCostListParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerCostListResponse>

        /**
         * Returns a raw HTTP response for
         * `get /customers/external_customer_id/{external_customer_id}/costs`, but is
         * otherwise the same as [CostServiceAsync.listByExternalId].
         */
        @MustBeClosed
        suspend fun listByExternalId(params: CustomerCostListByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerCostListByExternalIdResponse>
    }
}

...
interface ExternalPlanIdService {
    ...
    /**
     * A view of [ExternalPlanIdService] that provides access to raw HTTP responses for
     * each method.
     */
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun update(params: PlanExternalPlanIdUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Plan>
         ...
         */
        @MustBeClosed
        fun fetch(params: PlanExternalPlanIdFetchParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Plan>
    }
}

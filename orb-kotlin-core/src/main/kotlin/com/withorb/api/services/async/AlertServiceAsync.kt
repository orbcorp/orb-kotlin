...
interface AlertServiceAsync {
    ...
    suspend fun retrieve(params: AlertRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): Alert

    /** This endpoint updates the thresholds of an alert. */
    suspend fun update(params: AlertUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): Alert
     ...
     */
    suspend fun list(params: AlertListParams = AlertListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): AlertListPageAsync

    /** @see [list] */
    suspend fun list(requestOptions: RequestOptions): AlertListPageAsync = list(AlertListParams.none(), requestOptions)
     ...
     * require thresholds.
     */
    suspend fun createForCustomer(params: AlertCreateForCustomerParams, requestOptions: RequestOptions = RequestOptions.none()): Alert
     ...
     * require thresholds.
     */
    suspend fun createForExternalCustomer(params: AlertCreateForExternalCustomerParams, requestOptions: RequestOptions = RequestOptions.none()): Alert
     ...
     */
    suspend fun createForSubscription(params: AlertCreateForSubscriptionParams, requestOptions: RequestOptions = RequestOptions.none()): Alert
     ...
     */
    suspend fun disable(params: AlertDisableParams, requestOptions: RequestOptions = RequestOptions.none()): Alert
     ...
     * `subscription_id` is not required for customer or subscription level alerts.
     */
    suspend fun enable(params: AlertEnableParams, requestOptions: RequestOptions = RequestOptions.none()): Alert
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        suspend fun retrieve(params: AlertRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Alert>
         ...
         */
        @MustBeClosed
        suspend fun update(params: AlertUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Alert>
         ...
         */
        @MustBeClosed
        suspend fun list(params: AlertListParams = AlertListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<AlertListPageAsync>

        /** @see [list] */
        @MustBeClosed
        suspend fun list(requestOptions: RequestOptions): HttpResponseFor<AlertListPageAsync> = list(AlertListParams.none(), requestOptions)
         ...
         */
        @MustBeClosed
        suspend fun createForCustomer(params: AlertCreateForCustomerParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Alert>
         ...
         */
        @MustBeClosed
        suspend fun createForExternalCustomer(params: AlertCreateForExternalCustomerParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Alert>
         ...
         */
        @MustBeClosed
        suspend fun createForSubscription(params: AlertCreateForSubscriptionParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Alert>
         ...
         */
        @MustBeClosed
        suspend fun disable(params: AlertDisableParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Alert>
         ...
         */
        @MustBeClosed
        suspend fun enable(params: AlertEnableParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Alert>
    }
}

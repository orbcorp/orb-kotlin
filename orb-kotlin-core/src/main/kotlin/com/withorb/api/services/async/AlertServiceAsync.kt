...
interface AlertServiceAsync {
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): AlertServiceAsync
     ...
     *
     * If querying by subscription_id, the endpoint will return the subscription level alerts as
     * well as the plan level alerts associated with the subscription.
     *
    ...
    /** @see delete */
    suspend fun delete(alertConfigurationId: String, requestOptions: RequestOptions) =
    ...
    interface WithRawResponse {
         ...
         * otherwise the same as [AlertServiceAsync.delete].
         */
        @MustBeClosed
        suspend fun delete(
            alertConfigurationId: String,
        ...
        suspend fun delete(
            alertConfigurationId: String,
            requestOptions: RequestOptions,
        ): HttpResponse = delete(alertConfigurationId, AlertDeleteParams.none(), requestOptions)

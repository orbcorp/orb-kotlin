...
interface CostService {
     ...
     */
    fun list(params: CustomerCostListParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerCostListResponse
     ...
     * `grouping_value` and `secondary_grouping_value` available.
     */
    fun listByExternalId(params: CustomerCostListByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): CustomerCostListByExternalIdResponse

    /**
     * A view of [CostService] that provides access to raw HTTP responses for each
     * method.
     */
    interface WithRawResponse {
         ...
         * otherwise the same as [CostService.list].
         */
        @MustBeClosed
        fun list(params: CustomerCostListParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerCostListResponse>

        /**
         * Returns a raw HTTP response for
         * `get /customers/external_customer_id/{external_customer_id}/costs`, but is
         * otherwise the same as [CostService.listByExternalId].
         */
        @MustBeClosed
        fun listByExternalId(params: CustomerCostListByExternalIdParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CustomerCostListByExternalIdResponse>
    }
}

...
interface ExternalPriceIdService {
    ...
    /**
     * A view of [ExternalPriceIdService] that provides access to raw HTTP responses
     * for each method.
     */
    interface WithRawResponse {
         ...
         * as [ExternalPriceIdService.update].
         */
        @MustBeClosed
        fun update(params: PriceExternalPriceIdUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Price>

        /**
         * Returns a raw HTTP response for
         * `get /prices/external_price_id/{external_price_id}`, but is otherwise the same
         * as [ExternalPriceIdService.fetch].
         */
        @MustBeClosed
        fun fetch(params: PriceExternalPriceIdFetchParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Price>
    }
}

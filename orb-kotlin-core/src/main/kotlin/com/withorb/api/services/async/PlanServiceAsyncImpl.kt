...
class PlanServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : PlanServiceAsync {

    private val withRawResponse: PlanServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    override suspend fun list(params: PlanListParams, requestOptions: RequestOptions): PlanListPageAsync =
        // get /plans
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val externalPlanId: ExternalPlanIdServiceAsync.WithRawResponse by lazy { ExternalPlanIdServiceAsyncImpl.WithRawResponseImpl(clientOptions) }

        override fun externalPlanId(): ExternalPlanIdServiceAsync.WithRawResponse = externalPlanId

        private val createHandler: Handler<Plan> = jsonHandler<Plan>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override suspend fun create(params: PlanCreateParams, requestOptions: RequestOptions): HttpResponseFor<Plan> {
        ...
        override suspend fun update(params: PlanUpdateParams, requestOptions: RequestOptions): HttpResponseFor<Plan> {
          val request = HttpRequest.builder()
        ...
        private val listHandler: Handler<PlanListPageAsync.Response> = jsonHandler<PlanListPageAsync.Response>(clientOptions.jsonMapper).withErrorHandler(errorHandler)

        override suspend fun list(params: PlanListParams, requestOptions: RequestOptions): HttpResponseFor<PlanListPageAsync> {
          val request = HttpRequest.builder()
          ...
          return response.parseable {
              ...
              .let {
                  PlanListPageAsync.of(PlanServiceAsyncImpl(clientOptions), params, it)
              }
          }
        }
        ...
        override suspend fun fetch(params: PlanFetchParams, requestOptions: RequestOptions): HttpResponseFor<Plan> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("plans", params.getPathParam(0))
            .build()

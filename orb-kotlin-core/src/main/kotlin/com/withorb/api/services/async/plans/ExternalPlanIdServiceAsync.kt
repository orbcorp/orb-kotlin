...
interface ExternalPlanIdServiceAsync {
     ...
     */
    suspend fun update(params: PlanExternalPlanIdUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): Plan
     ...
     */
    suspend fun fetch(params: PlanExternalPlanIdFetchParams, requestOptions: RequestOptions = RequestOptions.none()): Plan

    /**
     * A view of [ExternalPlanIdServiceAsync] that provides access to raw HTTP
    ...
    interface WithRawResponse {
         ...
         * `put /plans/external_plan_id/{external_plan_id}`, but is otherwise the same as
         * [ExternalPlanIdServiceAsync.update].
         */
        @MustBeClosed
        suspend fun update(params: PlanExternalPlanIdUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Plan>

        /**
         * Returns a raw HTTP response for
         * `get /plans/external_plan_id/{external_plan_id}`, but is otherwise the same as
         * [ExternalPlanIdServiceAsync.fetch].
         */
        @MustBeClosed
        suspend fun fetch(params: PlanExternalPlanIdFetchParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Plan>
    }
}

...
interface SubscriptionService {
     ...
     */
    fun list(params: CouponSubscriptionListParams, requestOptions: RequestOptions = RequestOptions.none()): CouponSubscriptionListPage
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun list(params: CouponSubscriptionListParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<CouponSubscriptionListPage>
    }
}

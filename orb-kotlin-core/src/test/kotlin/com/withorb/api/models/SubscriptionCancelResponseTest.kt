...
internal class SubscriptionCancelResponseTest {
    ...
    fun create() {
            ...
            SubscriptionCancelResponse.builder()
                ...
                .addAdjustmentInterval(
                    SubscriptionCancelResponse.AdjustmentInterval.builder()
                        .id("id")
                        .adjustment(
                            SubscriptionCancelResponse.AdjustmentInterval.Adjustment.UsageDiscount
                                .builder()
                                .id("id")
                ...
                .addDiscountInterval(
                    SubscriptionCancelResponse.DiscountInterval.Amount.builder()
                        .amountDiscount("amount_discount")
                        .addAppliesToPriceIntervalId("string")
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .addFilter(
                            SubscriptionCancelResponse.DiscountInterval.Amount.Filter.builder()
                                .field(
                                    SubscriptionCancelResponse.DiscountInterval.Amount.Filter.Field
                                        .PRICE_ID
                                )
                                .operator(
                                    SubscriptionCancelResponse.DiscountInterval.Amount.Filter
                                        .Operator
                                        .INCLUDES
                                )
                                .addValue("string")
                ...
                .addMaximumInterval(
                    SubscriptionCancelResponse.MaximumInterval.builder()
                        ...
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .addFilter(
                            SubscriptionCancelResponse.MaximumInterval.Filter.builder()
                                .field(
                                    SubscriptionCancelResponse.MaximumInterval.Filter.Field.PRICE_ID
                                )
                                .operator(
                                    SubscriptionCancelResponse.MaximumInterval.Filter.Operator
                                        .INCLUDES
                                )
                                .addValue("string")
                                .build()
                ...
                .metadata(
                    SubscriptionCancelResponse.Metadata.builder()
                        .putAdditionalProperty("foo", JsonValue.from("string"))
                        .build()
                )
                .addMinimumInterval(
                    SubscriptionCancelResponse.MinimumInterval.builder()
                        ...
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .addFilter(
                            SubscriptionCancelResponse.MinimumInterval.Filter.builder()
                                .field(
                                    SubscriptionCancelResponse.MinimumInterval.Filter.Field.PRICE_ID
                                )
                                .operator(
                                    SubscriptionCancelResponse.MinimumInterval.Filter.Operator
                                        .INCLUDES
                                )
                                .addValue("string")
                                .build()
                ...
                .pendingSubscriptionChange(
                    SubscriptionCancelResponse.PendingSubscriptionChange.builder().id("id").build()
                )
                .plan(
                    Plan.builder()
                        .id("id")
                ...
                .changedResources(
                    SubscriptionCancelResponse.ChangedResources.builder()
        ...
        assertThat(subscriptionCancelResponse.defaultInvoiceMemo())
        ...
        assertThat(subscriptionCancelResponse.maximumIntervals())
            .containsExactly(
                SubscriptionCancelResponse.MaximumInterval.builder()
                    ...
                    .addFilter(
                        SubscriptionCancelResponse.MaximumInterval.Filter.builder()
                            .field(SubscriptionCancelResponse.MaximumInterval.Filter.Field.PRICE_ID)
                            .operator(
                                SubscriptionCancelResponse.MaximumInterval.Filter.Operator.INCLUDES
                            )
                            .addValue("string")
                            .build()
                    )
        ...
        assertThat(subscriptionCancelResponse.minimumIntervals())
            .containsExactly(
                SubscriptionCancelResponse.MinimumInterval.builder()
                    ...
                    .addFilter(
                        SubscriptionCancelResponse.MinimumInterval.Filter.builder()
                            .field(SubscriptionCancelResponse.MinimumInterval.Filter.Field.PRICE_ID)
                            .operator(
                                SubscriptionCancelResponse.MinimumInterval.Filter.Operator.INCLUDES
                            )
                            .addValue("string")
                            .build()
                    )
        ...
        assertThat(subscriptionCancelResponse.name()).isEqualTo("name")
        assertThat(subscriptionCancelResponse.netTerms()).isEqualTo(0L)
        assertThat(subscriptionCancelResponse.pendingSubscriptionChange())
            .isEqualTo(
                SubscriptionCancelResponse.PendingSubscriptionChange.builder().id("id").build()
            )
        ...
        assertThat(subscriptionCancelResponse.changedResources())
            .isEqualTo(
                SubscriptionCancelResponse.ChangedResources.builder()
                    .addCreatedCreditNote(
                        CreditNote.builder()
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionCancelResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionCancelResponse),
                jacksonTypeRef<SubscriptionCancelResponse>(),
            )

        assertThat(roundtrippedSubscriptionCancelResponse).isEqualTo(subscriptionCancelResponse)
    }
}

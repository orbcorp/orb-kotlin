    ...
    fun create() {
        val newPlanMinimumCompositePrice =
            NewPlanMinimumCompositePrice.builder()
                ...
                .modelType(NewPlanMinimumCompositePrice.ModelType.MINIMUM_COMPOSITE)
                .name("Annual fee")
        ...
        assertThat(newPlanMinimumCompositePrice.modelType())
            .isEqualTo(NewPlanMinimumCompositePrice.ModelType.MINIMUM_COMPOSITE)
        ...
        assertThat(newPlanMinimumCompositePrice.licenseTypeId()).isEqualTo("license_type_id")

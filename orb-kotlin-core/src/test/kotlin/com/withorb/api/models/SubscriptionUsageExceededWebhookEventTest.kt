...
internal class SubscriptionUsageExceededWebhookEventTest {

    @Test
    fun create() {
        val subscriptionUsageExceededWebhookEvent =
            SubscriptionUsageExceededWebhookEvent.builder()
                .id("id")
                .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                .properties(
                    SubscriptionUsageExceededWebhookEvent.Properties.builder()
                        .alertConfiguration(
                            SubscriptionUsageExceededWebhookEvent.Properties.AlertConfiguration
                                .builder()
                                .id("XuxCbt7x9L82yyeF")
                                .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                                .currency("currency")
                                ...
                                .enabled(true)
                                .metric(
                                    SubscriptionUsageExceededWebhookEvent.Properties
                                        .AlertConfiguration
                                        .Metric
                                        .builder()
                                        .id("id")
                ...
                .type(SubscriptionUsageExceededWebhookEvent.Type.SUBSCRIPTION_USAGE_EXCEEDED)
                .build()

        assertThat(subscriptionUsageExceededWebhookEvent.id()).isEqualTo("id")
        assertThat(subscriptionUsageExceededWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionUsageExceededWebhookEvent.properties())
            .isEqualTo(
                SubscriptionUsageExceededWebhookEvent.Properties.builder()
                    .alertConfiguration(
                        SubscriptionUsageExceededWebhookEvent.Properties.AlertConfiguration
        ...
        assertThat(subscriptionUsageExceededWebhookEvent.subscription())
            .isEqualTo(
                Subscription.builder()
                    .id("id")
                    .activePlanPhaseOrder(0L)
        ...
        assertThat(subscriptionUsageExceededWebhookEvent.type())
            .isEqualTo(SubscriptionUsageExceededWebhookEvent.Type.SUBSCRIPTION_USAGE_EXCEEDED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionUsageExceededWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionUsageExceededWebhookEvent),
                jacksonTypeRef<SubscriptionUsageExceededWebhookEvent>(),
            )

        assertThat(roundtrippedSubscriptionUsageExceededWebhookEvent)
            .isEqualTo(subscriptionUsageExceededWebhookEvent)
    }
}

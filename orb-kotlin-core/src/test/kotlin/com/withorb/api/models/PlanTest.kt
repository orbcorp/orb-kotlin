...
class PlanTest {
    ...
    fun createPlan() {
      ...
      assertThat(plan.adjustments()).containsExactly(Plan.Adjustment.ofPlanPhaseUsageDiscount(Plan.Adjustment.PlanPhaseUsageDiscountAdjustment.builder()
          .id("id")
          .adjustmentType(Plan.Adjustment.PlanPhaseUsageDiscountAdjustment.AdjustmentType.USAGE_DISCOUNT)
          .addAppliesToPriceId("string")
          .isInvoiceLevel(true)
          ...
          .usageDiscount(0.0)
          .build()))
      assertThat(plan.basePlan()).isEqualTo(Plan.BasePlan.builder()
          .id("m2t5akQeh2obwxeU")
          .externalPlanId("m2t5akQeh2obwxeU")
          .name("Example plan")
          .build())
      ...
      assertThat(plan.discount()).isEqualTo(Discount.ofPercentage(PercentageDiscount.builder()
          .addAppliesToPriceId("h74gfhdjvn7ujokd")
          .addAppliesToPriceId("7hfgtgjnbvc3ujkl")
          .discountType(PercentageDiscount.DiscountType.PERCENTAGE)
          .percentageDiscount(0.15)
          .reason("reason")
          .build()))
      assertThat(plan.externalPlanId()).isEqualTo("external_plan_id")
      assertThat(plan.invoicingCurrency()).isEqualTo("invoicing_currency")
      assertThat(plan.maximum()).isEqualTo(Plan.Maximum.builder()
          .addAppliesToPriceId("string")
          .maximumAmount("maximum_amount")
          .build())
      assertThat(plan.maximumAmount()).isEqualTo("maximum_amount")
      assertThat(plan.metadata()).isEqualTo(Plan.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      assertThat(plan.minimum()).isEqualTo(Plan.Minimum.builder()
          .addAppliesToPriceId("string")
          .minimumAmount("minimum_amount")
          .build())
      assertThat(plan.minimumAmount()).isEqualTo("minimum_amount")
      assertThat(plan.name()).isEqualTo("name")
      assertThat(plan.netTerms()).isEqualTo(0L)
      assertThat(plan.planPhases()).containsExactly(Plan.PlanPhase.builder()
          .id("id")
          .description("description")
          .discount(PercentageDiscount.builder()
              .addAppliesToPriceId("h74gfhdjvn7ujokd")
          ...
          .order(0L)
          .build())
      assertThat(plan.prices()).containsExactly(Price.ofUnit(Price.UnitPrice.builder()
          .id("id")
          .billableMetric(Price.UnitPrice.BillableMetric.builder()
              .id("id")
              .build())

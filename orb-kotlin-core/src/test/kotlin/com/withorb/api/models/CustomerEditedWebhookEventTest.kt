...
internal class CustomerEditedWebhookEventTest {

    @Test
    fun create() {
        val customerEditedWebhookEvent =
            CustomerEditedWebhookEvent.builder()
                .id("id")
                ...
                .properties(
                    CustomerEditedWebhookEvent.Properties.builder()
                        .previousAttributes(
                            CustomerEditedWebhookEvent.Properties.PreviousAttributes.builder()
                                .autoCollection(true)
                                .billingAddress(
                                    Address.builder()
                                        .city("city")
                                ...
                                .externalCustomerId("external_customer_id")
                                .metadata(
                                    CustomerEditedWebhookEvent.Properties.PreviousAttributes
                                        .Metadata
                                        .builder()
                                        .putAdditionalProperty("foo", JsonValue.from("string"))
                                        .build()
                ...
                .type(CustomerEditedWebhookEvent.Type.CUSTOMER_EDITED)
                .build()

        assertThat(customerEditedWebhookEvent.id()).isEqualTo("id")
        assertThat(customerEditedWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(customerEditedWebhookEvent.customer())
            .isEqualTo(
                Customer.builder()
                    .id("id")
                    .addAdditionalEmail("string")
        ...
        assertThat(customerEditedWebhookEvent.properties())
            .isEqualTo(
                CustomerEditedWebhookEvent.Properties.builder()
                    .previousAttributes(
                        CustomerEditedWebhookEvent.Properties.PreviousAttributes.builder()
                            ...
                            .externalCustomerId("external_customer_id")
                            .metadata(
                                CustomerEditedWebhookEvent.Properties.PreviousAttributes.Metadata
                                    .builder()
                                    .putAdditionalProperty("foo", JsonValue.from("string"))
                                    .build()
                            )
        ...
        assertThat(customerEditedWebhookEvent.type())
            .isEqualTo(CustomerEditedWebhookEvent.Type.CUSTOMER_EDITED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedCustomerEditedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(customerEditedWebhookEvent),
                jacksonTypeRef<CustomerEditedWebhookEvent>(),
            )

        assertThat(roundtrippedCustomerEditedWebhookEvent).isEqualTo(customerEditedWebhookEvent)
    }
}

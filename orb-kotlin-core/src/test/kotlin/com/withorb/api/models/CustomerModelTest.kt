...
class CustomerModelTest {
    ...
    fun createCustomerModel() {
        ...
        assertThat(customerModel.currency()).isEqualTo("currency")
        assertThat(customerModel.email()).isEqualTo("email")
        assertThat(customerModel.emailDelivery()).isEqualTo(true)
        assertThat(customerModel.exemptFromAutomatedTax()).isEqualTo(true)
        assertThat(customerModel.externalCustomerId()).isEqualTo("external_customer_id")
        ...
        assertThat(customerModel.paymentProvider())
            .isEqualTo(CustomerModel.PaymentProvider.QUICKBOOKS)
        assertThat(customerModel.paymentProviderId()).isEqualTo("payment_provider_id")
        assertThat(customerModel.portalUrl()).isEqualTo("portal_url")
        ...
        assertThat(customerModel.reportingConfiguration())
            .isEqualTo(CustomerModel.ReportingConfiguration.builder().exempt(true).build())
    }
}

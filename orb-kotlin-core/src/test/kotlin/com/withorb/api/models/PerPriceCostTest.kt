...
internal class PerPriceCostTest {
    ...
    fun create() {
        ...
        assertThat(perPriceCost.priceId()).isEqualTo("price_id")
        assertThat(perPriceCost.subtotal()).isEqualTo("subtotal")
        assertThat(perPriceCost.total()).isEqualTo("total")
        assertThat(perPriceCost.quantity()).isEqualTo(0.0)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedPerPriceCost =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(perPriceCost),
                jacksonTypeRef<PerPriceCost>(),
            )

        assertThat(roundtrippedPerPriceCost).isEqualTo(perPriceCost)
    }
}

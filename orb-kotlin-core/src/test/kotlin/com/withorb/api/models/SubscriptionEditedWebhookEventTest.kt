...
internal class SubscriptionEditedWebhookEventTest {

    @Test
    fun create() {
        val subscriptionEditedWebhookEvent =
            SubscriptionEditedWebhookEvent.builder()
                .id("id")
                .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                .properties(
                    SubscriptionEditedWebhookEvent.Properties.builder()
                        .previousAttributes(
                            SubscriptionEditedWebhookEvent.Properties.PreviousAttributes.builder()
                                .autoCollection(true)
                                .autoIssuance(true)
                                .defaultInvoiceMemo("default_invoice_memo")
                                .invoicingThreshold("invoicing_threshold")
                                .metadata(
                                    SubscriptionEditedWebhookEvent.Properties.PreviousAttributes
                                        .Metadata
                                        .builder()
                ...
                .type(SubscriptionEditedWebhookEvent.Type.SUBSCRIPTION_EDITED)
                .build()

        assertThat(subscriptionEditedWebhookEvent.id()).isEqualTo("id")
        assertThat(subscriptionEditedWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionEditedWebhookEvent.properties())
            .isEqualTo(
                SubscriptionEditedWebhookEvent.Properties.builder()
                    .previousAttributes(
                        SubscriptionEditedWebhookEvent.Properties.PreviousAttributes.builder()
        ...
        assertThat(subscriptionEditedWebhookEvent.subscription())
            .isEqualTo(
                Subscription.builder()
                    .id("id")
                    .activePlanPhaseOrder(0L)
        ...
        assertThat(subscriptionEditedWebhookEvent.type())
            .isEqualTo(SubscriptionEditedWebhookEvent.Type.SUBSCRIPTION_EDITED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionEditedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionEditedWebhookEvent),
                jacksonTypeRef<SubscriptionEditedWebhookEvent>(),
            )

        assertThat(roundtrippedSubscriptionEditedWebhookEvent)
            .isEqualTo(subscriptionEditedWebhookEvent)
    }
}

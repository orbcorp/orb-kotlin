...
internal class NewPlanMatrixWithAllocationPriceTest {
    ...
    fun create() {
        ...
        assertThat(newPlanMatrixWithAllocationPrice.licenseTypeId()).isEqualTo("license_type_id")
        ...
        assertThat(newPlanMatrixWithAllocationPrice.referenceId()).isEqualTo("reference_id")
    }

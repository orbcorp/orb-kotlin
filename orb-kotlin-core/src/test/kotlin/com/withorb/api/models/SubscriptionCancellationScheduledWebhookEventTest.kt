...
internal class SubscriptionCancellationScheduledWebhookEventTest {

    @Test
    fun create() {
        val subscriptionCancellationScheduledWebhookEvent =
            SubscriptionCancellationScheduledWebhookEvent.builder()
                .id("id")
                .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                .properties(
                    SubscriptionCancellationScheduledWebhookEvent.Properties.builder()
                ...
                .type(
                    SubscriptionCancellationScheduledWebhookEvent.Type
                        .SUBSCRIPTION_CANCELLATION_SCHEDULED
                )
                .build()

        assertThat(subscriptionCancellationScheduledWebhookEvent.id()).isEqualTo("id")
        assertThat(subscriptionCancellationScheduledWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionCancellationScheduledWebhookEvent.properties())
            .isEqualTo(
                SubscriptionCancellationScheduledWebhookEvent.Properties.builder()
                    .cancellationDate("cancellation_date")
                    .build()
            )
        assertThat(subscriptionCancellationScheduledWebhookEvent.subscription())
            .isEqualTo(
                Subscription.builder()
                    .id("id")
                    .activePlanPhaseOrder(0L)
        ...
        assertThat(subscriptionCancellationScheduledWebhookEvent.type())
            .isEqualTo(
                SubscriptionCancellationScheduledWebhookEvent.Type
                    .SUBSCRIPTION_CANCELLATION_SCHEDULED
            )
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionCancellationScheduledWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionCancellationScheduledWebhookEvent),
                jacksonTypeRef<SubscriptionCancellationScheduledWebhookEvent>(),
            )

        assertThat(roundtrippedSubscriptionCancellationScheduledWebhookEvent)
            .isEqualTo(subscriptionCancellationScheduledWebhookEvent)
    }
}

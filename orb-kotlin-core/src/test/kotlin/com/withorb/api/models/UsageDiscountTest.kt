...
class UsageDiscountTest {

    @Test
    fun createUsageDiscount() {
      val usageDiscount = UsageDiscount.builder()
      ...
      assertThat(usageDiscount.appliesToPriceIds()).containsExactly("h74gfhdjvn7ujokd", "7hfgtgjnbvc3ujkl")

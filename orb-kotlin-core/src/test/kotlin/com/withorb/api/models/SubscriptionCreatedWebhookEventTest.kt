...
internal class SubscriptionCreatedWebhookEventTest {

    @Test
    fun create() {
        val subscriptionCreatedWebhookEvent =
            SubscriptionCreatedWebhookEvent.builder()
                .id("id")
                ...
                .type(SubscriptionCreatedWebhookEvent.Type.SUBSCRIPTION_CREATED)
                .build()

        assertThat(subscriptionCreatedWebhookEvent.id()).isEqualTo("id")
        assertThat(subscriptionCreatedWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionCreatedWebhookEvent._properties())
            .isEqualTo(JsonValue.from(mapOf<String, Any>()))
        assertThat(subscriptionCreatedWebhookEvent.subscription())
            .isEqualTo(
                Subscription.builder()
                    .id("id")
                    .activePlanPhaseOrder(0L)
        ...
        assertThat(subscriptionCreatedWebhookEvent.type())
            .isEqualTo(SubscriptionCreatedWebhookEvent.Type.SUBSCRIPTION_CREATED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionCreatedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionCreatedWebhookEvent),
                jacksonTypeRef<SubscriptionCreatedWebhookEvent>(),
            )

        assertThat(roundtrippedSubscriptionCreatedWebhookEvent)
            .isEqualTo(subscriptionCreatedWebhookEvent)
    }
}

    ...
    fun create() {
        val percentageDiscountInterval =
            PercentageDiscountInterval.builder()
                ...
                .addFilter(
                    PercentageDiscountInterval.Filter.builder()
                        .field(PercentageDiscountInterval.Filter.Field.PRICE_ID)
                        .operator(PercentageDiscountInterval.Filter.Operator.INCLUDES)
                        .addValue("string")
                        .build()
                )

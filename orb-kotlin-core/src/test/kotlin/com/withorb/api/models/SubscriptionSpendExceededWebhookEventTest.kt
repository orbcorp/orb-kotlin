...
internal class SubscriptionSpendExceededWebhookEventTest {

    @Test
    fun create() {
        val subscriptionSpendExceededWebhookEvent =
            SubscriptionSpendExceededWebhookEvent.builder()
                .id("id")
                .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                .properties(
                    SubscriptionSpendExceededWebhookEvent.Properties.builder()
                        .alertConfiguration(
                            SubscriptionSpendExceededWebhookEvent.Properties.AlertConfiguration
                                .builder()
                                .id("XuxCbt7x9L82yyeF")
                                .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                                .currency("currency")
                                ...
                                .enabled(true)
                                .metric(
                                    SubscriptionSpendExceededWebhookEvent.Properties
                                        .AlertConfiguration
                                        .Metric
                                        .builder()
                                        .id("id")
                ...
                .type(SubscriptionSpendExceededWebhookEvent.Type.SUBSCRIPTION_SPEND_EXCEEDED)
                .build()

        assertThat(subscriptionSpendExceededWebhookEvent.id()).isEqualTo("id")
        assertThat(subscriptionSpendExceededWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionSpendExceededWebhookEvent.properties())
            .isEqualTo(
                SubscriptionSpendExceededWebhookEvent.Properties.builder()
                    .alertConfiguration(
                        SubscriptionSpendExceededWebhookEvent.Properties.AlertConfiguration
        ...
        assertThat(subscriptionSpendExceededWebhookEvent.subscription())
            .isEqualTo(
                Subscription.builder()
                    .id("id")
                    .activePlanPhaseOrder(0L)
        ...
        assertThat(subscriptionSpendExceededWebhookEvent.type())
            .isEqualTo(SubscriptionSpendExceededWebhookEvent.Type.SUBSCRIPTION_SPEND_EXCEEDED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionSpendExceededWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionSpendExceededWebhookEvent),
                jacksonTypeRef<SubscriptionSpendExceededWebhookEvent>(),
            )

        assertThat(roundtrippedSubscriptionSpendExceededWebhookEvent)
            .isEqualTo(subscriptionSpendExceededWebhookEvent)
    }
}

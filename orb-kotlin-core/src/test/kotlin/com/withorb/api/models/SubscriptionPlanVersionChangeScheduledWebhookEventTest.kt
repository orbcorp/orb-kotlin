...
internal class SubscriptionPlanVersionChangeScheduledWebhookEventTest {

    @Test
    fun create() {
        val subscriptionPlanVersionChangeScheduledWebhookEvent =
            SubscriptionPlanVersionChangeScheduledWebhookEvent.builder()
                .id("id")
                .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                .properties(
                    SubscriptionPlanVersionChangeScheduledWebhookEvent.Properties.builder()
                        .effectiveDate("effective_date")
                        .newPlanVersionNumber(0L)
                        .previousPlanVersionNumber(0L)
                        .build()
                )
                .subscription(
                ...
                .type(
                    SubscriptionPlanVersionChangeScheduledWebhookEvent.Type
                        .SUBSCRIPTION_PLAN_VERSION_CHANGE_SCHEDULED
                )
                .build()

        assertThat(subscriptionPlanVersionChangeScheduledWebhookEvent.id()).isEqualTo("id")
        assertThat(subscriptionPlanVersionChangeScheduledWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionPlanVersionChangeScheduledWebhookEvent.properties())
            .isEqualTo(
                SubscriptionPlanVersionChangeScheduledWebhookEvent.Properties.builder()
                    .effectiveDate("effective_date")
                    .newPlanVersionNumber(0L)
        ...
        assertThat(subscriptionPlanVersionChangeScheduledWebhookEvent.subscription())
            .isEqualTo(
                Subscription.builder()
                    .id("id")
                    .activePlanPhaseOrder(0L)
        ...
        assertThat(subscriptionPlanVersionChangeScheduledWebhookEvent.type())
            .isEqualTo(
                SubscriptionPlanVersionChangeScheduledWebhookEvent.Type
                    .SUBSCRIPTION_PLAN_VERSION_CHANGE_SCHEDULED
            )
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionPlanVersionChangeScheduledWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionPlanVersionChangeScheduledWebhookEvent),
                jacksonTypeRef<SubscriptionPlanVersionChangeScheduledWebhookEvent>(),
            )

        assertThat(roundtrippedSubscriptionPlanVersionChangeScheduledWebhookEvent)
            .isEqualTo(subscriptionPlanVersionChangeScheduledWebhookEvent)
    }
}

...
internal class NewPlanGroupedAllocationPriceTest {
    ...
    fun create() {
        ...
        assertThat(newPlanGroupedAllocationPrice.licenseTypeId()).isEqualTo("license_type_id")
        ...
        assertThat(newPlanGroupedAllocationPrice.referenceId()).isEqualTo("reference_id")
    }

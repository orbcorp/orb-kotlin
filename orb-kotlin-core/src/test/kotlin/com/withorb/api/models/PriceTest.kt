...
internal class PriceTest {
    ...
    fun ofUnit() {
        ...
        assertThat(price.groupedTieredMatrix()).isNull()
        ...
        assertThat(price.tieredMatrixWithAllocation()).isNull()
        assertThat(price.matrixWithThresholdDiscounts()).isNull()
        ...
        assertThat(price.dailyCreditAllowance()).isNull()
        assertThat(price.meteredAllowance()).isNull()
    ...
    @Test
    fun ofGroupedTieredMatrix() {
        val groupedTieredMatrix =
            Price.GroupedTieredMatrix.builder()
                .id("id")
                .billableMetric(BillableMetricTiny.builder().id("id").build())
                .billingCycleConfiguration(
                    BillingCycleConfiguration.builder()
                ...
                .billingMode(Price.GroupedTieredMatrix.BillingMode.IN_ADVANCE)
                .cadence(Price.GroupedTieredMatrix.Cadence.ONE_TIME)
                .addCompositePriceFilter(
                    Price.GroupedTieredMatrix.CompositePriceFilter.builder()
                        .field(Price.GroupedTieredMatrix.CompositePriceFilter.Field.PRICE_ID)
                        .operator(Price.GroupedTieredMatrix.CompositePriceFilter.Operator.INCLUDES)
                        .addValue("string")
                        .build()
                )
                .conversionRate(0.0)
                ...
                .groupedTieredMatrixConfig(
                    Price.GroupedTieredMatrix.GroupedTieredMatrixConfig.builder()
                        .defaultUnitAmount("default_unit_amount")
                        .dimension("x")
                        .addTier(
                            Price.GroupedTieredMatrix.GroupedTieredMatrixConfig.Tier.builder()
                ...
                .maximumAmount("maximum_amount")
                .metadata(
                    Price.GroupedTieredMatrix.Metadata.builder()
                        .putAdditionalProperty("foo", JsonValue.from("string"))
                        .build()
                )
                .minimum(
                ...
                .name("name")
                .planPhaseOrder(0L)
                .priceType(Price.GroupedTieredMatrix.PriceType.USAGE_PRICE)
                .replacesPriceId("replaces_price_id")
                .dimensionalPriceConfiguration(
                    DimensionalPriceConfiguration.builder()
                        .addDimensionValue("string")
                ...
                .licenseType(
                    Price.GroupedTieredMatrix.LicenseType.builder()
                        .id("id")
                        .groupingKey("grouping_key")
                        .name("name")
                        .build()
        ...
        val price = Price.ofGroupedTieredMatrix(groupedTieredMatrix)
        ...
        assertThat(price.tieredWithMinimum()).isNull()
        assertThat(price.groupedTiered()).isNull()
        assertThat(price.groupedTieredMatrix()).isEqualTo(groupedTieredMatrix)
        assertThat(price.tieredPackageWithMinimum()).isNull()
        assertThat(price.packageWithAllocation()).isNull()
        assertThat(price.unitWithPercent()).isNull()
        assertThat(price.matrixWithAllocation()).isNull()
    ...
    @Test
    fun ofGroupedTieredMatrixRoundtrip() {
        val jsonMapper = jsonMapper()
        val price =
            Price.ofGroupedTieredMatrix(
                Price.GroupedTieredMatrix.builder()
                    .id("id")
                    .billableMetric(BillableMetricTiny.builder().id("id").build())
                    .billingCycleConfiguration(
                    ...
                    .addCompositePriceFilter(
                        Price.GroupedTieredMatrix.CompositePriceFilter.builder()
                            .field(Price.GroupedTieredMatrix.CompositePriceFilter.Field.PRICE_ID)
                            .operator(
                                Price.GroupedTieredMatrix.CompositePriceFilter.Operator.INCLUDES
                            )
                            .addValue("string")
                            .build()
                    )
    ...
    fun ofTieredMatrixWithAllocation() {
        ...
        assertThat(price.unitWithPercent()).isNull()
        assertThat(price.matrixWithAllocation()).isNull()
        assertThat(price.tieredMatrixWithAllocation()).isEqualTo(tieredMatrixWithAllocation)
        assertThat(price.matrixWithThresholdDiscounts()).isNull()
        assertThat(price.tieredWithProration()).isNull()
        assertThat(price.unitWithProration()).isNull()
        assertThat(price.groupedAllocation()).isNull()
    ...
    fun ofMatrixWithThresholdDiscounts() {
        ...
        assertThat(price.matrixWithAllocation()).isNull()
        assertThat(price.tieredMatrixWithAllocation()).isNull()
        assertThat(price.matrixWithThresholdDiscounts()).isEqualTo(matrixWithThresholdDiscounts)
        assertThat(price.tieredWithProration()).isNull()
        assertThat(price.unitWithProration()).isNull()
        assertThat(price.groupedAllocation()).isNull()
        assertThat(price.bulkWithProration()).isNull()
    ...
    fun ofDailyCreditAllowance() {
        ...
        assertThat(price.cumulativeGroupedBulk()).isNull()
        assertThat(price.cumulativeGroupedAllocation()).isNull()
        assertThat(price.dailyCreditAllowance()).isEqualTo(dailyCreditAllowance)
        assertThat(price.meteredAllowance()).isNull()
        assertThat(price.minimumComposite()).isNull()
        assertThat(price.percent()).isNull()
        assertThat(price.eventOutput()).isNull()
    ...
    fun ofMeteredAllowance() {
        ...
        assertThat(price.cumulativeGroupedAllocation()).isNull()
        assertThat(price.dailyCreditAllowance()).isNull()
        assertThat(price.meteredAllowance()).isEqualTo(meteredAllowance)
        assertThat(price.minimumComposite()).isNull()
        assertThat(price.percent()).isNull()
        assertThat(price.eventOutput()).isNull()
    }

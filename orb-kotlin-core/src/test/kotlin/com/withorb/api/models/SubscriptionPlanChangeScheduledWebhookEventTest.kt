...
internal class SubscriptionPlanChangeScheduledWebhookEventTest {

    @Test
    fun create() {
        val subscriptionPlanChangeScheduledWebhookEvent =
            SubscriptionPlanChangeScheduledWebhookEvent.builder()
                .id("id")
                .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                .properties(
                    SubscriptionPlanChangeScheduledWebhookEvent.Properties.builder()
                ...
                .type(
                    SubscriptionPlanChangeScheduledWebhookEvent.Type
                        .SUBSCRIPTION_PLAN_CHANGE_SCHEDULED
                )
                .build()

        assertThat(subscriptionPlanChangeScheduledWebhookEvent.id()).isEqualTo("id")
        assertThat(subscriptionPlanChangeScheduledWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionPlanChangeScheduledWebhookEvent.properties())
            .isEqualTo(
                SubscriptionPlanChangeScheduledWebhookEvent.Properties.builder()
                    .changeDate("change_date")
                    .newPlanId("new_plan_id")
        ...
        assertThat(subscriptionPlanChangeScheduledWebhookEvent.subscription())
            .isEqualTo(
                Subscription.builder()
                    .id("id")
                    .activePlanPhaseOrder(0L)
        ...
        assertThat(subscriptionPlanChangeScheduledWebhookEvent.type())
            .isEqualTo(
                SubscriptionPlanChangeScheduledWebhookEvent.Type.SUBSCRIPTION_PLAN_CHANGE_SCHEDULED
            )
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionPlanChangeScheduledWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionPlanChangeScheduledWebhookEvent),
                jacksonTypeRef<SubscriptionPlanChangeScheduledWebhookEvent>(),
            )

        assertThat(roundtrippedSubscriptionPlanChangeScheduledWebhookEvent)
            .isEqualTo(subscriptionPlanChangeScheduledWebhookEvent)
    }
}

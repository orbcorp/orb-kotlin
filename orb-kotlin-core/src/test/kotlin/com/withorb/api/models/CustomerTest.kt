...
class CustomerTest {
    ...
    fun createCustomer() {
      ...
      assertThat(customer.billingAddress()).isEqualTo(Customer.BillingAddress.builder()
          .city("city")
          .country("country")
          .line1("line1")
          .line2("line2")
      ...
      assertThat(customer.hierarchy()).isEqualTo(Customer.Hierarchy.builder()
          .addChild(Customer.Hierarchy.Child.builder()
              .id("id")
              .externalCustomerId("external_customer_id")
              .build())
          .parent(Customer.Hierarchy.Parent.builder()
              ...
              .build())
          .build())
      assertThat(customer.metadata()).isEqualTo(Customer.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      ...
      assertThat(customer.shippingAddress()).isEqualTo(Customer.ShippingAddress.builder()
          .city("city")
          .country("country")
          .line1("line1")
          .line2("line2")
          ...
          .state("state")
          .build())
      assertThat(customer.taxId()).isEqualTo(Customer.TaxId.builder()
          .country(Customer.TaxId.Country.AD)
          .type(Customer.TaxId.Type.AD_NRT)
          .value("value")
          .build())
      assertThat(customer.timezone()).isEqualTo("timezone")
      assertThat(customer.accountingSyncConfiguration()).isEqualTo(Customer.AccountingSyncConfiguration.builder()
          .addAccountingProvider(Customer.AccountingSyncConfiguration.AccountingProvider.builder()
              .externalProviderId("external_provider_id")
              .providerType(Customer.AccountingSyncConfiguration.AccountingProvider.ProviderType.QUICKBOOKS)
              .build())
          .excluded(true)
          .build())
      assertThat(customer.reportingConfiguration()).isEqualTo(Customer.ReportingConfiguration.builder()
          .exempt(true)
          .build())
    }
}

    ...
    fun create() {
        val monetaryMaximumAdjustment =
            MonetaryMaximumAdjustment.builder()
                ...
                .addFilter(
                    MonetaryMaximumAdjustment.Filter.builder()
                        .field(MonetaryMaximumAdjustment.Filter.Field.PRICE_ID)
                        .operator(MonetaryMaximumAdjustment.Filter.Operator.INCLUDES)
                        .addValue("string")
                        .build()
                )
                .isInvoiceLevel(true)
        ...
        assertThat(monetaryMaximumAdjustment.reason()).isEqualTo("reason")

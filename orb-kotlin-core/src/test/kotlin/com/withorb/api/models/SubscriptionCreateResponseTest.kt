...
internal class SubscriptionCreateResponseTest {
    ...
    fun create() {
            ...
            SubscriptionCreateResponse.builder()
                ...
                .addAdjustmentInterval(
                    SubscriptionCreateResponse.AdjustmentInterval.builder()
                        .id("id")
                        .adjustment(
                            SubscriptionCreateResponse.AdjustmentInterval.Adjustment.UsageDiscount
                                .builder()
                                .id("id")
                                .addAppliesToPriceId("string")
                                .addFilter(
                                    SubscriptionCreateResponse.AdjustmentInterval.Adjustment
                                        .UsageDiscount
                                        .Filter
                                        .builder()
                                        .field(
                ...
                .addDiscountInterval(
                    SubscriptionCreateResponse.DiscountInterval.Amount.builder()
                        .amountDiscount("amount_discount")
                        .addAppliesToPriceIntervalId("string")
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .addFilter(
                            SubscriptionCreateResponse.DiscountInterval.Amount.Filter.builder()
                                .field(
                                    SubscriptionCreateResponse.DiscountInterval.Amount.Filter.Field
                                        .PRICE_ID
                                )
                                .operator(
                                    SubscriptionCreateResponse.DiscountInterval.Amount.Filter
                                        .Operator
                                        .INCLUDES
                                )
                                .addValue("string")
                ...
                .addMaximumInterval(
                    SubscriptionCreateResponse.MaximumInterval.builder()
                        .addAppliesToPriceIntervalId("string")
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .addFilter(
                            SubscriptionCreateResponse.MaximumInterval.Filter.builder()
                                .field(
                                    SubscriptionCreateResponse.MaximumInterval.Filter.Field.PRICE_ID
                                )
                                .operator(
                                    SubscriptionCreateResponse.MaximumInterval.Filter.Operator
                                        .INCLUDES
                                )
                                .addValue("string")
                                .build()
                ...
                .addMinimumInterval(
                    SubscriptionCreateResponse.MinimumInterval.builder()
                        .addAppliesToPriceIntervalId("string")
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .addFilter(
                            SubscriptionCreateResponse.MinimumInterval.Filter.builder()
                                .field(
                                    SubscriptionCreateResponse.MinimumInterval.Filter.Field.PRICE_ID
                                )
                                .operator(
                                    SubscriptionCreateResponse.MinimumInterval.Filter.Operator
                                        .INCLUDES
                                )
                                .addValue("string")
                                .build()
                ...
                .pendingSubscriptionChange(
                    SubscriptionCreateResponse.PendingSubscriptionChange.builder().id("id").build()
                )
                .plan(
                    Plan.builder()
                        .id("id")
                ...
                .addPriceInterval(
                    SubscriptionCreateResponse.PriceInterval.builder()
                        ...
                        .addFixedFeeQuantityTransition(
                            SubscriptionCreateResponse.PriceInterval.FixedFeeQuantityTransition
                                .builder()
                ...
                .redeemedCoupon(
                    SubscriptionCreateResponse.RedeemedCoupon.builder()
                        .couponId("coupon_id")
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .startDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .build()
                ...
                .trialInfo(
                    SubscriptionCreateResponse.TrialInfo.builder()
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .build()
                )
                .changedResources(
                    SubscriptionCreateResponse.ChangedResources.builder()
        ...
        assertThat(subscriptionCreateResponse.currentBillingPeriodEndDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionCreateResponse.currentBillingPeriodStartDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(subscriptionCreateResponse.defaultInvoiceMemo())
            .isEqualTo("default_invoice_memo")
        assertThat(subscriptionCreateResponse.discountIntervals())
            .containsExactly(
                SubscriptionCreateResponse.DiscountInterval.ofAmount(
                    SubscriptionCreateResponse.DiscountInterval.Amount.builder()
                        .amountDiscount("amount_discount")
                        .addAppliesToPriceIntervalId("string")
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(subscriptionCreateResponse.endDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionCreateResponse.fixedFeeQuantitySchedule())
            .containsExactly(
                SubscriptionCreateResponse.FixedFeeQuantitySchedule.builder()
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .priceId("price_id")
        ...
        assertThat(subscriptionCreateResponse.maximumIntervals())
            .containsExactly(
                SubscriptionCreateResponse.MaximumInterval.builder()
                    .addAppliesToPriceIntervalId("string")
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .addFilter(
                        SubscriptionCreateResponse.MaximumInterval.Filter.builder()
                            .field(SubscriptionCreateResponse.MaximumInterval.Filter.Field.PRICE_ID)
                            .operator(
                                SubscriptionCreateResponse.MaximumInterval.Filter.Operator.INCLUDES
                            )
                            .addValue("string")
                            .build()
                    )
        ...
        assertThat(subscriptionCreateResponse.minimumIntervals())
            .containsExactly(
                SubscriptionCreateResponse.MinimumInterval.builder()
                    .addAppliesToPriceIntervalId("string")
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .addFilter(
                        SubscriptionCreateResponse.MinimumInterval.Filter.builder()
                            .field(SubscriptionCreateResponse.MinimumInterval.Filter.Field.PRICE_ID)
                            .operator(
                                SubscriptionCreateResponse.MinimumInterval.Filter.Operator.INCLUDES
                            )
                            .addValue("string")
                            .build()
                    )
        ...
        assertThat(subscriptionCreateResponse.name()).isEqualTo("name")
        assertThat(subscriptionCreateResponse.netTerms()).isEqualTo(0L)
        assertThat(subscriptionCreateResponse.pendingSubscriptionChange())
            .isEqualTo(
                SubscriptionCreateResponse.PendingSubscriptionChange.builder().id("id").build()
            )
        ...
        assertThat(subscriptionCreateResponse.redeemedCoupon())
            .isEqualTo(
                SubscriptionCreateResponse.RedeemedCoupon.builder()
                    .couponId("coupon_id")
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(subscriptionCreateResponse.startDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionCreateResponse.status())
            .isEqualTo(SubscriptionCreateResponse.Status.ACTIVE)
        assertThat(subscriptionCreateResponse.trialInfo())
            .isEqualTo(
                SubscriptionCreateResponse.TrialInfo.builder()
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .build()
            )
        assertThat(subscriptionCreateResponse.changedResources())
            .isEqualTo(
                SubscriptionCreateResponse.ChangedResources.builder()
                    .addCreatedCreditNote(
                        CreditNote.builder()

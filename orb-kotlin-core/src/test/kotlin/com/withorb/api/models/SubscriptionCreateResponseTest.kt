    ...
    fun createSubscriptionCreateResponse() {
        val subscriptionCreateResponse =
            SubscriptionCreateResponse.builder()
                                ...
                                SubscriptionCreateResponse.AdjustmentInterval.Adjustment
                                    .ofAmountDiscountAdjustment(
                                        SubscriptionCreateResponse.AdjustmentInterval.Adjustment
                                            ...
                                            .builder()
                                            .adjustmentType(
                                                SubscriptionCreateResponse.AdjustmentInterval
                                                    .Adjustment
                                                    .AmountDiscountAdjustment
                                                    .AdjustmentType
                                                    .AMOUNT_DISCOUNT
                ...
                .discountIntervals(
                    listOf(
                        SubscriptionCreateResponse.DiscountInterval.ofAmountDiscountInterval(
                            SubscriptionCreateResponse.DiscountInterval.AmountDiscountInterval
                                ...
                                .appliesToPriceIntervalIds(listOf("string"))
                                .discountType(
                                    SubscriptionCreateResponse.DiscountInterval
                ...
                .metadata(SubscriptionCreateResponse.Metadata.builder().build())
                .minimumIntervals(
                    listOf(
        ...
        assertThat(subscriptionCreateResponse.activePlanPhaseOrder()).isEqualTo(123L)
        ...
        assertThat(subscriptionCreateResponse.metadata())
            .isEqualTo(SubscriptionCreateResponse.Metadata.builder().build())

...
internal class SubscriptionCostExceededWebhookEventTest {

    @Test
    fun create() {
        val subscriptionCostExceededWebhookEvent =
            SubscriptionCostExceededWebhookEvent.builder()
                .id("id")
                .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                .properties(
                    SubscriptionCostExceededWebhookEvent.Properties.builder()
                        .alertConfiguration(
                            SubscriptionCostExceededWebhookEvent.Properties.AlertConfiguration
                                .builder()
                                .id("XuxCbt7x9L82yyeF")
                                .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                                .currency("currency")
                                ...
                                .enabled(true)
                                .metric(
                                    SubscriptionCostExceededWebhookEvent.Properties
                                        .AlertConfiguration
                                        .Metric
                                        .builder()
                                        .id("id")
                ...
                .type(SubscriptionCostExceededWebhookEvent.Type.SUBSCRIPTION_COST_EXCEEDED)
                .build()

        assertThat(subscriptionCostExceededWebhookEvent.id()).isEqualTo("id")
        assertThat(subscriptionCostExceededWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionCostExceededWebhookEvent.properties())
            .isEqualTo(
                SubscriptionCostExceededWebhookEvent.Properties.builder()
                    .alertConfiguration(
                        SubscriptionCostExceededWebhookEvent.Properties.AlertConfiguration.builder()
                            .id("XuxCbt7x9L82yyeF")
                            .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                            .currency("currency")
                            .customer(
        ...
        assertThat(subscriptionCostExceededWebhookEvent.subscription())
            .isEqualTo(
                Subscription.builder()
                    .id("id")
                    .activePlanPhaseOrder(0L)
        ...
        assertThat(subscriptionCostExceededWebhookEvent.type())
            .isEqualTo(SubscriptionCostExceededWebhookEvent.Type.SUBSCRIPTION_COST_EXCEEDED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionCostExceededWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionCostExceededWebhookEvent),
                jacksonTypeRef<SubscriptionCostExceededWebhookEvent>(),
            )

        assertThat(roundtrippedSubscriptionCostExceededWebhookEvent)
            .isEqualTo(subscriptionCostExceededWebhookEvent)
    }
}

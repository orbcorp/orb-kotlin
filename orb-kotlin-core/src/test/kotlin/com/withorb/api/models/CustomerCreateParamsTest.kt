...
class CustomerCreateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.hierarchy()).isEqualTo(CustomerCreateParams.Hierarchy.builder()
          .addChildCustomerId("string")
          .parentCustomerId("parent_customer_id")
          .build())
      assertThat(body.metadata()).isEqualTo(CustomerCreateParams.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      ...
      assertThat(body.shippingAddress()).isEqualTo(CustomerCreateParams.ShippingAddress.builder()
          ...
          .state("state")
          .build())
      assertThat(body.taxConfiguration()).isEqualTo(CustomerCreateParams.TaxConfiguration.ofNewAvalara(CustomerCreateParams.TaxConfiguration.NewAvalaraTaxConfiguration.builder()
          .taxExempt(true)
          .taxProvider(CustomerCreateParams.TaxConfiguration.NewAvalaraTaxConfiguration.TaxProvider.AVALARA)
          .taxExemptionCode("tax_exemption_code")
          .build()))

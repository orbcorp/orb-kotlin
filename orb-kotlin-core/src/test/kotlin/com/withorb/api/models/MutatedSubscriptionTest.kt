...
internal class MutatedSubscriptionTest {
    ...
    fun create() {
        ...
        assertThat(mutatedSubscription.activePlanPhaseOrder()).isEqualTo(0L)
        ...
        assertThat(mutatedSubscription.autoCollection()).isEqualTo(true)
        assertThat(mutatedSubscription.autoIssuance()).isEqualTo(true)
        ...
        assertThat(mutatedSubscription.defaultInvoiceMemo()).isEqualTo("default_invoice_memo")
        ...
        assertThat(mutatedSubscription.invoicingThreshold()).isEqualTo("invoicing_threshold")

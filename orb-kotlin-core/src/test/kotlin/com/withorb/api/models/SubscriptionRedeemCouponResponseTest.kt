...
internal class SubscriptionRedeemCouponResponseTest {

    @Test
    fun create() {
        val subscriptionRedeemCouponResponse =
            SubscriptionRedeemCouponResponse.builder()
                .id("id")
                .activePlanPhaseOrder(0L)
                .addAdjustmentInterval(
                    SubscriptionRedeemCouponResponse.AdjustmentInterval.builder()
                        .id("id")
                        .adjustment(
                            SubscriptionRedeemCouponResponse.AdjustmentInterval.Adjustment
                                .UsageDiscount
                                .builder()
                                .id("id")
                                ...
                                .addFilter(
                                    SubscriptionRedeemCouponResponse.AdjustmentInterval.Adjustment
                                        ...
                                        .builder()
                                        .field(
                                            SubscriptionRedeemCouponResponse.AdjustmentInterval
                                                .Adjustment
                                                .UsageDiscount
                                                .Filter
                                                .Field
                ...
                .billingCycleAnchorConfiguration(
                    SubscriptionRedeemCouponResponse.BillingCycleAnchorConfiguration.builder()
                        .day(1L)
                        .month(1L)
                        .year(0L)
                        .build()
                ...
                .addDiscountInterval(
                    SubscriptionRedeemCouponResponse.DiscountInterval.Amount.builder()
                        .amountDiscount("amount_discount")
                        .addAppliesToPriceIntervalId("string")
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .addFilter(
                            SubscriptionRedeemCouponResponse.DiscountInterval.Amount.Filter
                                .builder()
                                .field(
                                    SubscriptionRedeemCouponResponse.DiscountInterval.Amount.Filter
                                        .Field
                ...
                .addFixedFeeQuantitySchedule(
                    SubscriptionRedeemCouponResponse.FixedFeeQuantitySchedule.builder()
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .priceId("price_id")
                        .quantity(0.0)
                        .startDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                ...
                .addMaximumInterval(
                    SubscriptionRedeemCouponResponse.MaximumInterval.builder()
                        .addAppliesToPriceIntervalId("string")
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .addFilter(
                            SubscriptionRedeemCouponResponse.MaximumInterval.Filter.builder()
                                .field(
                                    SubscriptionRedeemCouponResponse.MaximumInterval.Filter.Field
                                        .PRICE_ID
                                )
                                .operator(
                                    SubscriptionRedeemCouponResponse.MaximumInterval.Filter.Operator
                                        .INCLUDES
                                )
                                .addValue("string")
                                .build()
                ...
                .metadata(
                    SubscriptionRedeemCouponResponse.Metadata.builder()
                        .putAdditionalProperty("foo", JsonValue.from("string"))
                        .build()
                )
                .addMinimumInterval(
                    SubscriptionRedeemCouponResponse.MinimumInterval.builder()
                        .addAppliesToPriceIntervalId("string")
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .addFilter(
                            SubscriptionRedeemCouponResponse.MinimumInterval.Filter.builder()
                                .field(
                                    SubscriptionRedeemCouponResponse.MinimumInterval.Filter.Field
                                        .PRICE_ID
                                )
                                .operator(
                                    SubscriptionRedeemCouponResponse.MinimumInterval.Filter.Operator
                                        .INCLUDES
                                )
                                .addValue("string")
                                .build()
                ...
                .pendingSubscriptionChange(
                    SubscriptionRedeemCouponResponse.PendingSubscriptionChange.builder()
                        .id("id")
                        .build()
                )
                .plan(
                ...
                .addPriceInterval(
                    SubscriptionRedeemCouponResponse.PriceInterval.builder()
                        .id("id")
                        .billingCycleDay(0L)
                        ...
                        .addFixedFeeQuantityTransition(
                            SubscriptionRedeemCouponResponse.PriceInterval
                ...
                .redeemedCoupon(
                    SubscriptionRedeemCouponResponse.RedeemedCoupon.builder()
                        .couponId("coupon_id")
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .startDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .build()
                ...
                .startDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                .status(SubscriptionRedeemCouponResponse.Status.ACTIVE)
                .trialInfo(
                    SubscriptionRedeemCouponResponse.TrialInfo.builder()
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .build()
                )
                .changedResources(
                    SubscriptionRedeemCouponResponse.ChangedResources.builder()
        ...
        assertThat(subscriptionRedeemCouponResponse.id()).isEqualTo("id")
        assertThat(subscriptionRedeemCouponResponse.activePlanPhaseOrder()).isEqualTo(0L)
        assertThat(subscriptionRedeemCouponResponse.adjustmentIntervals())
            .containsExactly(
                SubscriptionRedeemCouponResponse.AdjustmentInterval.builder()
                    .id("id")
                    .adjustment(
                        SubscriptionRedeemCouponResponse.AdjustmentInterval.Adjustment.UsageDiscount
                            .builder()
                            .id("id")
                            .addAppliesToPriceId("string")
                            .addFilter(
        ...
        assertThat(subscriptionRedeemCouponResponse.autoCollection()).isEqualTo(true)
        assertThat(subscriptionRedeemCouponResponse.billingCycleAnchorConfiguration())
            .isEqualTo(
                SubscriptionRedeemCouponResponse.BillingCycleAnchorConfiguration.builder()
                    .day(1L)
                    .month(1L)
        ...
        assertThat(subscriptionRedeemCouponResponse.billingCycleDay()).isEqualTo(1L)
        assertThat(subscriptionRedeemCouponResponse.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionRedeemCouponResponse.currentBillingPeriodEndDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionRedeemCouponResponse.currentBillingPeriodStartDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionRedeemCouponResponse.customer())
            .isEqualTo(
                Customer.builder()
                    .id("id")
                    .addAdditionalEmail("string")
        ...
        assertThat(subscriptionRedeemCouponResponse.defaultInvoiceMemo())
            .isEqualTo("default_invoice_memo")
        assertThat(subscriptionRedeemCouponResponse.discountIntervals())
            .containsExactly(
                SubscriptionRedeemCouponResponse.DiscountInterval.ofAmount(
                    SubscriptionRedeemCouponResponse.DiscountInterval.Amount.builder()
                        .amountDiscount("amount_discount")
                        .addAppliesToPriceIntervalId("string")
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(subscriptionRedeemCouponResponse.endDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionRedeemCouponResponse.fixedFeeQuantitySchedule())
            .containsExactly(
                SubscriptionRedeemCouponResponse.FixedFeeQuantitySchedule.builder()
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .priceId("price_id")
        ...
        assertThat(subscriptionRedeemCouponResponse.invoicingThreshold())
            .isEqualTo("invoicing_threshold")
        assertThat(subscriptionRedeemCouponResponse.maximumIntervals())
            .containsExactly(
                SubscriptionRedeemCouponResponse.MaximumInterval.builder()
                    .addAppliesToPriceIntervalId("string")
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(subscriptionRedeemCouponResponse.metadata())
            .isEqualTo(
                SubscriptionRedeemCouponResponse.Metadata.builder()
                    .putAdditionalProperty("foo", JsonValue.from("string"))
                    .build()
            )
        assertThat(subscriptionRedeemCouponResponse.minimumIntervals())
            .containsExactly(
                SubscriptionRedeemCouponResponse.MinimumInterval.builder()
                    .addAppliesToPriceIntervalId("string")
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(subscriptionRedeemCouponResponse.name()).isEqualTo("name")
        assertThat(subscriptionRedeemCouponResponse.netTerms()).isEqualTo(0L)
        assertThat(subscriptionRedeemCouponResponse.pendingSubscriptionChange())
            .isEqualTo(
                SubscriptionRedeemCouponResponse.PendingSubscriptionChange.builder()
                    .id("id")
                    .build()
            )
        assertThat(subscriptionRedeemCouponResponse.plan())
            .isEqualTo(
                Plan.builder()
                    .id("id")
                    .addAdjustment(
        ...
        assertThat(subscriptionRedeemCouponResponse.priceIntervals())
            .containsExactly(
                SubscriptionRedeemCouponResponse.PriceInterval.builder()
                    .id("id")
                    .billingCycleDay(0L)
                    ...
                    .filter("filter")
                    .addFixedFeeQuantityTransition(
                        SubscriptionRedeemCouponResponse.PriceInterval.FixedFeeQuantityTransition
                            .builder()
                            .effectiveDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                            .priceId("price_id")
                            .quantity(0L)
        ...
        assertThat(subscriptionRedeemCouponResponse.redeemedCoupon())
            .isEqualTo(
                SubscriptionRedeemCouponResponse.RedeemedCoupon.builder()
                    .couponId("coupon_id")
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(subscriptionRedeemCouponResponse.startDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionRedeemCouponResponse.status())
            .isEqualTo(SubscriptionRedeemCouponResponse.Status.ACTIVE)
        assertThat(subscriptionRedeemCouponResponse.trialInfo())
            .isEqualTo(
                SubscriptionRedeemCouponResponse.TrialInfo.builder()
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .build()
            )
        assertThat(subscriptionRedeemCouponResponse.changedResources())
            .isEqualTo(
                SubscriptionRedeemCouponResponse.ChangedResources.builder()
                    .addCreatedCreditNote(
                        CreditNote.builder()
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionRedeemCouponResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionRedeemCouponResponse),
                jacksonTypeRef<SubscriptionRedeemCouponResponse>(),
            )

        assertThat(roundtrippedSubscriptionRedeemCouponResponse)
            .isEqualTo(subscriptionRedeemCouponResponse)
    }
}

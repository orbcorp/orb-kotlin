...
internal class SubscriptionUnscheduleCancellationResponseTest {
    ...
    fun create() {
            ...
            SubscriptionUnscheduleCancellationResponse.builder()
                ...
                .addAdjustmentInterval(
                    SubscriptionUnscheduleCancellationResponse.AdjustmentInterval.builder()
                        .id("id")
                        .adjustment(
                            SubscriptionUnscheduleCancellationResponse.AdjustmentInterval.Adjustment
                                .UsageDiscount
                                .builder()
                                .id("id")
                ...
                .metadata(
                    SubscriptionUnscheduleCancellationResponse.Metadata.builder()
                        .putAdditionalProperty("foo", JsonValue.from("string"))
                        .build()
                )
                .addMinimumInterval(
                ...
                .addPriceInterval(
                    SubscriptionUnscheduleCancellationResponse.PriceInterval.builder()
                        ...
                        .addFixedFeeQuantityTransition(
                            SubscriptionUnscheduleCancellationResponse.PriceInterval
                ...
                .redeemedCoupon(
                    SubscriptionUnscheduleCancellationResponse.RedeemedCoupon.builder()
                        .couponId("coupon_id")
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .startDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .build()
                ...
                .trialInfo(
                    SubscriptionUnscheduleCancellationResponse.TrialInfo.builder()
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .build()
                )
                .changedResources(
                    SubscriptionUnscheduleCancellationResponse.ChangedResources.builder()
        ...
        assertThat(subscriptionUnscheduleCancellationResponse.currentBillingPeriodEndDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionUnscheduleCancellationResponse.currentBillingPeriodStartDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionUnscheduleCancellationResponse.customer())
            .isEqualTo(
                Customer.builder()
                    .id("id")
                    .addAdditionalEmail("string")
        ...
        assertThat(subscriptionUnscheduleCancellationResponse.defaultInvoiceMemo())
        ...
        assertThat(subscriptionUnscheduleCancellationResponse.endDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionUnscheduleCancellationResponse.fixedFeeQuantitySchedule())
            .containsExactly(
                SubscriptionUnscheduleCancellationResponse.FixedFeeQuantitySchedule.builder()
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .priceId("price_id")
        ...
        assertThat(subscriptionUnscheduleCancellationResponse.invoicingThreshold())
        ...
        assertThat(subscriptionUnscheduleCancellationResponse.metadata())
            .isEqualTo(
                SubscriptionUnscheduleCancellationResponse.Metadata.builder()
                    .putAdditionalProperty("foo", JsonValue.from("string"))
                    .build()
        ...
        assertThat(subscriptionUnscheduleCancellationResponse.redeemedCoupon())
            .isEqualTo(
                SubscriptionUnscheduleCancellationResponse.RedeemedCoupon.builder()
                    .couponId("coupon_id")
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(subscriptionUnscheduleCancellationResponse.startDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionUnscheduleCancellationResponse.status())
            .isEqualTo(SubscriptionUnscheduleCancellationResponse.Status.ACTIVE)
        assertThat(subscriptionUnscheduleCancellationResponse.trialInfo())
            .isEqualTo(
                SubscriptionUnscheduleCancellationResponse.TrialInfo.builder()
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .build()
            )
        assertThat(subscriptionUnscheduleCancellationResponse.changedResources())
            .isEqualTo(
                SubscriptionUnscheduleCancellationResponse.ChangedResources.builder()
                    .addCreatedCreditNote(
                        CreditNote.builder()
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionUnscheduleCancellationResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionUnscheduleCancellationResponse),
                jacksonTypeRef<SubscriptionUnscheduleCancellationResponse>(),
            )

        assertThat(roundtrippedSubscriptionUnscheduleCancellationResponse)

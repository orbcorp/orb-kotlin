...
class CreditNoteTest {
    ...
    fun createCreditNote() {
      val creditNote = CreditNote.builder()
          ...
          .addLineItem(CreditNote.LineItem.builder()
              .id("id")
              .amount("amount")
              .itemId("item_id")
              .name("name")
              .quantity(0.0)
              .subtotal("subtotal")
              .addTaxAmount(CreditNote.LineItem.TaxAmount.builder()
                  .amount("amount")
                  .taxRateDescription("tax_rate_description")
                  .taxRatePercentage("tax_rate_percentage")
                  .build())
              .addDiscount(CreditNote.LineItem.Discount.builder()
                  .id("id")
          ...
          .maximumAmountAdjustment(CreditNote.MaximumAmountAdjustment.builder()
              ...
              .percentageDiscount(0.0)
              .addAppliesToPrice(CreditNote.MaximumAmountAdjustment.AppliesToPrice.builder()
                  .id("id")
                  .name("name")
                  .build())
              .reason("reason")
          ...
          .addDiscount(CreditNote.Discount.builder()
              .amountApplied("amount_applied")
              .discountType(CreditNote.Discount.DiscountType.PERCENTAGE)
              .percentageDiscount(0.0)
              .addAppliesToPrice(CreditNote.Discount.AppliesToPrice.builder()
                  .id("id")
                  .name("name")
                  .build())
              .reason("reason")
      ...
      assertThat(creditNote.lineItems()).containsExactly(CreditNote.LineItem.builder()
          ...
          .addDiscount(CreditNote.LineItem.Discount.builder()
              ...
              .build())
          .build())
      assertThat(creditNote.maximumAmountAdjustment()).isEqualTo(CreditNote.MaximumAmountAdjustment.builder()
          .amountApplied("amount_applied")
          .discountType(CreditNote.MaximumAmountAdjustment.DiscountType.PERCENTAGE)
          .percentageDiscount(0.0)
          .addAppliesToPrice(CreditNote.MaximumAmountAdjustment.AppliesToPrice.builder()
          ...
          .reason("reason")
          .build())
      assertThat(creditNote.memo()).isEqualTo("memo")
      assertThat(creditNote.minimumAmountRefunded()).isEqualTo("minimum_amount_refunded")
      ...
      assertThat(creditNote.voidedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(creditNote.discounts()).containsExactly(CreditNote.Discount.builder()
          .amountApplied("amount_applied")
          .discountType(CreditNote.Discount.DiscountType.PERCENTAGE)
          .percentageDiscount(0.0)
          .addAppliesToPrice(CreditNote.Discount.AppliesToPrice.builder()

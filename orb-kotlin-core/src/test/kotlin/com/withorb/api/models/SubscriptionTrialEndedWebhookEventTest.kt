...
internal class SubscriptionTrialEndedWebhookEventTest {

    @Test
    fun create() {
        val subscriptionTrialEndedWebhookEvent =
            SubscriptionTrialEndedWebhookEvent.builder()
                .id("id")
                ...
                .type(SubscriptionTrialEndedWebhookEvent.Type.SUBSCRIPTION_TRIAL_ENDED)
                .build()

        assertThat(subscriptionTrialEndedWebhookEvent.id()).isEqualTo("id")
        assertThat(subscriptionTrialEndedWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionTrialEndedWebhookEvent._properties())
            .isEqualTo(JsonValue.from(mapOf<String, Any>()))
        assertThat(subscriptionTrialEndedWebhookEvent.subscription())
            .isEqualTo(
                Subscription.builder()
                    .id("id")
                    .activePlanPhaseOrder(0L)
        ...
        assertThat(subscriptionTrialEndedWebhookEvent.type())
            .isEqualTo(SubscriptionTrialEndedWebhookEvent.Type.SUBSCRIPTION_TRIAL_ENDED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionTrialEndedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionTrialEndedWebhookEvent),
                jacksonTypeRef<SubscriptionTrialEndedWebhookEvent>(),
            )

        assertThat(roundtrippedSubscriptionTrialEndedWebhookEvent)
            .isEqualTo(subscriptionTrialEndedWebhookEvent)
    }
}

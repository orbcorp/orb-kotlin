    ...
    fun create() {
        val newSubscriptionMinimumCompositePrice =
            NewSubscriptionMinimumCompositePrice.builder()
                ...
                .itemId("item_id")
                .minimumConfig(
                    NewSubscriptionMinimumCompositePrice.MinimumConfig.builder()
                        .minimumAmount("minimum_amount")
                        .prorated(true)
                        .build()
                )
                .modelType(NewSubscriptionMinimumCompositePrice.ModelType.MINIMUM)
                .name("Annual fee")
        ...
        assertThat(newSubscriptionMinimumCompositePrice.minimumConfig())
            .isEqualTo(
                NewSubscriptionMinimumCompositePrice.MinimumConfig.builder()
                    .minimumAmount("minimum_amount")
                    .prorated(true)
        ...
        assertThat(newSubscriptionMinimumCompositePrice.modelType())
            .isEqualTo(NewSubscriptionMinimumCompositePrice.ModelType.MINIMUM)

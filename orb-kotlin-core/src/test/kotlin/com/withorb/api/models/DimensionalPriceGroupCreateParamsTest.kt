...
class DimensionalPriceGroupCreateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.externalDimensionalPriceGroupId()).isEqualTo("external_dimensional_price_group_id")
      assertThat(body.metadata()).isEqualTo(DimensionalPriceGroupCreateParams.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
    }

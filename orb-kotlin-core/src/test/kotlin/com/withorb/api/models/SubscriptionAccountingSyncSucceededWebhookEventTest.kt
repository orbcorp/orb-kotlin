...
internal class SubscriptionAccountingSyncSucceededWebhookEventTest {

    @Test
    fun create() {
        val subscriptionAccountingSyncSucceededWebhookEvent =
            SubscriptionAccountingSyncSucceededWebhookEvent.builder()
                .id("id")
                .accountingSyncRecord(
                    SubscriptionAccountingSyncSucceededWebhookEvent.AccountingSyncRecord.builder()
                        .id("id")
                ...
                .properties(
                    SubscriptionAccountingSyncSucceededWebhookEvent.Properties.builder()
                ...
                .type(
                    SubscriptionAccountingSyncSucceededWebhookEvent.Type
                        .SUBSCRIPTION_ACCOUNTING_SYNC_SUCCEEDED
                )
                .build()

        assertThat(subscriptionAccountingSyncSucceededWebhookEvent.id()).isEqualTo("id")
        assertThat(subscriptionAccountingSyncSucceededWebhookEvent.accountingSyncRecord())
            .isEqualTo(
                SubscriptionAccountingSyncSucceededWebhookEvent.AccountingSyncRecord.builder()
                    .id("id")
                    .customerId("customer_id")
        ...
        assertThat(subscriptionAccountingSyncSucceededWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionAccountingSyncSucceededWebhookEvent.properties())
            .isEqualTo(
                SubscriptionAccountingSyncSucceededWebhookEvent.Properties.builder()
                    .connectionType("connection_type")
                    .build()
            )
        assertThat(subscriptionAccountingSyncSucceededWebhookEvent.subscription())
            .isEqualTo(
                Subscription.builder()
                    .id("id")
                    .activePlanPhaseOrder(0L)
        ...
        assertThat(subscriptionAccountingSyncSucceededWebhookEvent.type())
            .isEqualTo(
                SubscriptionAccountingSyncSucceededWebhookEvent.Type
                    .SUBSCRIPTION_ACCOUNTING_SYNC_SUCCEEDED
            )
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionAccountingSyncSucceededWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionAccountingSyncSucceededWebhookEvent),
                jacksonTypeRef<SubscriptionAccountingSyncSucceededWebhookEvent>(),
            )

        assertThat(roundtrippedSubscriptionAccountingSyncSucceededWebhookEvent)
            .isEqualTo(subscriptionAccountingSyncSucceededWebhookEvent)
    }
}

...
class InvoiceLineItemModelTest {
    ...
    fun createInvoiceLineItemModel() {
        ...
        assertThat(invoiceLineItemModel.filter()).isEqualTo("filter")
        assertThat(invoiceLineItemModel.grouping()).isEqualTo("grouping")
        ...
        assertThat(invoiceLineItemModel.maximumAmount()).isEqualTo("maximum_amount")
        ...
        assertThat(invoiceLineItemModel.minimumAmount()).isEqualTo("minimum_amount")
        ...
        assertThat(invoiceLineItemModel.usageCustomerIds()).containsExactly("string")
    }
}

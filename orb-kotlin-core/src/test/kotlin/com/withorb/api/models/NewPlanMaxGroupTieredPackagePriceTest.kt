...
internal class NewPlanMaxGroupTieredPackagePriceTest {
    ...
    fun create() {
        ...
        assertThat(newPlanMaxGroupTieredPackagePrice.licenseTypeId()).isEqualTo("license_type_id")
        ...
        assertThat(newPlanMaxGroupTieredPackagePrice.referenceId()).isEqualTo("reference_id")
    }

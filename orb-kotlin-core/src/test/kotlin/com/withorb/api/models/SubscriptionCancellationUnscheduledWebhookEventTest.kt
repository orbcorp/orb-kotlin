...
internal class SubscriptionCancellationUnscheduledWebhookEventTest {

    @Test
    fun create() {
        val subscriptionCancellationUnscheduledWebhookEvent =
            SubscriptionCancellationUnscheduledWebhookEvent.builder()
                .id("id")
                .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                .properties(
                    SubscriptionCancellationUnscheduledWebhookEvent.Properties.builder()
                        .originalCancellationDate("original_cancellation_date")
                        .build()
                )
                .subscription(
                ...
                .type(
                    SubscriptionCancellationUnscheduledWebhookEvent.Type
                        .SUBSCRIPTION_CANCELLATION_UNSCHEDULED
                )
                .build()

        assertThat(subscriptionCancellationUnscheduledWebhookEvent.id()).isEqualTo("id")
        assertThat(subscriptionCancellationUnscheduledWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionCancellationUnscheduledWebhookEvent.properties())
            .isEqualTo(
                SubscriptionCancellationUnscheduledWebhookEvent.Properties.builder()
                    .originalCancellationDate("original_cancellation_date")
                    .build()
            )
        assertThat(subscriptionCancellationUnscheduledWebhookEvent.subscription())
            .isEqualTo(
                Subscription.builder()
                    .id("id")
                    .activePlanPhaseOrder(0L)
        ...
        assertThat(subscriptionCancellationUnscheduledWebhookEvent.type())
            .isEqualTo(
                SubscriptionCancellationUnscheduledWebhookEvent.Type
                    .SUBSCRIPTION_CANCELLATION_UNSCHEDULED
            )
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionCancellationUnscheduledWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionCancellationUnscheduledWebhookEvent),
                jacksonTypeRef<SubscriptionCancellationUnscheduledWebhookEvent>(),
            )

        assertThat(roundtrippedSubscriptionCancellationUnscheduledWebhookEvent)
            .isEqualTo(subscriptionCancellationUnscheduledWebhookEvent)
    }
}

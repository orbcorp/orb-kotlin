    ...
    fun create() {
        val planPhaseMinimumAdjustment =
            PlanPhaseMinimumAdjustment.builder()
                ...
                .addFilter(
                    PlanPhaseMinimumAdjustment.Filter.builder()
                        .field(PlanPhaseMinimumAdjustment.Filter.Field.PRICE_ID)
                        .operator(PlanPhaseMinimumAdjustment.Filter.Operator.INCLUDES)
                        .addValue("string")
                        .build()
                )
                .isInvoiceLevel(true)
        ...
        assertThat(planPhaseMinimumAdjustment.planPhaseOrder()).isEqualTo(0L)
        assertThat(planPhaseMinimumAdjustment.reason()).isEqualTo("reason")

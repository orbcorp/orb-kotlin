...
internal class SubscriptionAccountingSyncFailedWebhookEventTest {

    @Test
    fun create() {
        val subscriptionAccountingSyncFailedWebhookEvent =
            SubscriptionAccountingSyncFailedWebhookEvent.builder()
                .id("id")
                .accountingSyncRecord(
                    SubscriptionAccountingSyncFailedWebhookEvent.AccountingSyncRecord.builder()
                        .id("id")
                        .customerId("customer_id")
                        .recordType(
                            SubscriptionAccountingSyncFailedWebhookEvent.AccountingSyncRecord
                                .RecordType
                                .CUSTOMER
                        )
                        .errorDetails(
                ...
                .properties(
                    SubscriptionAccountingSyncFailedWebhookEvent.Properties.builder()
                ...
                .type(
                    SubscriptionAccountingSyncFailedWebhookEvent.Type
                        .SUBSCRIPTION_ACCOUNTING_SYNC_FAILED
                )
                .build()

        assertThat(subscriptionAccountingSyncFailedWebhookEvent.id()).isEqualTo("id")
        assertThat(subscriptionAccountingSyncFailedWebhookEvent.accountingSyncRecord())
            .isEqualTo(
                SubscriptionAccountingSyncFailedWebhookEvent.AccountingSyncRecord.builder()
                    .id("id")
                    .customerId("customer_id")
                    .recordType(
                        SubscriptionAccountingSyncFailedWebhookEvent.AccountingSyncRecord.RecordType
                            .CUSTOMER
                    )
                    .errorDetails(
                        SubscriptionAccountingSyncFailedWebhookEvent.AccountingSyncRecord
        ...
        assertThat(subscriptionAccountingSyncFailedWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionAccountingSyncFailedWebhookEvent.properties())
            .isEqualTo(
                SubscriptionAccountingSyncFailedWebhookEvent.Properties.builder()
                    .connectionType("connection_type")
                    .failureReason("failure_reason")
        ...
        assertThat(subscriptionAccountingSyncFailedWebhookEvent.subscription())
            .isEqualTo(
                Subscription.builder()
                    .id("id")
                    .activePlanPhaseOrder(0L)
        ...
        assertThat(subscriptionAccountingSyncFailedWebhookEvent.type())
            .isEqualTo(
                SubscriptionAccountingSyncFailedWebhookEvent.Type
                    .SUBSCRIPTION_ACCOUNTING_SYNC_FAILED
            )
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionAccountingSyncFailedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionAccountingSyncFailedWebhookEvent),
                jacksonTypeRef<SubscriptionAccountingSyncFailedWebhookEvent>(),
            )

        assertThat(roundtrippedSubscriptionAccountingSyncFailedWebhookEvent)
            .isEqualTo(subscriptionAccountingSyncFailedWebhookEvent)
    }
}

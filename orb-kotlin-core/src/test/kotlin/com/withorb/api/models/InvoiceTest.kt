...
class InvoiceTest {
    ...
    fun createInvoice() {
      val invoice = Invoice.builder()
          .id("id")
          .amountDue("8.00")
          .autoCollection(Invoice.AutoCollection.builder()
              .enabled(true)
              ...
              .build())
          .billingAddress(Invoice.BillingAddress.builder()
              .city("city")
              .country("country")
              .line1("line1")
              .line2("line2")
          ...
          .creditNotes(listOf(Invoice.CreditNote.builder()
              .id("id")
              ...
              .build()))
          .currency("USD")
          .customer(Invoice.Customer.builder()
              .id("id")
              .externalCustomerId("external_customer_id")
              .build())
          .customerBalanceTransactions(listOf(Invoice.CustomerBalanceTransaction.builder()
              .id("cgZa3SXcsPTVyC4Y")
              .action(Invoice.CustomerBalanceTransaction.Action.APPLIED_TO_INVOICE)
              .amount("11.00")
              .createdAt(OffsetDateTime.parse("2022-05-01T07:01:31+00:00"))
              .creditNote(Invoice.CustomerBalanceTransaction.CreditNote.builder()
                  .id("id")
                  .build())
              .description("An optional description")
              .endingBalance("22.00")
              .invoice(Invoice.CustomerBalanceTransaction.Invoice.builder()
                  .id("gXcsPTVyC4YZa3Sc")
                  .build())
              .startingBalance("33.00")
              .type(Invoice.CustomerBalanceTransaction.Type.INCREMENT)
              .build()))
          .customerTaxId(Invoice.CustomerTaxId.builder()
          ...
          .lineItems(listOf(Invoice.LineItem.builder()
              .id("id")
              .amount("7.00")
              .discount(Discount.ofPercentageDiscount(Discount.PercentageDiscount.builder()
                  .appliesToPriceIds(listOf("string"))
              ...
              .grouping("grouping")
              .maximum(Invoice.LineItem.Maximum.builder()
                  .appliesToPriceIds(listOf("string"))
                  .maximumAmount("maximum_amount")
                  .build())
              .maximumAmount("maximum_amount")
              .minimum(Invoice.LineItem.Minimum.builder()
                  .appliesToPriceIds(listOf("string"))
              ...
              .subLineItems(listOf(Invoice.LineItem.SubLineItem.ofMatrixSubLineItem(Invoice.LineItem.SubLineItem.MatrixSubLineItem.builder()
                  .amount("9.00")
                  .grouping(Invoice.LineItem.SubLineItem.MatrixSubLineItem.Grouping.builder()
                      .key("region")
                      .value("west")
                      .build())
                  .matrixConfig(Invoice.LineItem.SubLineItem.MatrixSubLineItem.MatrixConfig.builder()
                  ...
                  .build())))
              .subtotal("9.00")
              .taxAmounts(listOf(Invoice.LineItem.TaxAmount.builder()
                  .amount("amount")
                  .taxRateDescription("tax_rate_description")
                  .taxRatePercentage("tax_rate_percentage")
                  .build()))
              .build()))
          .maximum(Invoice.Maximum.builder()
              .appliesToPriceIds(listOf("string"))
              .maximumAmount("maximum_amount")
              .build())
          .maximumAmount("maximum_amount")
          ...
          .minimum(Invoice.Minimum.builder()
              .appliesToPriceIds(listOf("string"))
              .minimumAmount("minimum_amount")
              .build())
          .minimumAmount("minimum_amount")
          ...
          .shippingAddress(Invoice.ShippingAddress.builder()
              .city("city")
              .country("country")
              .line1("line1")
              .line2("line2")
          ...
          .subscription(Invoice.Subscription.builder()
              .id("VDGsT23osdLb84KD")
              .build())
          .subtotal("8.00")
      ...
      assertThat(invoice.autoCollection()).isEqualTo(Invoice.AutoCollection.builder()
          .enabled(true)
          .nextAttemptAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .numAttempts(123L)
          .previouslyAttemptedAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(invoice.billingAddress()).isEqualTo(Invoice.BillingAddress.builder()
          .city("city")
          .country("country")
          .line1("line1")
          .line2("line2")
      ...
      assertThat(invoice.creditNotes()).containsExactly(Invoice.CreditNote.builder()
          .id("id")
          .creditNoteNumber("credit_note_number")
          .memo("memo")
          .reason("reason")
      ...
      assertThat(invoice.customer()).isEqualTo(Invoice.Customer.builder()
          .id("id")
          .externalCustomerId("external_customer_id")
          .build())
      assertThat(invoice.customerBalanceTransactions()).containsExactly(Invoice.CustomerBalanceTransaction.builder()
          ...
          .type(Invoice.CustomerBalanceTransaction.Type.INCREMENT)
          .build())
      assertThat(invoice.customerTaxId()).isEqualTo(Invoice.CustomerTaxId.builder()
          .country(Invoice.CustomerTaxId.Country.AD)
          .type(Invoice.CustomerTaxId.Type.AD_NRT)
          .value("value")
          .build())
      assertThat(invoice.discount()).isEqualTo(Discount.ofPercentageDiscount(Discount.PercentageDiscount.builder()
          .appliesToPriceIds(listOf("string"))
          .discountType(Discount.PercentageDiscount.DiscountType.PERCENTAGE)
          .percentageDiscount(1.0)
          .reason("reason")
          .build()))
      assertThat(invoice.discounts()).containsExactly(Discount.ofPercentageDiscount(Discount.PercentageDiscount.builder()
          .appliesToPriceIds(listOf("string"))
          .discountType(Discount.PercentageDiscount.DiscountType.PERCENTAGE)
          .percentageDiscount(1.0)
          .reason("reason")
      ...
      assertThat(invoice.eligibleToIssueAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(invoice.hostedInvoiceUrl()).isEqualTo("hosted_invoice_url")
      assertThat(invoice.invoiceDate()).isEqualTo(OffsetDateTime.parse("2022-05-01T07:00:00+00:00"))
      assertThat(invoice.invoiceNumber()).isEqualTo("JYEFHK-00001")
      assertThat(invoice.invoicePdf()).isEqualTo("https://assets.withorb.com/invoice/rUHdhmg45vY45DX/qEAeuYePaphGMdFb")
      assertThat(invoice.invoiceSource()).isEqualTo(Invoice.InvoiceSource.SUBSCRIPTION)
      assertThat(invoice.issueFailedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(invoice.issuedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(invoice.lineItems()).containsExactly(Invoice.LineItem.builder()
          .id("id")
          .amount("7.00")
          .discount(Discount.ofPercentageDiscount(Discount.PercentageDiscount.builder()
              .appliesToPriceIds(listOf("string"))
          ...
          .taxAmounts(listOf(Invoice.LineItem.TaxAmount.builder()
              ...
              .build()))
          .build())
      assertThat(invoice.maximum()).isEqualTo(Invoice.Maximum.builder()
          .appliesToPriceIds(listOf("string"))
          .maximumAmount("maximum_amount")
          .build())
      assertThat(invoice.maximumAmount()).isEqualTo("maximum_amount")
      assertThat(invoice.memo()).isEqualTo("memo")
      assertThat(invoice.metadata()).isEqualTo(Invoice.Metadata.builder().build())
      assertThat(invoice.minimum()).isEqualTo(Invoice.Minimum.builder()
          .appliesToPriceIds(listOf("string"))
          .minimumAmount("minimum_amount")
          .build())
      assertThat(invoice.minimumAmount()).isEqualTo("minimum_amount")
      assertThat(invoice.paidAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(invoice.paymentFailedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(invoice.paymentStartedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(invoice.scheduledIssueAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(invoice.shippingAddress()).isEqualTo(Invoice.ShippingAddress.builder()
          .city("city")
          .country("country")
          .line1("line1")
          .line2("line2")
      ...
      assertThat(invoice.subscription()).isEqualTo(Invoice.Subscription.builder()
          .id("VDGsT23osdLb84KD")
          .build())
      assertThat(invoice.subtotal()).isEqualTo("8.00")
      assertThat(invoice.syncFailedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))

...
class InvoiceTest {
    ...
    fun createInvoice() {
      val invoice = Invoice.builder()
          ...
          .addCreditNote(Invoice.CreditNote.builder()
              .id("id")
          ...
          .addCustomerBalanceTransaction(Invoice.CustomerBalanceTransaction.builder()
              ...
              .endingBalance("22.00")
              .invoice(Invoice.CustomerBalanceTransaction.InnerInvoice.builder()
                  .id("gXcsPTVyC4YZa3Sc")
                  .build())
          ...
          .addLineItem(Invoice.LineItem.builder()
              ...
              .addAdjustment(Invoice.LineItem.Adjustment.MonetaryUsageDiscountAdjustment.builder()
                  .id("id")
                  .adjustmentType(Invoice.LineItem.Adjustment.MonetaryUsageDiscountAdjustment.AdjustmentType.USAGE_DISCOUNT)
                  .amount("amount")
              ...
              .addSubLineItem(Invoice.LineItem.SubLineItem.MatrixSubLineItem.builder()
                  .amount("9.00")
                  ...
                  .build())
              .subtotal("9.00")
              .addTaxAmount(Invoice.LineItem.TaxAmount.builder()
                  .amount("amount")
          ...
          .addPaymentAttempt(Invoice.PaymentAttempt.builder()
              .id("id")
              .amount("amount")
              .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(invoice.discounts()).containsExactly(InvoiceLevelDiscount.ofPercentage(PercentageDiscount.builder()
          .addAppliesToPriceId("h74gfhdjvn7ujokd")
          .addAppliesToPriceId("7hfgtgjnbvc3ujkl")
          .discountType(PercentageDiscount.DiscountType.PERCENTAGE)
          .percentageDiscount(0.15)
      ...
      assertThat(invoice.paymentAttempts()).containsExactly(Invoice.PaymentAttempt.builder()
          .id("id")
          .amount("amount")
          .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .paymentProvider(Invoice.PaymentAttempt.PaymentProvider.STRIPE)

...
internal class SubscriptionEndedWebhookEventTest {

    @Test
    fun create() {
        val subscriptionEndedWebhookEvent =
            SubscriptionEndedWebhookEvent.builder()
                .id("id")
                ...
                .type(SubscriptionEndedWebhookEvent.Type.SUBSCRIPTION_ENDED)
                .build()

        assertThat(subscriptionEndedWebhookEvent.id()).isEqualTo("id")
        assertThat(subscriptionEndedWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionEndedWebhookEvent._properties())
            .isEqualTo(JsonValue.from(mapOf<String, Any>()))
        assertThat(subscriptionEndedWebhookEvent.subscription())
            .isEqualTo(
                Subscription.builder()
                    .id("id")
                    .activePlanPhaseOrder(0L)
        ...
        assertThat(subscriptionEndedWebhookEvent.type())
            .isEqualTo(SubscriptionEndedWebhookEvent.Type.SUBSCRIPTION_ENDED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionEndedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionEndedWebhookEvent),
                jacksonTypeRef<SubscriptionEndedWebhookEvent>(),
            )

        assertThat(roundtrippedSubscriptionEndedWebhookEvent)
            .isEqualTo(subscriptionEndedWebhookEvent)
    }
}

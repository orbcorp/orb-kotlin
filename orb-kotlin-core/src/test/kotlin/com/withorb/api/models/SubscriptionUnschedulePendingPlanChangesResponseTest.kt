...
internal class SubscriptionUnschedulePendingPlanChangesResponseTest {
    ...
    fun create() {
        val subscriptionUnschedulePendingPlanChangesResponse =
            SubscriptionUnschedulePendingPlanChangesResponse.builder()
                ...
                .addDiscountInterval(
                    SubscriptionUnschedulePendingPlanChangesResponse.DiscountInterval.Amount
                        .builder()
                ...
                .addMaximumInterval(
                    SubscriptionUnschedulePendingPlanChangesResponse.MaximumInterval.builder()
                        ...
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .addFilter(
                            SubscriptionUnschedulePendingPlanChangesResponse.MaximumInterval.Filter
                                .builder()
                                .field(
                                    SubscriptionUnschedulePendingPlanChangesResponse.MaximumInterval
                                        .Filter
                                        .Field
                                        .PRICE_ID
                                )
                ...
                .addMinimumInterval(
                    SubscriptionUnschedulePendingPlanChangesResponse.MinimumInterval.builder()
                        ...
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .addFilter(
                            SubscriptionUnschedulePendingPlanChangesResponse.MinimumInterval.Filter
                                .builder()
                                .field(
                                    SubscriptionUnschedulePendingPlanChangesResponse.MinimumInterval
                                        .Filter
                                        .Field
                                        .PRICE_ID
                                )
                ...
                .changedResources(
                    SubscriptionUnschedulePendingPlanChangesResponse.ChangedResources.builder()
        ...
        assertThat(subscriptionUnschedulePendingPlanChangesResponse.autoCollection())
            .isEqualTo(true)
        assertThat(
                subscriptionUnschedulePendingPlanChangesResponse.billingCycleAnchorConfiguration()
            )
        ...
        assertThat(subscriptionUnschedulePendingPlanChangesResponse.name()).isEqualTo("name")
        assertThat(subscriptionUnschedulePendingPlanChangesResponse.netTerms()).isEqualTo(0L)
        assertThat(subscriptionUnschedulePendingPlanChangesResponse.pendingSubscriptionChange())
            .isEqualTo(
                SubscriptionUnschedulePendingPlanChangesResponse.PendingSubscriptionChange.builder()
                    .id("id")
                    .build()
            )
        ...
        assertThat(subscriptionUnschedulePendingPlanChangesResponse.changedResources())
            .isEqualTo(
                SubscriptionUnschedulePendingPlanChangesResponse.ChangedResources.builder()
                    .addCreatedCreditNote(
                        CreditNote.builder()
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionUnschedulePendingPlanChangesResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionUnschedulePendingPlanChangesResponse),
                jacksonTypeRef<SubscriptionUnschedulePendingPlanChangesResponse>(),
            )

        assertThat(roundtrippedSubscriptionUnschedulePendingPlanChangesResponse)
            .isEqualTo(subscriptionUnschedulePendingPlanChangesResponse)
    }
}

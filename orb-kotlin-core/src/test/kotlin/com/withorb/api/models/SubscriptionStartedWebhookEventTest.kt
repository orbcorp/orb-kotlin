...
internal class SubscriptionStartedWebhookEventTest {

    @Test
    fun create() {
        val subscriptionStartedWebhookEvent =
            SubscriptionStartedWebhookEvent.builder()
                .id("id")
                ...
                .type(SubscriptionStartedWebhookEvent.Type.SUBSCRIPTION_STARTED)
                .build()

        assertThat(subscriptionStartedWebhookEvent.id()).isEqualTo("id")
        assertThat(subscriptionStartedWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionStartedWebhookEvent._properties())
            .isEqualTo(JsonValue.from(mapOf<String, Any>()))
        assertThat(subscriptionStartedWebhookEvent.subscription())
            .isEqualTo(
                Subscription.builder()
                    .id("id")
                    .activePlanPhaseOrder(0L)
        ...
        assertThat(subscriptionStartedWebhookEvent.type())
            .isEqualTo(SubscriptionStartedWebhookEvent.Type.SUBSCRIPTION_STARTED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionStartedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionStartedWebhookEvent),
                jacksonTypeRef<SubscriptionStartedWebhookEvent>(),
            )

        assertThat(roundtrippedSubscriptionStartedWebhookEvent)
            .isEqualTo(subscriptionStartedWebhookEvent)
    }
}

    ...
    fun createSubscriptionPriceIntervalsResponse() {
        val subscriptionPriceIntervalsResponse =
            SubscriptionPriceIntervalsResponse.builder()
                ...
                .discountIntervals(
                    listOf(
                        SubscriptionPriceIntervalsResponse.DiscountInterval
                ...
                .metadata(SubscriptionPriceIntervalsResponse.Metadata.builder().build())
                .minimumIntervals(
                    listOf(
        ...
        assertThat(subscriptionPriceIntervalsResponse.activePlanPhaseOrder()).isEqualTo(123L)
        ...
        assertThat(subscriptionPriceIntervalsResponse.discountIntervals())
            .containsExactly(
                SubscriptionPriceIntervalsResponse.DiscountInterval.ofAmountDiscountInterval(
                    SubscriptionPriceIntervalsResponse.DiscountInterval.AmountDiscountInterval
                        .builder()
                        .amountDiscount("amount_discount")
                        .appliesToPriceIds(listOf("string"))
                        .appliesToPriceIntervalIds(listOf("string"))
        ...
        assertThat(subscriptionPriceIntervalsResponse.metadata())
            .isEqualTo(SubscriptionPriceIntervalsResponse.Metadata.builder().build())

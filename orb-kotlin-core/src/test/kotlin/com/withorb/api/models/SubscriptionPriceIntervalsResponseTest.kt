...
internal class SubscriptionPriceIntervalsResponseTest {
    ...
    fun create() {
            ...
            SubscriptionPriceIntervalsResponse.builder()
                            ...
                            SubscriptionPriceIntervalsResponse.AdjustmentInterval.Adjustment
                                ...
                                .addFilter(
                                    SubscriptionPriceIntervalsResponse.AdjustmentInterval.Adjustment
                                        ...
                                        .builder()
                                        .field(
                                            SubscriptionPriceIntervalsResponse.AdjustmentInterval
                                                .Adjustment
                                                .UsageDiscount
                                                .Filter
                                                .Field
                ...
                .addDiscountInterval(
                    SubscriptionPriceIntervalsResponse.DiscountInterval.Amount.builder()
                        ...
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .addFilter(
                            SubscriptionPriceIntervalsResponse.DiscountInterval.Amount.Filter
                                .builder()
                                .field(
                                    SubscriptionPriceIntervalsResponse.DiscountInterval.Amount
                                        .Filter
                                        .Field
                                        .PRICE_ID
                                )
                ...
                .addMaximumInterval(
                    SubscriptionPriceIntervalsResponse.MaximumInterval.builder()
                        ...
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .addFilter(
                            SubscriptionPriceIntervalsResponse.MaximumInterval.Filter.builder()
                                .field(
                                    SubscriptionPriceIntervalsResponse.MaximumInterval.Filter.Field
                                        .PRICE_ID
                                )
                                .operator(
                                    SubscriptionPriceIntervalsResponse.MaximumInterval.Filter
                                        .Operator
                                        .INCLUDES
                                )
                                .addValue("string")
                ...
                .addMinimumInterval(
                    SubscriptionPriceIntervalsResponse.MinimumInterval.builder()
                        ...
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .addFilter(
                            SubscriptionPriceIntervalsResponse.MinimumInterval.Filter.builder()
                                .field(
                                    SubscriptionPriceIntervalsResponse.MinimumInterval.Filter.Field
                                        .PRICE_ID
                                )
                                .operator(
                                    SubscriptionPriceIntervalsResponse.MinimumInterval.Filter
                                        .Operator
                                        .INCLUDES
                                )
                                .addValue("string")
                ...
                SubscriptionPriceIntervalsResponse.MaximumInterval.builder()
                    ...
                    .addFilter(
                        SubscriptionPriceIntervalsResponse.MaximumInterval.Filter.builder()
                            ...
                            .operator(
                                SubscriptionPriceIntervalsResponse.MaximumInterval.Filter.Operator
                                    .INCLUDES
                            )
                            .addValue("string")
                            .build()
                ...
                SubscriptionPriceIntervalsResponse.MinimumInterval.builder()
                    ...
                    .addFilter(
                        SubscriptionPriceIntervalsResponse.MinimumInterval.Filter.builder()
                            ...
                            .operator(
                                SubscriptionPriceIntervalsResponse.MinimumInterval.Filter.Operator
                                    .INCLUDES
                            )
                            .addValue("string")
                            .build()
        ...
        assertThat(subscriptionPriceIntervalsResponse.name()).isEqualTo("name")

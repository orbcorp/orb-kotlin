...
class PriceIntervalModelTest {
    ...
    fun createPriceIntervalModel() {
        ...
        assertThat(priceIntervalModel.endDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(priceIntervalModel.filter()).isEqualTo("filter")
        assertThat(priceIntervalModel.fixedFeeQuantityTransitions())
            .containsExactly(
                PriceIntervalModel.FixedFeeQuantityTransition.builder()
                    .effectiveDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .priceId("price_id")
        ...
        assertThat(priceIntervalModel.startDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(priceIntervalModel.usageCustomerIds()).containsExactly("string")
    }
}

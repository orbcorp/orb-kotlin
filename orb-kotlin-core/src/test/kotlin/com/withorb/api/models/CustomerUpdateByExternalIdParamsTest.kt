...
class CustomerUpdateByExternalIdParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.hierarchy()).isEqualTo(CustomerUpdateByExternalIdParams.Hierarchy.builder()
          .addChildCustomerId("string")
          .parentCustomerId("parent_customer_id")
          .build())
      assertThat(body.metadata()).isEqualTo(CustomerUpdateByExternalIdParams.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      ...
      assertThat(body.shippingAddress()).isEqualTo(CustomerUpdateByExternalIdParams.ShippingAddress.builder()
          ...
          .state("state")
          .build())
      assertThat(body.taxConfiguration()).isEqualTo(CustomerUpdateByExternalIdParams.TaxConfiguration.ofNewAvalara(CustomerUpdateByExternalIdParams.TaxConfiguration.NewAvalaraTaxConfiguration.builder()
          .taxExempt(true)
          .taxProvider(CustomerUpdateByExternalIdParams.TaxConfiguration.NewAvalaraTaxConfiguration.TaxProvider.AVALARA)
          .taxExemptionCode("tax_exemption_code")
          .build()))

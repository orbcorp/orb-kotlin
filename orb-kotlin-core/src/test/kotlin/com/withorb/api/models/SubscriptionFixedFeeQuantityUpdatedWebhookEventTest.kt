...
internal class SubscriptionFixedFeeQuantityUpdatedWebhookEventTest {

    @Test
    fun create() {
        val subscriptionFixedFeeQuantityUpdatedWebhookEvent =
            SubscriptionFixedFeeQuantityUpdatedWebhookEvent.builder()
                .id("id")
                .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                .properties(
                    SubscriptionFixedFeeQuantityUpdatedWebhookEvent.Properties.builder()
                ...
                .type(
                    SubscriptionFixedFeeQuantityUpdatedWebhookEvent.Type
                        .SUBSCRIPTION_FIXED_FEE_QUANTITY_UPDATED
                )
                .build()

        assertThat(subscriptionFixedFeeQuantityUpdatedWebhookEvent.id()).isEqualTo("id")
        assertThat(subscriptionFixedFeeQuantityUpdatedWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionFixedFeeQuantityUpdatedWebhookEvent.properties())
            .isEqualTo(
                SubscriptionFixedFeeQuantityUpdatedWebhookEvent.Properties.builder()
                    .effectiveDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .newQuantity(0.0)
        ...
        assertThat(subscriptionFixedFeeQuantityUpdatedWebhookEvent.subscription())
            .isEqualTo(
                Subscription.builder()
                    .id("id")
                    .activePlanPhaseOrder(0L)
        ...
        assertThat(subscriptionFixedFeeQuantityUpdatedWebhookEvent.type())
            .isEqualTo(
                SubscriptionFixedFeeQuantityUpdatedWebhookEvent.Type
                    .SUBSCRIPTION_FIXED_FEE_QUANTITY_UPDATED
            )
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionFixedFeeQuantityUpdatedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionFixedFeeQuantityUpdatedWebhookEvent),
                jacksonTypeRef<SubscriptionFixedFeeQuantityUpdatedWebhookEvent>(),
            )

        assertThat(roundtrippedSubscriptionFixedFeeQuantityUpdatedWebhookEvent)
            .isEqualTo(subscriptionFixedFeeQuantityUpdatedWebhookEvent)
    }
}

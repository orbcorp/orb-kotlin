...
class InvoiceModelTest {
    ...
    fun createInvoiceModel() {
        ...
        assertThat(invoiceModel.hostedInvoiceUrl()).isEqualTo("hosted_invoice_url")
        ...
        assertThat(invoiceModel.maximumAmount()).isEqualTo("maximum_amount")
        assertThat(invoiceModel.memo()).isEqualTo("memo")
        ...
        assertThat(invoiceModel.minimumAmount()).isEqualTo("minimum_amount")
        assertThat(invoiceModel.paidAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))

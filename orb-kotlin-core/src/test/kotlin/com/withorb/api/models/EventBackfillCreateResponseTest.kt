...
class EventBackfillCreateResponseTest {
    ...
    fun createEventBackfillCreateResponse() {
      ...
      assertThat(eventBackfillCreateResponse.closeTime()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(eventBackfillCreateResponse.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(eventBackfillCreateResponse.customerId()).isEqualTo("customer_id")
      ...
      assertThat(eventBackfillCreateResponse.revertedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(eventBackfillCreateResponse.deprecationFilter()).isEqualTo("my_numeric_property > 100 AND my_other_property = 'bar'")
    }
}

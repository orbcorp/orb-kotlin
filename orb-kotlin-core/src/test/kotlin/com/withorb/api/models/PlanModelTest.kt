...
class PlanModelTest {
    ...
    fun createPlanModel() {
        ...
        assertThat(planModel.basePlanId()).isEqualTo("base_plan_id")
        assertThat(planModel.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(planModel.currency()).isEqualTo("currency")
        assertThat(planModel.defaultInvoiceMemo()).isEqualTo("default_invoice_memo")
        ...
        assertThat(planModel.externalPlanId()).isEqualTo("external_plan_id")
        ...
        assertThat(planModel.maximumAmount()).isEqualTo("maximum_amount")
        ...
        assertThat(planModel.minimumAmount()).isEqualTo("minimum_amount")
        assertThat(planModel.name()).isEqualTo("name")
        assertThat(planModel.netTerms()).isEqualTo(0L)
        assertThat(planModel.planPhases())
            .containsExactly(
                PlanModel.PlanPhase.builder()
                    .id("id")
                    .description("description")

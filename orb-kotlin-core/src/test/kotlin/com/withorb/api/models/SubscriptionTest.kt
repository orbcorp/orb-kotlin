...
class SubscriptionTest {
    ...
    fun createSubscription() {
      ...
      assertThat(subscription.activePlanPhaseOrder()).isEqualTo(123L)
      ...
      assertThat(subscription.discountIntervals()).containsExactly(Subscription.DiscountInterval.ofAmountDiscountInterval(Subscription.DiscountInterval.AmountDiscountInterval.builder()
          .amountDiscount("amount_discount")
          .appliesToPriceIds(listOf("string"))
          .appliesToPriceIntervalIds(listOf("string"))
          .discountType(Subscription.DiscountInterval.AmountDiscountInterval.DiscountType.AMOUNT)
      ...
      assertThat(subscription.maximumIntervals()).containsExactly(Subscription.MaximumInterval.builder()
          ...
          .startDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(subscription.metadata()).isEqualTo(Subscription.Metadata.builder().build())

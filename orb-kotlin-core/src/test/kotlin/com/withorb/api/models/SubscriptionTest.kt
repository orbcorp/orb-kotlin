...
class SubscriptionTest {
    ...
    fun createSubscription() {
      val subscription = Subscription.builder()
          ...
          .addAdjustmentInterval(Subscription.AdjustmentInterval.builder()
              .id("id")
              .adjustment(Subscription.AdjustmentInterval.Adjustment.PlanPhaseUsageDiscountAdjustment.builder()
                  .id("id")
                  .adjustmentType(Subscription.AdjustmentInterval.Adjustment.PlanPhaseUsageDiscountAdjustment.AdjustmentType.USAGE_DISCOUNT)
              ...
              .build())
          .autoCollection(true)
          .billingCycleAnchorConfiguration(Subscription.BillingCycleAnchorConfiguration.builder()
              .day(1L)
              .month(1L)
              .year(0L)
              .build())
          ...
          .addDiscountInterval(Subscription.DiscountInterval.AmountDiscountInterval.builder()
              ...
              .build())
          .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .addFixedFeeQuantitySchedule(Subscription.FixedFeeQuantitySchedule.builder()
              .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .priceId("price_id")
              .quantity(0.0)
              .startDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          ...
          .addMaximumInterval(Subscription.MaximumInterval.builder()
              .addAppliesToPriceId("string")
              .addAppliesToPriceIntervalId("string")
              .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          ...
          .metadata(Subscription.Metadata.builder()
              .putAdditionalProperty("foo", JsonValue.from("string"))
              .build())
          .addMinimumInterval(Subscription.MinimumInterval.builder()
              .addAppliesToPriceId("string")
              .addAppliesToPriceIntervalId("string")
              .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          ...
          .plan(Plan.builder()
              ...
              .version(0L)
              .build())
          .addPriceInterval(Subscription.PriceInterval.builder()
              .id("id")
              .billingCycleDay(0L)
              .currentBillingPeriodEndDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .currentBillingPeriodStartDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
              .filter("filter")
              .addFixedFeeQuantityTransition(Subscription.PriceInterval.FixedFeeQuantityTransition.builder()
      ...
      assertThat(subscription.activePlanPhaseOrder()).isEqualTo(0L)
      assertThat(subscription.adjustmentIntervals()).containsExactly(Subscription.AdjustmentInterval.builder()
          .id("id")
          .adjustment(Subscription.AdjustmentInterval.Adjustment.PlanPhaseUsageDiscountAdjustment.builder()
              .id("id")
              .adjustmentType(Subscription.AdjustmentInterval.Adjustment.PlanPhaseUsageDiscountAdjustment.AdjustmentType.USAGE_DISCOUNT)
          ...
          .startDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(subscription.autoCollection()).isEqualTo(true)
      assertThat(subscription.billingCycleAnchorConfiguration()).isEqualTo(Subscription.BillingCycleAnchorConfiguration.builder()
          .day(1L)
          .month(1L)
          .year(0L)
          .build())
      assertThat(subscription.billingCycleDay()).isEqualTo(1L)
      assertThat(subscription.createdAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(subscription.currentBillingPeriodEndDate()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(subscription.currentBillingPeriodStartDate()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(subscription.customer()).isEqualTo(Customer.builder()
          .id("id")
          .addAdditionalEmail("string")
          .autoCollection(true)
          .balance("balance")
          ...
          .reportingConfiguration(Customer.ReportingConfiguration.builder()
              ...
              .build())
          .build())
      assertThat(subscription.defaultInvoiceMemo()).isEqualTo("default_invoice_memo")
      assertThat(subscription.discountIntervals()).containsExactly(Subscription.DiscountInterval.ofAmount(Subscription.DiscountInterval.AmountDiscountInterval.builder()
          .amountDiscount("amount_discount")
          .addAppliesToPriceId("string")
          .addAppliesToPriceIntervalId("string")
          .discountType(Subscription.DiscountInterval.AmountDiscountInterval.DiscountType.AMOUNT)
          ...
          .startDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build()))
      assertThat(subscription.endDate()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(subscription.fixedFeeQuantitySchedule()).containsExactly(Subscription.FixedFeeQuantitySchedule.builder()
          .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .priceId("price_id")
          .quantity(0.0)
          .startDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(subscription.invoicingThreshold()).isEqualTo("invoicing_threshold")
      assertThat(subscription.maximumIntervals()).containsExactly(Subscription.MaximumInterval.builder()
          .addAppliesToPriceId("string")
          .addAppliesToPriceIntervalId("string")
          .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .maximumAmount("maximum_amount")
          .startDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(subscription.metadata()).isEqualTo(Subscription.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("string"))
          .build())
      assertThat(subscription.minimumIntervals()).containsExactly(Subscription.MinimumInterval.builder()
          .addAppliesToPriceId("string")
          .addAppliesToPriceIntervalId("string")
          .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .minimumAmount("minimum_amount")
      ...
      assertThat(subscription.plan()).isEqualTo(Plan.builder()
          .id("id")
          .addAdjustment(Plan.Adjustment.PlanPhaseUsageDiscountAdjustment.builder()
              .id("id")
              .adjustmentType(Plan.Adjustment.PlanPhaseUsageDiscountAdjustment.AdjustmentType.USAGE_DISCOUNT)
          ...
          .version(0L)
          .build())
      assertThat(subscription.priceIntervals()).containsExactly(Subscription.PriceInterval.builder()
          .id("id")
          .billingCycleDay(0L)
          .currentBillingPeriodEndDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .currentBillingPeriodStartDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          ...
          .addUsageCustomerId("string")
          .build())
      assertThat(subscription.redeemedCoupon()).isEqualTo(Subscription.RedeemedCoupon.builder()
          .couponId("coupon_id")
          .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .startDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
      assertThat(subscription.startDate()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(subscription.status()).isEqualTo(Subscription.Status.ACTIVE)
      assertThat(subscription.trialInfo()).isEqualTo(Subscription.TrialInfo.builder()
          .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .build())
    }
}

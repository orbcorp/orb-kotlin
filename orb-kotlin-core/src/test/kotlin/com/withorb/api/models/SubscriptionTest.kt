...
internal class SubscriptionTest {
    ...
    fun create() {
                            ...
                            PlanPhaseUsageDiscountAdjustment.builder()
                                ...
                                .addFilter(
                                    PlanPhaseUsageDiscountAdjustment.Filter.builder()
                                        .field(
                                            PlanPhaseUsageDiscountAdjustment.Filter.Field.PRICE_ID
                                        )
                                        .operator(
                        ...
                        PlanPhaseUsageDiscountAdjustment.builder()
                            ...
                            .addFilter(
                                PlanPhaseUsageDiscountAdjustment.Filter.builder()
                                    ...
                                    .operator(
                                        PlanPhaseUsageDiscountAdjustment.Filter.Operator.INCLUDES
                                    )
                                    .addValue("string")
                                    .build()
                            )
        ...
        assertThat(subscription.autoIssuance()).isEqualTo(true)
        ...
        assertThat(subscription.pendingSubscriptionChange())
            .isEqualTo(SubscriptionChangeMinified.builder().id("id").build())

    ...
    fun create() {
        val planPhaseMaximumAdjustment =
            PlanPhaseMaximumAdjustment.builder()
                ...
                .addFilter(
                    PlanPhaseMaximumAdjustment.Filter.builder()
                        .field(PlanPhaseMaximumAdjustment.Filter.Field.PRICE_ID)
                        .operator(PlanPhaseMaximumAdjustment.Filter.Operator.INCLUDES)
                        .addValue("string")
                        .build()
                )
                .isInvoiceLevel(true)

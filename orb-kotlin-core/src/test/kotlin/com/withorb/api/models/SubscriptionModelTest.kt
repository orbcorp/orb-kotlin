...
class SubscriptionModelTest {
    ...
    fun createSubscriptionModel() {
        ...
        assertThat(subscriptionModel.activePlanPhaseOrder()).isEqualTo(0L)
        ...
        assertThat(subscriptionModel.autoCollection()).isEqualTo(true)
        ...
        assertThat(subscriptionModel.defaultInvoiceMemo()).isEqualTo("default_invoice_memo")
        ...
        assertThat(subscriptionModel.invoicingThreshold()).isEqualTo("invoicing_threshold")

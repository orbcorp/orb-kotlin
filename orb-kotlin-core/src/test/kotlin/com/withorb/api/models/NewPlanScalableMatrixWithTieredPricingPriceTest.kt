...
internal class NewPlanScalableMatrixWithTieredPricingPriceTest {
    ...
    fun create() {
        ...
        assertThat(newPlanScalableMatrixWithTieredPricingPrice.billedInAdvance()).isEqualTo(true)
        ...
        assertThat(newPlanScalableMatrixWithTieredPricingPrice.fixedPriceQuantity()).isEqualTo(0.0)
        assertThat(newPlanScalableMatrixWithTieredPricingPrice.invoiceGroupingKey()).isEqualTo("x")
        ...
        assertThat(newPlanScalableMatrixWithTieredPricingPrice.referenceId())

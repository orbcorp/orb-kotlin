...
class MutatedSubscriptionModelTest {

    @Test
    fun createMutatedSubscriptionModel() {
        val mutatedSubscriptionModel =
            MutatedSubscriptionModel.builder()
                .id("id")
                ...
                .metadata(
                    MutatedSubscriptionModel.Metadata.builder()
                        .putAdditionalProperty("foo", JsonValue.from("string"))
                        .build()
                )
                .addMinimumInterval(
                ...
                .startDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                .status(MutatedSubscriptionModel.Status.ACTIVE)
                .trialInfo(
                ...
                .build()
        assertThat(mutatedSubscriptionModel).isNotNull
        assertThat(mutatedSubscriptionModel.id()).isEqualTo("id")
        assertThat(mutatedSubscriptionModel.activePlanPhaseOrder()).isEqualTo(0L)
        assertThat(mutatedSubscriptionModel.adjustmentIntervals())
            .containsExactly(
                AdjustmentIntervalModel.builder()
                    .id("id")
                    .adjustment(
        ...
        assertThat(mutatedSubscriptionModel.autoCollection()).isEqualTo(true)
        assertThat(mutatedSubscriptionModel.billingCycleAnchorConfiguration())
            .isEqualTo(
                BillingCycleAnchorConfigurationModel.builder().day(1L).month(1L).year(0L).build()
            )
        assertThat(mutatedSubscriptionModel.billingCycleDay()).isEqualTo(1L)
        assertThat(mutatedSubscriptionModel.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(mutatedSubscriptionModel.currentBillingPeriodEndDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(mutatedSubscriptionModel.currentBillingPeriodStartDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(mutatedSubscriptionModel.customer())
            .isEqualTo(
                CustomerModel.builder()
                    .id("id")
                    .addAdditionalEmail("string")
        ...
        assertThat(mutatedSubscriptionModel.defaultInvoiceMemo()).isEqualTo("default_invoice_memo")
        assertThat(mutatedSubscriptionModel.discountIntervals())
            .containsExactly(
                MutatedSubscriptionModel.DiscountInterval.ofAmountDiscountIntervalModel(
                    AmountDiscountIntervalModel.builder()
                        .amountDiscount("amount_discount")
                        .addAppliesToPriceId("string")
                        .addAppliesToPriceIntervalId("string")
        ...
        assertThat(mutatedSubscriptionModel.endDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(mutatedSubscriptionModel.fixedFeeQuantitySchedule())
            .containsExactly(
                FixedFeeQuantityScheduleEntryModel.builder()
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .priceId("price_id")
        ...
        assertThat(mutatedSubscriptionModel.invoicingThreshold()).isEqualTo("invoicing_threshold")
        assertThat(mutatedSubscriptionModel.maximumIntervals())
            .containsExactly(
                MaximumIntervalModel.builder()
                    .addAppliesToPriceId("string")
                    .addAppliesToPriceIntervalId("string")
        ...
        assertThat(mutatedSubscriptionModel.metadata())
            .isEqualTo(
                MutatedSubscriptionModel.Metadata.builder()
                    .putAdditionalProperty("foo", JsonValue.from("string"))
                    .build()
            )
        assertThat(mutatedSubscriptionModel.minimumIntervals())
            .containsExactly(
                MinimumIntervalModel.builder()
                    .addAppliesToPriceId("string")
                    .addAppliesToPriceIntervalId("string")
        ...
        assertThat(mutatedSubscriptionModel.netTerms()).isEqualTo(0L)
        assertThat(mutatedSubscriptionModel.plan())
            .isEqualTo(
                PlanModel.builder()
                    .id("id")
                    .addAdjustment(
        ...
        assertThat(mutatedSubscriptionModel.priceIntervals())
            .containsExactly(
                PriceIntervalModel.builder()
                    .id("id")
                    .billingCycleDay(0L)
        ...
        assertThat(mutatedSubscriptionModel.redeemedCoupon())
            .isEqualTo(
                CouponRedemptionModel.builder()
                    .couponId("coupon_id")
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(mutatedSubscriptionModel.startDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(mutatedSubscriptionModel.status())
            .isEqualTo(MutatedSubscriptionModel.Status.ACTIVE)
        assertThat(mutatedSubscriptionModel.trialInfo())
            .isEqualTo(
                SubscriptionTrialInfoModel.builder()
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .build()

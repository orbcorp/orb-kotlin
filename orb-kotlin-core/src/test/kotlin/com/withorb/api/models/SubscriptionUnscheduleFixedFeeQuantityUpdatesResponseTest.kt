...
internal class SubscriptionUnscheduleFixedFeeQuantityUpdatesResponseTest {
    ...
    fun create() {
        val subscriptionUnscheduleFixedFeeQuantityUpdatesResponse =
            SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse.builder()
                ...
                .metadata(
                    SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse.Metadata.builder()
                        .putAdditionalProperty("foo", JsonValue.from("string"))
                        .build()
                )
                .addMinimumInterval(
                ...
                .changedResources(
                    SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse.ChangedResources.builder()
        ...
        assertThat(subscriptionUnscheduleFixedFeeQuantityUpdatesResponse.maximumIntervals())
            .containsExactly(
                SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse.MaximumInterval.builder()
                    ...
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .addFilter(
                        SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse.MaximumInterval.Filter
                            .builder()
                            .field(
                                SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse
                                    .MaximumInterval
        ...
        assertThat(subscriptionUnscheduleFixedFeeQuantityUpdatesResponse.minimumIntervals())
            .containsExactly(
                SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse.MinimumInterval.builder()
                    ...
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .addFilter(
                        SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse.MinimumInterval.Filter
                            .builder()
                            .field(
                                SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse
                                    .MinimumInterval
        ...
        assertThat(subscriptionUnscheduleFixedFeeQuantityUpdatesResponse.name()).isEqualTo("name")
        ...
        assertThat(subscriptionUnscheduleFixedFeeQuantityUpdatesResponse.changedResources())
            .isEqualTo(
                SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse.ChangedResources.builder()
                    .addCreatedCreditNote(
                        CreditNote.builder()
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionUnscheduleFixedFeeQuantityUpdatesResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(
                    subscriptionUnscheduleFixedFeeQuantityUpdatesResponse
                ),
                jacksonTypeRef<SubscriptionUnscheduleFixedFeeQuantityUpdatesResponse>(),
            )

        assertThat(roundtrippedSubscriptionUnscheduleFixedFeeQuantityUpdatesResponse)
            .isEqualTo(subscriptionUnscheduleFixedFeeQuantityUpdatesResponse)
    }
}

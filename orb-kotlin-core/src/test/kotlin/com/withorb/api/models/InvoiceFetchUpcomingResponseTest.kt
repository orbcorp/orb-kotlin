...
internal class InvoiceFetchUpcomingResponseTest {
    ...
    fun create() {
                            ...
                            MonetaryUsageDiscountAdjustment.builder()
                                ...
                                .addFilter(
                                    MonetaryUsageDiscountAdjustment.Filter.builder()
                                        .field(
                                            MonetaryUsageDiscountAdjustment.Filter.Field.PRICE_ID
                                        )
                                        .operator(
                                            MonetaryUsageDiscountAdjustment.Filter.Operator.INCLUDES
                                        )
                                        .addValue("string")
                                        .build()
                                )
        ...
        assertThat(invoiceFetchUpcomingResponse.hiddenLineItemCount()).isEqualTo(0L)

...
class AlertTest {
    ...
    fun createAlert() {
      ...
      assertThat(alert.customer()).isEqualTo(Alert.Customer.builder()
          .id("id")
          .externalCustomerId("external_customer_id")
          .build())
      assertThat(alert.enabled()).isEqualTo(true)
      assertThat(alert.metric()).isEqualTo(Alert.Metric.builder()
          .id("id")
          .build())
      assertThat(alert.plan()).isEqualTo(Alert.Plan.builder()
          .id("m2t5akQeh2obwxeU")
          .externalPlanId("m2t5akQeh2obwxeU")
          .name("Example plan")
          .planVersion("plan_version")
          .build())
      assertThat(alert.subscription()).isEqualTo(Alert.Subscription.builder()
          .id("VDGsT23osdLb84KD")
          .build())
      assertThat(alert.thresholds()).containsExactly(Alert.Threshold.builder()
          .value(0.0)
          .build())

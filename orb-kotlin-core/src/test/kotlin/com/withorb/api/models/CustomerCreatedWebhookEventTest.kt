...
internal class CustomerCreatedWebhookEventTest {

    @Test
    fun create() {
        val customerCreatedWebhookEvent =
            CustomerCreatedWebhookEvent.builder()
                .id("id")
                ...
                .type(CustomerCreatedWebhookEvent.Type.CUSTOMER_CREATED)
                .build()

        assertThat(customerCreatedWebhookEvent.id()).isEqualTo("id")
        assertThat(customerCreatedWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(customerCreatedWebhookEvent.customer())
            .isEqualTo(
                Customer.builder()
                    .id("id")
                    .addAdditionalEmail("string")
        ...
        assertThat(customerCreatedWebhookEvent._properties())
            .isEqualTo(JsonValue.from(mapOf<String, Any>()))
        assertThat(customerCreatedWebhookEvent.type())
            .isEqualTo(CustomerCreatedWebhookEvent.Type.CUSTOMER_CREATED)
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedCustomerCreatedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(customerCreatedWebhookEvent),
                jacksonTypeRef<CustomerCreatedWebhookEvent>(),
            )

        assertThat(roundtrippedCustomerCreatedWebhookEvent).isEqualTo(customerCreatedWebhookEvent)
    }
}

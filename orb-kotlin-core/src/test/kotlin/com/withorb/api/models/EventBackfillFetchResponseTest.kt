...
class EventBackfillFetchResponseTest {
    ...
    fun createEventBackfillFetchResponse() {
      ...
      assertThat(eventBackfillFetchResponse.closeTime()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(eventBackfillFetchResponse.revertedAt()).isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(eventBackfillFetchResponse.deprecationFilter()).isEqualTo("my_numeric_property > 100 AND my_other_property = 'bar'")
    }
}

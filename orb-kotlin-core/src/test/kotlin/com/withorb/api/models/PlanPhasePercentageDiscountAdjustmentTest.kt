    ...
    fun create() {
        val planPhasePercentageDiscountAdjustment =
            PlanPhasePercentageDiscountAdjustment.builder()
                ...
                .addFilter(
                    PlanPhasePercentageDiscountAdjustment.Filter.builder()
                        .field(PlanPhasePercentageDiscountAdjustment.Filter.Field.PRICE_ID)
                        .operator(PlanPhasePercentageDiscountAdjustment.Filter.Operator.INCLUDES)
                        .addValue("string")
                        .build()
                )
                .isInvoiceLevel(true)
        ...
        assertThat(planPhasePercentageDiscountAdjustment.planPhaseOrder()).isEqualTo(0L)
        assertThat(planPhasePercentageDiscountAdjustment.reason()).isEqualTo("reason")

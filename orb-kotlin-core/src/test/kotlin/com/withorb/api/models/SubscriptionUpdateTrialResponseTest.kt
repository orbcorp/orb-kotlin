...
internal class SubscriptionUpdateTrialResponseTest {
    ...
    fun create() {
            ...
            SubscriptionUpdateTrialResponse.builder()
                ...
                .addAdjustmentInterval(
                    SubscriptionUpdateTrialResponse.AdjustmentInterval.builder()
                        .id("id")
                        .adjustment(
                            SubscriptionUpdateTrialResponse.AdjustmentInterval.Adjustment
                                .UsageDiscount
                                .builder()
                                .id("id")
                                ...
                                .addFilter(
                                    SubscriptionUpdateTrialResponse.AdjustmentInterval.Adjustment
                                        ...
                                        .builder()
                                        .field(
                                            SubscriptionUpdateTrialResponse.AdjustmentInterval
                                                .Adjustment
                                                .UsageDiscount
                                                .Filter
                                                .Field
                ...
                .addDiscountInterval(
                    SubscriptionUpdateTrialResponse.DiscountInterval.Amount.builder()
                        .amountDiscount("amount_discount")
                        .addAppliesToPriceIntervalId("string")
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .addFilter(
                            SubscriptionUpdateTrialResponse.DiscountInterval.Amount.Filter.builder()
                                .field(
                                    SubscriptionUpdateTrialResponse.DiscountInterval.Amount.Filter
                                        .Field
                                        .PRICE_ID
                                )
                                .operator(
                ...
                .addMaximumInterval(
                    SubscriptionUpdateTrialResponse.MaximumInterval.builder()
                        .addAppliesToPriceIntervalId("string")
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .addFilter(
                            SubscriptionUpdateTrialResponse.MaximumInterval.Filter.builder()
                                .field(
                                    SubscriptionUpdateTrialResponse.MaximumInterval.Filter.Field
                                        .PRICE_ID
                                )
                                .operator(
                                    SubscriptionUpdateTrialResponse.MaximumInterval.Filter.Operator
                                        .INCLUDES
                                )
                                .addValue("string")
                                .build()
                ...
                .addMinimumInterval(
                    SubscriptionUpdateTrialResponse.MinimumInterval.builder()
                        ...
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .addFilter(
                            SubscriptionUpdateTrialResponse.MinimumInterval.Filter.builder()
                                .field(
                                    SubscriptionUpdateTrialResponse.MinimumInterval.Filter.Field
                                        .PRICE_ID
                                )
                                .operator(
                                    SubscriptionUpdateTrialResponse.MinimumInterval.Filter.Operator
                                        .INCLUDES
                                )
                                .addValue("string")
                                .build()
                ...
                .pendingSubscriptionChange(
                    SubscriptionUpdateTrialResponse.PendingSubscriptionChange.builder()
                        .id("id")
                        .build()
                )
                .plan(
                ...
                .addPriceInterval(
                    SubscriptionUpdateTrialResponse.PriceInterval.builder()
                        ...
                        .addFixedFeeQuantityTransition(
                            SubscriptionUpdateTrialResponse.PriceInterval.FixedFeeQuantityTransition
                                .builder()
                ...
                .redeemedCoupon(
                    SubscriptionUpdateTrialResponse.RedeemedCoupon.builder()
                        .couponId("coupon_id")
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .startDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .build()
                ...
                .trialInfo(
                    SubscriptionUpdateTrialResponse.TrialInfo.builder()
                        .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                        .build()
                )
                .changedResources(
                    SubscriptionUpdateTrialResponse.ChangedResources.builder()
        ...
        assertThat(subscriptionUpdateTrialResponse.activePlanPhaseOrder()).isEqualTo(0L)
        assertThat(subscriptionUpdateTrialResponse.adjustmentIntervals())
            .containsExactly(
                SubscriptionUpdateTrialResponse.AdjustmentInterval.builder()
                    .id("id")
                    .adjustment(
                        SubscriptionUpdateTrialResponse.AdjustmentInterval.Adjustment.UsageDiscount
                            .builder()
                            .id("id")
                            .addAppliesToPriceId("string")
                            .addFilter(
        ...
        assertThat(subscriptionUpdateTrialResponse.autoCollection()).isEqualTo(true)
        ...
        assertThat(subscriptionUpdateTrialResponse.currentBillingPeriodEndDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionUpdateTrialResponse.currentBillingPeriodStartDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionUpdateTrialResponse.customer())
            .isEqualTo(
                Customer.builder()
                    .id("id")
                    .addAdditionalEmail("string")
        ...
        assertThat(subscriptionUpdateTrialResponse.defaultInvoiceMemo())
        ...
        assertThat(subscriptionUpdateTrialResponse.endDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionUpdateTrialResponse.fixedFeeQuantitySchedule())
            .containsExactly(
                SubscriptionUpdateTrialResponse.FixedFeeQuantitySchedule.builder()
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .priceId("price_id")
        ...
        assertThat(subscriptionUpdateTrialResponse.invoicingThreshold())
            .isEqualTo("invoicing_threshold")
        assertThat(subscriptionUpdateTrialResponse.maximumIntervals())
            .containsExactly(
                SubscriptionUpdateTrialResponse.MaximumInterval.builder()
                    .addAppliesToPriceIntervalId("string")
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(subscriptionUpdateTrialResponse.name()).isEqualTo("name")
        assertThat(subscriptionUpdateTrialResponse.netTerms()).isEqualTo(0L)
        assertThat(subscriptionUpdateTrialResponse.pendingSubscriptionChange())
            .isEqualTo(
                SubscriptionUpdateTrialResponse.PendingSubscriptionChange.builder().id("id").build()
            )
        ...
        assertThat(subscriptionUpdateTrialResponse.redeemedCoupon())
            .isEqualTo(
                SubscriptionUpdateTrialResponse.RedeemedCoupon.builder()
                    .couponId("coupon_id")
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(subscriptionUpdateTrialResponse.startDate())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionUpdateTrialResponse.status())
            .isEqualTo(SubscriptionUpdateTrialResponse.Status.ACTIVE)
        assertThat(subscriptionUpdateTrialResponse.trialInfo())
            .isEqualTo(
                SubscriptionUpdateTrialResponse.TrialInfo.builder()
                    .endDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                    .build()
            )
        assertThat(subscriptionUpdateTrialResponse.changedResources())
            .isEqualTo(
                SubscriptionUpdateTrialResponse.ChangedResources.builder()
                    .addCreatedCreditNote(
                        CreditNote.builder()
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionUpdateTrialResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionUpdateTrialResponse),
                jacksonTypeRef<SubscriptionUpdateTrialResponse>(),
            )

        assertThat(roundtrippedSubscriptionUpdateTrialResponse)

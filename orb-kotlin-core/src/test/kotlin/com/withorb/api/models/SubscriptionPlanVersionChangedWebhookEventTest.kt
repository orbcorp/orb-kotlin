...
internal class SubscriptionPlanVersionChangedWebhookEventTest {

    @Test
    fun create() {
        val subscriptionPlanVersionChangedWebhookEvent =
            SubscriptionPlanVersionChangedWebhookEvent.builder()
                .id("id")
                .createdAt(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
                .properties(
                    SubscriptionPlanVersionChangedWebhookEvent.Properties.builder()
                ...
                .type(
                    SubscriptionPlanVersionChangedWebhookEvent.Type
                        .SUBSCRIPTION_PLAN_VERSION_CHANGED
                )
                .build()

        assertThat(subscriptionPlanVersionChangedWebhookEvent.id()).isEqualTo("id")
        assertThat(subscriptionPlanVersionChangedWebhookEvent.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(subscriptionPlanVersionChangedWebhookEvent.properties())
            .isEqualTo(
                SubscriptionPlanVersionChangedWebhookEvent.Properties.builder()
                    .effectiveDate("effective_date")
                    .newPlanVersionNumber(0L)
        ...
        assertThat(subscriptionPlanVersionChangedWebhookEvent.subscription())
            .isEqualTo(
                Subscription.builder()
                    .id("id")
                    .activePlanPhaseOrder(0L)
        ...
        assertThat(subscriptionPlanVersionChangedWebhookEvent.type())
            .isEqualTo(
                SubscriptionPlanVersionChangedWebhookEvent.Type.SUBSCRIPTION_PLAN_VERSION_CHANGED
            )
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedSubscriptionPlanVersionChangedWebhookEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(subscriptionPlanVersionChangedWebhookEvent),
                jacksonTypeRef<SubscriptionPlanVersionChangedWebhookEvent>(),
            )

        assertThat(roundtrippedSubscriptionPlanVersionChangedWebhookEvent)
            .isEqualTo(subscriptionPlanVersionChangedWebhookEvent)
    }
}

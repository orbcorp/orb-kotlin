...
internal class NewPlanMatrixWithDisplayNamePriceTest {
    ...
    fun create() {
        ...
        assertThat(newPlanMatrixWithDisplayNamePrice.licenseTypeId()).isEqualTo("license_type_id")
        ...
        assertThat(newPlanMatrixWithDisplayNamePrice.referenceId()).isEqualTo("reference_id")
    }

...
internal class IncrementLedgerEntryTest {
    ...
    fun create() {
        ...
        assertThat(incrementLedgerEntry.id()).isEqualTo("id")
        assertThat(incrementLedgerEntry.amount()).isEqualTo(0.0)
        assertThat(incrementLedgerEntry.createdAt())
            .isEqualTo(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(incrementLedgerEntry.creditBlock())
            .isEqualTo(
                AffectedBlock.builder()
                    .id("id")
                    .expiryDate(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        ...
        assertThat(incrementLedgerEntry.currency()).isEqualTo("currency")
        assertThat(incrementLedgerEntry.customer())
            .isEqualTo(
                CustomerMinified.builder()
                    .id("id")
                    .externalCustomerId("external_customer_id")
        ...
        assertThat(incrementLedgerEntry.description()).isEqualTo("description")
        assertThat(incrementLedgerEntry.endingBalance()).isEqualTo(0.0)
        assertThat(incrementLedgerEntry.entryStatus())
            .isEqualTo(IncrementLedgerEntry.EntryStatus.COMMITTED)
        assertThat(incrementLedgerEntry.entryType())
            .isEqualTo(IncrementLedgerEntry.EntryType.INCREMENT)
        assertThat(incrementLedgerEntry.ledgerSequenceNumber()).isEqualTo(0L)
        assertThat(incrementLedgerEntry.metadata())
            .isEqualTo(
                IncrementLedgerEntry.Metadata.builder()
                    .putAdditionalProperty("foo", JsonValue.from("string"))
                    .build()
            )
        assertThat(incrementLedgerEntry.startingBalance()).isEqualTo(0.0)
        assertThat(incrementLedgerEntry.createdInvoices())
            .containsExactly(
                Invoice.builder()
                    .id("id")
                    .amountDue("8.00")
    ...
    fun roundtrip() {
        ...
        val roundtrippedIncrementLedgerEntry =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(incrementLedgerEntry),
                jacksonTypeRef<IncrementLedgerEntry>(),
            )

        assertThat(roundtrippedIncrementLedgerEntry).isEqualTo(incrementLedgerEntry)
    }
}

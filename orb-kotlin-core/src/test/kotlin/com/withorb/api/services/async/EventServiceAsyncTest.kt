...
class EventServiceAsyncTest {
    ...
    suspend fun update() {
      ...
      val event = eventServiceAsync.update(EventUpdateParams.builder()
          .eventId("event_id")
    ...
    suspend fun deprecate() {
      ...
      val response = eventServiceAsync.deprecate(EventDeprecateParams.builder()
          .eventId("event_id")
          .build())
    ...
    suspend fun ingest() {
      ...
      val response = eventServiceAsync.ingest(EventIngestParams.builder()
          .backfillId("backfill_id")
          .debug(true)
          .addEvent(EventIngestParams.Event.builder()
              .eventName("event_name")
    ...
    suspend fun search() {
      ...
      val response = eventServiceAsync.search(EventSearchParams.builder()
          .addEventId("string")

...
class LedgerServiceAsyncTest {
    ...
    suspend fun list() {
      ...
      val page = ledgerServiceAsync.list(CustomerCreditLedgerListParams.builder()
    ...
    suspend fun createEntry() {
      ...
      val response = ledgerServiceAsync.createEntry(CustomerCreditLedgerCreateEntryParams.builder()
          .customerId("customer_id")
    ...
    suspend fun createEntryByExternalId() {
      ...
      val response = ledgerServiceAsync.createEntryByExternalId(CustomerCreditLedgerCreateEntryByExternalIdParams.builder()
    ...
    suspend fun listByExternalId() {
      ...
      val page = ledgerServiceAsync.listByExternalId(CustomerCreditLedgerListByExternalIdParams.builder()
          .externalCustomerId("external_customer_id")
          .build())

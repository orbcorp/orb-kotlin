...
class TopUpServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val topUp = topUpServiceAsync.create(CustomerCreditTopUpCreateParams.builder()
    ...
    suspend fun list() {
      ...
      val page = topUpServiceAsync.list(CustomerCreditTopUpListParams.builder()
          .customerId("customer_id")
          .build())
    ...
    suspend fun delete() {
      ...
      topUpServiceAsync.delete(CustomerCreditTopUpDeleteParams.builder()
          .customerId("customer_id")
          .topUpId("top_up_id")
          .build())
    }
    ...
    suspend fun createByExternalId() {
      ...
      val response = topUpServiceAsync.createByExternalId(CustomerCreditTopUpCreateByExternalIdParams.builder()
    ...
    suspend fun deleteByExternalId() {
      ...
      topUpServiceAsync.deleteByExternalId(CustomerCreditTopUpDeleteByExternalIdParams.builder()
          .externalCustomerId("external_customer_id")
          .topUpId("top_up_id")
          .build())
    }
    ...
    suspend fun listByExternalId() {
      ...
      val page = topUpServiceAsync.listByExternalId(CustomerCreditTopUpListByExternalIdParams.builder()
          .externalCustomerId("external_customer_id")
          .build())

...
class CouponServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val coupon = couponServiceAsync.create(CouponCreateParams.builder()
    ...
    suspend fun archive() {
      ...
      val coupon = couponServiceAsync.archive(CouponArchiveParams.builder()
          .couponId("coupon_id")
          .build())
    ...
    suspend fun fetch() {
      ...
      val coupon = couponServiceAsync.fetch(CouponFetchParams.builder()
          .couponId("coupon_id")
          .build())

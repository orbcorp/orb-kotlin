...
class InvoiceServiceAsyncTest {
    ...
    suspend fun fetch() {
      ...
      val invoice = invoiceServiceAsync.fetch(InvoiceFetchParams.builder()
          .invoiceId("invoice_id")
          .build())
    ...
    suspend fun fetchUpcoming() {
      ...
      val response = invoiceServiceAsync.fetchUpcoming(InvoiceFetchUpcomingParams.builder()
    ...
    suspend fun issue() {
      ...
      val invoice = invoiceServiceAsync.issue(InvoiceIssueParams.builder()
          .invoiceId("invoice_id")
          .synchronous(true)
          .build())
    ...
    suspend fun markPaid() {
      ...
      val invoice = invoiceServiceAsync.markPaid(InvoiceMarkPaidParams.builder()
          .invoiceId("invoice_id")
    ...
    suspend fun pay() {
      ...
      val invoice = invoiceServiceAsync.pay(InvoicePayParams.builder()
          .invoiceId("invoice_id")
          .build())
    ...
    suspend fun void() {
      ...
      val invoice = invoiceServiceAsync.void(InvoiceVoidParams.builder()
          .invoiceId("invoice_id")
          .build())

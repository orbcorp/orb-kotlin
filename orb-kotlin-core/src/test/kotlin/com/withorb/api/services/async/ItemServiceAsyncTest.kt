...
class ItemServiceAsyncTest {
    ...
    suspend fun create() {
      ...
      val item = itemServiceAsync.create(ItemCreateParams.builder()
          .name("API requests")
          .build())
    ...
    suspend fun update() {
      ...
      val item = itemServiceAsync.update(ItemUpdateParams.builder()
          .itemId("item_id")
    ...
    suspend fun fetch() {
      ...
      val item = itemServiceAsync.fetch(ItemFetchParams.builder()
          .itemId("item_id")
          .build())
